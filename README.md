...
The stem-consistency scoreboard (`tests/test_mamari_stem_consistency_scoreboard.py`) lists the published Barthel stems under each G00n ID in those seven mixed hits. It is a positional alignment table, not a type map. Standing lock: G009 aligns to 041 and 670, G004 to 008/078/670, G003 to 008/078/711 — the repeating 3-gram is on the delimiter span, not a consistent encoding of one delimiter stem. Snapshot stays 83/62 / 43+40.
