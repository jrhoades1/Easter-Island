"""I's cycle-172 leftover 2-gram previous 090 cluster lock.

Cycle 194 text-search lock. Uses already-vendored A–V and the
...
before 076 071 is 090 (backward 3-gram 090 076 071; the local
previous 4-gram ends with 090 076 071). Start-of-line is
no-backward. Cycle 191 leftover-3 previous 700, cycle 190
leftover previous-stem N_distinct=28, cycle 172 leftover
N=34, and cycle 171 I-only 43/0 stay. The 9 inside-family
sites do not count as leftover (including leftover n=4
maximal 999 090 076 071 at Ia4[155], Ia5[3], Ia5[24], which
are previous 090 076 071 but not leftover). Cycle 191's
three leftover 700 076 071 sites are a different 3-gram and
are disjoint from this previous-090 cluster. Cycle 179's
three leftover 076 071 090 forward sites are a different
3-gram and do not count. Ia1[163] 090 700 076 071 is leftover
but previous stem 700, not 090. 071 999 and 076 076 do not
count as this 2-gram.

Hypothesis N=3: exactly 3 of the 34 leftover sites share
previous 3-gram 090 076 071. Measured: N_leftover=34,
N_with_previous_090_076_071=3 at Ia5[67] 000 090 076 071,
Ia13[153] 076 090 076 071, Ia14[106] 090 090 076 071;
N_without=31; N_no_backward=0. Claim that can lose:
i_leftover_076_071_exactly_3_previous_090_076_071. True only
if N_with_previous_090_076_071=3. The claim is true. Do not
retune.
...
STANDING_N4 = 4
STEM_090 = "090"
GRAM3_BACKWARD = ("090", "076", "071")
STANDING_N_LEFTOVER = 34
STANDING_N_WITH_PREVIOUS_090_076_071 = 3
STANDING_N_WITHOUT = 31
STANDING_N_NO_BACKWARD = 0
STANDING_NO_BACKWARD_SITES = ()
STANDING_INSIDE_PREVIOUS_090_SITES = STANDING_LEFTOVER_090071_COVERED
STANDING_INSIDE_PREVIOUS_090_PREVIOUS_4GRAM = LEFTOVER_N4_090071
...
STANDING_NEAR_MISS_INSIDE_090_305_SITE = (SIDE_IA, "Ia12", 71)
STANDING_NEAR_MISS_INSIDE_090_305_PREVIOUS_4GRAM = ("090", "305", "076", "071")
...
STANDING_CLAIM = "i_leftover_076_071_exactly_3_previous_090_076_071"
STANDING_I_LEFTOVER_076_071_EXACTLY_3_PREVIOUS_090_076_071 = True
STANDING_RESULT = "i_leftover_076_071_previous_090"
...
def leftover_without_previous_090_076_071(
    sites: tuple[tuple[str, str, int], ...],
    backwards: tuple[tuple[str, ...] | None, ...],
    needle: tuple[str, ...] = GRAM3_BACKWARD,
) -> tuple[tuple[str, str, int], ...]:
    """Leftover sites that have a previous stem other than 090, or none."""
    return tuple(
        site
        for site, back in zip(sites, backwards, strict=True)
        if back != needle
...
def i_leftover_076_071_exactly_3_previous_090_076_071(
    n_with_previous_090_076_071: int,
    expected: int = HYPOTHESIS_N,
) -> bool:
    """True iff N_with_previous_090_076_071 equals the hypothesized 3."""
    return n_with_previous_090_076_071 == expected


class TestILeftover076071Previous090Helpers(unittest.TestCase):
    """Helpers on cycle-172 leftover 076 071 previous 090. No CV, no LLM."""

    def test_previous_requires_stem_090_before_2gram(self):
        """A previous 090 is a 3-gram; start-of-line is no-backward."""
        provider = MockProvider()
        self.assertEqual(GRAM2, ("076", "071"))
        self.assertEqual(GRAM3_BACKWARD, ("090", "076", "071"))
        self.assertEqual(GRAM3_BACKWARD[1:], GRAM2)
        self.assertEqual(GRAM3_BACKWARD[0], STEM_090)
        ...
        self.assertEqual(site_previous_stem(has_090, 2, GRAM2), STEM_090)
        ...
        double_090 = ["090", "090", "076", "071", "004"]
        self.assertEqual(site_previous_stem(double_090, 2, GRAM2), STEM_090)
        self.assertEqual(site_backward_3gram(double_090, 2, GRAM2), GRAM3_BACKWARD)
        self.assertEqual(
            site_previous_4gram(double_090, 2, GRAM2),
            ("090", "090", "076", "071"),
        )
    ...
    def test_exactly_3_can_fail(self):
        """Boolean is True only when N_with_previous_090_076_071=3."""
        provider = MockProvider()
        self.assertTrue(i_leftover_076_071_exactly_3_previous_090_076_071(3))
        self.assertFalse(i_leftover_076_071_exactly_3_previous_090_076_071(0))
        self.assertFalse(i_leftover_076_071_exactly_3_previous_090_076_071(2))
        self.assertFalse(i_leftover_076_071_exactly_3_previous_090_076_071(4))
        self.assertFalse(i_leftover_076_071_exactly_3_previous_090_076_071(5))
        self.assertFalse(i_leftover_076_071_exactly_3_previous_090_076_071(28))
        self.assertFalse(i_leftover_076_071_exactly_3_previous_090_076_071(34))
        self.assertFalse(i_leftover_076_071_exactly_3_previous_090_076_071(1))
        planted = STANDING_MATCHING_SITES + (STANDING_INSIDE_PREVIOUS_090_SITES[0],)
        planted_backs = (GRAM3_BACKWARD,) * 4
        self.assertEqual(
            leftover_with_previous_090_076_071(planted, planted_backs),
            planted,
        )
        self.assertFalse(
            i_leftover_076_071_exactly_3_previous_090_076_071(len(planted))
        )
        self.assertEqual(STANDING_CLAIM, "i_leftover_076_071_exactly_3_previous_090_076_071")
        self.assertTrue(STANDING_I_LEFTOVER_076_071_EXACTLY_3_PREVIOUS_090_076_071)
        self.assertEqual(
            STANDING_I_LEFTOVER_076_071_EXACTLY_3_PREVIOUS_090_076_071,
            HYPOTHESIS_N == STANDING_N_WITH_PREVIOUS_090_076_071,
        )
        self.assertEqual(STANDING_N_WITH_PREVIOUS_090_076_071 + STANDING_N_WITHOUT, 34)
        self.assertEqual(provider.get_call_history(), [])

    def test_inside_family_forward_cluster_and_near_misses_do_not_count(self):
        """Inside family, cycle-191 previous 700, cycle-179 forward 090, and 090 700 are not this cluster."""
        provider = MockProvider()
        self.assertEqual(STANDING_INSIDE_PREVIOUS_090_SITES, STANDING_LEFTOVER_090071_COVERED)
        ...
        for site in STANDING_INSIDE_PREVIOUS_090_SITES:
        ...
        self.assertEqual(
            STANDING_INSIDE_PREVIOUS_090_PREVIOUS_4GRAM[1:],
            GRAM3_BACKWARD,
        )
        self.assertIn(STANDING_NEAR_MISS_INSIDE_090_305_SITE, STANDING_INSIDE_SITES)
        self.assertNotIn(STANDING_NEAR_MISS_INSIDE_090_305_SITE, STANDING_LEFTOVER_SITES)
        self.assertNotEqual(
            STANDING_NEAR_MISS_INSIDE_090_305_PREVIOUS_4GRAM[1:],
            GRAM3_BACKWARD,
        )
        self.assertEqual(
            STANDING_NEAR_MISS_INSIDE_090_305_PREVIOUS_4GRAM[1:],
        ...
        self.assertEqual(
            STANDING_NEAR_MISS_CYCLE191_090_700_PREVIOUS_4GRAM[1:],
        ...
        for site in CYCLE179_MATCHING_SITES:
            ...
            self.assertIn(site, STANDING_WITHOUT_SITES)
            self.assertNotIn(site, STANDING_MATCHING_SITES)
        self.assertTrue(STANDING_CYCLE179_FORWARD_090_DOES_NOT_COUNT)
        self.assertEqual(CYCLE179_N_WITH, 3)
        self.assertEqual(CYCLE179_GRAM3_FORWARD, ("076", "071", "090"))
        self.assertNotEqual(GRAM3_BACKWARD, CYCLE179_GRAM3_FORWARD)
...
class TestMamariILeftover076071Previous090Scoreboard(unittest.TestCase):
    """Cited-fixture leftover 076 071 previous-090 cluster. Mock only."""
    ...
    def setUp(self):
        ...
        self.with_sites = leftover_with_previous_090_076_071(
            self.leftover_sites,
            self.backwards,
        )
        self.without_sites = leftover_without_previous_090_076_071(
            self.leftover_sites,
            self.backwards,
        )
        ...
        self.claim_holds = i_leftover_076_071_exactly_3_previous_090_076_071(
            self.n_with,
        )

    def test_tokens_and_sites_are_cycle_172_leftover_not_retuned(self):
        """2-gram and leftover 34 stay the cycle-191/190/172/171 locks."""
        self.assertEqual(GRAM2, ("076", "071"))
        self.assertEqual(GRAM3_BACKWARD, ("090", "076", "071"))
        ...
        self.assertEqual(prior_190["previous_stem_frequency"][1]["previous_stem"], STEM_090)
        self.assertEqual(prior_190["previous_stem_frequency"][1]["count"], 3)
    ...
    def test_counts_3_of_34_and_hypothesis_n_3_holds(self):
        ...
        self.assertEqual(self.n_with, STANDING_N_WITH_PREVIOUS_090_076_071)
        self.assertEqual(STANDING_N_WITH_PREVIOUS_090_076_071, 3)
        ...
        self.assertTrue(i_leftover_076_071_exactly_3_previous_090_076_071(self.n_with))
        self.assertEqual(
            self.claim_holds,
            STANDING_I_LEFTOVER_076_071_EXACTLY_3_PREVIOUS_090_076_071,
        )
        ...
        if self.n_with != 3:
            self.fail("measured N_with_previous_090_076_071 drifted from 3")
    ...
    def test_matching_leftover_sites_and_previous_4grams(self):
        """Three leftover sites share 090 076 071; they are disjoint from cycle-191 leftover-3."""
        ...
        expected = (
            ((SIDE_IA, "Ia5", 67), ("000", "090", "076", "071")),
            ((SIDE_IA, "Ia13", 153), ("076", "090", "076", "071")),
            ((SIDE_IA, "Ia14", 106), ("090", "090", "076", "071")),
        )
        for (site, prev4), (want_site, want_prev4) in zip(
            ...
            self.assertEqual(stems[index - 1], STEM_090)
            self.assertEqual(site_previous_stem(stems, index, GRAM2), STEM_090)
        ...
        for site in STANDING_WITHOUT_SITES:
            ...
            self.assertNotEqual(back[0], STEM_090)
        ...
        self.assertEqual(near_stems[near_index - 2], STEM_090)
        ...
        for site, nxt in zip(CYCLE179_MATCHING_SITES, CYCLE179_MATCHING_NEXT_4GRAMS):
            stems = line_stems_for_site(self.i_sides, site)
            index = site[2]
            self.assertEqual(tuple(stems[index : index + STANDING_N3]), CYCLE179_GRAM3_FORWARD)
            self.assertEqual(nxt[:3], CYCLE179_GRAM3_FORWARD)
            self.assertIn(site, self.without_sites)
            self.assertNotIn(site, self.with_sites)
            self.assertNotEqual(
        ...
        inside_index = STANDING_NEAR_MISS_INSIDE_090_305_SITE[2]
        self.assertEqual(
            site_previous_4gram(inside_stems, inside_index, GRAM2),
            STANDING_NEAR_MISS_INSIDE_090_305_PREVIOUS_4GRAM,
        )
        self.assertEqual(site_previous_stem(inside_stems, inside_index, GRAM2), "305")
        self.assertNotIn(STANDING_NEAR_MISS_INSIDE_090_305_SITE, self.with_sites)
    ...
    def test_existing_191_190_172_171_scoreboards_still_compute(self):
        """Cycle 191 leftover-3, 190 N_distinct=28, 172 leftover-34, and 171 I-only 43/0 stay."""
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-194 leftover previous-090 lock."""
        lock = self.survey["i_leftover_076_071_previous_090"]
        self.assertEqual(lock["cycle"], 194)
        ...
        self.assertEqual(lock["previous_stem"], STEM_090)
        ...
        self.assertEqual(
            lock["N_with_previous_090_076_071"],
            STANDING_N_WITH_PREVIOUS_090_076_071,
        )
        self.assertEqual(lock["N_with_previous_090_076_071"], 3)
        ...
        self.assertEqual(
            [list(site) for site in STANDING_INSIDE_PREVIOUS_090_SITES],
            lock["inside_previous_090_sites"],
        )
        self.assertEqual(
            tuple(lock["inside_previous_090_previous_4gram"]),
            STANDING_INSIDE_PREVIOUS_090_PREVIOUS_4GRAM,
        )
        self.assertEqual(
        ...
        self.assertTrue(lock["cycle179_forward_090_does_not_count"])
        ...
        self.assertTrue(lock["i_leftover_076_071_exactly_3_previous_090_076_071"])
        self.assertEqual(
            lock["i_leftover_076_071_exactly_3_previous_090_076_071"],
            STANDING_I_LEFTOVER_076_071_EXACTLY_3_PREVIOUS_090_076_071,
        )
...
class TestMamariILeftover076071Previous090ImageSnapshot(unittest.TestCase):
    """Cycle 194 does not touch clustering. 83/62 / Hamming 6 stays."""
