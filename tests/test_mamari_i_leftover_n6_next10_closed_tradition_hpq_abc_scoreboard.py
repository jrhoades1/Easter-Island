"""Reframed closed-tradition hold-out of the locked leftover-6 next-10 grams.

Cycle 843 text-search lock. Uses already-vendored A–V and the
cycle-483 leftover n=6 remaining remaining-after-090-076
remaining-after-430-076 remaining-after-076-020 remaining-
after-076-010 next 10-grams (15 sequences; parent N=18; three
line-final holes at Ia8[167], Ia8[166], and Ia8[165]).
HEAD-check: that gram list exists and is not yet locked under
this reframed rule. Cycle 483 already locked the I-only claim
on these 10-grams as incomplete-set LOSE (N_with_next10=15,
N_no_next10=3, N_i_only=15, N_leak=0). Cycle 842 already locked
the reframed claim on the cycle-481 next-9 grams as
incomplete-set LOSE. This cycle does not re-lock either claim,
and does not re-lock Cycles 832–842.

Claim that can lose: each existing next-10 gram is an exact
...
Measured on the 15 with-next10 grams: N=15, N_hpq_ge1=0,
N_hpq_ge2=0, N_exact0_abc=15, N_i_ge1=15, N_exact0_i=0,
N_leak=0, N_hold=0, hits_I=15. Parent N=18, N_with_next10=15,
N_no_next10=3 (Ia8[167], Ia8[166], Ia8[165]). Every scored gram
is exact-0 on H/P/Q and on A/B/C and an exact contiguous hit
once on I. The next-9 hapax 604 076 071 600 999 050 076 000 002
extends to 604 076 071 600 999 050 076 000 002 999 at Ia9[9] and
hits I once. All fifteen next-9 grams extend; no new hole.
...
next 11-grams as a peel, prev-184, or next-185. The cycle-485
next-11 I-only list stays the named next lock and is not re-scored.
...
from tests.test_mamari_i_leftover_n6_next8_closed_tradition_hpq_abc_scoreboard import (
    CYCLE840_SEQUENCES,
    CYCLE840_SITES,
    STANDING_NEXT7_HAPAX_DROPPED_INDEX as CYCLE841_NEXT7_DROPPED_INDEX,
)
from tests.test_mamari_i_leftover_n6_next9_closed_tradition_hpq_abc_scoreboard import (
    STANDING_HITS_I as CYCLE842_HITS_I,
    STANDING_N_HOLD as CYCLE842_N_HOLD,
    STANDING_N_LEAK as CYCLE842_N_LEAK,
    STANDING_NEXT_CHEAP_LOCK as CYCLE842_NEXT_CHEAP_LOCK,
    STANDING_NO_NEXT9_SITES as CYCLE842_NO_NEXT9_SITES,
    STANDING_RESULT as CYCLE842_RESULT,
    STANDING_SEQUENCES as CYCLE842_SEQUENCES,
    STANDING_SITES as CYCLE842_SITES,
    STANDING_VERDICT as CYCLE842_VERDICT,
)
...
from tests.test_mamari_i_leftover_n6_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_next10_i_only_scoreboard import (
    HYPOTHESIS_ALL_I_ONLY as CYCLE483_HYPOTHESIS_ALL_I_ONLY,
    STANDING_I_LEFTOVER_N6_REMAINING_AFTER_090_076_REMAINING_AFTER_430_076_REMAINING_AFTER_076_020_REMAINING_AFTER_076_010_NEXT_10GRAMS_ALL_I_ONLY as CYCLE483_ALL_I_ONLY_CLAIM,
    STANDING_LEFTOVER_MATCHING_NEXT10_SITES as CYCLE483_SITES,
    STANDING_N as CYCLE483_N,
    STANDING_N_I_EACH as CYCLE483_N_I_EACH,
    STANDING_N_I_ONLY as CYCLE483_N_I_ONLY,
    STANDING_N_LEAK as CYCLE483_N_LEAK,
    STANDING_N_NO_NEXT10 as CYCLE483_N_NO_NEXT10,
    STANDING_N_SEQUENCES as CYCLE483_N_SEQUENCES,
    STANDING_N_WITH_NEXT10 as CYCLE483_N_WITH_NEXT10,
    STANDING_NO_NEXT10_SITES as CYCLE483_NO_NEXT10_SITES,
    STANDING_RESULT as CYCLE483_RESULT,
...
from tests.test_mamari_i_leftover_n6_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_next11_i_only_scoreboard import (
    HYPOTHESIS_ALL_I_ONLY as CYCLE485_HYPOTHESIS_ALL_I_ONLY,
    STANDING_I_LEFTOVER_N6_REMAINING_AFTER_090_076_REMAINING_AFTER_430_076_REMAINING_AFTER_076_020_REMAINING_AFTER_076_010_NEXT_11GRAMS_ALL_I_ONLY as CYCLE485_ALL_I_ONLY_CLAIM,
    ...
    STANDING_N_SEQUENCES as CYCLE485_N_SEQUENCES,
    STANDING_N_WITH_NEXT11 as CYCLE485_N_WITH_NEXT11,
    STANDING_NO_NEXT11_SITES as CYCLE485_NO_NEXT11_SITES,
    STANDING_RESULT as CYCLE485_RESULT,
...
STANDING_NO_NEXT10_SITES = CYCLE483_NO_NEXT10_SITES
STANDING_PARENT_COMPLETE = False
STANDING_HITS_EACH = (0, 0, 0, 0, 0, 0, 1)
STANDING_HITS = (STANDING_HITS_EACH,) * STANDING_N
STANDING_SITES = CYCLE483_SITES
STANDING_SEQUENCES = CYCLE483_SEQUENCES
...
STANDING_NEXT9_HAPAX_STILL_HAPAX = (3,)
STANDING_NEXT9_ALL_EXTEND = True
STANDING_HITS_H = 0
STANDING_HITS_P = 0
STANDING_HITS_Q = 0
STANDING_HITS_A = 0
...
STANDING_CLAIM = "leftover6_next10_reframed_closed_tradition_hpq_ge1_and_exact0_abc"
STANDING_RESULT = "i_leftover_n6_next10_closed_tradition_hpq_abc"
STANDING_AXIS = "closed-tradition-reframed"
STANDING_FROM_CYCLE = 483
STANDING_I_ONLY_ALREADY_LOCKED = True
STANDING_I_ONLY_CYCLE = 483
...
STANDING_DO_NOT_RELOCK_CYCLES_832_842 = True
...
STANDING_DO_NOT_LAUNCH_NEXT11 = True
STANDING_DO_NOT_LAUNCH_PREV184 = True
STANDING_DO_NOT_LAUNCH_NEXT185 = True
STANDING_NEW_TABLET = False
STANDING_I_IN_ABSENT_SET = False
STANDING_NAMED_BY_CYCLE842 = (
    "cycle483_next10_reframed_closed_tradition_hpq_ge1_exact0_abc"
)
STANDING_NEXT_CHEAP_LOCK = (
    "cycle485_next11_reframed_closed_tradition_hpq_ge1_exact0_abc"
)
...
class TestMamariILeftoverN6Next10ClosedTraditionHpqAbcScoreboard(unittest.TestCase):
    """Cycle 843 reframed closed-tradition lock on the cycle-483 next-10 population."""
    ...
    def test_population_is_the_locked_cycle_483_next10_grams(self):
        """Fifteen next-10 sequences and sites come from cycle 483. None invented."""
        self.assertEqual(len(STANDING_SEQUENCES), STANDING_N)
        self.assertEqual(len(STANDING_SITES), STANDING_N)
        self.assertEqual(STANDING_SEQUENCES, CYCLE483_SEQUENCES)
        self.assertEqual(STANDING_SITES, CYCLE483_SITES)
        self.assertEqual(CYCLE483_N, STANDING_N_PARENT)
        self.assertEqual(CYCLE483_N, 18)
        self.assertEqual(CYCLE483_N_SEQUENCES, 15)
        self.assertEqual(STANDING_N_WITH_NEXT10, CYCLE483_N_WITH_NEXT10)
        self.assertEqual(STANDING_N_NO_NEXT10, CYCLE483_N_NO_NEXT10)
        self.assertEqual(
            STANDING_NO_NEXT10_SITES,
            (("Ia", "Ia8", 167), ("Ia", "Ia8", 166), ("Ia", "Ia8", 165)),
        )
        self.assertEqual(STANDING_NO_NEXT10_SITES, CYCLE842_NO_NEXT9_SITES)
        self.assertFalse(STANDING_PARENT_COMPLETE)
        self.assertTrue(CYCLE483_HYPOTHESIS_ALL_I_ONLY)
        self.assertFalse(CYCLE483_ALL_I_ONLY_CLAIM)
        self.assertEqual(CYCLE483_N_I_ONLY, 15)
        self.assertEqual(CYCLE483_N_LEAK, 0)
        self.assertEqual(STANDING_FROM_CYCLE, 483)
        ...
        for row, tokens, site in zip(self.rows, STANDING_SEQUENCES, STANDING_SITES, strict=True):
            ...
            self.assertEqual(len(row.tokens), 10)
        prior = self.survey[CYCLE483_RESULT]
        all_i_only_key = (
            "i_leftover_n6_remaining_after_090_076_remaining_after_430_076_"
            "remaining_after_076_020_remaining_after_076_010_next_10grams_all_i_only"
        )
        self.assertEqual(CYCLE483_RESULT, (
            "i_leftover_n6_remaining_after_090_076_remaining_after_430_076_"
            "remaining_after_076_020_remaining_after_076_010_next10_i_only"
        ))
        self.assertEqual(prior["cycle"], 483)
        ...
        self.assertFalse(prior[CYCLE483_RESULT])
        self.assertEqual(prior["N_i_only"], 15)
        self.assertEqual(prior["N_leak"], 0)
        self.assertEqual(prior["N_no_next10"], 3)
        self.assertEqual(prior["N_with_next10"], 15)
        self.assertNotIn(STANDING_NAMED_BY_CYCLE842, self.survey)
        self.assertEqual(self.provider.get_call_history(), [])

    def test_prior_locks_stay_locked(self):
        """Do not re-lock cycle 483 I-only or the cycle 832–842 boards."""
        ...
        self.assertEqual(STANDING_I_ONLY_CYCLE, 483)
        ...
        next9 = self.survey[CYCLE842_RESULT]
        self.assertEqual(next9["cycle"], STANDING_NEXT9_REFRAMED_CYCLE)
        self.assertEqual(next9["verdict"], CYCLE842_VERDICT)
        self.assertEqual(next9["verdict"], "incomplete-set LOSE")
        self.assertEqual(next9["N_hold"], CYCLE842_N_HOLD)
        self.assertEqual(next9["N_hold"], 0)
        self.assertEqual(next9["N_leak"], CYCLE842_N_LEAK)
        self.assertEqual(next9["N_leak"], 0)
        self.assertEqual(next9["hits_I"], CYCLE842_HITS_I)
        self.assertEqual(next9["hits_I"], 15)
        self.assertEqual(next9["N_hpq_ge1"], 0)
        self.assertEqual(next9["N_exact0_abc"], 15)
        self.assertEqual(next9["N_with_next9"], 15)
        self.assertEqual(next9["N_no_next9"], 3)
        self.assertEqual(next9["next_cheap_lock"], STANDING_NAMED_BY_CYCLE842)
        self.assertEqual(next9["next_cheap_lock"], CYCLE842_NEXT_CHEAP_LOCK)
        self.assertNotIn(STANDING_NAMED_BY_CYCLE842, self.survey)
        ...
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLES_832_842)
        self.assertEqual(self.provider.get_call_history(), [])
    ...
    def test_measured_table_is_incomplete_set_lose(self):
        ...
        self.assertEqual(tuple(row.hits[-1] for row in self.rows), CYCLE483_N_I_EACH)
        self.assertEqual(CYCLE483_N_I_EACH, (1,) * STANDING_N)
        ...
        self.assertTrue(STANDING_NEXT9_ALL_EXTEND)
        for n9, n10, site9, site10 in zip(
            CYCLE842_SEQUENCES, STANDING_SEQUENCES, CYCLE842_SITES, STANDING_SITES, strict=True
        ):
            self.assertEqual(n10[:9], n9)
            self.assertEqual(site10, site9)
        still = self.rows[STANDING_NEXT9_HAPAX_STILL_HAPAX[0]]
        self.assertEqual(
            still.tokens,
            ("604", "076", "071", "600", "999", "050", "076", "000", "002", "999"),
        )
        self.assertEqual(still.site, ("Ia", "Ia9", 9))
        self.assertEqual(still.as_map()["I"], 1)
        self.assertEqual(still.tokens[:9], CYCLE842_SEQUENCES[3])
        self.assertEqual(CYCLE842_SITES[3], ("Ia", "Ia9", 9))
        ...
        self.assertIn(("Ia", "Ia8", 165), STANDING_NO_NEXT10_SITES)
    ...
    def test_window_peels_closed_and_prev1_list_is_absent(self):
        ...
        self.assertTrue(STANDING_DO_NOT_LAUNCH_NEXT11)
    ...
    def test_next_cheap_lock_is_the_locked_cycle_485_next11_list(self):
        """Cycle 485 next-11 grams are already locked and not yet reframed."""
        self.assertEqual(CYCLE485_N, 18)
        self.assertEqual(CYCLE485_N_SEQUENCES, 15)
        self.assertEqual(len(CYCLE485_SEQUENCES), 15)
        self.assertTrue(all(len(tokens) == 11 for tokens in CYCLE485_SEQUENCES))
        self.assertTrue(CYCLE485_HYPOTHESIS_ALL_I_ONLY)
        self.assertFalse(CYCLE485_ALL_I_ONLY_CLAIM)
        ...
        self.assertEqual(
            CYCLE485_NO_NEXT11_SITES,
            (("Ia", "Ia8", 167), ("Ia", "Ia8", 166), ("Ia", "Ia8", 165)),
        )
        prior = self.survey[CYCLE485_RESULT]
        all_i_only_key = (
            "i_leftover_n6_remaining_after_090_076_remaining_after_430_076_"
            "remaining_after_076_020_remaining_after_076_010_next_11grams_all_i_only"
        )
        self.assertEqual(prior["cycle"], 485)
        self.assertEqual(prior["N"], 18)
        self.assertEqual(prior["N_sequences"], 15)
        self.assertEqual(prior["N_6grams"], 18)
        self.assertTrue(prior["hypothesis_all_i_only"])
        self.assertFalse(prior[all_i_only_key])
        self.assertFalse(prior[CYCLE485_RESULT])
        self.assertEqual(prior["N_i_only"], 15)
        self.assertEqual(prior["N_leak"], 0)
        self.assertEqual(prior["N_no_next11"], 3)
        self.assertEqual(prior["N_with_next11"], 15)
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-843 incomplete-set LOSE table."""
        lock = self.survey[STANDING_RESULT]
        self.assertEqual(lock["cycle"], 843)
        ...
        self.assertEqual(
            tuple(tuple(site) for site in lock["no_next10_sites"]),
            STANDING_NO_NEXT10_SITES,
        )
        ...
        self.assertTrue(lock["do_not_relock_cycles_832_842"])
        ...
        self.assertEqual(lock["named_by_cycle842"], STANDING_NAMED_BY_CYCLE842)
        ...
        self.assertEqual(
            tuple(lock["next9_hapax_still_hapax"]),
            STANDING_NEXT9_HAPAX_STILL_HAPAX,
        )
        self.assertTrue(lock["next9_all_extend"])
        self.assertEqual(lock["next9_all_extend"], STANDING_NEXT9_ALL_EXTEND)
