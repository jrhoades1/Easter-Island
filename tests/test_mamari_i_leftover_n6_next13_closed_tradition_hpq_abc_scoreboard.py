"""Reframed closed-tradition hold-out of the locked leftover-6 next-13 grams.

Cycle 846 text-search lock. Uses already-vendored A–V and the
cycle-489 leftover n=6 remaining remaining-after-090-076
remaining-after-430-076 remaining-after-076-020 remaining-
after-076-010 next 13-grams (15 sequences; parent N=18; three
line-final holes at Ia8[167], Ia8[166], and Ia8[165]).
HEAD-check: that gram list exists and is not yet locked under
this reframed rule. Cycle 489 already locked the I-only claim
on these 13-grams as incomplete-set LOSE (N_with_next13=15,
N_no_next13=3, N_i_only=15, N_leak=0). Cycle 845 already locked
the reframed claim on the cycle-487 next-12 grams as
incomplete-set LOSE. This cycle does not re-lock either claim,
and does not re-lock Cycles 832–845.

Claim that can lose: each existing next-13 gram is an exact
...
Measured on the 15 with-next13 grams: N=15, N_hpq_ge1=0,
N_hpq_ge2=0, N_exact0_abc=15, N_i_ge1=15, N_exact0_i=0,
N_leak=0, N_hold=0, hits_I=15. Parent N=18, N_with_next13=15,
N_no_next13=3 (Ia8[167], Ia8[166], Ia8[165]). Every scored gram
is exact-0 on H/P/Q and on A/B/C and an exact contiguous hit
once on I. The next-12 hapax 604 076 071 600 999 050 076 000
002 999 076 092 extends to 604 076 071 600 999 050 076 000 002
999 076 092 535 at Ia9[9] and hits I once. All fifteen next-12
...
next 13-grams as a peel, next 14-grams as a peel, prev-184, or
next-185. The cycle-491 next-14 I-only list stays the named
...
from tests.test_mamari_i_leftover_n6_next12_closed_tradition_hpq_abc_scoreboard import (
    ABSENT_TABLETS,
    CYCLE457_RESULT,
    ...
    PREV1_N6_SCOREBOARD,
    PROBE_TABLETS,
    STANDING_HITS_I as CYCLE845_HITS_I,
    STANDING_N_HOLD as CYCLE845_N_HOLD,
    STANDING_N_LEAK as CYCLE845_N_LEAK,
    STANDING_NEXT_CHEAP_LOCK as CYCLE845_NEXT_CHEAP_LOCK,
    STANDING_NO_NEXT12_SITES as CYCLE845_NO_NEXT12_SITES,
    STANDING_RESULT as CYCLE845_RESULT,
    STANDING_SEQUENCES as CYCLE845_SEQUENCES,
    STANDING_SITES as CYCLE845_SITES,
    STANDING_VERDICT as CYCLE845_VERDICT,
    absent_hit_sum,
    hpq_tablets_hit,
    reframed_verdict,
    row_holds,
...
from tests.test_mamari_i_leftover_n6_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_next13_i_only_scoreboard import (
    STANDING_LEFTOVER_MATCHING_NEXT13_SITES as CYCLE489_SITES,
    STANDING_N_I_EACH as CYCLE489_N_I_EACH,
)
from tests.test_mamari_i_leftover_n6_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_next14_i_only_scoreboard import (
    HYPOTHESIS_ALL_I_ONLY as CYCLE491_HYPOTHESIS_ALL_I_ONLY,
    STANDING_I_LEFTOVER_N6_REMAINING_AFTER_090_076_REMAINING_AFTER_430_076_REMAINING_AFTER_076_020_REMAINING_AFTER_076_010_NEXT14_I_ONLY as CYCLE491_ALL_I_ONLY_CLAIM,
    ...
    STANDING_N_SEQUENCES as CYCLE491_N_SEQUENCES,
    STANDING_N_WITH_NEXT14 as CYCLE491_N_WITH_NEXT14,
    STANDING_NO_NEXT14_SITES as CYCLE491_NO_NEXT14_SITES,
    STANDING_RESULT as CYCLE491_RESULT,
...
STANDING_NO_NEXT13_SITES = CYCLE489_NO_NEXT13_SITES
STANDING_PARENT_COMPLETE = False
STANDING_HITS_EACH = (0, 0, 0, 0, 0, 0, 1)
STANDING_HITS = (STANDING_HITS_EACH,) * STANDING_N
STANDING_SITES = CYCLE489_SITES
STANDING_SEQUENCES = CYCLE489_SEQUENCES
...
STANDING_NEXT12_HAPAX_STILL_HAPAX = (3,)
STANDING_NEXT12_ALL_EXTEND = True
STANDING_HITS_H = 0
STANDING_HITS_P = 0
STANDING_HITS_Q = 0
STANDING_HITS_A = 0
...
STANDING_CLAIM = "leftover6_next13_reframed_closed_tradition_hpq_ge1_and_exact0_abc"
STANDING_RESULT = "i_leftover_n6_next13_closed_tradition_hpq_abc"
STANDING_AXIS = "closed-tradition-reframed"
STANDING_FROM_CYCLE = 489
STANDING_I_ONLY_ALREADY_LOCKED = True
STANDING_I_ONLY_CYCLE = 489
...
STANDING_DO_NOT_RELOCK_CYCLES_832_845 = True
...
STANDING_NAMED_BY_CYCLE845 = (
    "cycle489_next13_reframed_closed_tradition_hpq_ge1_exact0_abc"
)
STANDING_NEXT_CHEAP_LOCK = (
    "cycle491_next14_reframed_closed_tradition_hpq_ge1_exact0_abc"
)
...
class TestMamariILeftoverN6Next13ClosedTraditionHpqAbcScoreboard(unittest.TestCase):
    """Cycle 846 reframed closed-tradition lock on the cycle-489 next-13 population."""
    ...
    def test_population_is_the_locked_cycle_489_next13_grams(self):
        """Fifteen next-13 sequences and sites come from cycle 489. None invented."""
        self.assertEqual(len(STANDING_SEQUENCES), STANDING_N)
        self.assertEqual(len(STANDING_SITES), STANDING_N)
        self.assertEqual(STANDING_SEQUENCES, CYCLE489_SEQUENCES)
        self.assertEqual(STANDING_SITES, CYCLE489_SITES)
        self.assertEqual(CYCLE489_N, STANDING_N_PARENT)
        self.assertEqual(CYCLE489_N, 18)
        self.assertEqual(CYCLE489_N_SEQUENCES, 15)
        self.assertEqual(STANDING_N_WITH_NEXT13, CYCLE489_N_WITH_NEXT13)
        self.assertEqual(STANDING_N_NO_NEXT13, CYCLE489_N_NO_NEXT13)
        self.assertEqual(
            STANDING_NO_NEXT13_SITES,
            (("Ia", "Ia8", 167), ("Ia", "Ia8", 166), ("Ia", "Ia8", 165)),
        )
        self.assertEqual(STANDING_NO_NEXT13_SITES, CYCLE845_NO_NEXT12_SITES)
        ...
        self.assertEqual(STANDING_FROM_CYCLE, 489)
        ...
        for row, tokens, site in zip(self.rows, STANDING_SEQUENCES, STANDING_SITES, strict=True):
            ...
            self.assertEqual(len(row.tokens), 13)
        ...
        self.assertEqual(CYCLE489_RESULT, (
            "i_leftover_n6_remaining_after_090_076_remaining_after_430_076_"
            "remaining_after_076_020_remaining_after_076_010_next13_i_only"
        ))
        ...
        self.assertNotIn(STANDING_NAMED_BY_CYCLE845, self.survey)
        self.assertEqual(self.provider.get_call_history(), [])

    def test_prior_locks_stay_locked(self):
        """Do not re-lock cycle 489 I-only or the cycle 832–845 boards."""
        ...
        self.assertEqual(STANDING_I_ONLY_CYCLE, 489)
        ...
        next12 = self.survey[CYCLE845_RESULT]
        self.assertEqual(next12["cycle"], STANDING_NEXT12_REFRAMED_CYCLE)
        self.assertEqual(next12["verdict"], CYCLE845_VERDICT)
        self.assertEqual(next12["verdict"], "incomplete-set LOSE")
        self.assertEqual(next12["N_hold"], CYCLE845_N_HOLD)
        self.assertEqual(next12["N_hold"], 0)
        self.assertEqual(next12["N_leak"], CYCLE845_N_LEAK)
        self.assertEqual(next12["N_leak"], 0)
        self.assertEqual(next12["hits_I"], CYCLE845_HITS_I)
        self.assertEqual(next12["hits_I"], 15)
        self.assertEqual(next12["N_hpq_ge1"], 0)
        self.assertEqual(next12["N_exact0_abc"], 15)
        self.assertEqual(next12["N_with_next12"], 15)
        self.assertEqual(next12["N_no_next12"], 3)
        self.assertEqual(next12["next_cheap_lock"], STANDING_NAMED_BY_CYCLE845)
        self.assertEqual(next12["next_cheap_lock"], CYCLE845_NEXT_CHEAP_LOCK)
        self.assertNotIn(STANDING_NAMED_BY_CYCLE845, self.survey)
        ...
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLES_832_845)
        self.assertEqual(self.provider.get_call_history(), [])
    ...
    def test_measured_table_is_incomplete_set_lose(self):
        ...
        self.assertEqual(tuple(row.hits[-1] for row in self.rows), CYCLE489_N_I_EACH)
        self.assertEqual(CYCLE489_N_I_EACH, (1,) * STANDING_N)
        ...
        self.assertTrue(STANDING_NEXT12_ALL_EXTEND)
        for n12, n13, site12, site13 in zip(
            CYCLE845_SEQUENCES, STANDING_SEQUENCES, CYCLE845_SITES, STANDING_SITES, strict=True
        ):
            self.assertEqual(n13[:12], n12)
            self.assertEqual(site13, site12)
        still = self.rows[STANDING_NEXT12_HAPAX_STILL_HAPAX[0]]
        self.assertEqual(
            still.tokens,
            (
        ...
        self.assertEqual(still.tokens[:12], CYCLE845_SEQUENCES[3])
        self.assertEqual(CYCLE845_SITES[3], ("Ia", "Ia9", 9))
        ...
        self.assertIn(("Ia", "Ia8", 165), STANDING_NO_NEXT13_SITES)
    ...
    def test_next_cheap_lock_is_the_locked_cycle_491_next14_list(self):
        """Cycle 491 next-14 grams are already locked and not yet reframed."""
        self.assertEqual(CYCLE491_N, 18)
        self.assertEqual(CYCLE491_N_SEQUENCES, 15)
        self.assertEqual(len(CYCLE491_SEQUENCES), 15)
        self.assertTrue(all(len(tokens) == 14 for tokens in CYCLE491_SEQUENCES))
        self.assertTrue(CYCLE491_HYPOTHESIS_ALL_I_ONLY)
        self.assertFalse(CYCLE491_ALL_I_ONLY_CLAIM)
        ...
        self.assertEqual(
            CYCLE491_NO_NEXT14_SITES,
            (("Ia", "Ia8", 167), ("Ia", "Ia8", 166), ("Ia", "Ia8", 165)),
        )
        prior = self.survey[CYCLE491_RESULT]
        all_i_only_key = (
            "i_leftover_n6_remaining_after_090_076_remaining_after_430_076_"
            "remaining_after_076_020_remaining_after_076_010_next_14grams_all_i_only"
        )
        self.assertEqual(prior["cycle"], 491)
        self.assertEqual(prior["N"], 18)
        self.assertEqual(prior["N_sequences"], 15)
        self.assertEqual(prior["N_6grams"], 18)
        self.assertTrue(prior["hypothesis_all_i_only"])
        self.assertFalse(prior[all_i_only_key])
        self.assertFalse(prior[CYCLE491_RESULT])
        self.assertEqual(prior["N_i_only"], 15)
        self.assertEqual(prior["N_leak"], 0)
        self.assertEqual(prior["N_no_next14"], 3)
        self.assertEqual(prior["N_with_next14"], 15)
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-846 incomplete-set LOSE table."""
        lock = self.survey[STANDING_RESULT]
        self.assertEqual(lock["cycle"], 846)
        ...
        self.assertEqual(
            tuple(tuple(site) for site in lock["no_next13_sites"]),
            STANDING_NO_NEXT13_SITES,
        )
        ...
        self.assertTrue(lock["do_not_relock_cycles_832_845"])
        ...
        self.assertEqual(lock["named_by_cycle845"], STANDING_NAMED_BY_CYCLE845)
        ...
        self.assertEqual(
            tuple(lock["next12_hapax_still_hapax"]),
            STANDING_NEXT12_HAPAX_STILL_HAPAX,
        )
        self.assertTrue(lock["next12_all_extend"])
        self.assertEqual(lock["next12_all_extend"], STANDING_NEXT12_ALL_EXTEND)
