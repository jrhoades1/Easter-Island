"""I's cycle-282 3-gram site previous 4-grams off-I hapax lock.

Cycle 283 text-search lock. Uses already-vendored A–V and the
cycle-282 I sites of 3-gram 009 090 076 (N_I=2, N_off_I=0,
extra I=0). Both I sites are the leftover extra remaining-
after-045 previous-009 pair (009-starts one token earlier;
090-starts Ia2[174]/Ia5[164]). Extra I of this 3-gram is empty
leftover-of-leftover; there is no extra I to include (unlike
cycle 246 / 263 / 269). Does not retune that 3-gram, leftover
extra remaining-after-045 previous-009 (cycle 281 K_009=2 /
N_remaining_after_090_and_076_and_071_and_045_and_009=27),
leftover extra remaining-after-071 previous-045 (cycle 278
K_045=2 / N_remaining_after_090_and_076_and_071_and_045=29),
leftover extra remaining-after-076 previous-071 (cycle 275
holds), leftover extra remaining-after-090 previous-076
(cycle 273 holds), leftover extra remaining-after-600
previous-090 (cycle 271 holds), leftover extra remaining-
after-600 unique previous stem (cycle 270 lost), leftover
extra remaining-after-999 previous-600 (cycle 267 holds),
leftover extra previous-999 (cycle 261 holds), leftover extra
...
Does not peel leftover extra remaining-after-009 / remaining
hapax this cycle. Does not retune leftover n=4. Does not
retune the forward peel of leftover extra I 090 076 (cycles
225–259). Does not overwrite cycle 167's 3-gram I-only 16/0
lock. Does not overwrite cycle 282's 3-gram I-only 2/0 lock.
Does not overwrite cycle 281's leftover extra remaining-
after-045 previous-009 lock. Does not overwrite cycle 280's
previous-4 I-only hapax 2/0 lock. Does not overwrite cycle
279's 3-gram I-only 2/0 lock. Does not overwrite cycle 277's
previous-4 I-only hapax 2/0 lock. Does not overwrite cycle
276's 3-gram I-only 2/0 lock. Does not retune cycle 272's
3-gram 090 090 076 I-only lose 3/1 on T extra I=1 or peel
its T / extra-I. Does not retune cycle 274's 3-gram
076 090 076 I-only lose 3/1 on T extra I=1 or peel its T /
extra-I. Does not retune cycle 255's 090 076 000 I-only hapax
(Ia2[174] is the 090-start of both this 3-gram and
090 076 000; line-final 000). Does not vendor a new tablet.
...
hapax 6/0), cycle 277 (previous 4-grams of I-only
071 090 076 were all I-only hapax 2/0), and cycle 280
(previous 4-grams of I-only 045 090 076 were all I-only
hapax 2/0). Token before G: each previous 4-gram is
contiguous W 009 090 076. Cycle 219 lost: 090 076 070 000
leaks 1/1 on T. Cycle 207 lost: 090 076 070 is not I-only
(8/1 on T). Cycle 223 lost: 090 076 is not I-only (69/3 on
T). Cycle 263 lost: previous 4-grams of I 999 090 076 were
I-only but not all hapax (14/0, N_not_hapax=2). Cycle 272
listed previous 4-gram 009 009 090 076 so doubled-009 is a
real analog lose path for the hapax claim if that 4-gram
leaks or is shared; do not retune 272. Cycle 281 listed
previous 4-grams 009 009 090 076 / 071 009 090 076;
measure, do not assume. 090 076 without 009, 999 090 076,
600 090 076, 090 090 076, 076 090 076, 071 090 076,
045 090 076, 720 076 070, 090 076 070, 076 071 090,
090 076 000, and leftover n=4 remaining 090 076 020 010 do
not count as these 4-grams. Do not retune leftover n=4,
076-cells, or any detector. Do not lock leftover extra
remaining-after-009. Do not assume hapax; count each from
fixtures.

Locks exact consecutive hits of each I 009 090 076 previous
...
previous-009 (extra I=0). Both have N_I=1 and N_off_I=0.
Claim that can lose:
i_009_090_076_previous_4grams_all_i_only_hapax. True only if
every I 009 090 076 site that has a previous token has
...
its previous 4-gram. Nested cycle 282 2/0 extra I=0, cycle
281 K_009=2 N_remaining_after_090_and_076_and_071_and_045_and_009=27
previous 4-grams 009 009 090 076 / 071 009 090 076, cycle
280 prev4 hapax 2/0, cycle 279 2/0 extra I=0, cycle 278
K_045=2 N=29, cycle 277 prev4 hapax 2/0, cycle 276 2/0 extra
I=0, cycle 275 K_071=2 N=31, cycle 274 3/1 extra I=1, cycle
273 K_076=2 N=33, cycle 272 3/1 extra I=1, cycle 271 K_090=2
N=35, cycle 270 unique-max false 5-way K=2 G=090, cycle 269
6/0 N_not_hapax=0, cycle 268 6/0 extra I=2, cycle 263 14/0
...
from tests.test_mamari_i_3gram_009_090_076_i_only_scoreboard import (
    ...
    STANDING_I_SITE_ROWS as CYCLE282_SITE_ROWS,
    STANDING_I_SITES as CYCLE282_I_SITES,
    STANDING_LEFTOVER_3GRAM_SITES as CYCLE282_LEFTOVER_3GRAM_SITES,
    STANDING_LEFTOVER_MATCHING_SITES as CYCLE282_LEFTOVER_MATCHING_SITES,
...
from tests.test_mamari_i_045_090_076_previous_4grams_i_only_scoreboard import (
    STANDING_I_045_090_076_PREVIOUS_4GRAMS_ALL_I_ONLY_HAPAX as CYCLE280_CLAIM,
...
STANDING_CYCLE282_SITES = CYCLE282_I_SITES
STANDING_PER_SITE_PREVIOUS_4GRAMS = CYCLE282_PREVIOUS_4GRAMS
...
STANDING_CYCLE282_SITES_BY_GRAM = (
    ((SIDE_IA, "Ia2", 173),),
    ((SIDE_IA, "Ia5", 163),),
)
STANDING_ROLES = (
...
STANDING_EXTRA_I_SITES = CYCLE282_EXTRA_I_SITES
STANDING_N_EXTRA = 0
STANDING_LEFTOVER_MATCHING_SITES = CYCLE282_LEFTOVER_MATCHING_SITES
STANDING_LEFTOVER_3GRAM_SITES = CYCLE282_LEFTOVER_3GRAM_SITES
STANDING_KNOWN_DISTINCT = True
STANDING_NOT_ASSUMED_HAPAX = True
STANDING_CLAIM = "i_009_090_076_previous_4grams_all_i_only_hapax"
STANDING_I_009_090_076_PREVIOUS_4GRAMS_ALL_I_ONLY_HAPAX = True
STANDING_I_009_090_076_PREVIOUS_4GRAMS_ALL_I_ONLY = True
STANDING_RESULT = "i_009_090_076_previous_4grams_i_only"
...
STANDING_SAME_AS_CYCLE280_PREVIOUS_4GRAMS = False
...
STANDING_SAME_CLAIM_SHAPE_AS_CYCLE280 = True
STANDING_090_076_WITHOUT_009_DOES_NOT_COUNT = True
...
STANDING_CYCLE280_NOT_OVERWRITTEN = True
STANDING_CYCLE281_NOT_RETUNED = True
...
def previous_4gram_start_site(
    cycle282_site: tuple[str, str, int],
) -> tuple[str, str, int] | None:
    """Previous 4-gram starts one token before 009 090 076; None at line start."""
    side, line, index = cycle282_site
    if index < 1:
        return None
...
def i_009_090_076_previous_4grams_all_i_only_hapax(
...
def i_sites_subset_of_previous_4gram(
    ...
    start = previous_4gram_start_site(cycle282_site)
    if start is None:
        return True
...
def site_row_as_survey(row: dict) -> dict:
    ...
    return {
        ...
        "cycle282_site": list(row["cycle282_site"]),
...
STANDING_SITE_ROWS = tuple(
    {
        ...
        "cycle282_site": (prior["side"], prior["line"], prior["index"]),
        "leftover_extra_090_076_site": prior["leftover_extra_090_076_site"],
        "previous_stem": prior["previous_4gram"][0],
        "role": (
            "extra_i"
            if not prior["in_cycle281_leftover_extra_2"]
            else "leftover_extra"
        ),
        "in_cycle281_leftover_extra_2": prior["in_cycle281_leftover_extra_2"],
    ...
    for prior in CYCLE282_SITE_ROWS
)


class TestI009090076Previous4gramsIOnlyHelpers(unittest.TestCase):
    """Helpers on cycle-282 previous 4-grams. No CV, no LLM."""

    def test_counts_require_consecutive_tokens(self):
        """Adjacent 4-gram counts; a gap is not a hit. 999 / 090 076 / leftover n=4 are not."""
        provider = MockProvider()
        self.assertEqual(STANDING_SEQUENCES[0], ("009", "009", "090", "076"))
        self.assertEqual(STANDING_SEQUENCES[1], ("071", "009", "090", "076"))
        ...
        overlap = [["009", "009", "090", "076", "009", "009", "090", "076"]]
        ...
        self.assertEqual(ngram_hit_count([list(NEAR_MISS_045_090_076)], STANDING_SEQUENCES[0]), 0)
        self.assertEqual(ngram_hit_count([list(NEAR_MISS_076_071_090)], STANDING_SEQUENCES[0]), 0)
        self.assertEqual(ngram_hit_count([list(NEAR_MISS_090_076_000)], STANDING_SEQUENCES[0]), 0)
        ...
        planted = ["009", "009", "090", "076"]
        self.assertEqual(site_previous_4gram_for_3gram(planted, 1, GRAM3), STANDING_SEQUENCES[0])
        self.assertIsNone(site_previous_4gram_for_3gram(["009", "090", "076"], 0, GRAM3))
        self.assertTrue(STANDING_090_076_WITHOUT_009_DOES_NOT_COUNT)
    ...
    def test_all_i_only_hapax_requires_n_i_1_and_zero_off_i_per_site(self):
        ...
        self.assertEqual(STANDING_CLAIM, "i_009_090_076_previous_4grams_all_i_only_hapax")
        self.assertTrue(STANDING_I_009_090_076_PREVIOUS_4GRAMS_ALL_I_ONLY_HAPAX)
        self.assertTrue(STANDING_I_009_090_076_PREVIOUS_4GRAMS_ALL_I_ONLY)
    ...
    def test_4grams_are_cycle_282_previous_not_retuned(self):
        """4-grams stay the cycle-282 I-site previous runs; extra I is empty."""
        provider = MockProvider()
        self.assertEqual(GRAM3, ("009", "090", "076"))
        self.assertEqual(STANDING_PER_SITE_PREVIOUS_4GRAMS, CYCLE282_PREVIOUS_4GRAMS)
        self.assertEqual(STANDING_CYCLE282_SITES, CYCLE282_I_SITES)
        self.assertEqual(STANDING_N_EXTRA, 0)
        self.assertEqual(STANDING_EXTRA_I_SITES, ())
        self.assertEqual(STANDING_SEQUENCES, CYCLE281_MATCHING_PREVIOUS_4GRAMS)
        leftover_set = set(CYCLE281_MATCHING_PREVIOUS_4GRAMS)
        self.assertTrue(leftover_set.issubset(set(STANDING_PER_SITE_PREVIOUS_4GRAMS)))
        self.assertEqual(len(CYCLE281_MATCHING_PREVIOUS_4GRAMS), 2)
        ...
        for gram in STANDING_SEQUENCES:
            ...
            self.assertFalse(is_contiguous_substring(gram, NEAR_MISS_045_090_076))
            self.assertFalse(is_contiguous_substring(gram, CYCLE219_LEAK_4GRAM))
        for site, gram in zip(
            STANDING_CYCLE282_SITES,
            STANDING_PER_SITE_PREVIOUS_4GRAMS,
            strict=True,
        ):
        ...
        self.assertFalse(STANDING_SAME_AS_CYCLE280_PREVIOUS_4GRAMS)
        ...
        self.assertTrue(STANDING_SAME_CLAIM_SHAPE_AS_CYCLE280)
...
class TestMamariI009090076Previous4gramsIOnlyScoreboard(unittest.TestCase):
    """Cited-fixture cycle-282 previous-4 I-only hapax lock. Mock only."""

    def setUp(self):
        self.provider = MockProvider()
        self.survey = load_corpus_survey()
        self.i_sides = load_i_sides()
        self.cycle282_sites = STANDING_CYCLE282_SITES
        ...
        self.per_site_previous = tuple(
            ...
            for site in self.cycle282_sites
        )
        self.line_initial = tuple(
            site
            for site, gram in zip(self.cycle282_sites, self.per_site_previous, strict=True)
            if gram is None
        )
        ...
        self.claim_holds = i_009_090_076_previous_4grams_all_i_only_hapax(
            self.per_site_previous,
            self.n_i_by_gram,
            self.n_off_i_by_gram,
        )

    def test_tokens_and_sites_are_cycle_282_lock_not_retuned(self):
        """4-grams and I sites stay the cycle-282 previous lock; cycle 167 stays 16/0."""
        self.assertEqual(GRAM3, ("009", "090", "076"))
        self.assertEqual(GRAM5, ("999", "071", "076", "010", "079"))
        self.assertEqual(self.cycle282_sites, STANDING_CYCLE282_SITES)
        self.assertEqual(len(self.cycle282_sites), 2)
        ...
        self.assertEqual(tuple(prior_282["tokens3"]), GRAM3)
        self.assertEqual(prior_282["N_I"], CYCLE282_N_I)
        self.assertEqual(prior_282["N_I"], 2)
        self.assertEqual(prior_282["N_off_I"], CYCLE282_N_OFF_I)
        self.assertEqual(prior_282["N_off_I"], 0)
        self.assertEqual(prior_282["N_extra"], CYCLE282_N_EXTRA)
        self.assertEqual(prior_282["N_extra"], 0)
        self.assertTrue(prior_282["i_3gram_009_090_076_i_only"])
        self.assertEqual(
            tuple(tuple(row) for row in prior_282["i_sites"]),
            STANDING_CYCLE282_SITES,
        )
        self.assertEqual(
            [list(gram) for gram in STANDING_PER_SITE_PREVIOUS_4GRAMS],
            prior_282["i_previous_4grams"],
        )
        self.assertEqual(
            tuple(tuple(row) for row in prior_282["extra_i_sites"]),
            STANDING_EXTRA_I_SITES,
        )
        self.assertTrue(leftover_extra_remaining_after_045_previous_009_subset())
        ...
        leftover_009_starts = tuple(
            (side, line, index - 1) for side, line, index in CYCLE281_MATCHING_SITES
        )
        self.assertTrue(set(leftover_009_starts).issubset(set(STANDING_CYCLE282_SITES)))
        ...
        self.assertNotEqual(STANDING_CLAIM, "i_3gram_009_090_076_i_only")
        self.assertNotEqual(STANDING_CLAIM, "i_045_090_076_previous_4grams_all_i_only_hapax")
        ...
        self.assertEqual(CYCLE281_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045_AND_009, 27)
    ...
    def test_all_4grams_are_i_only_hapax_and_claim_holds(self):
        ...
        self.assertEqual(
            self.claim_holds,
            STANDING_I_009_090_076_PREVIOUS_4GRAMS_ALL_I_ONLY_HAPAX,
        )
        self.assertTrue(STANDING_I_009_090_076_PREVIOUS_4GRAMS_ALL_I_ONLY)
        self.assertTrue(HYPOTHESIS_ALL_I_ONLY_HAPAX)
        self.assertEqual(STANDING_CLAIM, "i_009_090_076_previous_4grams_all_i_only_hapax")
        ...
        self.assertTrue(CYCLE280_CLAIM)
        ...
        self.assertEqual(leftover_rows[0]["cycle282_site"], (SIDE_IA, "Ia2", 173))
        self.assertEqual(leftover_rows[0]["tokens4"], ("009", "009", "090", "076"))
        self.assertEqual(leftover_rows[1]["cycle282_site"], (SIDE_IA, "Ia5", 163))
        self.assertEqual(leftover_rows[1]["tokens4"], ("071", "009", "090", "076"))
    ...
    def test_existing_282_281_280_279_278_277_276_275_274_273_272_271_270_269_268_263_223_207_167_still_compute(self):
        """Cycle 282 2/0 extra I=0, 281 K=2/27, 280 prev4 hapax 2/0, 279 2/0, 278 K=2/29, 277 prev4 hapax 2/0, 276 2/0, 275 K=2/31, 274 3/1, 273 K_076=2/33, 272 3/1, 271 K_090=2/35, 270 5-way lose, 269 6/0, 268 6/0 extra I=2, 263 14/0 N_not_hapax=2 stay."""
        ...
        self.assertEqual(prior_282.i_sites, CYCLE282_I_SITES)
        ...
        unused_281_n = CYCLE281_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045
        ...
        unused_279_extra = CYCLE279_EXTRA_I_SITES
        unused_282_extra = CYCLE282_EXTRA_I_SITES
        ...
        self.assertEqual(unused_281_n, 29)
        ...
        self.assertEqual(len(unused_279_extra), 0)
        self.assertEqual(len(unused_282_extra), 0)
        self.assertTrue(STANDING_LEFTOVER_EXTRA_REMAINING_AFTER_009_IS_NOT_THIS_CYCLE)
        self.assertTrue(STANDING_FORWARD_PEEL_NOT_RETUNED)
        self.assertTrue(STANDING_CYCLE167_NOT_OVERWRITTEN)
        ...
        self.assertTrue(STANDING_CYCLE280_NOT_OVERWRITTEN)
        self.assertTrue(STANDING_CYCLE281_NOT_RETUNED)
        self.assertTrue(STANDING_CYCLE282_NOT_OVERWRITTEN)
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-283 previous-4 I-only hapax lock."""
        lock = self.survey["i_009_090_076_previous_4grams_i_only"]
        self.assertEqual(lock["cycle"], 283)
        ...
        self.assertEqual(
            tuple(tuple(row) for row in lock["leftover_extra_remaining_after_045_previous_009_sites"]),
            STANDING_LEFTOVER_MATCHING_SITES,
        )
        self.assertTrue(lock["leftover_extra_remaining_after_045_previous_009_subset_of_i_sites"])
        ...
        for row, gram, sites, cycle_sites, prev, role, n_on, n_off, hapax, off_sites in zip(
            ...
            self.assertEqual(tuple(tuple(site_row) for site_row in row["cycle282_sites"]), cycle_sites)
        ...
        self.assertTrue(lock["i_009_090_076_previous_4grams_all_i_only_hapax"])
        self.assertTrue(lock["i_009_090_076_previous_4grams_all_i_only"])
        self.assertEqual(
            lock["i_009_090_076_previous_4grams_all_i_only_hapax"],
            STANDING_I_009_090_076_PREVIOUS_4GRAMS_ALL_I_ONLY_HAPAX,
        )
        ...
        self.assertFalse(lock["same_as_cycle280_previous_4grams"])
        ...
        self.assertTrue(lock["same_claim_shape_as_cycle280"])
        self.assertTrue(lock["090_076_without_009_does_not_count"])
        ...
        self.assertTrue(lock["cycle280_not_overwritten"])
        self.assertTrue(lock["cycle281_not_retuned"])
        ...
        self.assertEqual(lock["nested_cycle281_N_remaining_after_090_and_076_and_071_and_045_and_009"], 27)
        self.assertEqual(
            [list(gram) for gram in CYCLE281_MATCHING_PREVIOUS_4GRAMS],
...
class TestMamariI009090076Previous4gramsIOnlyImageSnapshot(unittest.TestCase):
    """Cycle 283 does not touch clustering. 83/62 / Hamming 6 stays."""
