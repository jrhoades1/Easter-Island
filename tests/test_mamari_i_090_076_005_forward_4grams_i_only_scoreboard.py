"""I's cycle-251 leftover extra remaining-after-011 090 076 005 forward-4-grams off-I lock.

Cycle 252 text-search lock. Uses already-vendored A–V and the
cycle-251 I sites of 3-gram 090 076 005 (all 2 I sites; each
has a next stem). Extra I sites = 0, so this is leftover extra
remaining-after-011 005 4-grams alone. Does not retune those
4-grams, the 2 I sites, leftover extra remaining-after-011
G=005 K=2 N_remaining9=23, leftover extra remaining-after-087
...
leftover extra sites, leftover n=4 999 090 076 005, the leftover
n=4 set, or the already-closed leftover remaining family. Does
not vendor a new tablet. Does not scrape X. W has no Barthel
(cycle 100); skip W. Unpublished Ib is 0. Does not redo H∩P∩Q
...
all I-only hapax 1/0 x2). Not the same as cycle 249 (I
090 076 011 forward 4-grams 4/4 extra I=2) or cycle 246
(I 090 076 087 forward 4-grams 5/5 extra I=3). Cycle 251
I 090 076 005 I-only holds 2/0 extra I=0, cycle 250 leftover
extra remaining-after-011 K=2 / G=005 N_remaining9=23, cycle
249 4/4 hapax, cycle 248 4/0 extra I=2, cycle 247 K=2 / G=011,
cycle 234 7-way tie at 2, and cycle 223 69/3 stay. Off-I T
sites of 090 076 are not this 3-gram and are not these
4-grams. Leftover extra remaining after 005 is not locked
this cycle. Previous 4-grams of the two I sites are not
locked this cycle. The other tied stem (000) is not locked.
Leftover extra 090 076 700 011 (Ia2[159]; cycle 237) is a
different 4-gram: 011 is the 4th token, not contiguous
090 076 005. 090 076 011, 090 076 087, 090 076 280,
090 076 530, 090 076 700, 090 076 001, 090 076 013,
090 076 070, 090 076 071, and 090 076 without 005 do not
count. Do not retune leftover n=4, 076-cells, or any detector.

Locks exact consecutive hits of each I 090 076 005 forward
4-gram on tablet I and on every other vendored tablet A–H
and J–V. Nested-check leftover extra remaining-after-011 pair
are 090 076 005 406 and 090 076 005 084; measure, do not
assume those next tokens. Do not assume hapax; count each
from fixtures. Hypothesis: all two are I-only. Measured:
each N_I=1 at the cycle-251 I site; all N_off_I=0. Claim
that can lose: i_090_076_005_forward_4grams_all_i_only.
True only if ALL two have N_off_I=0 and N_I>=1. The claim
is true. Extra I = 0, so this is leftover extra
remaining-after-011 005 4-grams alone. Do not assume the
I-only result; measure. Do not retune.
...
from tests.test_mamari_i_3gram_090_076_005_i_only_scoreboard import (
    ...
    STANDING_I_3GRAM_090_076_005_I_ONLY as CYCLE251_I_ONLY,
    STANDING_I_NEXT_4GRAMS as CYCLE251_NEXT_4GRAMS,
    STANDING_I_PREVIOUS_4GRAMS as CYCLE251_PREVIOUS_4GRAMS,
    STANDING_I_SITES as CYCLE251_I_SITES,
    STANDING_LEFTOVER_MATCHING_NEXT_4GRAMS as CYCLE251_LEFTOVER_MATCHING_NEXT_4GRAMS,
    STANDING_LEFTOVER_MATCHING_SITES as CYCLE251_LEFTOVER_MATCHING_SITES,
    ...
    named_off_i_sites as cycle251_named_off_i_sites,
...
from tests.test_mamari_i_090_076_011_forward_4grams_i_only_scoreboard import (
    STANDING_I_090_076_011_FORWARD_4GRAMS_ALL_I_ONLY as CYCLE249_I_ONLY,
...
STANDING_SEQUENCES = CYCLE251_NEXT_4GRAMS
STANDING_CYCLE251_SITES = CYCLE251_I_SITES
STANDING_NEXT_STEMS = (
    "406",
    "084",
)
STANDING_PREVIOUS_4GRAMS = CYCLE251_PREVIOUS_4GRAMS
...
STANDING_I_SITES = tuple((site,) for site in STANDING_CYCLE251_SITES)
STANDING_IB_HITS = 0
STANDING_IB_SITES = ()
...
STANDING_N_EXTRA = 0
STANDING_EXTRA_I_SITES = CYCLE251_EXTRA_I_SITES
STANDING_LEFTOVER_MATCHING_SITES = CYCLE251_LEFTOVER_MATCHING_SITES
STANDING_LEFTOVER_MATCHING_NEXT_4GRAMS = CYCLE251_LEFTOVER_MATCHING_NEXT_4GRAMS
STANDING_KNOWN_DISTINCT = True
STANDING_NOT_ASSUMED_HAPAX = True
STANDING_HAPAX_EACH = True
STANDING_CLAIM = "i_090_076_005_forward_4grams_all_i_only"
STANDING_I_090_076_005_FORWARD_4GRAMS_ALL_I_ONLY = True
STANDING_I_090_076_005_FORWARD_4GRAMS_I_ONLY = True
STANDING_RESULT = "i_090_076_005_forward_4grams_i_only"
...
STANDING_SAME_AS_LEFTOVER_EXTRA_REMAINING_AFTER_011_005_4GRAMS_ALONE = True
...
STANDING_SAME_CLAIM_SHAPE_AS_CYCLE249 = False
...
STANDING_CYCLE251_N_I = 2
STANDING_CYCLE251_N_OFF_I = 0
STANDING_CYCLE251_N_EXTRA = 0
...
def forward_4gram_start_site(
    cycle251_site: tuple[str, str, int],
) -> tuple[str, str, int]:
    """Forward 4-gram starts at the cycle-251 I 090 076 005 site."""
    return cycle251_site
...
def site_forward_4gram(
    ...
    """090 076 005 X if a next stem exists; None at end-of-line."""
    n3 = len(gram3)
...
def i_090_076_005_forward_4grams(
    i_sides: dict[str, list[list[str]]],
    sites: tuple[tuple[str, str, int], ...] = STANDING_CYCLE251_SITES,
    gram3: tuple[str, ...] = GRAM3,
...
def i_sites_without_forward(
    ...
    """I 090 076 005 sites that have no next stem after the 3-gram."""
    return tuple(
        site
...
def i_090_076_005_forward_4grams_all_i_only(
    n_i: tuple[int, ...],
    n_off_i: tuple[int, ...],
    expected_n: int = STANDING_N_SEQUENCES,
) -> bool:
    """True iff all 2 I 090 076 005 forward 4-grams are I-only.
    ...
    Extra I = 0, so leftover extra remaining-after-011 005
    4-grams alone are this claim.
    """
    return (
        len(n_i) == expected_n
...
class TestI090076005Forward4gramsIOnlyHelpers(unittest.TestCase):
    """Helpers on cycle-251 I 090 076 005 forward 4-grams. No CV, no LLM."""

    def test_counts_require_consecutive_tokens(self):
        """Adjacent 4-gram counts; a gap is not a hit. 011 / 087 / 280 / 530 / 700 / 001 / 013 / 070 / 071 / 700 011 are not."""
        provider = MockProvider()
        self.assertEqual(STANDING_SEQUENCES[0], ("090", "076", "005", "406"))
        self.assertEqual(STANDING_SEQUENCES[-1], ("090", "076", "005", "084"))
        ...
        overlap = [["090", "076", "005", "406", "090", "076", "005", "406"]]
        ...
        self.assertEqual(ngram_hit_count([["090", "076", "005"]], STANDING_SEQUENCES[0]), 0)
    ...
    def test_all_i_only_requires_on_i_and_zero_off_i_for_each_4gram(self):
        ...
        self.assertTrue(i_090_076_005_forward_4grams_all_i_only(hold_ones, hold_zeros))
        self.assertTrue(
            i_090_076_005_forward_4grams_all_i_only((2,) + hold_ones[1:], hold_zeros)
        )
        lose_off = list(hold_zeros)
        lose_off[0] = 1
        self.assertFalse(
            i_090_076_005_forward_4grams_all_i_only(hold_ones, tuple(lose_off))
        )
        lose_missing_i = list(hold_ones)
        lose_missing_i[0] = 0
        self.assertFalse(
            i_090_076_005_forward_4grams_all_i_only(tuple(lose_missing_i), hold_zeros)
        )
        self.assertFalse(i_090_076_005_forward_4grams_all_i_only((), ()))
        self.assertFalse(
            i_090_076_005_forward_4grams_all_i_only(hold_ones[:-1], hold_zeros[:-1])
        )
        self.assertEqual(STANDING_CLAIM, "i_090_076_005_forward_4grams_all_i_only")
        self.assertTrue(STANDING_I_090_076_005_FORWARD_4GRAMS_ALL_I_ONLY)
        self.assertTrue(STANDING_I_090_076_005_FORWARD_4GRAMS_I_ONLY)
        self.assertEqual(
            STANDING_I_090_076_005_FORWARD_4GRAMS_ALL_I_ONLY,
        ...
        self.assertTrue(CYCLE249_I_ONLY)
        self.assertEqual(CYCLE249_N_I_ONLY, 4)
        self.assertEqual(CYCLE249_N_NOT_I_ONLY, 0)
        self.assertEqual(provider.get_call_history(), [])

    def test_4grams_are_cycle_251_forwards_not_retuned(self):
        """4-grams stay the cycle-251 I forwards; leftover / 011 / 087 / 280 / 530 / 700 / 001 / 013 / 070 / 071 are not."""
        provider = MockProvider()
        self.assertEqual(GRAM3, ("090", "076", "005"))
        self.assertEqual(GRAM3, GRAM3_FORWARD)
        self.assertEqual(STANDING_SEQUENCES, CYCLE251_NEXT_4GRAMS)
        self.assertEqual(STANDING_SEQUENCES, CYCLE250_MATCHING_NEXT_4GRAMS)
        self.assertEqual(STANDING_SEQUENCES, CYCLE251_LEFTOVER_MATCHING_NEXT_4GRAMS)
        self.assertEqual(STANDING_CYCLE251_SITES, CYCLE251_I_SITES)
        self.assertEqual(STANDING_CYCLE251_SITES, CYCLE250_MATCHING_SITES)
        self.assertEqual(STANDING_CYCLE251_SITES, CYCLE251_LEFTOVER_MATCHING_SITES)
        self.assertEqual(len(STANDING_SEQUENCES), CYCLE251_N_I)
        ...
        self.assertTrue(STANDING_SAME_AS_LEFTOVER_EXTRA_REMAINING_AFTER_011_005_4GRAMS_ALONE)
        ...
        self.assertFalse(STANDING_SAME_CLAIM_SHAPE_AS_CYCLE249)
...
class TestMamariI090076005Forward4gramsIOnlyScoreboard(unittest.TestCase):
    """Cited-fixture I 090 076 005 forward-4 off-I lock. Mock only."""

    def setUp(self):
        self.provider = MockProvider()
        self.survey = load_corpus_survey()
        self.i_sides = load_i_sides()
        self.cycle251_sites = STANDING_CYCLE251_SITES
        ...
        self.off_i_sites = tuple(
            cycle251_named_off_i_sites(gram) for gram in self.grams
        )
        self.measured_forwards = i_090_076_005_forward_4grams(
            self.i_sides,
            self.cycle251_sites,
            GRAM3,
        )
        ...
        self.extra = extra_i_sites(self.cycle251_sites, self.leftover_matching)
        ...
        self.claim_holds = i_090_076_005_forward_4grams_all_i_only(
            self.n_i,
            self.n_off_i,
        )
        self.n_i_only = sum(
    ...
    def test_tokens_and_sites_are_cycle_251_forwards_not_retuned(self):
        """4-grams and I sites stay the cycle-251 forward lock. Nested 2/0 extra I=0 must hold."""
        self.assertEqual(GRAM3, ("090", "076", "005"))
        self.assertEqual(GRAM3, GRAM3_FORWARD)
        self.assertEqual(GRAM5, ("999", "071", "076", "010", "079"))
        self.assertEqual(self.cycle251_sites, STANDING_CYCLE251_SITES)
        self.assertEqual(self.cycle251_sites, CYCLE251_I_SITES)
        self.assertEqual(self.cycle251_sites, CYCLE250_MATCHING_SITES)
        self.assertEqual(self.measured_forwards, STANDING_SEQUENCES)
        self.assertEqual(self.measured_forwards, CYCLE251_NEXT_4GRAMS)
        self.assertEqual(self.measured_forwards, CYCLE250_MATCHING_NEXT_4GRAMS)
        self.assertEqual(self.leftover_matching_next_4grams, STANDING_SEQUENCES)
        self.assertEqual(self.no_forward, ())
        self.assertEqual(self.n3_i, STANDING_CYCLE251_N_I)
        self.assertEqual(self.n3_i, 2)
        self.assertEqual(self.n3_off_i, STANDING_CYCLE251_N_OFF_I)
        self.assertEqual(self.n3_off_i, 0)
        self.assertEqual(self.leftover_matching, CYCLE250_MATCHING_SITES)
        self.assertEqual(self.leftover_matching, CYCLE251_I_SITES)
        ...
        self.assertEqual(len(self.remaining9), CYCLE250_N_REMAINING9)
        ...
        self.assertEqual(prior_251["N_I"], CYCLE251_N_I)
        self.assertEqual(prior_251["N_I"], 2)
        self.assertEqual(prior_251["N_off_I"], CYCLE251_N_OFF_I)
        ...
        self.assertTrue(CYCLE251_I_ONLY)
        self.assertEqual(
            [list(gram) for gram in STANDING_SEQUENCES],
            prior_251["i_next_4grams"],
        )
        self.assertEqual(
            tuple(tuple(row) for row in prior_251["i_sites"]),
            STANDING_CYCLE251_SITES,
        )
        self.assertEqual(
            [list(gram) for gram in STANDING_PREVIOUS_4GRAMS],
            prior_251["i_previous_4grams"],
        )
    ...
    def test_each_4gram_is_one_on_i_zero_off_i_and_claim_holds(self):
        ...
        for site, start, gram, nxt, prev4, role, sites, n_on, n_off, off_sites in zip(
            ...
            self.assertEqual(prev4, STANDING_LEFTOVER_N4_999_090_076_005)
        ...
        for gram in STANDING_SEQUENCES:
            ...
            self.assertEqual(cycle251_named_off_i_sites(gram), ())
        ...
        self.assertNotEqual(tuple(ia2[159:163]), STANDING_SEQUENCES[0])
        self.assertEqual(
            i_090_076_005_forward_4grams_all_i_only(self.n_i, self.n_off_i),
            STANDING_I_090_076_005_FORWARD_4GRAMS_ALL_I_ONLY,
        )
        self.assertEqual(
            self.claim_holds,
    ...
    def test_existing_251_250_249_248_247_234_and_223_still_compute(self):
        """Cycle 251 2/0 extra I=0, 250 K=2/G=005 N_remaining9=23, 249 4/4 hapax, 248 4/0 extra I=2, 247 K=2/G=011, 234 7-way tie, 223 69/3 stay."""
        ...
        self.assertEqual(prior_250.matching_next_4grams, STANDING_SEQUENCES)
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-252 I-forward-4 I-only hold."""
        lock = self.survey["i_090_076_005_forward_4grams_i_only"]
        self.assertEqual(lock["cycle"], 252)
        ...
        self.assertEqual(lock["N_I"], CYCLE251_N_I)
        ...
        self.assertEqual(
            ...
            lock["leftover_extra_remaining_after_011_005_next_4grams"],
        )
        ...
        for row, gram, site, nxt, role, sites, n_on, n_off, off_sites, hits in zip(
            ...
            self.assertEqual(tuple(row["cycle251_site"]), site)
        ...
        self.assertTrue(lock["i_090_076_005_forward_4grams_all_i_only"])
        self.assertEqual(
            lock["i_090_076_005_forward_4grams_all_i_only"],
            STANDING_I_090_076_005_FORWARD_4GRAMS_ALL_I_ONLY,
        )
        self.assertTrue(lock["i_090_076_005_forward_4grams_i_only"])
        ...
        self.assertTrue(lock["same_as_leftover_extra_remaining_after_011_005_4grams_alone"])
        ...
        self.assertFalse(lock["same_claim_shape_as_cycle249"])
...
class TestMamariI090076005Forward4gramsIOnlyImageSnapshot(unittest.TestCase):
    """Cycle 252 does not touch clustering. 83/62 / Hamming 6 stays."""
