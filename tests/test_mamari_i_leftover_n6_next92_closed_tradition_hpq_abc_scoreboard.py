"""Reframed closed-tradition hold-out of the locked leftover-6 next-92 grams.

Cycle 925 text-search lock. Uses already-vendored A–V and the
cycle-647 leftover n=6 remaining remaining-after-090-076
remaining-after-430-076 remaining-after-076-020 remaining-
after-076-010 next 92-grams (12 sequences; parent N=18; six
holes at Ia10[144], Ia10[143], Ia10[142], Ia8[167], Ia8[166],
and Ia8[165]). HEAD-check: that gram list exists and is not yet
locked under this reframed rule. Cycle 647 already locked the
I-only claim on these 92-grams as incomplete-set LOSE
(N_with_next92=12, N_no_next92=6, N_i_only=12, N_leak=0). Cycle
924 already locked the reframed claim on the cycle-645 next-91
grams as incomplete-set LOSE. This cycle does not re-lock either
claim, and does not re-lock Cycles 832–924.

Claim that can lose: each existing next-92 gram is an exact
...
Named claim: cycle647_next92_reframed_closed_tradition_hpq_ge1_exact0_abc.

Measured on the 12 with-next92 grams: N=12, N_hpq_ge1=0,
N_hpq_ge2=0, N_exact0_abc=12, N_i_ge1=12, N_exact0_i=0,
N_leak=0, N_hold=0, hits_I=12. Parent N=18, N_with_next92=12,
N_no_next92=6 (Ia10[144], Ia10[143], Ia10[142], Ia8[167],
Ia8[166], Ia8[165]). Every scored gram is exact-0 on H/P/Q and
on A/B/C and an exact contiguous hit once on I. The next-91 hapax
604 076 071 600 999 050 076 000 002 999 076 092 535 999 208 076 532 244 999 090 076 057 600 700 076 076 053 177 700 076 057 741 430 076 532 200 059 076 074 379 002 076 244 280 001 076 532 071 065 071 999 700 076 480 600 005 076 420 519 999 006 076 073 430 076 006 006 040 999 002 076 240 382 999 076 053 472 021 386 076 001 037 150 076 001 526 383 076 280 472 790 at Ia9[9] extends
to 604 076 071 600 999 050 076 000 002 999 076 092 535 999 208 076 532 244 999 090 076 057 600 700 076 076 053 177 700 076 057 741 430 076 532 200 059 076 074 379 002 076 244 280 001 076 532 071 065 071 999 700 076 480 600 005 076 420 519 999 006 076 073 430 076 006 006 040 999 002 076 240 382 999 076 053 472 021 386 076 001 037 150 076 001 526 383 076 280 472 790 076 at Ia9[9]
and hits I once. All twelve next-91 grams extend; no new hole.
...
next 92-grams as a peel, next 93-grams as a peel, prev-184, or
next-185. The cycle-649 next-93 I-only list stays the named
...
from tests.test_mamari_i_leftover_n6_next91_closed_tradition_hpq_abc_scoreboard import (
    ...
    STANDING_NO_NEXT91_SITES as CYCLE924_NO_NEXT91_SITES,
    STANDING_RESULT as CYCLE924_RESULT,
    STANDING_SEQUENCES as CYCLE924_SEQUENCES,
    STANDING_SITES as CYCLE924_SITES,
...
from tests.test_mamari_i_leftover_n6_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_next92_i_only_scoreboard import (
    HYPOTHESIS_ALL_I_ONLY as CYCLE647_HYPOTHESIS_ALL_I_ONLY,
    STANDING_I_LEFTOVER_N6_REMAINING_AFTER_090_076_REMAINING_AFTER_430_076_REMAINING_AFTER_076_020_REMAINING_AFTER_076_010_NEXT92_I_ONLY as CYCLE647_ALL_I_ONLY_CLAIM,
    STANDING_LEFTOVER_MATCHING_NEXT92_SITES as CYCLE647_SITES,
    STANDING_N as CYCLE647_N,
    STANDING_N_I_EACH as CYCLE647_N_I_EACH,
    STANDING_N_I_ONLY as CYCLE647_N_I_ONLY,
    STANDING_N_LEAK as CYCLE647_N_LEAK,
    STANDING_N_NO_NEXT92 as CYCLE647_N_NO_NEXT92,
    STANDING_N_SEQUENCES as CYCLE647_N_SEQUENCES,
    STANDING_N_WITH_NEXT92 as CYCLE647_N_WITH_NEXT92,
    STANDING_NO_NEXT92_SITES as CYCLE647_NO_NEXT92_SITES,
    STANDING_RESULT as CYCLE647_RESULT,
...
STANDING_NO_NEXT92_SITES = CYCLE647_NO_NEXT92_SITES
STANDING_PARENT_COMPLETE = False
STANDING_HITS_EACH = (0, 0, 0, 0, 0, 0, 1)
STANDING_HITS = (STANDING_HITS_EACH,) * STANDING_N
STANDING_SITES = CYCLE647_SITES
STANDING_SEQUENCES = CYCLE647_SEQUENCES
...
STANDING_NEXT91_HAPAX_STILL_HAPAX = (3,)
STANDING_NEXT91_ALL_EXTEND = True
STANDING_HITS_H = 0
STANDING_HITS_P = 0
STANDING_HITS_Q = 0
STANDING_HITS_A = 0
...
STANDING_CLAIM = "leftover6_next92_reframed_closed_tradition_hpq_ge1_and_exact0_abc"
STANDING_RESULT = "i_leftover_n6_next92_closed_tradition_hpq_abc"
STANDING_AXIS = "closed-tradition-reframed"
STANDING_FROM_CYCLE = 647
STANDING_I_ONLY_ALREADY_LOCKED = True
STANDING_I_ONLY_CYCLE = 647
...
class TestMamariILeftoverN6Next92ClosedTraditionHpqAbcScoreboard(unittest.TestCase):
    """Cycle 925 reframed closed-tradition lock on the cycle-647 next-92 population."""
    ...
    def test_population_is_the_locked_cycle_647_next92_grams(self):
        """Twelve next-92 sequences and sites come from cycle 647. None invented."""
        self.assertEqual(len(STANDING_SEQUENCES), STANDING_N)
        self.assertEqual(len(STANDING_SITES), STANDING_N)
        self.assertEqual(STANDING_SEQUENCES, CYCLE647_SEQUENCES)
        self.assertEqual(STANDING_SITES, CYCLE647_SITES)
        self.assertEqual(CYCLE647_N, STANDING_N_PARENT)
        self.assertEqual(CYCLE647_N, 18)
        self.assertEqual(CYCLE647_N_SEQUENCES, 12)
        self.assertEqual(STANDING_N_WITH_NEXT92, CYCLE647_N_WITH_NEXT92)
        self.assertEqual(STANDING_N_NO_NEXT92, CYCLE647_N_NO_NEXT92)
        self.assertEqual(
            STANDING_NO_NEXT92_SITES,
            (
                ("Ia", "Ia10", 144),
                ("Ia", "Ia10", 143),
                ("Ia", "Ia10", 142),
        ...
        self.assertEqual(STANDING_NO_NEXT92_SITES, CYCLE924_NO_NEXT91_SITES)
        self.assertFalse(STANDING_PARENT_COMPLETE)
        self.assertTrue(CYCLE647_HYPOTHESIS_ALL_I_ONLY)
        self.assertFalse(CYCLE647_ALL_I_ONLY_CLAIM)
        self.assertEqual(CYCLE647_N_I_ONLY, 12)
        self.assertEqual(CYCLE647_N_LEAK, 0)
        self.assertEqual(STANDING_FROM_CYCLE, 647)
        ...
        for row, tokens, site in zip(self.rows, STANDING_SEQUENCES, STANDING_SITES, strict=True):
            ...
            self.assertEqual(len(row.tokens), 92)
        prior = self.survey[CYCLE647_RESULT]
        all_i_only_key = (
            "i_leftover_n6_remaining_after_090_076_remaining_after_430_076_"
            "remaining_after_076_020_remaining_after_076_010_next_92grams_all_i_only"
        )
        self.assertEqual(CYCLE647_RESULT, (
            "i_leftover_n6_remaining_after_090_076_remaining_after_430_076_"
            "remaining_after_076_020_remaining_after_076_010_next92_i_only"
        ))
        self.assertEqual(prior["cycle"], 647)
        ...
        self.assertFalse(prior[CYCLE647_RESULT])
        self.assertEqual(prior["N_i_only"], 12)
        self.assertEqual(prior["N_leak"], 0)
        self.assertEqual(prior["N_no_next92"], 6)
        self.assertEqual(prior["N_with_next92"], 12)
        self.assertNotIn(STANDING_NAMED_BY_CYCLE924, self.survey)
        self.assertEqual(self.provider.get_call_history(), [])

    def test_prior_locks_stay_locked(self):
        """Do not re-lock cycle 647 I-only or the cycle 832–924 boards."""
        ...
        self.assertEqual(STANDING_I_ONLY_CYCLE, 647)
    ...
    def test_measured_table_is_incomplete_set_lose(self):
        ...
        self.assertEqual(tuple(row.hits[-1] for row in self.rows), CYCLE647_N_I_EACH)
        self.assertEqual(CYCLE647_N_I_EACH, (1,) * STANDING_N)
        ...
        self.assertTrue(STANDING_NEXT91_ALL_EXTEND)
        for n91, n92, site91, site92 in zip(
            CYCLE924_SEQUENCES, STANDING_SEQUENCES, CYCLE924_SITES, STANDING_SITES, strict=True
        ):
            self.assertEqual(n92[:91], n91)
            self.assertEqual(site92, site91)
        still = self.rows[STANDING_NEXT91_HAPAX_STILL_HAPAX[0]]
        self.assertEqual(
            still.tokens,
            (
        ...
        self.assertEqual(still.tokens[:91], CYCLE924_SEQUENCES[3])
        self.assertEqual(CYCLE924_SITES[3], ("Ia", "Ia9", 9))
        ...
        self.assertIn(("Ia", "Ia10", 144), STANDING_NO_NEXT92_SITES)
        self.assertIn(("Ia", "Ia10", 143), STANDING_NO_NEXT92_SITES)
        self.assertIn(("Ia", "Ia10", 142), STANDING_NO_NEXT92_SITES)
        self.assertIn(("Ia", "Ia8", 167), STANDING_NO_NEXT92_SITES)
        self.assertIn(("Ia", "Ia8", 166), STANDING_NO_NEXT92_SITES)
        self.assertIn(("Ia", "Ia8", 165), STANDING_NO_NEXT92_SITES)
    ...
    def test_next_cheap_lock_is_the_locked_cycle_649_next93_list(self):
        """Cycle 649 next-93 I-only list stays locked. The claim name is not a survey key."""
        self.assertEqual(CYCLE649_N, 18)
        self.assertEqual(CYCLE649_N_SEQUENCES, 12)
        self.assertEqual(len(CYCLE649_SEQUENCES), 12)
        self.assertTrue(all(len(tokens) == 93 for tokens in CYCLE649_SEQUENCES))
        ...
        self.assertNotIn("i_leftover_n6_next93_closed_tradition_hpq_abc", self.survey)
        self.assertEqual(
            STANDING_NEXT_CHEAP_LOCK,
            "cycle649_next93_reframed_closed_tradition_hpq_ge1_exact0_abc",
        )
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-925 incomplete-set LOSE table."""
        lock = self.survey[STANDING_RESULT]
        self.assertEqual(lock["cycle"], 925)
        ...
        self.assertEqual(
            tuple(tuple(site) for site in lock["no_next92_sites"]),
            STANDING_NO_NEXT92_SITES,
        )
        ...
        self.assertEqual(
            tuple(lock["next91_hapax_still_hapax"]),
            STANDING_NEXT91_HAPAX_STILL_HAPAX,
        )
        self.assertTrue(lock["next91_all_extend"])
        self.assertEqual(lock["next91_all_extend"], STANDING_NEXT91_ALL_EXTEND)
