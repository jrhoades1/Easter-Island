"""I's cycle-273 leftover extra remaining-after-600 remaining-after-090
previous-076 3-gram 076 090 076 off-I lock.

Cycle 274 text-search lock. Uses already-vendored A–V and the
cycle-273 leftover extra remaining-after-600 remaining-after-090
previous-076 cluster (K_076=2 of N_remaining_after_090_and_076=33;
leftover extra=56; N_I=69). Does not retune that leftover extra
remaining-after-600 remaining-after-090 previous-076 lock, leftover
extra remaining-after-600 previous-090 (cycle 271 holds), leftover
extra remaining-after-600 unique previous stem (cycle 270 lost),
leftover extra remaining-after-999 previous-600 (cycle 267 holds),
leftover extra previous-999 (cycle 261 holds), leftover extra
share-one-previous-stem (cycle 260 lost), leftover extra
share-one-forward-stem (cycle 225 lost), leftover extra sites, the
leftover n=4 set, or the already-closed leftover remaining family.
Does not retune the forward peel of leftover extra I 090 076
(cycles 225–259). Does not peel leftover extra remaining-after-076
/ remaining 071/045/009 this cycle. Does not retune leftover n=4.
Does not overwrite cycle 167's 3-gram I-only 16/0 lock. Does not
overwrite cycle 268's 3-gram I-only 6/0 lock. Does not overwrite
cycle 273's leftover extra remaining-after-600 remaining-after-090
previous-076 lock. Does not retune cycle 272's 3-gram 090 090 076
I-only lose 3/1 on T extra I=1 or peel its T / extra-I. Does not
vendor a new tablet. Does not scrape X. W has no Barthel (cycle
100); skip W. Unpublished Ib is 0. Does not redo H∩P∩Q n≥8 or
G–K inventories. Raw stems. No invented Barthel. No G00n→Barthel
map. No type merge. No detector retune. No CV. No new agents.
Not a meaning dictionary.

Same claim-shape as cycle 212 (720 076 070 was I-only 3/0 after
leftover previous-720), cycle 268 (600 090 076 was I-only 6/0
extra I=2 after leftover extra remaining-after-999 previous-600),
and cycle 272 (090 090 076 was not I-only 3/1 on T extra I=1
after leftover extra remaining-after-600 previous-090). Extra I
of this 3-gram is leftover-of-leftover, same shape as cycle 245
extra I of 090 076 087, cycle 268 extra I of 600 090 076, and
cycle 272 extra I of 090 090 076. Cycle 207 lost: 090 076 070 is
not I-only (8/1 on T). Cycle 223 lost: 090 076 is not I-only
(69/3 on T). T leaks of 090 076 are a real lose path for
076 090 076. Cycle 167 already owns 999 090 076 I-only 16/0;
this cycle is the new leftover extra remaining-after-600
remaining-after-090 previous-076 3-gram 076 090 076 only.
090 076 without the leading 076, 999 090 076, 600 090 076,
090 090 076, 720 076 070, 090 076 070, and leftover n=4
remaining 090 076 020 010 do not count as this 3-gram. Cycle
271 K_090=2 of leftover extra remaining-after-600 at
Ia12[42]/Ia14[105] is a different cluster. Both leftover extra
remaining-after-600 remaining-after-090 previous-076 sites have
previous 4-grams 076 076 090 076 / 071 076 090 076 (not the
same 4-gram). Do not retune leftover n=4, 076-cells, or any
detector. Do not peel leftover extra remaining-after-076 /
remaining 071/045/009. Off-I T sites of 090 076 are this cycle
only as off-I of 076 090 076 if they match. Do not assume the
I-only result.

Locks exact consecutive hits of 076 090 076 on tablet I and
on every other vendored tablet A–H and J–V. Claim that can
lose: i_3gram_076_090_076_i_only (I hits ≥ 1 and off-I hits
== 0). True only if N_off_I == 0. Extra I ≠ 0 does not make
the claim lose (still I-only); still lock extra I. Measured:
Ia is exactly 3 at Ia2[164]/Ia4[85]/Ia13[151]; Ib unpublished
0; off-I is 1 on T (Ta7[4]). Leftover extra remaining-after-600
remaining-after-090 previous-076 2 sites (090-starts
Ia2[165]/Ia13[152]) ⊆ those I 3-gram sites (076-starts one
token earlier). Extra I = 1 at Ia4[85] (090-start Ia4[86] sits
inside leftover n=4 remaining 090 076 020 010; leftover of
leftover, not locked as remaining-after-076). The claim is
false. Not an n≥8 island. Not the cycle-103 I 5-gram. Nested
leftover extra remaining-after-600 remaining-after-090
previous-076 K_076=2 / N_remaining_after_090_and_076=33,
leftover extra==56, N_I==69, cycle 273 both previous 4-grams
076 076 090 076 / 071 076 090 076, cycle 272 3/1 on T extra
I=1, cycle 271 K_090=2 N_remaining_after_090=35, cycle 270
unique-max false 5-way K=2 G=090, cycle 268 6/0 extra I=2,
cycle 223 69/3, and cycle 207 8/1 on T stay.
...
STANDING_IB_SITES = ()
STANDING_LEFTOVER_MATCHING_SITES = CYCLE273_MATCHING_SITES
STANDING_LEFTOVER_MATCHING_COUNT = 2
STANDING_LEFTOVER_MATCHING_PREVIOUS_4GRAMS = CYCLE273_MATCHING_PREVIOUS_4GRAMS
...
STANDING_I_SITE_ROWS = (
    {
        ...
        "line": "Ia2",
        "index": 164,
        "previous_4gram": ("076", "076", "090", "076"),
        "leftover_extra_090_076_site": (SIDE_IA, "Ia2", 165),
        "in_cycle273_leftover_extra_2": True,
    ...
    },
    {
        ...
        "line": "Ia4",
        "index": 85,
        "previous_4gram": ("090", "076", "090", "076"),
        "leftover_extra_090_076_site": (SIDE_IA, "Ia4", 86),
        "in_cycle273_leftover_extra_2": False,
    ...
    },
    {
        ...
        "line": "Ia13",
        "index": 151,
        "previous_4gram": ("071", "076", "090", "076"),
        "leftover_extra_090_076_site": (SIDE_IA, "Ia13", 152),
        "in_cycle273_leftover_extra_2": True,
        "inside_leftover_n4_remaining": False,
    },
)
...
STANDING_OFF_I_PREVIOUS_4GRAM = ("664", "076", "090", "076")
STANDING_OFF_I_NEXT_4GRAM = ("076", "090", "076", "126")
...
STANDING_CLAIM = "i_3gram_076_090_076_i_only"
STANDING_I_3GRAM_076_090_076_I_ONLY = False
STANDING_RESULT = "i_3gram_076_090_076_i_only"
...
STANDING_090_076_WITHOUT_LEADING_076_DOES_NOT_COUNT = True
...
STANDING_LEFTOVER_EXTRA_REMAINING_AFTER_076_IS_NOT_THIS_CYCLE = True
STANDING_DO_NOT_PEEL_REMAINING_AFTER_076 = True
STANDING_DO_NOT_PEEL_071_045_009 = True
...
STANDING_CYCLE273_K_076 = 2
STANDING_CYCLE273_G = "076"
STANDING_CYCLE273_N_REMAINING_AFTER_090 = 35
STANDING_CYCLE273_N_REMAINING_AFTER_090_AND_076 = 33
STANDING_CYCLE273_N_LEFTOVER_EXTRA = 56


def leftover_extra_090_076_site_for_3gram(
    site: tuple[str, str, int],
) -> tuple[str, str, int]:
    """090 076 starts one token after 076 090 076."""
    side, line, index = site
    return (side, line, index + 1)


def leftover_extra_remaining_after_090_previous_076_3gram_sites(
    leftover_matching: tuple[tuple[str, str, int], ...] = STANDING_LEFTOVER_MATCHING_SITES,
) -> tuple[tuple[str, str, int], ...]:
    """Leftover extra remaining-after-090 previous-076 090-starts shifted to 3-gram starts."""
    return tuple((side, line, index - 1) for side, line, index in leftover_matching)


def leftover_extra_remaining_after_090_previous_076_subset(
    leftover_matching: tuple[tuple[str, str, int], ...] = STANDING_LEFTOVER_MATCHING_SITES,
    i_sites: tuple[tuple[str, str, int], ...] = STANDING_I_SITES,
) -> bool:
    """True iff leftover extra remaining-after-090 previous-076 2 sites ⊆ I 076 090 076."""
    return set(
        leftover_extra_remaining_after_090_previous_076_3gram_sites(leftover_matching)
...
def leftover_3gram_sites(
    ...
    """I 076 090 076 sites whose 090 076 is leftover extra remaining-after-090 previous-076."""
...
def extra_i_sites(
    ...
    """I 076 090 076 sites that are not leftover extra remaining-after-090 previous-076."""
    leftover_set = set(leftover_matching)
    return tuple(
        site
        for site in i_sites
...
def site_previous_4gram_for_3gram(
    ...
    """W 076 090 076 if a previous stem exists; None at start-of-line."""
...
def i_3gram_076_090_076_i_only(
    i_hits: int,
    off_i_hits: int,
) -> bool:
...
def i_site_row_as_survey(row: dict) -> dict:
    ...
    return {
        ...
        "in_cycle273_leftover_extra_2": row["in_cycle273_leftover_extra_2"],
        "inside_leftover_n4_remaining": row["inside_leftover_n4_remaining"],
    }


class TestI3gram076090076IOnlyHelpers(unittest.TestCase):
    """Helpers on cycle-273 leftover extra remaining-after-090 previous-076 3-gram."""

    def test_counts_require_consecutive_tokens(self):
        """Adjacent 3-gram counts; a gap is not a hit. 090 076 / 090 090 076 are not."""
        provider = MockProvider()
        self.assertEqual(GRAM3, ("076", "090", "076"))
        self.assertEqual(GRAM3, GRAM3_BACKWARD)
        adjacent = [list(GRAM3), list(GRAM3)]
        self.assertEqual(ngram_hit_count(adjacent, GRAM3), 2)
        overlap = [["076", "090", "076", "076", "090", "076"]]
        ...
        self.assertEqual(ngram_hit_count([["090", "090", "076"]], GRAM3), 0)
        self.assertTrue(STANDING_090_076_WITHOUT_LEADING_076_DOES_NOT_COUNT)
    ...
    def test_i_only_requires_i_ge_1_and_zero_off_i(self):
        ...
        provider = MockProvider()
        self.assertTrue(i_3gram_076_090_076_i_only(1, 0))
        self.assertTrue(i_3gram_076_090_076_i_only(2, 0))
        self.assertTrue(i_3gram_076_090_076_i_only(3, 0))
        self.assertFalse(i_3gram_076_090_076_i_only(3, 1))
        self.assertFalse(i_3gram_076_090_076_i_only(1, 1))
        self.assertFalse(i_3gram_076_090_076_i_only(0, 0))
        self.assertFalse(i_3gram_076_090_076_i_only(0, 1))
        self.assertEqual(STANDING_CLAIM, "i_3gram_076_090_076_i_only")
        self.assertFalse(STANDING_I_3GRAM_076_090_076_I_ONLY)
        self.assertTrue(HYPOTHESIS_I_ONLY)
        self.assertNotEqual(
            STANDING_I_3GRAM_076_090_076_I_ONLY,
            HYPOTHESIS_I_ONLY,
        )
    ...
    def test_leftover_matching_subset_and_extra_can_fail(self):
        """Leftover extra previous-076 ⊆ I sites; extra is nonempty leftover-of-leftover."""
        provider = MockProvider()
        self.assertTrue(
            leftover_extra_remaining_after_090_previous_076_subset(
                STANDING_LEFTOVER_MATCHING_SITES,
                STANDING_I_SITES,
            )
        )
        self.assertEqual(
            leftover_extra_remaining_after_090_previous_076_3gram_sites(),
            STANDING_LEFTOVER_3GRAM_SITES,
        )
    ...
    def test_3gram_is_cycle273_leftover_not_the_cycle_103_5gram(self):
        """3-gram is the cycle-273 leftover extra previous G, not priors."""
        provider = MockProvider()
        self.assertEqual(GRAM3, ("076", "090", "076"))
        self.assertEqual(GRAM3, GRAM3_BACKWARD)
        self.assertEqual(GRAM3[1:], GRAM2)
        self.assertEqual(GRAM3[0], CYCLE273_G)
        ...
        self.assertTrue(STANDING_LEFTOVER_EXTRA_REMAINING_AFTER_076_IS_NOT_THIS_CYCLE)
        self.assertTrue(STANDING_DO_NOT_PEEL_REMAINING_AFTER_076)
        self.assertTrue(STANDING_DO_NOT_PEEL_071_045_009)
        self.assertEqual(provider.get_call_history(), [])


class TestMamariI3gram076090076IOnlyScoreboard(unittest.TestCase):
    """Cited-fixture leftover extra remaining-after-090 previous-076 3-gram off-I lock."""
    ...
    def setUp(self):
        ...
        self.leftover_matching = leftover_extra_remaining_after_090_with_previous_076(
            STANDING_LEFTOVER_SITES,
            self.previous_stems,
        )
        ...
        self.claim_holds = i_3gram_076_090_076_i_only(
            self.i_hits,
            self.off_i_hits,
        )
    ...
    def test_tokens_are_cycle_273_leftover_not_retuned(self):
        """3-gram is the cycle-273 leftover extra previous G, not a new inventory."""
        self.assertEqual(GRAM3, ("076", "090", "076"))
        self.assertEqual(GRAM3, GRAM3_BACKWARD)
        self.assertEqual(GRAM3[1:], GRAM2)
        self.assertEqual(GRAM3[0], "076")
        ...
        self.assertEqual(tuple(prior_273["backward_3gram"]), GRAM3)
        self.assertEqual(prior_273["G"], "076")
        self.assertEqual(prior_273["K"], 2)
        ...
        self.assertEqual(CYCLE273_N_REMAINING_AFTER_090, 35)
        self.assertEqual(CYCLE273_N_REMAINING_AFTER_090_AND_076, 33)
        self.assertEqual(CYCLE273_N_LEFTOVER_EXTRA, 56)
        ...
        measured_matching = [list(site) for site in CYCLE273_MATCHING_SITES]
        self.assertEqual(
            [
                list(site)
                for site in prior_273["matching_leftover_extra_remaining_after_090_sites"]
            ],
            measured_matching,
        )
        self.assertEqual(
        ...
        self.assertNotEqual(
            CYCLE273_MATCHING_PREVIOUS_4GRAMS[0],
            CYCLE273_MATCHING_PREVIOUS_4GRAMS[1],
        )
        self.assertEqual(self.leftover_matching, CYCLE273_MATCHING_SITES)
        self.assertEqual(len(self.leftover_matching), STANDING_CYCLE273_K_076)
        self.assertEqual(STANDING_CYCLE273_K_076, 2)
        self.assertEqual(STANDING_CYCLE273_G, "076")
        self.assertEqual(STANDING_CYCLE273_N_REMAINING_AFTER_090, 35)
        self.assertEqual(STANDING_CYCLE273_N_REMAINING_AFTER_090_AND_076, 33)
        self.assertEqual(STANDING_CYCLE273_N_LEFTOVER_EXTRA, 56)
        self.assertEqual(STANDING_CYCLE223_N_I, 69)
        if (
            len(self.leftover_matching) != 2
            or CYCLE273_G != "076"
            or CYCLE273_K_076 != 2
            or CYCLE273_N_REMAINING_AFTER_090 != 35
            or CYCLE273_N_REMAINING_AFTER_090_AND_076 != 33
            or CYCLE273_N_LEFTOVER_EXTRA != 56
            or CYCLE223_N_I != 69
        ):
            self.fail(
    ...
    def test_i_hits_are_three_on_ia_and_leftover_extra_076_is_subset(self):
        """3-gram is 3 on Ia; Ib 0. Leftover extra previous-076 is 2 of those 3."""
        ...
        self.assertEqual(STANDING_N_EXTRA, 1)
        self.assertEqual(STANDING_N_LEFTOVER + STANDING_N_EXTRA, STANDING_N_I)
        self.assertEqual(self.leftover_extra_090_076_sites, CYCLE273_MATCHING_SITES)
        if self.i_hits != 3:
            self.fail("measured N_I drifted from 3")
        if self.leftover_matching != CYCLE273_MATCHING_SITES:
            self.fail(
                "leftover extra remaining-after-600 remaining-after-090 previous-076 set drifted"
            )
        if not leftover_extra_remaining_after_090_previous_076_subset(
            self.leftover_matching,
            self.i_sites,
        ):
            self.fail(
                "leftover extra remaining-after-600 remaining-after-090 previous-076 "
                "2 sites not subset of I 076 090 076"
            )
        if self.extra != STANDING_EXTRA_I_SITES:
            self.fail("extra I 076 090 076 leftover-of-leftover sites drifted")
        ...
        for (side, line, index), prev4, nxt4, row in zip(
            ...
            if site in leftover_set:
                ...
                self.assertFalse(row["in_cycle273_leftover_extra_2"])
                self.assertTrue(row["inside_leftover_n4_remaining"])
                self.assertEqual(nxt4, ("076", "090", "076", "020"))
        ...
        self.assertEqual(STANDING_EXTRA_I_SITES, ((SIDE_IA, "Ia4", 85),))
        self.assertEqual(STANDING_EXTRA_I_090_076_SITES, ((SIDE_IA, "Ia4", 86),))
    ...
    def test_3gram_is_one_off_i_and_not_i_only(self):
        ...
        self.assertEqual(STANDING_OFF_I_SITES, ((SIDE_TA, "Ta7", 4),))
        ...
        self.assertEqual(tuple(ta7[4:7]), GRAM3)
        self.assertEqual(tuple(ta7[3:7]), STANDING_OFF_I_PREVIOUS_4GRAM)
        self.assertEqual(tuple(ta7[4:8]), STANDING_OFF_I_NEXT_4GRAM)
        ...
        self.assertEqual(
            CYCLE223_OFF_I_PREVIOUS_4GRAMS[1],
        ...
        self.assertEqual(
            i_3gram_076_090_076_i_only(self.i_hits, self.off_i_hits),
            STANDING_I_3GRAM_076_090_076_I_ONLY,
        )
        self.assertEqual(
            self.claim_holds,
        ...
        if self.off_i_sites != STANDING_OFF_I_SITES:
            self.fail("off-I T site of 076 090 076 drifted")
        self.assertEqual(self.provider.get_call_history(), [])

    def test_existing_273_272_271_270_268_223_207_and_w_still_compute(self):
        """Cycle 273 K=2/33, 272 3/1 extra I=1, 271 K_090=2/35, 270 5-way lose, 268 6/0 extra I=2, 223 69/3, 207 8/1 stay."""
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-274 leftover extra previous-076 3-gram I-only lose."""
        lock = self.survey["i_3gram_076_090_076_i_only"]
        self.assertEqual(lock["cycle"], 274)
        ...
        self.assertEqual(
            tuple(
                tuple(row)
                for row in lock[
                    "leftover_extra_remaining_after_600_remaining_after_090_previous_076_sites"
                ]
            ),
            STANDING_LEFTOVER_MATCHING_SITES,
        )
        self.assertEqual(
            lock[
                "leftover_extra_remaining_after_600_remaining_after_090_previous_076_count"
            ],
        ...
        self.assertTrue(
            lock[
                "leftover_extra_remaining_after_600_remaining_after_090_previous_076_subset_of_i_sites"
            ]
        )
        self.assertEqual(
        ...
        self.assertFalse(lock["i_3gram_076_090_076_i_only"])
        self.assertEqual(
            lock["i_3gram_076_090_076_i_only"],
            STANDING_I_3GRAM_076_090_076_I_ONLY,
        )
        ...
        self.assertTrue(lock["090_076_without_leading_076_does_not_count"])
        ...
        self.assertTrue(lock["leftover_extra_remaining_after_076_is_not_this_cycle"])
        self.assertTrue(lock["do_not_peel_remaining_after_076"])
        self.assertTrue(lock["do_not_peel_071_045_009"])
        ...
        self.assertTrue(lock["raw_stems_076_kept"])
...
class TestMamariI3gram076090076IOnlyImageSnapshot(unittest.TestCase):
    """Cycle 274 does not touch clustering. 83/62 / Hamming 6 stays."""
