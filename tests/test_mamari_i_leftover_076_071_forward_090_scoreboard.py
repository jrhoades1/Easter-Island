"""I's cycle-172 leftover 2-gram forward 090 cluster lock.

Cycle 179 text-search lock. Uses already-vendored A–V and the
...
is 090 (forward 3-gram 076 071 090; the local next 4-gram
starts with 076 071 090). End-of-line is no-forward. The 9
inside-family sites do not count as leftover (including
leftover n=4 maximal 076 071 090 999 at Ia7[166] and
Ia14[136]). Cycle 173's five leftover 076 071 076 sites
and cycle 176's four leftover 076 071 600 sites are
different clusters and do not count toward this 090
cluster. 071 999 and 076 076 do not count as this 2-gram.
Same inventory move as cycles 173 and 176: lock the
next-largest leftover continuation cluster (after cycle
173 N=5 forward 076 and cycle 176 N=4 forward 600, this
is N=3 forward 090). Cycle 178's four 076 071 600 forward
4-grams stay I-only hapax 1/0.

Hypothesis N=3: exactly 3 of the 34 leftover sites share
forward 3-gram 076 071 090. Measured: N_leftover=34,
N_with_forward_076_071_090=3 at Ia1[86] 076 071 090 606,
Ia3[85] 076 071 090 076, Ia12[19] 076 071 090 047;
N_without=31; N_no_forward=0. Claim that can lose:
i_leftover_076_071_exactly_3_forward_076_071_090. True only
if N_with_forward_076_071_090=3. The claim is true. Do not
retune.
...
STANDING_N3 = 3
STANDING_N4 = 4
GRAM3_FORWARD = ("076", "071", "090")
STANDING_N_LEFTOVER = 34
STANDING_N_WITH_FORWARD_076_071_090 = 3
STANDING_N_WITHOUT = 31
STANDING_N_NO_FORWARD = 0
STANDING_N_DISTINCT_LEFTOVER_NEXT_4GRAMS = 34
STANDING_NO_FORWARD_SITES = ()
STANDING_INSIDE_FORWARD_090_SITES = STANDING_LEFTOVER_090999_COVERED
STANDING_INSIDE_FORWARD_090_NEXT_4GRAM = LEFTOVER_N4_090999
...
STANDING_CLAIM = "i_leftover_076_071_exactly_3_forward_076_071_090"
STANDING_I_LEFTOVER_076_071_EXACTLY_3_FORWARD_076_071_090 = True
STANDING_RESULT = "i_leftover_076_071_forward_090"
...
def leftover_without_forward_076_071_090(
    sites: tuple[tuple[str, str, int], ...],
    forwards: tuple[tuple[str, ...] | None, ...],
    needle: tuple[str, ...] = GRAM3_FORWARD,
) -> tuple[tuple[str, str, int], ...]:
    """Leftover sites that have a next stem other than 090, or none."""
    return tuple(
        site
        for site, fwd in zip(sites, forwards, strict=True)
        if fwd != needle
...
def i_leftover_076_071_exactly_3_forward_076_071_090(
    n_with_forward_076_071_090: int,
    expected: int = HYPOTHESIS_N,
) -> bool:
    """True iff N_with_forward_076_071_090 equals the hypothesized 3."""
    return n_with_forward_076_071_090 == expected


class TestILeftover076071Forward090Helpers(unittest.TestCase):
    ...
    def test_forward_requires_next_stem_after_2gram(self):
        ...
        self.assertEqual(GRAM3_FORWARD, ("076", "071", "090"))
        ...
        has_next = ["027", "200", "076", "071", "090", "606"]
    ...
    def test_exactly_3_can_fail(self):
        """Boolean is True only when N_with_forward_076_071_090=3."""
        provider = MockProvider()
        self.assertTrue(i_leftover_076_071_exactly_3_forward_076_071_090(3))
        self.assertFalse(i_leftover_076_071_exactly_3_forward_076_071_090(0))
        self.assertFalse(i_leftover_076_071_exactly_3_forward_076_071_090(2))
        self.assertFalse(i_leftover_076_071_exactly_3_forward_076_071_090(4))
        self.assertFalse(i_leftover_076_071_exactly_3_forward_076_071_090(5))
        self.assertFalse(i_leftover_076_071_exactly_3_forward_076_071_090(34))
        self.assertFalse(i_leftover_076_071_exactly_3_forward_076_071_090(1))
        planted = STANDING_MATCHING_SITES + (STANDING_INSIDE_FORWARD_090_SITES[0],)
        planted_forwards = (GRAM3_FORWARD,) * 4
        self.assertEqual(
            leftover_with_forward_076_071_090(planted, planted_forwards),
            planted,
        )
        self.assertFalse(
            i_leftover_076_071_exactly_3_forward_076_071_090(len(planted))
        )
        self.assertEqual(STANDING_CLAIM, "i_leftover_076_071_exactly_3_forward_076_071_090")
        self.assertTrue(STANDING_I_LEFTOVER_076_071_EXACTLY_3_FORWARD_076_071_090)
        self.assertEqual(
            STANDING_I_LEFTOVER_076_071_EXACTLY_3_FORWARD_076_071_090,
            HYPOTHESIS_N == STANDING_N_WITH_FORWARD_076_071_090,
        )
        self.assertEqual(STANDING_N_WITH_FORWARD_076_071_090 + STANDING_N_WITHOUT, 34)
        self.assertEqual(provider.get_call_history(), [])

    def test_inside_family_prior_clusters_and_near_misses_do_not_count(self):
        """Inside 090 999, cycle-173 076, cycle-176 600, 071 999, and 076 076 are not this 090 cluster."""
        provider = MockProvider()
        ...
        self.assertEqual(STANDING_INSIDE_FORWARD_090_NEXT_4GRAM[:3], GRAM3_FORWARD)
...
class TestMamariILeftover076071Forward090Scoreboard(unittest.TestCase):
    """Cited-fixture leftover 076 071 forward-090 cluster. Mock only."""
    ...
    def setUp(self):
        ...
        self.with_sites = leftover_with_forward_076_071_090(
            self.leftover_sites,
            self.forwards,
        )
        self.without_sites = leftover_without_forward_076_071_090(
            self.leftover_sites,
            self.forwards,
        )
        ...
        self.claim_holds = i_leftover_076_071_exactly_3_forward_076_071_090(
            self.n_with,
        )
    ...
    def test_counts_3_of_34_and_hypothesis_n_3_holds(self):
        ...
        self.assertEqual(self.n_with, STANDING_N_WITH_FORWARD_076_071_090)
        ...
        self.assertTrue(i_leftover_076_071_exactly_3_forward_076_071_090(self.n_with))
        self.assertEqual(
            self.claim_holds,
            STANDING_I_LEFTOVER_076_071_EXACTLY_3_FORWARD_076_071_090,
        )
    ...
    def test_matching_leftover_sites_and_next_4grams(self):
        """Three leftover sites share 076 071 090; next 4-grams stay distinct."""
        ...
        expected = (
            ((SIDE_IA, "Ia1", 86), ("076", "071", "090", "606")),
            ((SIDE_IA, "Ia3", 85), ("076", "071", "090", "076")),
            ((SIDE_IA, "Ia12", 19), ("076", "071", "090", "047")),
        )
        for (site, nxt), (want_site, want_nxt) in zip(
            ...
            self.assertEqual(stems[index + STANDING_N2], "090")
    ...
    def test_existing_178_176_173_172_171_170_103_and_w_scoreboards_still_compute(self):
        """Cycle 178 I-only 4-grams, 176 N=4, 173 N=5, 172 leftover 34, 171, 170, 103, W stay."""
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-179 leftover forward-090 lock."""
        lock = self.survey["i_leftover_076_071_forward_090"]
        self.assertEqual(lock["cycle"], 179)
        ...
        self.assertEqual(lock["N_with_forward_076_071_090"], STANDING_N_WITH_FORWARD_076_071_090)
        self.assertEqual(lock["N_with_forward_076_071_090"], 3)
        ...
        self.assertTrue(lock["i_leftover_076_071_exactly_3_forward_076_071_090"])
        self.assertEqual(
            lock["i_leftover_076_071_exactly_3_forward_076_071_090"],
            STANDING_I_LEFTOVER_076_071_EXACTLY_3_FORWARD_076_071_090,
        )
...
class TestMamariILeftover076071Forward090ImageSnapshot(unittest.TestCase):
    """Cycle 179 does not touch clustering. 83/62 / Hamming 6 stays."""
