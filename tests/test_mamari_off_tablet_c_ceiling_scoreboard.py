...
STANDING_CITED_TABLET_LETTERS = ("A", "B", "C", "D", "E", "G", "H", "I", "K", "P", "Q")
...
class TestMamariOffTabletCCeilingScoreboard(unittest.TestCase):
    ...
    def test_cited_kohaumotu_urls_are_tablet_c_or_license(self):
        """Navbar-era sources stay C. Cycles 36/38 cite A; 43/44 B; 46 I; 55/56 G; 59/60 K; 69 H/P; 70 Q; 79 D; 80 E."""
        ...
        for url in self.cited_urls:
            ...
            self.assertIn(letter, (None, "A", "B", "C", "D", "E", "G", "H", "I", "K", "P", "Q"), url)
        self.assertEqual(self.provider.get_call_history(), [])

    def test_no_other_tablet_html_was_vendored(self):
        """Ca/Cb plus Aa, Ab, Br, Bv, Ia, Gr, Gv, Kr, Kv, Hr/Hv/Pr/Pv, Qr/Qv, Da/Db, and cycle-80 Er/Ev."""
