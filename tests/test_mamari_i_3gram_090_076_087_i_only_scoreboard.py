"""I's cycle-244 leftover extra remaining-after-280 3-gram 090 076 087 off-I lock.

Cycle 245 text-search lock. Uses already-vendored A–V and the
cycle-244 leftover extra remaining-after-280 next stem G=087
(K=2 of N_remaining7=27). Does not retune that leftover extra
remaining-after-280 087 lock, leftover extra remaining-after-530
...
remaining family. Does not vendor a new tablet. Does not
...
Same claim-shape as cycle 242 (090 076 280 was I-only 2/0),
cycle 239 (090 076 530 was I-only 2/0), cycle 236 (090 076 700
was I-only 2/0), cycle 232 (090 076 001 was I-only 3/0), cycle
229 (090 076 013 was I-only 5/0), cycle 195 (090 076 071 was
I-only 6/0), and cycle 171 (076 071 was I-only 43/0). Cycle
207 lost: 090 076 070 is not I-only (8/1 on T). Cycle 223
lost: 090 076 is not I-only (69/3 on T). This cycle is the
new leftover extra remaining-after-280 3-gram 090 076 087
only. 090 076 280, 090 076 530, 090 076 700, 090 076 001,
090 076 013, 090 076 070, 090 076 071, and 090 076 without
087 do not count as this 3-gram. Do not retune leftover n=4,
076-cells, or any detector. Do not lock leftover extra
remaining after 087 this cycle. Do not lock the other three
tied stems (011/005/000). Off-I T sites of 090 076 are not
this cycle except as off-I of 090 076 087 if they match.
Do not assume the I-only result.

Locks exact consecutive hits of 090 076 087 on tablet I and
on every other vendored tablet A–H and J–V. Claim that can
lose: i_3gram_090_076_087_i_only (I hits ≥ 1 and off-I hits
== 0). True only if N_off_I == 0. Measured: Ia is exactly 5
at Ia3[87]/Ia4[117]/Ia4[162]/Ia5[28]/Ia6[78]; Ib unpublished
0; every other vendored tablet is exact-0. Leftover extra
remaining-after-280 087 cluster is 2 of those 5 (Ia3[87]/
Ia4[162]; next 4-grams 090 076 087 499 / 078). Extra I sites
not in leftover extra remaining-after-280 = 3 at Ia4[117]/
Ia5[28]/Ia6[78] (inside leftover n=4 remaining 021 090 076
087; leftover of leftover, not locked as remaining-after-087).
The claim is true. Not an n≥8 island. Not the cycle-103 I
5-gram. Nested leftover extra remaining-after-280 K=2 /
G=087 N_remaining7=27, cycle 243 2/0 hapax, cycle 242 2/0,
cycle 241 K=2 / G=280, cycle 240 2/0 hapax, cycle 239 2/0,
cycle 238 K=2 / G=530, cycle 237 2/0 hapax, cycle 236 2/0,
cycle 234 7-way tie at 2, cycle 233 3/0 hapax, cycle 232 3/0,
cycle 223 69/3, cycle 195 6/0, and cycle 171 43/0 stay.
...
STANDING_IB_SITES = ()
STANDING_LEFTOVER_MATCHING_SITES = CYCLE244_MATCHING_SITES
STANDING_LEFTOVER_MATCHING_COUNT = 2
STANDING_LEFTOVER_MATCHING_NEXT_4GRAMS = CYCLE244_MATCHING_NEXT_4GRAMS
...
STANDING_CLAIM = "i_3gram_090_076_087_i_only"
STANDING_I_3GRAM_090_076_087_I_ONLY = True
STANDING_RESULT = "i_3gram_090_076_087_i_only"
...
def i_3gram_090_076_087_i_only(
    i_hits: int,
    off_i_hits: int,
) -> bool:
...
def leftover_extra_remaining_after_280_087_subset(
    ...
    """True iff leftover extra remaining-after-280 087 sites ⊆ I 090 076 087."""
...
def extra_i_sites(
    ...
    """I 090 076 087 sites that are not leftover extra remaining-after-280 087."""
...
class TestI3gram090076087IOnlyHelpers(unittest.TestCase):
    """Helpers on cycle-244 leftover extra remaining-after-280 3-gram. No CV, no LLM."""

    def test_counts_require_consecutive_tokens(self):
        """Adjacent 3-gram counts; a gap is not a hit. 090 076 280 / 530 / 700 are not."""
        ...
        self.assertEqual(ngram_hit_count([["090", "076", "280"]], GRAM3), 0)
        self.assertEqual(ngram_hit_count([["090", "076", "530"]], GRAM3), 0)
    ...
    def test_i_only_requires_i_ge_1_and_zero_off_i(self):
        ...
        provider = MockProvider()
        self.assertTrue(i_3gram_090_076_087_i_only(1, 0))
        self.assertTrue(i_3gram_090_076_087_i_only(2, 0))
        self.assertTrue(i_3gram_090_076_087_i_only(5, 0))
        self.assertFalse(i_3gram_090_076_087_i_only(5, 1))
        self.assertFalse(i_3gram_090_076_087_i_only(1, 1))
        self.assertFalse(i_3gram_090_076_087_i_only(0, 0))
        self.assertFalse(i_3gram_090_076_087_i_only(0, 1))
        self.assertEqual(STANDING_CLAIM, "i_3gram_090_076_087_i_only")
        self.assertTrue(STANDING_I_3GRAM_090_076_087_I_ONLY)
        self.assertTrue(HYPOTHESIS_I_ONLY)
        self.assertEqual(
            STANDING_I_3GRAM_090_076_087_I_ONLY,
            HYPOTHESIS_I_ONLY,
        )
        self.assertEqual(provider.get_call_history(), [])

    def test_leftover_matching_subset_and_extra_can_fail(self):
        """Leftover extra remaining-after-280 087 ⊆ I sites; extra is nonempty."""
        provider = MockProvider()
        self.assertTrue(
        ...
        self.assertNotEqual(STANDING_LEFTOVER_MATCHING_SITES, STANDING_I_SITES)
        ...
        self.assertEqual(len(extra_i_sites(planted_extra)), 4)
        dropped = tuple(
    ...
    def test_3gram_is_cycle244_leftover_not_the_cycle_103_5gram(self):
        """3-gram is the cycle-244 leftover extra remaining-after-280 G, not priors."""
        provider = MockProvider()
        self.assertEqual(GRAM3, ("090", "076", "087"))
        self.assertEqual(GRAM3, GRAM3_FORWARD)
        self.assertEqual(GRAM3[:2], GRAM2)
        self.assertEqual(GRAM3[2], CYCLE244_G)
...
class TestMamariI3gram090076087IOnlyScoreboard(unittest.TestCase):
    """Cited-fixture leftover extra remaining-after-280 3-gram 090 076 087 off-I lock."""
    ...
    def setUp(self):
        ...
        self.claim_holds = i_3gram_090_076_087_i_only(
            self.i_hits,
            self.off_i_hits,
        )

    def test_tokens_are_cycle_244_leftover_not_retuned(self):
        """3-gram is the cycle-244 leftover extra remaining-after-280 G, not a new inventory."""
        self.assertEqual(GRAM3, ("090", "076", "087"))
        self.assertEqual(GRAM3, GRAM3_FORWARD)
        self.assertEqual(GRAM3[:2], GRAM2)
        self.assertEqual(GRAM3[2], "087")
        prior_244 = self.survey["i_leftover_extra_090_076_remaining_after_280_fwd087"]
        self.assertEqual(prior_244["cycle"], 244)
        self.assertEqual(tuple(prior_244["forward_3gram"]), GRAM3)
        ...
        measured_matching = [list(site) for site in CYCLE244_MATCHING_SITES]
        self.assertEqual(
            [list(site) for site in prior_244["matching_leftover_extra_remaining_after_280_sites"]],
            measured_matching,
        )
        self.assertEqual(
            [list(gram) for gram in CYCLE244_MATCHING_NEXT_4GRAMS],
        ...
        self.assertEqual(STANDING_CYCLE244_N_REMAINING7, 27)
    ...
    def test_i_hits_are_five_on_ia_and_leftover_extra_087_is_subset(self):
        """3-gram is 5 on Ia; Ib 0. Leftover extra remaining-after-280 087 is 2 of those 5."""
        ...
        self.assertEqual(self.leftover_matching, CYCLE244_MATCHING_SITES)
        self.assertNotEqual(self.leftover_matching, STANDING_I_SITES)
        ...
        if self.leftover_matching != CYCLE244_MATCHING_SITES:
            self.fail("leftover extra remaining-after-280 087 set drifted")
        if not leftover_extra_remaining_after_280_087_subset(
            self.leftover_matching,
            self.i_sites,
        ):
            self.fail("leftover extra remaining-after-280 087 not subset of I 090 076 087")
        if self.extra != STANDING_EXTRA_I_SITES:
            self.fail("extra I 090 076 087 leftover-of-leftover sites drifted")
        ...
        self.assertEqual(STANDING_LEFTOVER_MATCHING_NEXT_4GRAMS, CYCLE244_MATCHING_NEXT_4GRAMS)
        self.assertEqual(
        ...
        for site in CYCLE224_INSIDE_SITES:
            if site not in STANDING_EXTRA_I_SITES:
    ...
    def test_3gram_is_zero_off_i_and_i_only(self):
        ...
        self.assertEqual(
            i_3gram_090_076_087_i_only(self.i_hits, self.off_i_hits),
            STANDING_I_3GRAM_090_076_087_I_ONLY,
        )
        self.assertEqual(
            self.claim_holds,
    ...
    def test_existing_244_243_242_241_240_239_238_237_236_234_233_232_223_195_and_171_still_compute(self):
        """Cycle 244 K=2/G=087 N_remaining7=27, 243 2/0 hapax, 242 2/0, 241 K=2/G=280, 240 2/0 hapax, 239 2/0, 238 K=2/G=530, 237 2/0 hapax, 236 2/0, 234 7-way tie, 233 3/0, 232 3/0, 223 69/3, 195 6/0, 171 43/0 stay."""
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-245 3-gram I-only lock."""
        lock = self.survey["i_3gram_090_076_087_i_only"]
        self.assertEqual(lock["cycle"], 245)
        ...
        self.assertEqual(
            lock["leftover_extra_remaining_after_280_087_count"],
            STANDING_LEFTOVER_MATCHING_COUNT,
        )
        self.assertEqual(lock["leftover_extra_remaining_after_280_087_count"], 2)
        self.assertTrue(lock["leftover_extra_remaining_after_280_087_subset_of_i_sites"])
        self.assertEqual(
        ...
        self.assertEqual(lock["nested_cycle244_N_remaining7"], STANDING_CYCLE244_N_REMAINING7)
        ...
        self.assertTrue(lock["i_3gram_090_076_087_i_only"])
        self.assertEqual(
            lock["i_3gram_090_076_087_i_only"],
            STANDING_I_3GRAM_090_076_087_I_ONLY,
        )
...
class TestMamariI3gram090076087IOnlyImageSnapshot(unittest.TestCase):
    """Cycle 245 does not touch clustering. 83/62 / Hamming 6 stays."""
