"""I's cycle-172 leftover 2-gram previous 099 cluster lock.

Cycle 200 text-search lock. Uses already-vendored A–V and the
...
before 076 071 is 099 (backward 3-gram 099 076 071; the local
previous 4-gram ends with 099 076 071). Start-of-line is
no-backward. Coordinates are re-measured from fixtures, not
copied from cycle 190. Cycle 197 leftover-2 previous 604,
cycle 194 leftover-3 previous 090, cycle 191 leftover-3
previous 700, cycle 190 leftover previous-stem N_distinct=28,
cycle 172 leftover N=34, and cycle 171 I-only 43/0 stay. The
9 inside-family sites do not count as leftover (none of them
is 099 076 071). Cycle 197's two leftover 604 076 071 sites,
cycle 194's three leftover 090 076 071 sites, and cycle 191's
three leftover 700 076 071 sites are different 3-grams and
are disjoint from this previous-099 cluster. 071 999 and
076 076 do not count as this 2-gram.

Hypothesis N=2: exactly 2 of the 34 leftover sites share
previous 3-gram 099 076 071. Measured: N_leftover=34,
N_with_previous_099_076_071=2 at Ia6[117] 430 099 076 071,
Ia12[6] 019 099 076 071; N_without=32; N_no_backward=0.
Claim that can lose:
i_leftover_076_071_exactly_2_previous_099_076_071. True only
if N_with_previous_099_076_071=2. The claim is true. Do not
retune.
...
STANDING_N4 = 4
STEM_099 = "099"
GRAM3_BACKWARD = ("099", "076", "071")
STANDING_N_LEFTOVER = 34
STANDING_N_WITH_PREVIOUS_099_076_071 = 2
STANDING_N_WITHOUT = 32
STANDING_N_NO_BACKWARD = 0
STANDING_NO_BACKWARD_SITES = ()
STANDING_INSIDE_PREVIOUS_099_SITES = ()
STANDING_NEAR_MISS_CYCLE191_090_700_SITE = (SIDE_IA, "Ia1", 163)
STANDING_NEAR_MISS_CYCLE191_090_700_PREVIOUS_4GRAM = ("090", "700", "076", "071")
...
STANDING_CLAIM = "i_leftover_076_071_exactly_2_previous_099_076_071"
STANDING_I_LEFTOVER_076_071_EXACTLY_2_PREVIOUS_099_076_071 = True
STANDING_RESULT = "i_leftover_076_071_previous_099"
...
def leftover_without_previous_099_076_071(
    sites: tuple[tuple[str, str, int], ...],
    backwards: tuple[tuple[str, ...] | None, ...],
    needle: tuple[str, ...] = GRAM3_BACKWARD,
) -> tuple[tuple[str, str, int], ...]:
    """Leftover sites that have a previous stem other than 099, or none."""
    return tuple(
        site
        for site, back in zip(sites, backwards, strict=True)
        if back != needle
...
def i_leftover_076_071_exactly_2_previous_099_076_071(
    n_with_previous_099_076_071: int,
    expected: int = HYPOTHESIS_N,
) -> bool:
    """True iff N_with_previous_099_076_071 equals the hypothesized 2."""
    return n_with_previous_099_076_071 == expected


class TestILeftover076071Previous099Helpers(unittest.TestCase):
    """Helpers on cycle-172 leftover 076 071 previous 099. No CV, no LLM."""

    def test_previous_requires_stem_099_before_2gram(self):
        """A previous 099 is a 3-gram; start-of-line is no-backward."""
        provider = MockProvider()
        self.assertEqual(GRAM2, ("076", "071"))
        self.assertEqual(GRAM3_BACKWARD, ("099", "076", "071"))
        self.assertEqual(GRAM3_BACKWARD[1:], GRAM2)
        self.assertEqual(GRAM3_BACKWARD[0], STEM_099)
        ...
        has_099 = ["430", "099", "076", "071", "632", "670"]
        self.assertEqual(site_previous_stem(has_099, 2, GRAM2), STEM_099)
        self.assertEqual(site_backward_3gram(has_099, 2, GRAM2), GRAM3_BACKWARD)
        self.assertEqual(
            site_previous_4gram(has_099, 2, GRAM2),
            ("430", "099", "076", "071"),
        )
        other_prev = ["090", "700", "076", "071", "700", "076"]
        self.assertEqual(site_previous_stem(other_prev, 2, GRAM2), "700")
        self.assertNotEqual(site_backward_3gram(other_prev, 2, GRAM2), GRAM3_BACKWARD)
        self.assertEqual(
            site_previous_4gram(other_prev, 2, GRAM2),
            STANDING_NEAR_MISS_CYCLE191_090_700_PREVIOUS_4GRAM,
        )
        cycle197 = ["600", "604", "076", "071", "061", "011"]
        self.assertEqual(site_previous_stem(cycle197, 2, GRAM2), "604")
        self.assertNotEqual(site_backward_3gram(cycle197, 2, GRAM2), GRAM3_BACKWARD)
        self.assertEqual(
            site_previous_4gram(cycle197, 2, GRAM2),
            CYCLE197_MATCHING_PREVIOUS_4GRAMS[0],
        )
        cycle191_near_miss = ["700", "604", "076", "071", "600", "999"]
        self.assertEqual(site_previous_stem(cycle191_near_miss, 2, GRAM2), "604")
        self.assertNotEqual(
            site_backward_3gram(cycle191_near_miss, 2, GRAM2),
            GRAM3_BACKWARD,
        )
        self.assertEqual(
            site_previous_4gram(cycle191_near_miss, 2, GRAM2),
    ...
    def test_exactly_2_can_fail(self):
        """Boolean is True only when N_with_previous_099_076_071=2."""
        provider = MockProvider()
        self.assertTrue(i_leftover_076_071_exactly_2_previous_099_076_071(2))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_099_076_071(0))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_099_076_071(1))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_099_076_071(3))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_099_076_071(4))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_099_076_071(5))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_099_076_071(28))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_099_076_071(34))
        planted = STANDING_MATCHING_SITES + (STANDING_NEAR_MISS_CYCLE191_090_700_SITE,)
        planted_backs = (GRAM3_BACKWARD,) * 3
        self.assertEqual(
            leftover_with_previous_099_076_071(planted, planted_backs),
            planted,
        )
        self.assertFalse(
            i_leftover_076_071_exactly_2_previous_099_076_071(len(planted))
        )
        self.assertEqual(STANDING_CLAIM, "i_leftover_076_071_exactly_2_previous_099_076_071")
        self.assertTrue(STANDING_I_LEFTOVER_076_071_EXACTLY_2_PREVIOUS_099_076_071)
        self.assertEqual(
            STANDING_I_LEFTOVER_076_071_EXACTLY_2_PREVIOUS_099_076_071,
            HYPOTHESIS_N == STANDING_N_WITH_PREVIOUS_099_076_071,
        )
        self.assertEqual(STANDING_N_WITH_PREVIOUS_099_076_071 + STANDING_N_WITHOUT, 34)
        self.assertEqual(provider.get_call_history(), [])

    def test_inside_family_prior_clusters_and_near_misses_do_not_count(self):
        """Inside family, cycle-197 previous 604, cycle-194 previous 090, and cycle-191 previous 700 are not this cluster."""
        provider = MockProvider()
        self.assertEqual(STANDING_INSIDE_PREVIOUS_099_SITES, ())
        ...
        self.assertEqual(CYCLE197_GRAM3_BACKWARD, ("604", "076", "071"))
        self.assertNotEqual(GRAM3_BACKWARD, CYCLE197_GRAM3_BACKWARD)
        ...
        self.assertEqual(CYCLE194_GRAM3_BACKWARD, ("090", "076", "071"))
        self.assertNotEqual(GRAM3_BACKWARD, CYCLE194_GRAM3_BACKWARD)
        ...
        self.assertIn(CYCLE191_NEAR_MISS_700_604_SITE, STANDING_LEFTOVER_SITES)
        self.assertIn(CYCLE191_NEAR_MISS_700_604_SITE, STANDING_WITHOUT_SITES)
        self.assertNotIn(CYCLE191_NEAR_MISS_700_604_SITE, STANDING_MATCHING_SITES)
        self.assertIn(CYCLE191_NEAR_MISS_700_604_SITE, CYCLE197_MATCHING_SITES)
        ...
        self.assertNotEqual(
            CYCLE191_NEAR_MISS_700_604_PREVIOUS_4GRAM[1:],
            GRAM3_BACKWARD,
        )
        self.assertTrue(STANDING_NEAR_MISS_700_604_DOES_NOT_COUNT)
        self.assertIn(STANDING_NEAR_MISS_CYCLE191_090_700_SITE, STANDING_LEFTOVER_SITES)
        self.assertIn(STANDING_NEAR_MISS_CYCLE191_090_700_SITE, STANDING_WITHOUT_SITES)
        self.assertNotIn(STANDING_NEAR_MISS_CYCLE191_090_700_SITE, STANDING_MATCHING_SITES)
        self.assertIn(STANDING_NEAR_MISS_CYCLE191_090_700_SITE, CYCLE191_MATCHING_SITES)
...
class TestMamariILeftover076071Previous099Scoreboard(unittest.TestCase):
    """Cited-fixture leftover 076 071 previous-099 cluster. Mock only."""
    ...
    def setUp(self):
        ...
        self.with_sites = leftover_with_previous_099_076_071(
            self.leftover_sites,
            self.backwards,
        )
        self.without_sites = leftover_without_previous_099_076_071(
            self.leftover_sites,
            self.backwards,
        )
        ...
        self.claim_holds = i_leftover_076_071_exactly_2_previous_099_076_071(
            self.n_with,
        )

    def test_tokens_and_sites_are_cycle_172_leftover_not_retuned(self):
        """2-gram and leftover 34 stay the cycle-197/194/191/190/172/171 locks."""
        self.assertEqual(GRAM2, ("076", "071"))
        self.assertEqual(GRAM3_BACKWARD, ("099", "076", "071"))
        ...
        self.assertEqual(prior_190["previous_stem_frequency"][3]["previous_stem"], STEM_099)
        self.assertEqual(prior_190["previous_stem_frequency"][3]["count"], 2)
    ...
    def test_counts_2_of_34_and_hypothesis_n_2_holds(self):
        ...
        self.assertEqual(self.n_with, STANDING_N_WITH_PREVIOUS_099_076_071)
        self.assertEqual(STANDING_N_WITH_PREVIOUS_099_076_071, 2)
        ...
        self.assertTrue(i_leftover_076_071_exactly_2_previous_099_076_071(self.n_with))
        self.assertEqual(
            self.claim_holds,
            STANDING_I_LEFTOVER_076_071_EXACTLY_2_PREVIOUS_099_076_071,
        )
        ...
        if self.n_with != 2:
            self.fail("measured N_with_previous_099_076_071 drifted from 2")
    ...
    def test_matching_leftover_sites_and_previous_4grams(self):
        """Two leftover sites share 099 076 071; they are disjoint from cycle-197, cycle-194, and cycle-191 leftover clusters."""
        ...
        expected = (
            ((SIDE_IA, "Ia6", 117), ("430", "099", "076", "071")),
            ((SIDE_IA, "Ia12", 6), ("019", "099", "076", "071")),
        )
        for (site, prev4), (want_site, want_prev4) in zip(
            ...
            self.assertEqual(stems[index - 1], STEM_099)
            self.assertEqual(site_previous_stem(stems, index, GRAM2), STEM_099)
        ...
        self.assertEqual(len(set(STANDING_MATCHING_PREVIOUS_4GRAMS)), 2)
        self.assertTrue(STANDING_DISJOINT_FROM_CYCLE191_LEFTOVER_3)
        self.assertTrue(STANDING_DISJOINT_FROM_CYCLE194_LEFTOVER_3)
        self.assertTrue(STANDING_DISJOINT_FROM_CYCLE197_LEFTOVER_2)
        self.assertEqual(
            set(STANDING_MATCHING_SITES) & set(CYCLE191_MATCHING_SITES),
            set(),
        )
        self.assertEqual(
            set(STANDING_MATCHING_SITES) & set(CYCLE194_MATCHING_SITES),
            set(),
        )
        self.assertEqual(
            set(STANDING_MATCHING_SITES) & set(CYCLE197_MATCHING_SITES),
            set(),
        )
        for site in CYCLE191_MATCHING_SITES:
        ...
        for site in STANDING_WITHOUT_SITES:
            ...
            self.assertNotEqual(back[0], STEM_099)
        ...
        self.assertEqual(site_previous_stem(near_stems, near_index, GRAM2), "700")
        self.assertIn(STANDING_NEAR_MISS_CYCLE191_090_700_SITE, self.without_sites)
        self.assertNotIn(STANDING_NEAR_MISS_CYCLE191_090_700_SITE, self.with_sites)
        self.assertEqual(CYCLE191_NEAR_MISS_700_604_SITE, (SIDE_IA, "Ia9", 10))
        self.assertIn(CYCLE191_NEAR_MISS_700_604_SITE, self.without_sites)
        self.assertNotIn(CYCLE191_NEAR_MISS_700_604_SITE, self.with_sites)
        self.assertIn(CYCLE191_NEAR_MISS_700_604_SITE, CYCLE197_MATCHING_SITES)
        for site, prev4 in zip(CYCLE197_MATCHING_SITES, CYCLE197_MATCHING_PREVIOUS_4GRAMS):
            stems = line_stems_for_site(self.i_sides, site)
            index = site[2]
            self.assertEqual(site_backward_3gram(stems, index, GRAM2), CYCLE197_GRAM3_BACKWARD)
            self.assertEqual(site_previous_4gram(stems, index, GRAM2), prev4)
            self.assertIn(site, self.without_sites)
            self.assertNotIn(site, self.with_sites)
        for site, prev4 in zip(CYCLE194_MATCHING_SITES, CYCLE194_MATCHING_PREVIOUS_4GRAMS):
            stems = line_stems_for_site(self.i_sides, site)
            index = site[2]
            self.assertEqual(site_backward_3gram(stems, index, GRAM2), CYCLE194_GRAM3_BACKWARD)
            self.assertEqual(site_previous_4gram(stems, index, GRAM2), prev4)
            self.assertIn(site, self.without_sites)
            self.assertNotIn(site, self.with_sites)
        for site, prev4 in zip(CYCLE191_MATCHING_SITES, CYCLE191_MATCHING_PREVIOUS_4GRAMS):
            stems = line_stems_for_site(self.i_sides, site)
            index = site[2]
            self.assertEqual(site_backward_3gram(stems, index, GRAM2), CYCLE191_GRAM3_BACKWARD)
            self.assertEqual(site_previous_4gram(stems, index, GRAM2), prev4)
            self.assertIn(site, self.without_sites)
            self.assertNotIn(site, self.with_sites)
        for site in STANDING_INSIDE_SITES:
            ...
            inside_index = site[2]
            self.assertNotEqual(
                site_backward_3gram(inside_stems, inside_index, GRAM2),
                GRAM3_BACKWARD,
            )
            self.assertNotEqual(
                site_previous_stem(inside_stems, inside_index, GRAM2),
                STEM_099,
            )
    ...
    def test_existing_197_194_191_190_172_171_scoreboards_still_compute(self):
        """Cycle 197 leftover-2, 194 leftover-3, 191 leftover-3, 190 N_distinct=28, 172 leftover-34, and 171 I-only 43/0 stay."""
        ...
        self.assertEqual(
            set(self.with_sites) & set(prior_197.with_sites),
            set(),
        )
        ...
        self.assertEqual(
            set(self.with_sites) & set(prior_194.with_sites),
            set(),
        )
        ...
        self.assertEqual(
            set(self.with_sites) & set(prior_191.with_sites),
            set(),
        )
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-200 leftover previous-099 lock."""
        lock = self.survey["i_leftover_076_071_previous_099"]
        self.assertEqual(lock["cycle"], 200)
        ...
        self.assertEqual(lock["previous_stem"], STEM_099)
        ...
        self.assertEqual(
            lock["N_with_previous_099_076_071"],
            STANDING_N_WITH_PREVIOUS_099_076_071,
        )
        self.assertEqual(lock["N_with_previous_099_076_071"], 2)
        ...
        self.assertEqual(lock["inside_previous_099_sites"], [])
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            CYCLE191_NEAR_MISS_700_604_SITE,
        )
        self.assertEqual(
        ...
        self.assertTrue(lock["i_leftover_076_071_exactly_2_previous_099_076_071"])
        self.assertEqual(
            lock["i_leftover_076_071_exactly_2_previous_099_076_071"],
            STANDING_I_LEFTOVER_076_071_EXACTLY_2_PREVIOUS_099_076_071,
        )
        ...
        self.assertTrue(lock["coordinates_remeasured_not_copied_from_cycle190"])
...
class TestMamariILeftover076071Previous099ImageSnapshot(unittest.TestCase):
    """Cycle 200 does not touch clustering. 83/62 / Hamming 6 stays."""
