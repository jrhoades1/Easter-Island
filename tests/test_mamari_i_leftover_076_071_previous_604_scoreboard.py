"""I's cycle-172 leftover 2-gram previous 604 cluster lock.

Cycle 197 text-search lock. Uses already-vendored A–V and the
...
before 076 071 is 604 (backward 3-gram 604 076 071; the local
previous 4-gram ends with 604 076 071). Start-of-line is
no-backward. Coordinates are re-measured from fixtures, not
copied from cycle 190. Cycle 194 leftover-3 previous 090,
cycle 191 leftover-3 previous 700, cycle 190 leftover
previous-stem N_distinct=28, cycle 172 leftover N=34, and
cycle 171 I-only 43/0 stay. The 9 inside-family sites do not
count as leftover (none of them is 604 076 071). Cycle 194's
three leftover 090 076 071 sites and cycle 191's three
leftover 700 076 071 sites are different 3-grams and are
disjoint from this previous-604 cluster. Ia3[13] 076 071 274
604 and Ia3[133] 076 071 202 604 are leftover but 604 is
forward, not previous. Cycle 191's near-miss Ia9[10] 700 604
076 071 is leftover with previous stem 604 (not 700) and
does count here. 071 999 and 076 076 do not count as this
2-gram.

Hypothesis N=2: exactly 2 of the 34 leftover sites share
previous 3-gram 604 076 071. Measured: N_leftover=34,
N_with_previous_604_076_071=2 at Ia3[147] 600 604 076 071,
Ia9[10] 700 604 076 071; N_without=32; N_no_backward=0.
Claim that can lose:
i_leftover_076_071_exactly_2_previous_604_076_071. True only
if N_with_previous_604_076_071=2. The claim is true. Do not
retune.
...
STANDING_N4 = 4
STEM_604 = "604"
GRAM3_BACKWARD = ("604", "076", "071")
STANDING_N_LEFTOVER = 34
STANDING_N_WITH_PREVIOUS_604_076_071 = 2
STANDING_N_WITHOUT = 32
STANDING_N_NO_BACKWARD = 0
STANDING_NO_BACKWARD_SITES = ()
STANDING_INSIDE_PREVIOUS_604_SITES = ()
...
STANDING_CLAIM = "i_leftover_076_071_exactly_2_previous_604_076_071"
STANDING_I_LEFTOVER_076_071_EXACTLY_2_PREVIOUS_604_076_071 = True
STANDING_RESULT = "i_leftover_076_071_previous_604"
...
def leftover_without_previous_604_076_071(
    sites: tuple[tuple[str, str, int], ...],
    backwards: tuple[tuple[str, ...] | None, ...],
    needle: tuple[str, ...] = GRAM3_BACKWARD,
) -> tuple[tuple[str, str, int], ...]:
    """Leftover sites that have a previous stem other than 604, or none."""
    return tuple(
        site
        for site, back in zip(sites, backwards, strict=True)
        if back != needle
...
def i_leftover_076_071_exactly_2_previous_604_076_071(
    n_with_previous_604_076_071: int,
    expected: int = HYPOTHESIS_N,
) -> bool:
    """True iff N_with_previous_604_076_071 equals the hypothesized 2."""
    return n_with_previous_604_076_071 == expected


class TestILeftover076071Previous604Helpers(unittest.TestCase):
    """Helpers on cycle-172 leftover 076 071 previous 604. No CV, no LLM."""

    def test_previous_requires_stem_604_before_2gram(self):
        """A previous 604 is a 3-gram; start-of-line is no-backward."""
        provider = MockProvider()
        self.assertEqual(GRAM2, ("076", "071"))
        self.assertEqual(GRAM3_BACKWARD, ("604", "076", "071"))
        self.assertEqual(GRAM3_BACKWARD[1:], GRAM2)
        self.assertEqual(GRAM3_BACKWARD[0], STEM_604)
        ...
        has_604 = ["600", "604", "076", "071", "061", "011"]
        self.assertEqual(site_previous_stem(has_604, 2, GRAM2), STEM_604)
        self.assertEqual(site_backward_3gram(has_604, 2, GRAM2), GRAM3_BACKWARD)
        self.assertEqual(
            site_previous_4gram(has_604, 2, GRAM2),
            ("600", "604", "076", "071"),
        )
        ...
        self.assertEqual(site_previous_stem(cycle191_near_miss, 2, GRAM2), STEM_604)
        self.assertEqual(
        ...
        forward_604 = ["205", "225", "076", "071", "274", "604"]
        self.assertEqual(site_previous_stem(forward_604, 2, GRAM2), "225")
        self.assertNotEqual(site_backward_3gram(forward_604, 2, GRAM2), GRAM3_BACKWARD)
        self.assertEqual(tuple(forward_604[2:6]), STANDING_NEAR_MISS_FORWARD_604_NEXT_4GRAMS[0])
    ...
    def test_exactly_2_can_fail(self):
        """Boolean is True only when N_with_previous_604_076_071=2."""
        provider = MockProvider()
        self.assertTrue(i_leftover_076_071_exactly_2_previous_604_076_071(2))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_604_076_071(0))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_604_076_071(1))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_604_076_071(3))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_604_076_071(4))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_604_076_071(5))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_604_076_071(28))
        self.assertFalse(i_leftover_076_071_exactly_2_previous_604_076_071(34))
        planted = STANDING_MATCHING_SITES + (STANDING_NEAR_MISS_CYCLE191_090_700_SITE,)
        planted_backs = (GRAM3_BACKWARD,) * 3
        self.assertEqual(
            leftover_with_previous_604_076_071(planted, planted_backs),
            planted,
        )
        self.assertFalse(
            i_leftover_076_071_exactly_2_previous_604_076_071(len(planted))
        )
        self.assertEqual(STANDING_CLAIM, "i_leftover_076_071_exactly_2_previous_604_076_071")
        self.assertTrue(STANDING_I_LEFTOVER_076_071_EXACTLY_2_PREVIOUS_604_076_071)
        self.assertEqual(
            STANDING_I_LEFTOVER_076_071_EXACTLY_2_PREVIOUS_604_076_071,
            HYPOTHESIS_N == STANDING_N_WITH_PREVIOUS_604_076_071,
        )
        self.assertEqual(STANDING_N_WITH_PREVIOUS_604_076_071 + STANDING_N_WITHOUT, 34)
        self.assertEqual(provider.get_call_history(), [])

    def test_inside_family_prior_clusters_and_near_misses_do_not_count(self):
        """Inside family, cycle-194 previous 090, cycle-191 previous 700, and forward 604 are not this cluster."""
        provider = MockProvider()
        self.assertEqual(STANDING_INSIDE_PREVIOUS_604_SITES, ())
        ...
        self.assertIn(CYCLE191_NEAR_MISS_700_604_SITE, STANDING_MATCHING_SITES)
...
class TestMamariILeftover076071Previous604Scoreboard(unittest.TestCase):
    """Cited-fixture leftover 076 071 previous-604 cluster. Mock only."""
    ...
    def setUp(self):
        ...
        self.with_sites = leftover_with_previous_604_076_071(
            self.leftover_sites,
            self.backwards,
        )
        self.without_sites = leftover_without_previous_604_076_071(
            self.leftover_sites,
            self.backwards,
        )
        ...
        self.claim_holds = i_leftover_076_071_exactly_2_previous_604_076_071(
            self.n_with,
        )

    def test_tokens_and_sites_are_cycle_172_leftover_not_retuned(self):
        """2-gram and leftover 34 stay the cycle-194/191/190/172/171 locks."""
        self.assertEqual(GRAM2, ("076", "071"))
        self.assertEqual(GRAM3_BACKWARD, ("604", "076", "071"))
        ...
        self.assertEqual(prior_190["previous_stem_frequency"][2]["previous_stem"], STEM_604)
        self.assertEqual(prior_190["previous_stem_frequency"][2]["count"], 2)
    ...
    def test_counts_2_of_34_and_hypothesis_n_2_holds(self):
        ...
        self.assertEqual(self.n_with, STANDING_N_WITH_PREVIOUS_604_076_071)
        self.assertEqual(STANDING_N_WITH_PREVIOUS_604_076_071, 2)
        ...
        self.assertTrue(i_leftover_076_071_exactly_2_previous_604_076_071(self.n_with))
        self.assertEqual(
            self.claim_holds,
            STANDING_I_LEFTOVER_076_071_EXACTLY_2_PREVIOUS_604_076_071,
        )
        ...
        if self.n_with != 2:
            self.fail("measured N_with_previous_604_076_071 drifted from 2")
    ...
    def test_matching_leftover_sites_and_previous_4grams(self):
        """Two leftover sites share 604 076 071; they are disjoint from cycle-194 and cycle-191 leftover-3."""
        ...
        expected = (
            ((SIDE_IA, "Ia3", 147), ("600", "604", "076", "071")),
            ((SIDE_IA, "Ia9", 10), ("700", "604", "076", "071")),
        )
        for (site, prev4), (want_site, want_prev4) in zip(
            ...
            self.assertEqual(stems[index - 1], STEM_604)
            self.assertEqual(site_previous_stem(stems, index, GRAM2), STEM_604)
        ...
        for site in STANDING_WITHOUT_SITES:
            ...
            self.assertNotEqual(back[0], STEM_604)
        ...
        self.assertEqual(CYCLE191_NEAR_MISS_700_604_SITE, (SIDE_IA, "Ia9", 10))
        self.assertIn(CYCLE191_NEAR_MISS_700_604_SITE, self.with_sites)
        self.assertNotIn(CYCLE191_NEAR_MISS_700_604_SITE, CYCLE191_MATCHING_SITES)
        for site, nxt in zip(
            STANDING_NEAR_MISS_FORWARD_604_SITES,
            STANDING_NEAR_MISS_FORWARD_604_NEXT_4GRAMS,
            strict=True,
            ...
            self.assertEqual(nxt[3], STEM_604)
            ...
            self.assertNotEqual(site_previous_stem(stems, index, GRAM2), STEM_604)
    ...
    def test_existing_194_191_190_172_171_scoreboards_still_compute(self):
        """Cycle 194 leftover-3, 191 leftover-3, 190 N_distinct=28, 172 leftover-34, and 171 I-only 43/0 stay."""
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-197 leftover previous-604 lock."""
        lock = self.survey["i_leftover_076_071_previous_604"]
        self.assertEqual(lock["cycle"], 197)
        ...
        self.assertEqual(lock["previous_stem"], STEM_604)
        ...
        self.assertEqual(
            lock["N_with_previous_604_076_071"],
            STANDING_N_WITH_PREVIOUS_604_076_071,
        )
        self.assertEqual(lock["N_with_previous_604_076_071"], 2)
        ...
        self.assertEqual(lock["inside_previous_604_sites"], [])
        self.assertEqual(
        ...
        self.assertTrue(lock["i_leftover_076_071_exactly_2_previous_604_076_071"])
        self.assertEqual(
            lock["i_leftover_076_071_exactly_2_previous_604_076_071"],
            STANDING_I_LEFTOVER_076_071_EXACTLY_2_PREVIOUS_604_076_071,
        )
...
class TestMamariILeftover076071Previous604ImageSnapshot(unittest.TestCase):
    """Cycle 197 does not touch clustering. 83/62 / Hamming 6 stays."""
