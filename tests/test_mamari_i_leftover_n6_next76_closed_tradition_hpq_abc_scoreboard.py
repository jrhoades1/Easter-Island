...
STANDING_NO_NEXT76_SITES = CYCLE615_NO_NEXT75_SITES
...
class TestMamariILeftoverN6Next76ClosedTraditionHpqAbcScoreboard(unittest.TestCase):
    ...
    def test_population_is_the_locked_cycle_615_next76_grams(self):
        ...
        self.assertEqual(STANDING_N_WITH_NEXT76, CYCLE615_N_WITH_NEXT75)
        self.assertEqual(STANDING_N_NO_NEXT76, CYCLE615_N_NO_NEXT75)
        self.assertEqual(
