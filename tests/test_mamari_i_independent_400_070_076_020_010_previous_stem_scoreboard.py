...
Cycle 157 text-search lock. Uses already-vendored A–V and the
cycle-139 independent 5-gram 400 070 076 020 010 at Ia13[85]
and Ia14[126]. Does not retune that 5-gram or those sites.
...
stem Y (i.e. Y 400 070 076 020 010 at both). Measured:
N_sites=2, N_with_previous=2, N_distinct_previous_stems=2
(023 at Ia13[85], 077 at Ia14[126]). Claim that can lose:
...
Nearby leftover n=4 from cycle 136: 053 076 020 010 at
Ia12[0]/Ia14[109] (leftover maximal) and 070 076 020 010
(4-suffix of this 5-gram; non-maximal). Context only; do
not retune.
...
STEM_023 = "023"
STEM_077 = "077"
LEFTOVER_N4_053 = ("053", "076", "020", "010")
STANDING_N5 = 5
STANDING_N_SITES = 2
STANDING_I_SITES = (
    (SIDE_IA, "Ia13", 85),
...
STANDING_PER_SITE_PREVIOUS = (STEM_023, STEM_077)
STANDING_DISTINCT_PREVIOUS_STEMS = (STEM_023, STEM_077)
STANDING_SITES_PER_PREVIOUS_STEM = (
    (STEM_023, ((SIDE_IA, "Ia13", 85),)),
    (STEM_077, ((SIDE_IA, "Ia14", 126),)),
)
STANDING_NO_PREVIOUS_SITES = ()
STANDING_KNOWN_DISTINCT = True
STANDING_CLAIM = "i_independent_400_070_076_020_010_share_one_previous_stem"
STANDING_I_INDEPENDENT_400_070_076_020_010_SHARE_ONE_PREVIOUS_STEM = False
STANDING_RESULT = "i_independent_400_070_076_020_010_previous_stem"
...
STANDING_SAME_AS_CYCLE155_INDEPENDENT_N5 = False


def i_independent_400_070_076_020_010_share_one_previous_stem(
    n_with_previous: int,
...
class TestIIndependent400070076020010PreviousStemHelpers(unittest.TestCase):
    ...
    def test_previous_requires_stem_before_5gram(self):
        ...
        has_023 = ["023", "400", "070", "076", "020", "010"]
        self.assertEqual(site_previous_stem(has_023, 1, GRAM5_INDEPENDENT), STEM_023)
        has_077 = ["077", "400", "070", "076", "020", "010"]
        self.assertEqual(site_previous_stem(has_077, 1, GRAM5_INDEPENDENT), STEM_077)
        start_of_line = ["400", "070", "076", "020", "010"]
        self.assertIsNone(site_previous_stem(start_of_line, 0, GRAM5_INDEPENDENT))
        mismatch = ["023", "400", "070", "076", "020", "011"]
    ...
    def test_share_one_requires_two_previous_and_one_distinct(self):
        ...
        provider = MockProvider()
        self.assertTrue(
            i_independent_400_070_076_020_010_share_one_previous_stem(2, 1)
        )
        self.assertFalse(
            i_independent_400_070_076_020_010_share_one_previous_stem(2, 2)
        )
        self.assertFalse(
            i_independent_400_070_076_020_010_share_one_previous_stem(1, 1)
        )
        self.assertFalse(
            i_independent_400_070_076_020_010_share_one_previous_stem(0, 0)
        )
        self.assertFalse(
            i_independent_400_070_076_020_010_share_one_previous_stem(3, 1)
        )
        self.assertEqual(
            STANDING_CLAIM,
            "i_independent_400_070_076_020_010_share_one_previous_stem",
        ...
        self.assertFalse(
            STANDING_I_INDEPENDENT_400_070_076_020_010_SHARE_ONE_PREVIOUS_STEM
        )
        self.assertNotEqual(
            STANDING_I_INDEPENDENT_400_070_076_020_010_SHARE_ONE_PREVIOUS_STEM,
    ...
    def test_sites_group_by_previous_stem(self):
        ...
        both_023 = (STEM_023, STEM_023)
        self.assertEqual(sites_with_previous(sites, both_023), sites)
        self.assertEqual(
            group_sites_by_previous_stem(sites, both_023),
            ((STEM_023, sites),),
        )
        none_prev = (None, None)
...
class TestMamariIIndependent400070076020010PreviousStemScoreboard(
    unittest.TestCase
):
    ...
    def setUp(self):
        ...
        self.claim_holds = i_independent_400_070_076_020_010_share_one_previous_stem(
    ...
    def test_tokens_and_sites_are_cycle_139_lock_not_retuned(self):
        ...
        self.assertEqual(N5_400_SUFFIX, ("070", "076", "020", "010"))
        leftover_053 = [
        ...
        self.assertEqual(
            leftover_053[0],
            (LEFTOVER_N4_053, 4, 2, (("Ia", "Ia12", 0), ("Ia", "Ia14", 109))),
        )
        ...
        self.assertNotEqual(GRAM5_INDEPENDENT, MAXIMAL_N5_011)
        self.assertNotEqual(GRAM5_INDEPENDENT, N5_400_SUFFIX)
        self.assertNotEqual(GRAM5_INDEPENDENT, LEFTOVER_N4_053)
    ...
    def test_two_distinct_previous_stems_and_claim_loses(self):
        ...
        expected = (
            ((SIDE_IA, "Ia13", 85), STEM_023),
            ((SIDE_IA, "Ia14", 126), STEM_077),
        )
        ...
        self.assertFalse(STANDING_SAME_AS_CYCLE155_INDEPENDENT_N5)
    ...
    def test_existing_156_155_139_103_and_w_scoreboards_still_compute(self):
        """Cycle 156 I-only, 155 previous-stem, 139 076, 103 I-only, W stay."""
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-157 previous-stem lock."""
        lock = self.survey["i_independent_400_070_076_020_010_previous_stem"]
        self.assertEqual(lock["cycle"], 157)
        ...
        self.assertFalse(
            lock["i_independent_400_070_076_020_010_share_one_previous_stem"]
        )
        self.assertEqual(
            lock["i_independent_400_070_076_020_010_share_one_previous_stem"],
            STANDING_I_INDEPENDENT_400_070_076_020_010_SHARE_ONE_PREVIOUS_STEM,
        ...
        self.assertFalse(lock["same_as_cycle155_independent_n5"])
        self.assertEqual(tuple(lock["leftover_n4_053_076_020_010"]), LEFTOVER_N4_053)
        self.assertEqual(tuple(lock["n5_400_suffix_070_076_020_010"]), N5_400_SUFFIX)
        self.assertTrue(lock["leftover_n4_053_context_only"])
        self.assertTrue(lock["n5_400_suffix_nonmaximal_context_only"])
...
class TestMamariIIndependent400070076020010PreviousStemImageSnapshot(
    unittest.TestCase
):
    """Cycle 157 does not touch clustering. 83/62 / Hamming 6 stays."""
