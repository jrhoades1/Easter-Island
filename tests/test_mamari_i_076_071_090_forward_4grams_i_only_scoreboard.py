"""I's cycle-180 3-gram site forward 4-grams off-I lock.

Cycle 181 text-search lock. Uses already-vendored A–V and the
cycle-180 I sites of 3-gram 076 071 090 (N_I=5, all Ia:
leftover Ia1[86] 076 071 090 606, Ia3[85] 076 071 090 076,
Ia12[19] 076 071 090 047; inside-family leftover n=4 maximal
076 071 090 999 at Ia7[166] and Ia14[136]). Does not retune
...
Same leftover-shape as cycle 178 (076 071 600 forward 4-grams
all I-only hapax 1/0) and cycle 175 (076 071 076 forward
4-grams all I-only hapax 1/0). Cycle 179 leftover N=3 and
leftover n=4 set stay. 071 999 and 076 076 do not count.
Do not retune.

Locks exact consecutive hits of each distinct forward 4-gram
on tablet I and on every other vendored tablet A–H and J–V.
The four distinct 4-grams: 076 071 090 606, 076 071 090 076,
076 071 090 047, and 076 071 090 999. The last one has two
I sites; do not assume hapax. Hypothesis: all four are
I-only. Measured: N_I=1/1/1/2; all N_off_I=0. Claim that
can lose: i_076_071_090_forward_4grams_i_only. True only if
...
from tests.test_mamari_i_3gram_076_071_090_i_only_scoreboard import (
    GRAM3,
    STANDING_I_NEXT_4GRAMS as CYCLE180_NEXT_4GRAMS,
    ...
    TestMamariI3gram076071090IOnlyScoreboard,
)
...
STANDING_N3 = 3
STANDING_N4 = 4
GRAM4_606 = ("076", "071", "090", "606")
GRAM4_076 = ("076", "071", "090", "076")
GRAM4_047 = ("076", "071", "090", "047")
GRAM4_999 = ("076", "071", "090", "999")
STANDING_SEQUENCES = (
    GRAM4_606,
    GRAM4_076,
    GRAM4_047,
...
STANDING_NEXT_STEMS = ("606", "076", "047", "999")
STANDING_ROLES = (
    "leftover",
    "leftover",
    "leftover",
...
STANDING_N_I_047 = 1
STANDING_N_I_999 = 2
STANDING_N_ON_I_606 = 1
STANDING_N_ON_I_076 = 1
STANDING_N_ON_I_047 = 1
STANDING_N_ON_I_999 = 2
STANDING_I_SITES_606 = ((SIDE_IA, "Ia1", 86),)
STANDING_I_SITES_076 = ((SIDE_IA, "Ia3", 85),)
STANDING_I_SITES_047 = ((SIDE_IA, "Ia12", 19),)
STANDING_I_SITES_999 = (
    (SIDE_IA, "Ia7", 166),
    (SIDE_IA, "Ia14", 136),
)
STANDING_I_SITES = (
    STANDING_I_SITES_606,
    STANDING_I_SITES_076,
    STANDING_I_SITES_047,
    STANDING_I_SITES_999,
)
STANDING_CYCLE180_SITES = CYCLE180_I_SITES
STANDING_IB_HITS = 0
STANDING_IB_SITES = ()
STANDING_N_OFF_I_606 = 0
STANDING_N_OFF_I_076 = 0
STANDING_N_OFF_I_047 = 0
STANDING_N_OFF_I_999 = 0
STANDING_OFF_I_SITES_606 = ()
STANDING_OFF_I_SITES_076 = ()
STANDING_OFF_I_SITES_047 = ()
...
STANDING_HAPAX_606 = True
STANDING_HAPAX_076 = True
STANDING_HAPAX_047 = True
STANDING_HAPAX_999 = False
STANDING_CLAIM = "i_076_071_090_forward_4grams_i_only"
STANDING_I_076_071_090_FORWARD_4GRAMS_I_ONLY = True
STANDING_RESULT = "i_076_071_090_forward_4grams_i_only"
...
STANDING_SAME_LEFTOVER_SHAPE_AS_175_178 = True
...
def leftover_forward_4gram_start_site(
    cycle180_site: tuple[str, str, int],
) -> tuple[str, str, int]:
    """Forward 4-gram starts at the cycle-180 076 071 090 site."""
    return cycle180_site
...
def i_076_071_090_forward_4grams_i_only(
    n_i_606: int,
    n_off_i_606: int,
    n_i_076: int,
    n_off_i_076: int,
    ...
    """True iff all four distinct forward 4-grams are I-only.

    Claim holds only if all four have N_off_I=0. N_I>=1 is
    required so a missing I hit is not I-only. The 999
    4-gram is allowed N_I=2; hapax is not assumed.
    """
    return (
        sequence_is_i_only(n_i_606, n_off_i_606)
        and sequence_is_i_only(n_i_076, n_off_i_076)
        and sequence_is_i_only(n_i_047, n_off_i_047)
        and sequence_is_i_only(n_i_999, n_off_i_999)
    )


class TestI076071090Forward4gramsIOnlyHelpers(unittest.TestCase):
    """Helpers on cycle-180 forward 4-grams. No CV, no LLM."""

    def test_counts_require_consecutive_tokens(self):
        """Adjacent 4-gram counts; a gap is not a hit. 071 999 / 076 076 are not."""
        provider = MockProvider()
        self.assertEqual(GRAM4_606, ("076", "071", "090", "606"))
        self.assertEqual(GRAM4_076, ("076", "071", "090", "076"))
        self.assertEqual(GRAM4_047, ("076", "071", "090", "047"))
        self.assertEqual(GRAM4_999, ("076", "071", "090", "999"))
        for gram in STANDING_SEQUENCES:
            self.assertEqual(gram[:3], GRAM3)
        adjacent = [list(GRAM4_606), list(GRAM4_076)]
        self.assertEqual(ngram_hit_count(adjacent, GRAM4_606), 1)
        self.assertEqual(ngram_hit_count(adjacent, GRAM4_076), 1)
        overlap = [["076", "071", "090", "999", "076", "071", "090", "999"]]
        self.assertEqual(ngram_hit_count(overlap, GRAM4_999), 2)
        gapped = [list(GRAM4_606[:2]) + ["000"] + list(GRAM4_606[2:])]
        self.assertEqual(ngram_hit_count(gapped, GRAM4_606), 0)
        self.assertEqual(ngram_hit_count([[]], GRAM4_606), 0)
        self.assertEqual(ngram_hit_count([[]], GRAM4_999), 0)
        self.assertEqual(ngram_hit_count([list(NEAR_MISS_071_065_071_999)], GRAM4_606), 0)
        self.assertEqual(ngram_hit_count([list(NEAR_MISS_700_076_076_053)], GRAM4_076), 0)
        self.assertEqual(ngram_hit_count([["071", "999"]], GRAM4_606), 0)
        self.assertEqual(ngram_hit_count([["076", "076"]], GRAM4_076), 0)
        self.assertEqual(ngram_hit_count([["076", "071", "090"]], GRAM4_606), 0)
    ...
    def test_all_i_only_requires_on_i_and_zero_off_i_for_each_4gram(self):
        """Boolean is True only when all four distinct forward 4-grams are I-only."""
        provider = MockProvider()
        hold = (1, 0, 1, 0, 1, 0, 2, 0)
        self.assertTrue(i_076_071_090_forward_4grams_i_only(*hold))
        self.assertTrue(i_076_071_090_forward_4grams_i_only(1, 0, 1, 0, 1, 0, 1, 0))
        self.assertTrue(i_076_071_090_forward_4grams_i_only(2, 0, 1, 0, 1, 0, 2, 0))
        lose_off = (
            (1, 1, 1, 0, 1, 0, 2, 0),
            (1, 0, 1, 1, 1, 0, 2, 0),
            (1, 0, 1, 0, 1, 1, 2, 0),
        ...
        for counts in lose_off:
            self.assertFalse(i_076_071_090_forward_4grams_i_only(*counts))
        lose_missing_i = (
            (0, 0, 1, 0, 1, 0, 2, 0),
            (1, 0, 0, 0, 1, 0, 2, 0),
            (1, 0, 1, 0, 0, 0, 2, 0),
        ...
        for counts in lose_missing_i:
            self.assertFalse(i_076_071_090_forward_4grams_i_only(*counts))
        self.assertFalse(i_076_071_090_forward_4grams_i_only(0, 0, 0, 0, 0, 0, 0, 0))
        self.assertEqual(STANDING_CLAIM, "i_076_071_090_forward_4grams_i_only")
        self.assertTrue(STANDING_I_076_071_090_FORWARD_4GRAMS_I_ONLY)
        self.assertEqual(
            STANDING_I_076_071_090_FORWARD_4GRAMS_I_ONLY,
    ...
    def test_4grams_are_cycle_180_forwards_not_retuned(self):
        """4-grams stay the cycle-180 I-site forwards; 999 is not hapax."""
        provider = MockProvider()
        self.assertEqual(GRAM3, ("076", "071", "090"))
        self.assertEqual(set(STANDING_SEQUENCES), set(CYCLE180_NEXT_4GRAMS))
        self.assertEqual(len(STANDING_SEQUENCES), 4)
        self.assertEqual(len(CYCLE180_NEXT_4GRAMS), 5)
        self.assertEqual(CYCLE180_NEXT_4GRAMS.count(GRAM4_999), 2)
        self.assertEqual(STANDING_NEXT_STEMS, ("606", "076", "047", "999"))
        self.assertEqual(STANDING_CYCLE180_SITES, CYCLE180_I_SITES)
        self.assertNotEqual(GRAM4_606, GRAM5)
        self.assertNotEqual(GRAM4_999, GRAM5)
        self.assertEqual(GRAM5, ("999", "071", "076", "010", "079"))
        self.assertFalse(is_contiguous_substring(GRAM4_606, GRAM5))
        leftover_forwards = (
            GRAM4_606,
            GRAM4_076,
            GRAM4_047,
        ...
        self.assertEqual(GRAM4_999, STANDING_INSIDE_FAMILY_NEXT_4GRAM)
        self.assertEqual(GRAM4_999, LEFTOVER_N4_090999)
        self.assertEqual(
            STANDING_INSIDE_FAMILY_NEXT_4GRAMS,
            (GRAM4_999, GRAM4_999),
        )
        self.assertEqual(STANDING_INSIDE_FAMILY_SITES, STANDING_I_SITES_999)
        self.assertEqual(STANDING_INSIDE_FAMILY_SITES, STANDING_LEFTOVER_090999_COVERED)
        ...
        for site in STANDING_CYCLE180_SITES:
            self.assertEqual(leftover_forward_4gram_start_site(site), site)
        ...
        self.assertTrue(STANDING_SAME_LEFTOVER_SHAPE_AS_175_178)
        self.assertTrue(STANDING_INSIDE_FAMILY_SITE_INCLUDED)
        self.assertTrue(STANDING_LEFTOVER_N4_SET_NOT_RETUNED)
        self.assertEqual(len(GRAM4_606), STANDING_N4)
        self.assertLess(STANDING_N4, 8)
        self.assertEqual(provider.get_call_history(), [])


class TestMamariI076071090Forward4gramsIOnlyScoreboard(unittest.TestCase):
    """Cited-fixture cycle-180 forward-4 off-I lock. Mock only."""

    def setUp(self):
        self.provider = MockProvider()
        self.survey = load_corpus_survey()
        self.i_sides = load_i_sides()
        self.cycle180_sites = STANDING_CYCLE180_SITES
        ...
        self.claim_holds = i_076_071_090_forward_4grams_i_only(
            *sum(zip(self.n_i, self.n_off_i, strict=True), ())
        )

    def test_tokens_and_sites_are_cycle_180_lock_not_retuned(self):
        """4-grams and I sites stay the cycle-180 forward lock."""
        self.assertEqual(GRAM3, ("076", "071", "090"))
        self.assertEqual(GRAM5, ("999", "071", "076", "010", "079"))
        self.assertEqual(self.cycle180_sites, STANDING_CYCLE180_SITES)
        self.assertEqual(
            STANDING_CYCLE180_SITES,
            (
                (SIDE_IA, "Ia1", 86),
                (SIDE_IA, "Ia3", 85),
                (SIDE_IA, "Ia7", 166),
        ...
        prior_180 = self.survey["i_3gram_076_071_090_i_only"]
        self.assertEqual(prior_180["cycle"], 180)
        self.assertEqual(tuple(prior_180["tokens3"]), GRAM3)
        self.assertEqual(prior_180["N_I"], CYCLE180_N_I)
        self.assertEqual(prior_180["N_I"], 5)
        self.assertEqual(prior_180["N_off_I"], CYCLE180_N_OFF_I)
        self.assertEqual(prior_180["N_off_I"], 0)
        self.assertTrue(prior_180["i_3gram_076_071_090_i_only"])
        self.assertEqual(
            tuple(tuple(row) for row in prior_180["i_sites"]),
            STANDING_CYCLE180_SITES,
        )
        self.assertEqual(
            [list(gram) for gram in CYCLE180_NEXT_4GRAMS],
            prior_180["i_next_4grams"],
        )
        self.assertEqual(set(STANDING_SEQUENCES), set(CYCLE180_NEXT_4GRAMS))
        self.assertEqual(
            tuple(tuple(row) for row in prior_180["leftover_matching_sites"]),
            STANDING_LEFTOVER_MATCHING_SITES,
        )
        self.assertEqual(prior_180["leftover_matching_count"], 3)
        self.assertEqual(
            [list(site) for site in STANDING_INSIDE_FAMILY_SITES],
            prior_180["inside_family_sites"],
        )
        self.assertEqual(prior_180["inside_family_count"], 2)
        self.assertTrue(prior_180["inside_family_site_included"])
        prior_179 = self.survey["i_leftover_076_071_forward_090"]
        self.assertEqual(prior_179["cycle"], 179)
        self.assertEqual(
            prior_179["N_with_forward_076_071_090"],
            STANDING_N_WITH_FORWARD_076_071_090,
        )
        ...
        self.assertEqual(CYCLE179_MATCHING_SITES, STANDING_LEFTOVER_MATCHING_SITES)
    ...
    def test_each_4gram_is_i_only_and_claim_holds(self):
        """N_I=1/1/1/2, N_off_I=0/0/0/0. All I-only. 999 is not hapax. Claim holds."""
        standing_on = (
            STANDING_N_I_606,
            STANDING_N_I_076,
            STANDING_N_I_047,
        ...
        standing_off = (
            STANDING_N_OFF_I_606,
            STANDING_N_OFF_I_076,
            STANDING_N_OFF_I_047,
            STANDING_N_OFF_I_999,
        )
        self.assertEqual(self.i_sites, STANDING_I_SITES)
        self.assertEqual(self.n_i, standing_on)
        self.assertEqual(standing_on, (1, 1, 1, 2))
        self.assertEqual(self.n_off_i, standing_off)
        self.assertEqual(standing_off, (0, 0, 0, 0))
        self.assertEqual(STANDING_IB_HITS, 0)
        self.assertEqual(STANDING_IB_SITES, ())
        leftover_sites = (
            STANDING_I_SITES_606[0],
            STANDING_I_SITES_076[0],
            STANDING_I_SITES_047[0],
        )
        self.assertEqual(leftover_sites, STANDING_LEFTOVER_MATCHING_SITES)
        self.assertEqual(len(leftover_sites), STANDING_LEFTOVER_MATCHING_COUNT)
        self.assertEqual(STANDING_I_SITES_999, STANDING_INSIDE_FAMILY_SITES)
        for gram, sites, nxt, role, n_on in zip(
            STANDING_SEQUENCES,
            STANDING_I_SITES,
            STANDING_NEXT_STEMS,
            STANDING_ROLES,
            ...
            self.assertEqual(len(sites), n_on)
            for start in sites:
                self.assertEqual(leftover_forward_4gram_start_site(start), start)
                ...
                self.assertEqual(start[0], SIDE_IA)
            if role == "leftover":
                self.assertEqual(n_on, 1)
                self.assertIn(sites[0], STANDING_LEFTOVER_MATCHING_SITES)
                self.assertIn(sites[0], STANDING_LEFTOVER_SITES)
                self.assertIn(gram, STANDING_MATCHING_NEXT_4GRAMS)
                self.assertNotIn(sites[0], STANDING_INSIDE_SITES)
            else:
                self.assertEqual(role, "inside_family")
                self.assertEqual(n_on, 2)
                self.assertEqual(gram, GRAM4_999)
                self.assertEqual(gram, LEFTOVER_N4_090999)
                for start in sites:
                    self.assertIn(start, STANDING_INSIDE_FAMILY_SITES)
                    self.assertIn(start, STANDING_INSIDE_SITES)
                    self.assertNotIn(start, STANDING_LEFTOVER_SITES)
        self.assertTrue(STANDING_INSIDE_FAMILY_SITE_INCLUDED)
        self.assertEqual(STANDING_INSIDE_FAMILY_COUNT, 2)
        self.assertTrue(STANDING_NOT_ASSUMED_HAPAX)
        self.assertTrue(STANDING_HAPAX_606)
        self.assertTrue(STANDING_HAPAX_076)
        self.assertTrue(STANDING_HAPAX_047)
        self.assertFalse(STANDING_HAPAX_999)
        ...
        for tablet, *counts in zip(
            ...
            *self.hits_by_tablet,
            ...
            for count, gram, n_on in zip(counts, self.grams, standing_on, strict=True):
    ...
    def test_existing_180_179_178_175_171_170_103_and_w_scoreboards_still_compute(self):
        """Cycle 180 I-only, 179 leftover 3, 178/175 I-only 4-grams, 171/170, 103, W stay."""
        prior_180 = TestMamariI3gram076071090IOnlyScoreboard()
        prior_180.setUp()
        prior_180.test_i_hits_are_five_on_ia()
        prior_180.test_3gram_is_zero_off_i_and_i_only()
        prior_180.test_survey_matches_computed_lock()
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-181 forward-4 I-only lock."""
        lock = self.survey["i_076_071_090_forward_4grams_i_only"]
        self.assertEqual(lock["cycle"], 181)
        ...
        self.assertEqual(lock["N_I_3gram"], CYCLE180_N_I)
        self.assertEqual(lock["N_I_3gram"], 5)
        self.assertEqual(lock["N_off_I_3gram"], CYCLE180_N_OFF_I)
        self.assertEqual(
            tuple(tuple(row) for row in lock["cycle180_sites"]),
            STANDING_CYCLE180_SITES,
        )
        ...
        self.assertEqual(tuple(lock["per_site_next_stems"]), ("606", "076", "999", "047", "999"))
        self.assertEqual(tuple(lock["distinct_next_stems"]), STANDING_NEXT_STEMS)
        self.assertEqual(lock["distinct_4grams"], 4)
        ...
        for row, gram, sites, nxt, role, n_on, n_off, hapax, expected_hits in zip(
            rows,
            STANDING_SEQUENCES,
            STANDING_I_SITES,
            STANDING_NEXT_STEMS,
            ...
            self.assertEqual(
                tuple(tuple(site_row) for site_row in row["cycle180_sites"]),
                sites,
            )
            self.assertEqual(tuple(row["cycle180_site"]), sites[0])
            ...
            self.assertEqual(
                tuple(tuple(site_row) for site_row in row["i_sites"]),
                sites,
            )
            self.assertEqual(
        ...
        self.assertEqual(lock["N_I_606"], STANDING_N_I_606)
        self.assertEqual(lock["N_off_I_606"], STANDING_N_OFF_I_606)
        self.assertEqual(lock["N_I_076"], STANDING_N_I_076)
        self.assertEqual(lock["N_off_I_076"], STANDING_N_OFF_I_076)
        self.assertEqual(lock["N_I_047"], STANDING_N_I_047)
        self.assertEqual(lock["N_off_I_047"], STANDING_N_OFF_I_047)
        self.assertEqual(lock["N_I_999"], STANDING_N_I_999)
        self.assertEqual(lock["N_off_I_999"], STANDING_N_OFF_I_999)
        self.assertEqual(lock["N_I_999"], 2)
        self.assertFalse(lock["hapax_999"])
        self.assertEqual(lock["claim"], STANDING_CLAIM)
        self.assertTrue(lock["i_076_071_090_forward_4grams_i_only"])
        self.assertEqual(
            lock["i_076_071_090_forward_4grams_i_only"],
            STANDING_I_076_071_090_FORWARD_4GRAMS_I_ONLY,
        )
        ...
        self.assertTrue(lock["same_leftover_shape_as_cycle_175_178"])
        ...
        self.assertEqual(self.survey["i_3gram_076_071_090_i_only"]["cycle"], 180)
        self.assertTrue(
            self.survey["i_3gram_076_071_090_i_only"]["i_3gram_076_071_090_i_only"]
        )
        self.assertEqual(self.survey["i_3gram_076_071_090_i_only"]["N_I"], 5)
        self.assertEqual(self.survey["i_3gram_076_071_090_i_only"]["N_off_I"], 0)
...
class TestMamariI076071090Forward4gramsIOnlyImageSnapshot(unittest.TestCase):
    """Cycle 181 does not touch clustering. 83/62 / Hamming 6 stays."""
