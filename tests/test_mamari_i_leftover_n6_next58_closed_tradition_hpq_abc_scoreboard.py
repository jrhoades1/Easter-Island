...
class TestMamariILeftoverN6Next58ClosedTraditionHpqAbcScoreboard(unittest.TestCase):
    ...
    def test_next_cheap_lock_is_the_locked_cycle_581_next59_list(self):
        """Cycle 581 next-59 I-only list stays locked. The claim name is not a survey key."""
        ...
        self.assertNotIn("i_leftover_n6_next59_closed_tradition_hpq_abc", self.survey)
        self.assertEqual(
            STANDING_NEXT_CHEAP_LOCK,
            "cycle581_next59_reframed_closed_tradition_hpq_ge1_exact0_abc",
        )
