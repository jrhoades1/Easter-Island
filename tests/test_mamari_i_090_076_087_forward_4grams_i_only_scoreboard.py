"""I's cycle-245 090 076 087 forward-4-grams off-I lock.

Cycle 246 text-search lock. Uses already-vendored A–V and the
cycle-245 I sites of 3-gram 090 076 087 (all 5 I sites; each
has a next stem). Extra I sites ≠ 0, so this is not the same
as leftover extra remaining-after-280 087 4-grams alone.
Does not retune those 4-grams, the 5 I sites, leftover extra
remaining-after-280 G=087 K=2 N_remaining7=27, leftover extra
...
leftover extra sites, leftover n=4 remaining
021 090 076 087 (cycle 222), the leftover n=4 set, or the
...
hapax 1/0 x2), and cycle 243 (I 090 076 280 forward 4-grams
all I-only hapax 1/0 x2). Cycle 245 I 090 076 087 I-only
holds 5/0 extra I=3, cycle 244 leftover extra
remaining-after-280 K=2 / G=087 N_remaining7=27, cycle 243
...
233 3/0 hapax, cycle 232 3/0, cycle 223 69/3, cycle 222
leftover n=4 remaining K=5, cycle 195 6/0, and cycle 171
43/0 stay. Off-I T sites of 090 076 are not this 3-gram and
are not these 4-grams. Leftover extra remaining after 087
is not locked this cycle. Previous 4-grams of the five I
sites are not locked this cycle. The other three tied stems
(011/005/000) are not locked. Do not retune leftover n=4
021 090 076 087. 090 076 280, 090 076 530, 090 076 700,
090 076 001, 090 076 013, 090 076 070, 090 076 071, and
090 076 without 087 do not count. Do not retune leftover
n=4, 076-cells, or any detector.

Locks exact consecutive hits of each I 090 076 087 forward
4-gram on tablet I and on every other vendored tablet A–H
and J–V. The five 4-grams: 090 076 087 499, 090 076 087 291,
090 076 087 078, 090 076 087 224, 090 076 087 755. Leftover
extra remaining-after-280 pair are 090 076 087 499 and
090 076 087 078. Extra I next tokens are 291 / 224 / 755;
do not assume they share one stem or that they are
021 090 076 087 tails. Do not assume hapax; count each from
fixtures. Hypothesis: all five are I-only. Measured: each
N_I=1 at the cycle-245 I site; all N_off_I=0. Claim that
can lose: i_090_076_087_forward_4grams_all_i_only.
...
from tests.test_mamari_i_3gram_090_076_087_i_only_scoreboard import (
    ...
    STANDING_I_NEXT_4GRAMS as CYCLE245_NEXT_4GRAMS,
    STANDING_I_PREVIOUS_4GRAMS as CYCLE245_PREVIOUS_4GRAMS,
    STANDING_I_SITES as CYCLE245_I_SITES,
    STANDING_LEFTOVER_MATCHING_NEXT_4GRAMS as CYCLE245_LEFTOVER_MATCHING_NEXT_4GRAMS,
    STANDING_LEFTOVER_MATCHING_SITES as CYCLE245_LEFTOVER_MATCHING_SITES,
    STANDING_N_EXTRA as CYCLE245_N_EXTRA,
    STANDING_N_I as CYCLE245_N_I,
    STANDING_N_OFF_I as CYCLE245_N_OFF_I,
    extra_i_sites,
    leftover_extra_remaining_after_280_087_subset,
    named_off_i_sites as cycle245_named_off_i_sites,
...
from tests.test_mamari_i_leftover_extra_090_076_remaining_after_280_fwd087_scoreboard import (
    ...
    STANDING_OTHER_TIED_STEMS as CYCLE244_OTHER_TIED_STEMS,
...
STANDING_SEQUENCES = CYCLE245_NEXT_4GRAMS
STANDING_CYCLE245_SITES = CYCLE245_I_SITES
STANDING_NEXT_STEMS = (
    "499",
    "291",
    "078",
...
STANDING_PREVIOUS_4GRAMS = CYCLE245_PREVIOUS_4GRAMS
...
STANDING_I_SITES = tuple((site,) for site in STANDING_CYCLE245_SITES)
STANDING_IB_HITS = 0
STANDING_IB_SITES = ()
...
STANDING_N_EXTRA = 3
STANDING_EXTRA_I_SITES = CYCLE245_EXTRA_I_SITES
STANDING_LEFTOVER_MATCHING_SITES = CYCLE245_LEFTOVER_MATCHING_SITES
STANDING_LEFTOVER_MATCHING_NEXT_4GRAMS = CYCLE245_LEFTOVER_MATCHING_NEXT_4GRAMS
STANDING_KNOWN_DISTINCT = True
STANDING_NOT_ASSUMED_HAPAX = True
STANDING_HAPAX_EACH = True
STANDING_EXTRA_NEXT_STEMS_NOT_ASSUMED_SHARED = True
STANDING_CLAIM = "i_090_076_087_forward_4grams_all_i_only"
STANDING_I_090_076_087_FORWARD_4GRAMS_ALL_I_ONLY = True
STANDING_I_090_076_087_FORWARD_4GRAMS_I_ONLY = True
STANDING_RESULT = "i_090_076_087_forward_4grams_i_only"
...
STANDING_SAME_AS_LEFTOVER_EXTRA_REMAINING_AFTER_280_087_4GRAMS_ALONE = False
...
STANDING_LEFTOVER_EXTRA_REMAINING_AFTER_087_IS_NOT_THIS_CYCLE = True
...
STANDING_OTHER_TIED_STEMS = CYCLE244_OTHER_TIED_STEMS
STANDING_CYCLE245_N_I = 5
STANDING_CYCLE245_N_OFF_I = 0
STANDING_CYCLE245_N_EXTRA = 3
STANDING_CYCLE244_K = 2
STANDING_CYCLE244_G = "087"
STANDING_CYCLE244_N_REMAINING7 = 27
STANDING_CYCLE222_K = 5


def forward_4gram_start_site(
    cycle245_site: tuple[str, str, int],
) -> tuple[str, str, int]:
    """Forward 4-gram starts at the cycle-245 I 090 076 087 site."""
    return cycle245_site
...
def site_forward_4gram(
    ...
    """090 076 087 X if a next stem exists; None at end-of-line."""
    n3 = len(gram3)
...
def i_090_076_087_forward_4grams(
    i_sides: dict[str, list[list[str]]],
    sites: tuple[tuple[str, str, int], ...] = STANDING_CYCLE245_SITES,
    gram3: tuple[str, ...] = GRAM3,
...
def i_sites_without_forward(
    ...
    """I 090 076 087 sites that have no next stem after the 3-gram."""
    return tuple(
        site
...
def i_090_076_087_forward_4grams_all_i_only(
    n_i: tuple[int, ...],
    n_off_i: tuple[int, ...],
    expected_n: int = STANDING_N_SEQUENCES,
) -> bool:
    """True iff all 5 I 090 076 087 forward 4-grams are I-only.
    ...
    Extra I sites ≠ 0, so leftover extra remaining-after-280
    087 4-grams alone are not this claim.
    """
    return (
        len(n_i) == expected_n
...
class TestI090076087Forward4gramsIOnlyHelpers(unittest.TestCase):
    """Helpers on cycle-245 I 090 076 087 forward 4-grams. No CV, no LLM."""

    def test_counts_require_consecutive_tokens(self):
        """Adjacent 4-gram counts; a gap is not a hit. 280 / 530 / 700 / 001 / 013 / 070 / 071 are not."""
        provider = MockProvider()
        self.assertEqual(STANDING_SEQUENCES[0], ("090", "076", "087", "499"))
        self.assertEqual(STANDING_SEQUENCES[1], ("090", "076", "087", "291"))
        self.assertEqual(STANDING_SEQUENCES[2], ("090", "076", "087", "078"))
        self.assertEqual(STANDING_SEQUENCES[3], ("090", "076", "087", "224"))
        self.assertEqual(STANDING_SEQUENCES[-1], ("090", "076", "087", "755"))
        ...
        overlap = [["090", "076", "087", "499", "090", "076", "087", "499"]]
        ...
        self.assertEqual(ngram_hit_count([["090", "076", "087"]], STANDING_SEQUENCES[0]), 0)
        self.assertEqual(ngram_hit_count([["090", "076"]], STANDING_SEQUENCES[0]), 0)
        self.assertEqual(ngram_hit_count([["090", "076", "280", "139"]], STANDING_SEQUENCES[0]), 0)
        planted = ["071", "090", "076", "087", "499"]
    ...
    def test_all_i_only_requires_on_i_and_zero_off_i_for_each_4gram(self):
        ...
        self.assertTrue(i_090_076_087_forward_4grams_all_i_only(hold_ones, hold_zeros))
        self.assertTrue(
            i_090_076_087_forward_4grams_all_i_only((2,) + hold_ones[1:], hold_zeros)
        )
        lose_off = list(hold_zeros)
        lose_off[0] = 1
        self.assertFalse(
            i_090_076_087_forward_4grams_all_i_only(hold_ones, tuple(lose_off))
        )
        lose_missing_i = list(hold_ones)
        lose_missing_i[0] = 0
        self.assertFalse(
            i_090_076_087_forward_4grams_all_i_only(tuple(lose_missing_i), hold_zeros)
        )
        leftover_only = hold_ones[:2]
        leftover_only_off = hold_zeros[:2]
        self.assertFalse(
            i_090_076_087_forward_4grams_all_i_only(leftover_only, leftover_only_off)
        )
        self.assertFalse(i_090_076_087_forward_4grams_all_i_only((), ()))
        self.assertFalse(
            i_090_076_087_forward_4grams_all_i_only(hold_ones[:-1], hold_zeros[:-1])
        )
        self.assertEqual(STANDING_CLAIM, "i_090_076_087_forward_4grams_all_i_only")
        self.assertTrue(STANDING_I_090_076_087_FORWARD_4GRAMS_ALL_I_ONLY)
        self.assertTrue(STANDING_I_090_076_087_FORWARD_4GRAMS_I_ONLY)
        self.assertEqual(
            STANDING_I_090_076_087_FORWARD_4GRAMS_ALL_I_ONLY,
            HYPOTHESIS_ALL_I_ONLY,
        )
        self.assertTrue(HYPOTHESIS_ALL_I_ONLY)
        self.assertTrue(STANDING_NOT_ASSUMED_HAPAX)
        self.assertFalse(STANDING_SAME_AS_LEFTOVER_EXTRA_REMAINING_AFTER_280_087_4GRAMS_ALONE)
    ...
    def test_4grams_are_cycle_245_forwards_not_retuned(self):
        """4-grams stay the cycle-245 I forwards; leftover / 280 / 530 / 700 / 001 / 013 / 070 / 071 are not."""
        provider = MockProvider()
        self.assertEqual(GRAM3, ("090", "076", "087"))
        self.assertEqual(GRAM3, GRAM3_FORWARD)
        self.assertEqual(STANDING_SEQUENCES, CYCLE245_NEXT_4GRAMS)
        self.assertEqual(STANDING_CYCLE245_SITES, CYCLE245_I_SITES)
        self.assertNotEqual(STANDING_SEQUENCES, CYCLE244_MATCHING_NEXT_4GRAMS)
        self.assertNotEqual(STANDING_SEQUENCES, CYCLE245_LEFTOVER_MATCHING_NEXT_4GRAMS)
        self.assertEqual(
            STANDING_LEFTOVER_MATCHING_NEXT_4GRAMS,
            CYCLE244_MATCHING_NEXT_4GRAMS,
        )
        self.assertEqual(
            STANDING_LEFTOVER_MATCHING_NEXT_4GRAMS,
            (
        ...
        self.assertEqual(len(STANDING_SEQUENCES), CYCLE245_N_I)
        ...
        self.assertEqual(len(set(STANDING_EXTRA_NEXT_STEMS)), 3)
        ...
        self.assertTrue(STANDING_LEFTOVER_EXTRA_REMAINING_AFTER_087_IS_NOT_THIS_CYCLE)
        ...
        self.assertTrue(STANDING_LEFTOVER_N4_021_090_076_087_NOT_RETUNED)
        self.assertEqual(LEFTOVER_N4_021087, ("021", "090", "076", "087"))
        self.assertIn(LEFTOVER_N4_021087, CYCLE222_MATCHING_LEFTOVERS)
        self.assertEqual(len(STANDING_SEQUENCES[0]), STANDING_N4)
        self.assertLess(STANDING_N4, 8)
        self.assertEqual(provider.get_call_history(), [])


class TestMamariI090076087Forward4gramsIOnlyScoreboard(unittest.TestCase):
    """Cited-fixture I 090 076 087 forward-4 off-I lock. Mock only."""

    def setUp(self):
        self.provider = MockProvider()
        self.survey = load_corpus_survey()
        self.i_sides = load_i_sides()
        self.cycle245_sites = STANDING_CYCLE245_SITES
        ...
        self.off_i_sites = tuple(
            cycle245_named_off_i_sites(gram) for gram in self.grams
        )
        self.measured_forwards = i_090_076_087_forward_4grams(
            self.i_sides,
            self.cycle245_sites,
            GRAM3,
        )
        ...
        self.leftover_matching = leftover_extra_remaining_after_280_with_087(
            STANDING_LEFTOVER_SITES,
            self.next_stems,
            CYCLE244_G,
        )
        ...
        self.extra = extra_i_sites(self.cycle245_sites, self.leftover_matching)
        ...
        self.claim_holds = i_090_076_087_forward_4grams_all_i_only(
            self.n_i,
            self.n_off_i,
        )
        self.n_i_only = sum(
    ...
    def test_tokens_and_sites_are_cycle_245_forwards_not_retuned(self):
        """4-grams and I sites stay the cycle-245 forward lock. Nested 5/0 extra I=3 must hold."""
        self.assertEqual(GRAM3, ("090", "076", "087"))
        self.assertEqual(GRAM3, GRAM3_FORWARD)
        self.assertEqual(GRAM5, ("999", "071", "076", "010", "079"))
        self.assertEqual(self.cycle245_sites, STANDING_CYCLE245_SITES)
        self.assertEqual(self.cycle245_sites, CYCLE245_I_SITES)
        self.assertEqual(
            self.cycle245_sites,
            (
                (SIDE_IA, "Ia3", 87),
        ...
        self.assertEqual(self.measured_forwards, CYCLE245_NEXT_4GRAMS)
        self.assertNotEqual(self.measured_forwards, CYCLE244_MATCHING_NEXT_4GRAMS)
        self.assertEqual(self.leftover_matching_next_4grams, CYCLE244_MATCHING_NEXT_4GRAMS)
        ...
        self.assertEqual(self.n3_i, STANDING_CYCLE245_N_I)
        self.assertEqual(self.n3_i, 5)
        self.assertEqual(self.n3_off_i, STANDING_CYCLE245_N_OFF_I)
        self.assertEqual(self.n3_off_i, 0)
        self.assertEqual(self.leftover_matching, CYCLE244_MATCHING_SITES)
        self.assertEqual(self.leftover_matching, CYCLE245_LEFTOVER_MATCHING_SITES)
        self.assertNotEqual(self.leftover_matching, self.cycle245_sites)
        self.assertEqual(len(self.leftover_matching), STANDING_CYCLE244_K)
        self.assertEqual(STANDING_CYCLE244_K, 2)
        self.assertEqual(STANDING_CYCLE244_G, "087")
        ...
        self.assertEqual(self.extra, CYCLE245_EXTRA_I_SITES)
        self.assertEqual(len(self.extra), STANDING_N_EXTRA)
        self.assertEqual(STANDING_N_EXTRA, 3)
        self.assertEqual(STANDING_CYCLE245_N_EXTRA, 3)
        self.assertEqual(
            self.extra,
            (
                (SIDE_IA, "Ia4", 117),
        ...
        self.assertEqual(self.extra_next_stems, ("291", "224", "755"))
        self.assertEqual(len(set(self.extra_next_stems)), 3)
        self.assertTrue(STANDING_EXTRA_NEXT_STEMS_NOT_ASSUMED_SHARED)
        ...
        if len(self.leftover_matching) != 2 or CYCLE244_G != "087":
            self.fail("nested cycle 244 leftover extra remaining-after-280 G=087 K=2 drifted")
        if self.leftover_matching_next_4grams != CYCLE244_MATCHING_NEXT_4GRAMS:
            self.fail("leftover extra remaining-after-280 pair 090 076 087 499 / 078 drifted")
        ...
        self.assertEqual(
            ...
            prior_245["i_next_4grams"],
        )
        self.assertEqual(
            tuple(tuple(row) for row in prior_245["i_sites"]),
            STANDING_CYCLE245_SITES,
        )
        self.assertEqual(
            [list(gram) for gram in STANDING_PREVIOUS_4GRAMS],
            prior_245["i_previous_4grams"],
        )
        self.assertEqual(
            tuple(tuple(row) for row in prior_245["extra_i_sites"]),
        ...
        self.assertEqual(
            ...
            prior_244["matching_next_4grams"],
        )
        ...
        self.assertTrue(STANDING_LEFTOVER_N4_021_090_076_087_NOT_RETUNED)
        self.assertFalse(STANDING_SAME_AS_LEFTOVER_EXTRA_REMAINING_AFTER_280_087_4GRAMS_ALONE)
        self.assertEqual(CYCLE244_OTHER_TIED_STEMS, ("011", "005", "000"))
        self.assertEqual(STANDING_OTHER_TIED_STEMS, ("011", "005", "000"))
        self.assertEqual(self.provider.get_call_history(), [])

    def test_each_4gram_is_one_on_i_zero_off_i_and_claim_holds(self):
        """Each forward 4-gram is 1/0. All five I-only. Extra I next tokens 291/224/755. Claim holds."""
        ...
        leftover_021087_starts = {
            (side, line, index + 1)
            for side, line, index in STANDING_LEFTOVER_021087_SITES
        }
        for site, start, gram, nxt, prev4, role, sites, n_on, n_off, off_sites in zip(
            ...
            if site in leftover_set:
                ...
                self.assertEqual(prev4, LEFTOVER_N4_021087)
                self.assertIn(site, leftover_021087_starts)
                self.assertNotIn(gram, STANDING_LEFTOVER_MATCHING_NEXT_4GRAMS)
        self.assertEqual(STANDING_N_IN_LEFTOVER_021087, 3)
        self.assertEqual(len(STANDING_LEFTOVER_021087_SITES), 3)
        ...
        for gram in STANDING_SEQUENCES:
            ...
            self.assertEqual(cycle245_named_off_i_sites(gram), ())
        ...
        self.assertEqual(
            i_090_076_087_forward_4grams_all_i_only(self.n_i, self.n_off_i),
            STANDING_I_090_076_087_FORWARD_4GRAMS_ALL_I_ONLY,
        )
        self.assertEqual(
            self.claim_holds,
    ...
    def test_existing_245_244_243_242_241_240_239_238_237_236_234_233_232_223_222_195_and_171_still_compute(self):
        """Cycle 245 5/0 extra I=3, 244 K=2/G=087 N_remaining7=27, 243 2/0 hapax, 242 2/0, 241 K=2/G=280, 240 2/0 hapax, 239 2/0, 238 K=2/G=530, 237 2/0 hapax, 236 2/0, 234 7-way tie, 233 3/0 hapax, 232 3/0, 223 69/3, 222 leftover n=4 remaining K=5, 195 6/0, 171 43/0 stay."""
        ...
        self.assertEqual(prior_244.matching_next_4grams, STANDING_LEFTOVER_MATCHING_NEXT_4GRAMS)
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-246 I-forward-4 I-only hold."""
        lock = self.survey["i_090_076_087_forward_4grams_i_only"]
        self.assertEqual(lock["cycle"], 246)
        ...
        self.assertEqual(lock["N_I"], CYCLE245_N_I)
        ...
        self.assertEqual(
            tuple(tuple(row) for row in lock["leftover_extra_remaining_after_280_087_sites"]),
            STANDING_LEFTOVER_MATCHING_SITES,
        )
        self.assertEqual(
            [list(gram) for gram in STANDING_LEFTOVER_MATCHING_NEXT_4GRAMS],
            lock["leftover_extra_remaining_after_280_087_next_4grams"],
        )
        self.assertEqual(
        ...
        for row, gram, site, nxt, role, sites, n_on, n_off, off_sites, hits in zip(
            ...
            self.assertEqual(tuple(row["cycle245_site"]), site)
        ...
        self.assertTrue(lock["i_090_076_087_forward_4grams_all_i_only"])
        self.assertEqual(
            lock["i_090_076_087_forward_4grams_all_i_only"],
            STANDING_I_090_076_087_FORWARD_4GRAMS_ALL_I_ONLY,
        )
        self.assertTrue(lock["i_090_076_087_forward_4grams_i_only"])
        ...
        self.assertEqual(lock["nested_cycle244_G"], STANDING_CYCLE244_G)
        self.assertEqual(lock["nested_cycle244_G"], "087")
        self.assertEqual(lock["nested_cycle244_K"], STANDING_CYCLE244_K)
        ...
        self.assertFalse(lock["same_as_leftover_extra_remaining_after_280_087_4grams_alone"])
        ...
        self.assertTrue(lock["leftover_extra_remaining_after_087_is_not_this_cycle"])
        ...
        self.assertEqual(
            self.survey["i_leftover_extra_090_076_remaining_after_280_fwd087"]["N_remaining7"],
            27,
        )
...
class TestMamariI090076087Forward4gramsIOnlyImageSnapshot(unittest.TestCase):
    """Cycle 246 does not touch clustering. 83/62 / Hamming 6 stays."""
