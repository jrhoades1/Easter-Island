"""I's cycle-312 leftover n=4 remaining remaining-after-600 forward-020 lock.

Cycle 313 text-search lock. Uses already-vendored A–V and the
...
share previous 021 (cycle 303), leftover n=4 remaining
remaining-after-021 unique previous stem (cycle 306), leftover
n=4 remaining remaining-after-021 exactly 2 share previous
600 (cycle 307), leftover n=4 remaining remaining-after-600
unique previous stem (cycle 308 lost), leftover n=4 remaining
remaining-after-600 previous 4-grams (cycle 309), leftover
n=4 remaining remaining-after-600 previous 3-grams (cycle
310), leftover n=4 remaining remaining-after-600 extra-I
previous 4-grams (cycle 311), leftover n=4 remaining
remaining-after-600 unique next stem (cycle 312), leftover
n=4 remaining exactly 4 share next 020 (cycle 289), leftover
n=4 remaining remaining-after-087 exactly 2 share next 057
(cycle 295), leftover extra remaining-after-000 extra I
(cycles 258/259), leftover extra remaining-after-009 extra-I
previous 4-grams (cycle 287), leftover extra remaining-after-
009 previous 4-grams (cycle 285), leftover n=4 remaining
remaining-after-020 unique next (cycle 292), leftover n=4
remaining remaining-after-020 exactly 3 share next 087
(cycle 293), leftover n=4 remaining remaining-after-057
unique next (cycle 296), leftover n=4 remaining remaining-
after-057 exactly 2 share next 011 (cycle 297), leftover n=4
remaining unique next stem (cycle 288 G=020 K=4), or leftover
n=4 remaining remaining-after-600 remaining-after-020 unique
next. Does not vendor a new tablet. Does not scrape X. W has
...
Cycle 312 leftover n=4 remaining remaining-after-600 unique
next stem HOLDS: unique_max true, G=020 K=4, N_distinct=2,
N_remaining_after_600=6, N_line_final=0, N_with_next=6.
Histogram: 020×4, 057×2. After peeling G: 2 (Ia8[114],
Ia9[28] next 057). Four next-020 sites: Ia2[119], Ia4[86],
Ia5[143], Ia12[83], all 090 076 020 010. Unique-max G/K is
inventory; this cycle peels 020 as exact-K. Analog after
unique-max HOLD: cycle 292 leftover n=4 remaining remaining-
after-020 unique next G=087 K=3 then cycle 293 leftover n=4
remaining remaining-after-020 exactly 3 share next 087.
Cycle 296 leftover n=4 remaining remaining-after-057 unique
next G=011 K=2 then cycle 297 leftover n=4 remaining
remaining-after-057 exactly 2 share next 011. Cycle 306
leftover n=4 remaining remaining-after-021 unique previous
G=600 K=2 then cycle 307 leftover n=4 remaining remaining-
after-021 exactly 2 share previous 600. Cycle 288 leftover
n=4 remaining unique next LOSE then cycle 289 leftover n=4
remaining exactly 4 share next 020 (all 090 076 020 010).
Do NOT skip this lock because cycle 289 already locked
leftover n=4 remaining next-020: remaining-after-600 exactly
4 share next 020 is remaining-after-600-specific (previous
neither 021 nor 600). Record cycle 289 overlap if remaining-
after-600 next-020 sites are the leftover n=4 remaining
next-020 sites. Do NOT re-lock leftover n=4 remaining
exactly 4 share next 020 as the claim (cycle 289). Do NOT
re-lock leftover n=4 remaining remaining-after-087 exactly
2 share next 057 (cycle 295, Ia8[114]/Ia9[28]). Do NOT lock
remaining-after-600 remaining-after-020 unique next in this
cycle. Do NOT re-lock leftover n=4 remaining remaining-
after-600 unique next (cycle 312). Off-I T sites are not
this cycle. 076 071 and 076 070 do not count as this
2-gram. Leftover extra sites do not count as leftover n=4
remaining.

Leftover n=4 remaining remaining-after-021 remaining-after-
600 I 090 076 = leftover n=4 remaining I 090 076 sites whose
previous token is neither 021 nor 600. Cycle 302 N=13, cycle
303 K_021=5, cycle 307 K_600=2, N_remaining_after_600=6.
Verify the 6 remaining-after-600 sites from fixtures; do not
invent sites. Cycle 309 remaining-after-600 previous
4-grams / cycle 312 next-020 sites: Ia2[119] 570 591 090 076
next 020, Ia4[86] 090 076 090 076 next 020, Ia5[143]
079 090 090 076 next 020, Ia8[114] 607 000 090 076 next 057,
Ia9[28] 244 999 090 076 next 057, Ia12[83] 700 008 090 076
next 020. Next stem is the token after leftover n=4 remaining
090 076 at that site.

Hypothesis K=4: leftover n=4 remaining remaining-after-600 I
090 076 sites include exactly 4 that share next stem 020
(forward 3-gram 090 076 020). Nested leftover n=4 remaining
13 / 4 / 9 / 3 / 6 / 2 / 4 / 2 / 2. Nested leftover n=4
remaining K_020=4 all 090 076 020 010 (cycle 289). Nested
remaining-after-021 unique-max G=600 K=2. Nested remaining-
after-600 unique-max previous false G=999 K=1 N_distinct=6.
Nested remaining-after-600 unique-max next true G=020 K=4
N_distinct=2. Nested remaining-after-600 previous 4-grams
all I-only hapax 6/0. Nested remaining-after-600 previous
3-grams I-only false N_i_only=4 N_leak=2 extra I total=21.
Nested remaining-after-600 extra-I previous 4-grams I-only
hapax 2/0. Count remaining-after-600 leftover n=4 remaining
I 090 076 sites whose next token is 020. Cycle 312 listed
Ia2[119]/Ia4[86]/Ia5[143]/Ia12[83]; measure, do not assume
if nested-check differs. N_remaining after peeling 020 =
N_remaining_after_600 − K_020. Unique-max next of remaining-
after-600 is still 020. Nested-check each next-020 remaining-
after-600 site ⊆ leftover n=4 remaining remaining-after-600
and has next token 020. Record whether they are the leftover
n=4 remaining next-020 sites (cycle 289) and whether all
4-grams are 090 076 020 010. Claim that can lose:
i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020.
True iff K_020==4 among leftover n=4 remaining remaining-
after-600 I 090 076, N_remaining_after_600==6, each next-020
site is leftover n=4 remaining remaining-after-600, the six
sites still compute as leftover n=4 remaining remaining-
after-021 remaining-after-600 I 090 076, and unique-max next
of remaining-after-600 is still 020. The claim is true.
Same claim-shape as cycle 293 leftover n=4 remaining
remaining-after-020 exactly 3 share next 087, cycle 297
leftover n=4 remaining remaining-after-057 exactly 2 share
next 011, and cycle 307 leftover n=4 remaining remaining-
after-021 exactly 2 share previous 600 (exactly K after
unique-max HOLD). This can lose if K_020 != 4, if
N_remaining_after_600 != 6, if a next-020 site is not
leftover n=4 remaining remaining-after-600, or if the six
sites no longer compute as leftover n=4 remaining remaining-
after-021 remaining-after-600 I 090 076. Remaining-after-600
overlaps leftover extra remaining-after-000 extra I at
Ia8[114]/Ia9[28] (those two are the next-057 remainder, not
the next-020 four). Cycle 295 leftover n=4 remaining
remaining-after-087 next 057 overlap Ia8[114]/Ia9[28]. Cycle
289 leftover n=4 remaining next-020 overlap if remaining-
after-600 next-020 = leftover n=4 remaining next-020. Extra
I 090-starts leftover extra remaining-after-009 (cycle 285).
Record, do not fail the exactly-4 claim on leftover-extra
overlap alone. Nested cycle 224 13/56, cycle 223 69/3, cycle
288 unique-max G=020 K=4 share-one lost, cycle 289 leftover
n=4 remaining K_020=4, cycle 303 K_021=5, cycle 307 K_600=2,
cycle 308 unique-max false G=999 K=1, cycle 312 unique-max
true G=020 K=4 stay. Do not assume the result; measure. Do
not retune.
...
from tests.test_mamari_i_leftover_n4_remaining_090_076_remaining_after_600_3grams_i_only_scoreboard import (
    ...
    STANDING_N_EXTRA_TOTAL as CYCLE310_N_EXTRA,
...
from tests.test_mamari_i_leftover_n4_remaining_090_076_remaining_after_600_extra_i_prev4_i_only_scoreboard import (
    STANDING_EXTRA_I_090_076_SITES as CYCLE311_EXTRA_I_090_STARTS,
    STANDING_I_LEFTOVER_N4_REMAINING_090_076_REMAINING_AFTER_600_EXTRA_I_PREV4_ALL_I_ONLY as CYCLE311_CLAIM,
    STANDING_N_HAPAX_I_ONLY as CYCLE311_N_HAPAX,
    STANDING_N_I_ONLY as CYCLE311_N_I_ONLY,
    TestMamariILeftoverN4Remaining090076RemainingAfter600ExtraIPrev4IOnlyScoreboard,
)
from tests.test_mamari_i_leftover_n4_remaining_090_076_remaining_after_600_next_stem_scoreboard import (
    STANDING_G as CYCLE312_G,
    STANDING_G_UNIQUELY_MOST_FREQUENT as CYCLE312_UNIQUE,
    STANDING_I_LEFTOVER_N4_REMAINING_090_076_REMAINING_AFTER_600_UNIQUE_NEXT_STEM as CYCLE312_CLAIM,
    STANDING_K as CYCLE312_K,
    STANDING_MATCHING_NEXT_4GRAMS as CYCLE312_MATCHING_NEXT_4GRAMS,
    STANDING_MATCHING_SITES as CYCLE312_MATCHING_SITES,
    STANDING_N_DISTINCT as CYCLE312_N_DISTINCT,
    STANDING_N_REMAINING_AFTER_600_LOCK as CYCLE312_N_REMAINING,
    STANDING_REMAINING_NEXT_STEMS as CYCLE312_REMAINING_NEXT_STEMS,
    STANDING_WITHOUT_G_SITES as CYCLE312_WITHOUT_G_SITES,
    leftover_n4_remaining_remaining_after_600_next_stems,
    leftover_n4_remaining_remaining_after_600_with_g,
    leftover_n4_remaining_remaining_after_600_with_next,
    leftover_n4_remaining_remaining_after_600_without_g,
    leftover_n4_remaining_remaining_after_600_without_next,
    matching_leftover_n4_remaining_remaining_after_600_local_4gram_rows,
    select_remaining_after_600_next_g,
    TestMamariILeftoverN4Remaining090076RemainingAfter600NextStemScoreboard,
)
from tests.test_mamari_i_leftover_n4_remaining_090_076_remaining_after_600_prev4_i_only_scoreboard import (
    ...
    STANDING_REMAINING_PREVIOUS_4GRAMS as CYCLE309_PREVIOUS_4GRAMS,
...
GRAM4_FORWARD = ("090", "076", "020", "010")
STANDING_N_I_LOCK = 69
...
STANDING_REMAINING_AFTER_PEELING_020_SITES = (
    (SIDE_IA, "Ia8", 114),
    (SIDE_IA, "Ia9", 28),
)
STANDING_REMAINING_AFTER_PEELING_020_NEXT_4GRAMS = (
    ("090", "076", "057", "600"),
    ("090", "076", "057", "600"),
)
STANDING_MATCHING_EQUALS_CYCLE312_G_SITES = True
STANDING_MATCHING_EQUALS_CYCLE289_NEXT_020 = True
STANDING_ALL_MATCHING_4GRAMS_ARE_090_076_020_010 = True
STANDING_G_UNIQUELY_MOST_FREQUENT = True
STANDING_UNIQUE_MAX_STILL_020 = True
...
STANDING_OVERLAP_CYCLE289_NEXT_020 = STANDING_LEFTOVER_020010_COVERED
STANDING_OVERLAP_G_CYCLE258_EXTRA_I = ()
STANDING_OVERLAP_G_CYCLE259_EXTRA_I = ()
STANDING_OVERLAP_G_CYCLE295_NEXT_057 = ()
STANDING_OVERLAP_CYCLE285_EXTRA_I_090_STARTS = ()
STANDING_OVERLAP_G_CYCLE287_EXTRA_I_090_START = ((SIDE_IA, "Ia12", 83),)
STANDING_OVERLAP_DOES_NOT_LOSE = True
STANDING_KNOWN_DISTINCT = True
STANDING_CLAIM = (
    "i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020"
)
STANDING_I_LEFTOVER_N4_REMAINING_090_076_REMAINING_AFTER_600_EXACTLY_4_SHARE_FORWARD_020 = True
STANDING_RESULT = "i_leftover_n4_remaining_090_076_remaining_after_600_fwd020"
...
STANDING_SAME_AS_CYCLE312 = False
STANDING_SAME_CLAIM_SHAPE_AS_CYCLE289 = True
STANDING_SAME_CLAIM_SHAPE_AS_CYCLE293 = True
STANDING_SAME_CLAIM_SHAPE_AS_CYCLE297 = True
STANDING_SAME_CLAIM_SHAPE_AS_CYCLE307 = True
STANDING_OFF_I_T_SITES_ARE_NOT_THIS_CYCLE = True
STANDING_DO_NOT_RELOCK_CYCLE289_EXACTLY_4_SHARE_NEXT_020 = True
STANDING_DO_NOT_RELOCK_CYCLE295_REMAINING_AFTER_087_NEXT_057 = True
STANDING_DO_NOT_LOCK_REMAINING_AFTER_600_REMAINING_AFTER_020_UNIQUE_NEXT = True
STANDING_DO_NOT_RELOCK_CYCLE312_UNIQUE_NEXT = True
STANDING_076_071_DOES_NOT_COUNT = True
STANDING_076_070_DOES_NOT_COUNT = True
STANDING_LEFTOVER_EXTRA_DOES_NOT_COUNT = True
STANDING_LEFTOVER_N4_REMAINING_REMAINING_AFTER_087_IS_NOT_THIS_CYCLE = True
STANDING_LEFTOVER_EXTRA_REMAINING_AFTER_009_EXTRA_I_IS_NOT_THIS_CYCLE = True
...
STANDING_NESTED_LEFTOVER_N4_REMAINING_LOCK = STANDING_NESTED_LEFTOVER_N4_REMAINING


def leftover_n4_remaining_remaining_after_600_with_forward_020(
    ...
    """Leftover n=4 remaining remaining-after-600 sites whose next token is 020."""
    return leftover_n4_remaining_remaining_after_600_with_g(
        sites,
        previous_stems,
        next_stems,
        stem=stem,
...
def leftover_n4_remaining_remaining_after_600_without_forward_020(
    sites: tuple[tuple[str, str, int], ...],
    previous_stems: tuple[str | None, ...],
    next_stems: tuple[str | None, ...],
    stem: str = STANDING_G,
    ...
    """Leftover n=4 remaining remaining-after-600 sites whose next token is not 020."""
    return leftover_n4_remaining_remaining_after_600_without_g(
        sites,
        previous_stems,
        next_stems,
        stem=stem,
...
def matching_equals_cycle312_g_set(
    matching_sites: tuple[tuple[str, str, int], ...],
    cycle312_g_sites: tuple[tuple[str, str, int], ...] = CYCLE312_MATCHING_SITES,
) -> bool:
    """True iff remaining-after-600 next-020 sites equal the cycle-312 G set."""
    return matching_sites == cycle312_g_sites


def matching_equals_cycle289_next_020(
    matching_sites: tuple[tuple[str, str, int], ...],
    cycle289_sites: tuple[tuple[str, str, int], ...] = CYCLE289_MATCHING_SITES,
) -> bool:
    """True iff remaining-after-600 next-020 sites equal leftover n=4 remaining next-020."""
    return matching_sites == cycle289_sites


def all_matching_4grams_are_090_076_020_010(
    next_4grams: tuple[tuple[str, ...], ...],
    expected: tuple[str, ...] = GRAM4_FORWARD,
) -> bool:
    """True iff every matching next 4-gram is 090 076 020 010."""
    return bool(next_4grams) and all(gram == expected for gram in next_4grams)


def next_020_sites_subset_of_remaining_after_600(
    matching_sites: tuple[tuple[str, str, int], ...],
    remaining: tuple[tuple[str, str, int], ...],
    next_stems_by_site: dict[tuple[str, str, int], str | None],
    stem: str = STANDING_G,
) -> bool:
    """True iff each next-020 site ⊆ remaining-after-600 and has next token 020."""
...
def remaining_after_600_still_computes(
    inside_sites: tuple[tuple[str, str, int], ...],
    previous_stems: tuple[str | None, ...],
    remaining: tuple[tuple[str, str, int], ...],
    expected: tuple[tuple[str, str, int], ...] = STANDING_REMAINING_SITES,
) -> bool:
    """True iff the six sites still compute as remaining-after-021 remaining-after-600."""
    computed = leftover_n4_remaining_remaining_after_600(inside_sites, previous_stems)
    after_021 = leftover_n4_remaining_remaining_after_021_without_previous_600(
        inside_sites,
        previous_stems,
    )
    return remaining == computed == after_021 == expected and len(remaining) == 6


def i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020(
    k: int,
    unique: bool,
    g: str | None,
    n_remaining: int,
    matching: tuple[tuple[str, str, int], ...],
    remaining: tuple[tuple[str, str, int], ...],
    expected: int = HYPOTHESIS_K,
    expected_g: str = STANDING_G,
    expected_remaining: int = STANDING_N_REMAINING_AFTER_600_LOCK,
) -> bool:
    """True iff K_020=4, remaining=6, unique-max still 020, and each next-020 site ⊆ remaining."""
    remaining_set = set(remaining)
    return (
        k == expected
        and unique
        ...
        and remaining == STANDING_REMAINING_SITES
        and all(site in remaining_set for site in matching)
        and len(matching) == expected
    )


class TestILeftoverN4Remaining090076RemainingAfter600Fwd020Helpers(unittest.TestCase):
    """Helpers on leftover n=4 remaining remaining-after-600 next 020. No CV, no LLM."""

    def test_forward_020_requires_stem_after_2gram_and_not_021_or_600_previous(self):
        """Next stem 020 is 090 076 020; previous 021/600 are not remaining-after-600."""
        ...
        self.assertEqual(GRAM4_FORWARD, ("090", "076", "020", "010"))
        self.assertEqual(LOCKED_PREVIOUS_STEMS_AFTER_600, ("021", "600"))
        ...
        self.assertEqual(site_next_4gram(has_020, 0, GRAM2), GRAM4_FORWARD)
        has_057 = ["090", "076", "057", "600"]
        self.assertEqual(site_next_stem(has_057, 0, GRAM2), "057")
        self.assertNotEqual(site_next_stem(has_057, 0, GRAM2), "020")
        end_of_line = ["591", "090", "076"]
        self.assertIsNone(site_next_stem(end_of_line, 1, GRAM2))
        planted_sites = (
            (SIDE_IA, "Ia1", 0),
            (SIDE_IA, "Ia1", 1),
            (SIDE_IA, "Ia1", 2),
        ...
        planted_prev = ("591", "021", "600", "999", "008")
        planted_next = ("020", "087", "011", None, "057")
        rem = leftover_n4_remaining_remaining_after_600(planted_sites, planted_prev)
        self.assertEqual(rem, (planted_sites[0], planted_sites[3], planted_sites[4]))
        self.assertEqual(
            leftover_n4_remaining_remaining_after_600_with_forward_020(
                planted_sites, planted_prev, planted_next
            ),
            (planted_sites[0],),
        )
        self.assertEqual(
            leftover_n4_remaining_remaining_after_600_without_forward_020(
                planted_sites, planted_prev, planted_next
            ),
            (planted_sites[4],),
        )
        ...
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLE312_UNIQUE_NEXT)
        self.assertEqual(provider.get_call_history(), [])

    def test_exactly_4_can_fail(self):
        """Boolean is True only when K=4, remaining=6, unique-max G is 020, sites ⊆ remaining."""
        provider = MockProvider()
        remaining = STANDING_REMAINING_SITES
        matching = STANDING_MATCHING_SITES
        self.assertTrue(
            i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020(
                4, True, "020", 6, matching, remaining
            )
        )
        self.assertFalse(
            i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020(
                0, True, "020", 6, matching, remaining
            )
        )
        self.assertFalse(
            i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020(
                3, True, "020", 6, matching[:3], remaining
            )
        )
        self.assertFalse(
            i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020(
                5, True, "020", 6, matching, remaining
            )
        )
        self.assertFalse(
            i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020(
                4, False, "020", 6, matching, remaining
            )
        )
        self.assertFalse(
            i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020(
                4, True, "057", 6, matching, remaining
            )
        )
        self.assertFalse(
            i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020(
                4, True, "020", 5, matching, remaining
            )
        )
        outsider = matching + ((SIDE_IA, "Ia1", 2),)
        self.assertFalse(
            i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020(
                5, True, "020", 6, outsider, remaining
            )
        )
        drifted = remaining[:-1]
        self.assertFalse(
            i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020(
                4, True, "020", 5, matching, drifted
            )
        )
        self.assertEqual(
            STANDING_CLAIM,
        ...
        self.assertTrue(
            STANDING_I_LEFTOVER_N4_REMAINING_090_076_REMAINING_AFTER_600_EXACTLY_4_SHARE_FORWARD_020
        )
        self.assertEqual(
            STANDING_K_020_AFTER_600 + STANDING_N_REMAINING_AFTER_PEELING_020,
            STANDING_N_REMAINING_AFTER_600_LOCK,
        )
        self.assertEqual(4 + 2, 6)
        self.assertEqual(STANDING_K_600 + STANDING_N_REMAINING_AFTER_600, STANDING_N_REMAINING_AFTER_021)
    ...
    def test_cycle312_cycle289_set_and_overlap_can_diverge(self):
        """Cycle-312/289 equality can fail; leftover-extra overlap does not make K_020 lose."""
        provider = MockProvider()
        self.assertTrue(matching_equals_cycle312_g_set(STANDING_MATCHING_SITES))
        self.assertTrue(matching_equals_cycle289_next_020(STANDING_MATCHING_SITES))
        self.assertTrue(STANDING_MATCHING_EQUALS_CYCLE312_G_SITES)
        self.assertTrue(STANDING_MATCHING_EQUALS_CYCLE289_NEXT_020)
        self.assertTrue(
            all_matching_4grams_are_090_076_020_010(STANDING_MATCHING_NEXT_4GRAMS)
        )
        ...
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLE289_EXACTLY_4_SHARE_NEXT_020)
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLE295_REMAINING_AFTER_087_NEXT_057)
        self.assertTrue(STANDING_DO_NOT_LOCK_REMAINING_AFTER_600_REMAINING_AFTER_020_UNIQUE_NEXT)
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLE312_UNIQUE_NEXT)
        self.assertTrue(STANDING_SAME_CLAIM_SHAPE_AS_CYCLE289)
        self.assertTrue(STANDING_SAME_CLAIM_SHAPE_AS_CYCLE293)
        self.assertTrue(STANDING_SAME_CLAIM_SHAPE_AS_CYCLE297)
        self.assertTrue(STANDING_SAME_CLAIM_SHAPE_AS_CYCLE307)
        ...
        self.assertFalse(STANDING_SAME_AS_CYCLE312)
        self.assertEqual(provider.get_call_history(), [])


class TestMamariILeftoverN4Remaining090076RemainingAfter600Fwd020Scoreboard(
    unittest.TestCase
):
    """Cited-fixture leftover n=4 remaining remaining-after-600 forward-020 lock. Mock only."""
    ...
    def setUp(self):
        ...
        self.remaining_after_021 = leftover_n4_remaining_remaining_after_021(
            self.inside_sites,
            self.previous_stems,
        )
        self.remaining_after_021_stems = leftover_n4_remaining_remaining_after_021_previous_stems(
            self.inside_sites,
            self.previous_stems,
        )
        self.share_600 = leftover_n4_remaining_remaining_after_021_with_previous_600(
            self.inside_sites,
            self.previous_stems,
        )
        ...
        self.remaining_prev = leftover_n4_remaining_remaining_after_600_previous_stems(
            self.inside_sites,
            self.previous_stems,
        )
        self.remaining_stems = leftover_n4_remaining_remaining_after_600_next_stems(
            self.inside_sites,
            self.previous_stems,
            self.next_stems,
        )
        self.with_next = leftover_n4_remaining_remaining_after_600_with_next(
            self.inside_sites,
            self.previous_stems,
            self.next_stems,
        )
        self.line_final = leftover_n4_remaining_remaining_after_600_without_next(
            self.inside_sites,
            self.previous_stems,
            self.next_stems,
        )
        self.matching = leftover_n4_remaining_remaining_after_600_with_forward_020(
            self.inside_sites,
            self.previous_stems,
            self.next_stems,
        )
        self.without = leftover_n4_remaining_remaining_after_600_without_forward_020(
            self.inside_sites,
            self.previous_stems,
            self.next_stems,
        )
        ...
        self.n_remaining_after_021 = len(self.remaining_after_021)
        ...
        self.g, self.unique_k, self.unique = select_remaining_after_600_next_g(
            self.remaining_stems
        )
        self.k = len(self.matching)
        self.k_020 = self.k
        self.n_without = len(self.without)
        self.n_remaining_after_peeling_020 = self.n_remaining - self.k_020
        self.equals_cycle312 = matching_equals_cycle312_g_set(self.matching)
        self.equals_cycle289 = matching_equals_cycle289_next_020(self.matching)
        self.all_4grams = all_matching_4grams_are_090_076_020_010(
            self.matching_next_4grams
        )
        self.next_by_site = dict(zip(self.inside_sites, self.next_stems, strict=True))
        self.subset_ok = next_020_sites_subset_of_remaining_after_600(
            self.matching,
            self.remaining,
            self.next_by_site,
        )
        self.still_computes = remaining_after_600_still_computes(
            self.inside_sites,
            self.previous_stems,
            self.remaining,
        )
        ...
        self.overlap_289 = leftover_n4_remaining_g_overlap_sites(
            self.matching,
            CYCLE289_MATCHING_SITES,
        )
        self.overlap_g_258 = leftover_n4_remaining_g_overlap_sites(
            self.matching,
            CYCLE259_EXTRA_I_SITES,
        )
        self.overlap_g_259 = leftover_n4_remaining_g_overlap_sites(
            self.matching,
            CYCLE259_EXTRA_I_SITES,
        )
        self.overlap_g_295 = leftover_n4_remaining_g_overlap_sites(
            self.matching,
            CYCLE295_MATCHING_SITES,
        )
        self.overlap_285 = leftover_n4_remaining_g_overlap_sites(
            self.remaining,
            CYCLE311_EXTRA_I_090_STARTS,
        )
        self.overlap_g_287 = leftover_n4_remaining_g_overlap_sites(
            self.matching,
            CYCLE287_EXTRA_I_090_076_SITES,
        )
        self.leftover_n4_remaining_next_020 = leftover_n4_remaining_with_forward_020(
            self.inside_sites,
            self.next_stems,
        )
        self.claim_holds = (
    ...
    def test_tokens_and_nested_leftover_n4_remaining_13_5_8_2_6_not_retuned(self):
        """2-gram and leftover n=4 remaining 13/0/5/8/2/6 stay the cycle-312/308/306 locks."""
        self.assertEqual(GRAM2, ("090", "076"))
        self.assertEqual(GRAM3_FORWARD, ("090", "076", "020"))
        self.assertEqual(GRAM3_NESTED_057, ("090", "076", "057"))
        ...
        self.assertEqual(len(STANDING_INSIDE_SITES), STANDING_N_INSIDE_LOCK)
        self.assertEqual(STANDING_N_INSIDE_LOCK, CYCLE224_N_INSIDE)
        self.assertEqual(STANDING_N_INSIDE_LOCK, CYCLE288_N_INSIDE)
        ...
        prior_312 = self.survey[
            "i_leftover_n4_remaining_090_076_remaining_after_600_next_stem"
        ]
        self.assertEqual(prior_312["cycle"], 312)
        self.assertEqual(prior_312["G"], "020")
        self.assertEqual(prior_312["K"], 4)
        self.assertEqual(prior_312["N_remaining_after_600"], 6)
        self.assertEqual(prior_312["N_distinct"], 2)
        self.assertTrue(prior_312["G_uniquely_most_frequent"])
        self.assertTrue(
            prior_312["i_leftover_n4_remaining_090_076_remaining_after_600_unique_next_stem"]
        )
        self.assertTrue(CYCLE312_CLAIM)
        self.assertEqual(CYCLE312_G, "020")
        self.assertEqual(CYCLE312_K, 4)
        self.assertEqual(CYCLE312_N_REMAINING, 6)
        self.assertEqual(CYCLE312_N_DISTINCT, 2)
        self.assertTrue(CYCLE312_UNIQUE)
        prior_311 = self.survey[
            "i_leftover_n4_remaining_090_076_remaining_after_600_extra_i_prev4_i_only"
        ]
        self.assertEqual(prior_311["cycle"], 311)
        self.assertEqual(prior_311["N_i_only"], 2)
        self.assertEqual(prior_311["N_hapax_i_only"], 2)
        self.assertTrue(CYCLE311_CLAIM)
        self.assertEqual(CYCLE311_N_I_ONLY, 2)
        self.assertEqual(CYCLE311_N_HAPAX, 2)
        prior_310 = self.survey[
            "i_leftover_n4_remaining_090_076_remaining_after_600_3grams_i_only"
        ]
        self.assertEqual(prior_310["cycle"], 310)
        self.assertEqual(prior_310["N_i_only"], 4)
        self.assertEqual(prior_310["N_leak_off_i"], 2)
        self.assertFalse(CYCLE310_CLAIM)
        self.assertEqual(CYCLE310_N_I_ONLY, 4)
        self.assertEqual(CYCLE310_N_LEAK, 2)
        self.assertEqual(CYCLE310_N_EXTRA, 21)
        prior_309 = self.survey[
            "i_leftover_n4_remaining_090_076_remaining_after_600_prev4_i_only"
        ]
        self.assertEqual(prior_309["cycle"], 309)
        self.assertEqual(prior_309["N_i_only"], 6)
        self.assertEqual(prior_309["N_hapax_i_only"], 6)
        ...
        self.assertTrue(
            prior_289["i_leftover_n4_remaining_090_076_exactly_4_share_forward_020"]
        )
        ...
        self.assertEqual(
            STANDING_NESTED_LEFTOVER_N4_REMAINING_LOCK, (13, 4, 9, 3, 6, 2, 4, 2, 2)
        )
        ...
        self.assertEqual(CYCLE309_PREVIOUS_4GRAMS[0], ("570", "591", "090", "076"))
    ...
    def test_counts_4_of_6_and_hypothesis_k_4_holds(self):
        """N_remaining_after_600=6, K_020=4. Unique-max still 020. Claim holds."""
        self.assertEqual(self.n_i, STANDING_N_I)
        self.assertEqual(STANDING_N_I, 69)
        self.assertEqual(self.n_inside, STANDING_N_INSIDE_LOCK)
        self.assertEqual(STANDING_N_INSIDE_LOCK, 13)
        ...
        self.assertEqual(STANDING_K_600, CYCLE307_K_600)
        self.assertEqual(STANDING_K_600, 2)
        self.assertEqual(self.share_600, CYCLE307_MATCHING_SITES)
        self.assertTrue(
            leftover_n4_remaining_remaining_after_600_nested_counts_hold(
                self.n_inside,
                self.n_line_initial_inside,
                self.k_021,
                self.n_remaining_after_021,
                self.k_600,
                self.n_remaining,
            )
        )
        ...
        self.assertEqual(self.n_remaining, STANDING_N_REMAINING_AFTER_600_LOCK)
        self.assertEqual(STANDING_N_REMAINING_AFTER_600_LOCK, 6)
        self.assertEqual(self.n_remaining, CYCLE312_N_REMAINING)
        self.assertEqual(self.n_remaining, self.n_remaining_after_021 - self.k_600)
        ...
        self.assertEqual(self.remaining_prev, STANDING_REMAINING_PREVIOUS_STEMS)
        self.assertEqual(self.remaining_stems, STANDING_REMAINING_NEXT_STEMS)
        self.assertEqual(self.remaining_stems, CYCLE312_REMAINING_NEXT_STEMS)
        self.assertTrue(self.still_computes)
        self.assertTrue(
            remaining_after_600_still_computes(
                self.inside_sites,
                self.previous_stems,
                self.remaining,
            )
        ...
        self.assertEqual(self.n_with_next + self.n_line_final, self.n_remaining)
        ...
        self.assertEqual(self.k_020, STANDING_K_020_AFTER_600)
        self.assertEqual(STANDING_K_020_AFTER_600, HYPOTHESIS_K)
        self.assertEqual(STANDING_K_020_AFTER_600, 4)
        self.assertEqual(STANDING_K, CYCLE312_K)
        self.assertEqual(STANDING_G, "020")
        self.assertEqual(STANDING_G, CYCLE312_G)
        self.assertEqual(self.g, "020")
        self.assertEqual(self.unique_k, 4)
        self.assertTrue(self.unique)
        self.assertTrue(STANDING_G_UNIQUELY_MOST_FREQUENT)
        self.assertTrue(STANDING_UNIQUE_MAX_STILL_020)
        self.assertEqual(self.n_without, STANDING_N_WITHOUT)
        self.assertEqual(STANDING_N_WITHOUT, 2)
        self.assertEqual(self.n_remaining_after_peeling_020, STANDING_N_REMAINING_AFTER_PEELING_020)
        self.assertEqual(STANDING_N_REMAINING_AFTER_PEELING_020, 2)
        self.assertEqual(self.k_020 + self.n_remaining_after_peeling_020, self.n_remaining)
        self.assertEqual(4 + 2, 6)
        if self.k_020 != 4:
            self.fail("nested-check K_020 drifted from 4")
        if self.g != "020" or not self.unique:
            self.fail("unique-max next is no longer 020")
        ...
        self.assertEqual(self.matching, CYCLE312_MATCHING_SITES)
        self.assertEqual(self.matching, CYCLE289_MATCHING_SITES)
        self.assertEqual(self.matching, self.leftover_n4_remaining_next_020)
        self.assertTrue(self.equals_cycle312)
        self.assertTrue(self.equals_cycle289)
        self.assertTrue(STANDING_MATCHING_EQUALS_CYCLE312_G_SITES)
        self.assertTrue(STANDING_MATCHING_EQUALS_CYCLE289_NEXT_020)
        self.assertTrue(self.all_4grams)
        self.assertTrue(STANDING_ALL_MATCHING_4GRAMS_ARE_090_076_020_010)
        if len(self.matching) != 4 or not self.equals_cycle312:
            self.fail(
                "leftover n=4 remaining remaining-after-600 next-020 set drifted from cycle-312 G set"
            )
        self.assertEqual(self.without, STANDING_REMAINING_AFTER_PEELING_020_SITES)
        self.assertEqual(self.without, CYCLE312_WITHOUT_G_SITES)
    ...
    def test_matching_remaining_after_600_sites_have_next_020(self):
        """Four remaining-after-600 leftover n=4 remaining sites are 090 076 020 010."""
        self.assertEqual(self.matching, STANDING_MATCHING_SITES)
        self.assertEqual(self.matching_next_4grams, STANDING_MATCHING_NEXT_4GRAMS)
        self.assertEqual(self.matching_next_4grams, CYCLE312_MATCHING_NEXT_4GRAMS)
        self.assertEqual(self.matching_next_4grams, CYCLE289_MATCHING_NEXT_4GRAMS)
        expected = (
        ...
        for (site, nxt4), (want_site, want_nxt) in zip(
            ...
            self.assertEqual(nxt4, want_nxt)
            self.assertEqual(site, want_site)
            self.assertEqual(nxt4[:3], GRAM3_FORWARD)
            self.assertEqual(nxt4, GRAM4_FORWARD)
            self.assertEqual(len(nxt4), STANDING_N4)
            ...
            self.assertIn(site, CYCLE312_MATCHING_SITES)
            self.assertIn(site, CYCLE289_MATCHING_SITES)
        self.assertEqual(self.matching, CYCLE312_MATCHING_SITES)
        self.assertEqual(self.matching, CYCLE289_MATCHING_SITES)
        self.assertTrue(matching_equals_cycle312_g_set(self.matching))
        self.assertTrue(matching_equals_cycle289_next_020(self.matching))
        self.assertTrue(self.subset_ok)
        self.assertTrue(
            all_matching_4grams_are_090_076_020_010(self.matching_next_4grams)
        )
        for site in self.without:
            ...
            self.assertEqual(nxt, "057")
            self.assertIn(site, STANDING_REMAINING_SITES)
            self.assertIn(site, CYCLE295_MATCHING_SITES)
            self.assertNotIn(site, CYCLE289_MATCHING_SITES)
        self.assertEqual(self.without, STANDING_REMAINING_AFTER_PEELING_020_SITES)
        without_4grams = leftover_n4_remaining_next_4grams(
            self.i_sides,
            self.without,
            GRAM2,
        )
        self.assertEqual(without_4grams, STANDING_REMAINING_AFTER_PEELING_020_NEXT_4GRAMS)
        for site in self.share_021:
            self.assertNotIn(site, self.remaining)
        ...
        for site in self.share_600:
            self.assertNotIn(site, self.remaining)
            self.assertNotIn(site, self.matching)
            self.assertIn(site, CYCLE307_MATCHING_SITES)
    ...
    def test_nested_overlap_recorded_does_not_lose(self):
        """Remaining-after-600 overlaps leftover extra / cycle 295 at Ia8[114]/Ia9[28]; next-020 equals cycle 289."""
        ...
        self.assertEqual(self.overlap_289, STANDING_OVERLAP_CYCLE289_NEXT_020)
        self.assertEqual(self.overlap_289, STANDING_LEFTOVER_020010_COVERED)
        self.assertEqual(self.overlap_289, CYCLE289_MATCHING_SITES)
        self.assertEqual(self.overlap_g_258, STANDING_OVERLAP_G_CYCLE258_EXTRA_I)
        self.assertEqual(self.overlap_g_259, STANDING_OVERLAP_G_CYCLE259_EXTRA_I)
        self.assertEqual(self.overlap_g_295, STANDING_OVERLAP_G_CYCLE295_NEXT_057)
        self.assertEqual(self.overlap_g_258, ())
        self.assertEqual(self.overlap_285, STANDING_OVERLAP_CYCLE285_EXTRA_I_090_STARTS)
        self.assertEqual(self.overlap_285, ())
        self.assertEqual(self.overlap_g_287, STANDING_OVERLAP_G_CYCLE287_EXTRA_I_090_START)
        self.assertEqual(self.overlap_g_287, ((SIDE_IA, "Ia12", 83),))
        ...
        self.assertNotIn((SIDE_IA, "Ia8", 114), self.matching)
        self.assertNotIn((SIDE_IA, "Ia9", 28), self.matching)
        self.assertNotIn((SIDE_IA, "Ia5", 66), self.remaining)
        self.assertNotIn((SIDE_IA, "Ia13", 135), self.remaining)
        self.assertEqual(
            CYCLE311_EXTRA_I_090_STARTS,
            ((SIDE_IA, "Ia5", 66), (SIDE_IA, "Ia13", 135)),
        )
        self.assertIn((SIDE_IA, "Ia12", 83), CYCLE287_EXTRA_I_090_076_SITES)
        self.assertIn((SIDE_IA, "Ia8", 114), CYCLE287_EXTRA_I_090_076_SITES)
        self.assertTrue(STANDING_OVERLAP_DOES_NOT_LOSE)
        ...
        self.assertTrue(CYCLE289_CLAIM)
        self.assertTrue(STANDING_LEFTOVER_N4_REMAINING_REMAINING_AFTER_087_IS_NOT_THIS_CYCLE)
        self.assertTrue(STANDING_LEFTOVER_EXTRA_REMAINING_AFTER_000_EXTRA_I_IS_NOT_THIS_CYCLE)
        self.assertTrue(STANDING_LEFTOVER_EXTRA_REMAINING_AFTER_009_EXTRA_I_IS_NOT_THIS_CYCLE)
        self.assertEqual(self.provider.get_call_history(), [])

    def test_existing_312_311_310_309_308_307_306_303_295_289_288_224_223_still_compute(self):
        """Cycle 312 unique-max G=020 K=4, 311 extra-I prev4 2/0, 310 3-grams 4/2, 309 prev4 6/0, 308 previous hapax, 307 K_600=2, 306 G=600 K=2, 303 K_021=5, 295 K_057=2, 289 K_020=4, 288 G=020 K=4, 224 13/56, 223 69/3 stay."""
        prior_312 = TestMamariILeftoverN4Remaining090076RemainingAfter600NextStemScoreboard()
        prior_312.setUp()
        prior_312.test_counts_6_remaining_g_020_k_4_unique_max_and_hypothesis_holds()
        prior_312.test_survey_matches_computed_lock()
        self.assertEqual(prior_312.g, "020")
        self.assertEqual(prior_312.k, 4)
        self.assertEqual(prior_312.n_remaining, 6)
        self.assertEqual(prior_312.n_distinct, 2)
        self.assertTrue(prior_312.unique)
        self.assertTrue(prior_312.claim_holds)
        self.assertTrue(CYCLE312_CLAIM)
        if (
            prior_312.g != "020"
            or prior_312.k != 4
            or prior_312.n_remaining != 6
            or prior_312.n_distinct != 2
            or not prior_312.unique
            or not prior_312.claim_holds
        ):
            self.fail(
                "nested cycle 312 remaining-after-600 unique-max true G=020 K=4 N_distinct=2 drifted"
            )
        prior_311 = TestMamariILeftoverN4Remaining090076RemainingAfter600ExtraIPrev4IOnlyScoreboard()
        prior_311.setUp()
        prior_311.test_each_extra_i_4gram_lock_and_claim_holds()
        prior_311.test_survey_matches_computed_lock()
        self.assertEqual(prior_311.n_i_only, 2)
        self.assertEqual(prior_311.n_hapax_i_only, 2)
        self.assertTrue(prior_311.claim_holds)
        self.assertTrue(CYCLE311_CLAIM)
        if prior_311.n_i_only != 2 or not prior_311.claim_holds:
            self.fail(
                "nested cycle 311 remaining-after-600 extra-I previous 4-grams I-only hapax 2/0 drifted"
            )
        prior_310 = TestMamariILeftoverN4Remaining090076RemainingAfter6003gramsIOnlyScoreboard()
        prior_310.setUp()
        prior_310.test_each_3gram_lock_extra_i_and_claim_loses_on_t()
        prior_310.test_survey_matches_computed_lock()
        self.assertEqual(prior_310.n_i_only, 4)
        self.assertEqual(prior_310.n_leak_off_i, 2)
        self.assertEqual(sum(prior_310.n_extra), 21)
        self.assertFalse(prior_310.claim_holds)
        self.assertFalse(CYCLE310_CLAIM)
        if (
            prior_310.n_i_only != 4
            or prior_310.n_leak_off_i != 2
            or sum(prior_310.n_extra) != 21
            or prior_310.claim_holds
        ):
            self.fail(
                "nested cycle 310 remaining-after-600 previous 3-grams I-only false N_i_only=4 N_leak=2 extra I=21 drifted"
            )
        ...
        if prior_309.n_i_only != 6 or prior_309.n_not_i_only != 0:
            self.fail(
                "nested cycle 309 remaining-after-600 previous 4-grams I-only hapax 6/0 drifted"
            )
        ...
        if (
            ...
            self.fail(
                "nested cycle 308 remaining-after-600 unique previous false G=999 K=1 N_distinct=6 drifted"
            )
        ...
        if prior_307.k_600 != 2 or prior_307.n_remaining_after_600 != 6:
            self.fail("nested cycle 307 remaining-after-021 exactly 2 share previous 600 drifted")
        ...
        if prior_306.g != "600" or prior_306.k != 2 or not prior_306.unique:
            self.fail("nested cycle 306 remaining-after-021 unique-max G=600 K=2 drifted")
        ...
        if prior_303.k_021 != 5 or prior_303.n_remaining_after_021 != 8:
            self.fail("nested cycle 303 leftover n=4 remaining exactly 5 share 021 drifted")
        ...
        if prior_295.k_057 != 2:
            self.fail("nested cycle 295 leftover n=4 remaining remaining-after-087 next 057 drifted")
        ...
        self.assertEqual(prior_289.matching, self.matching)
        self.assertTrue(prior_289.claim_holds)
        self.assertTrue(CYCLE289_CLAIM)
        if prior_289.k != 4 or not prior_289.claim_holds:
            self.fail("nested cycle 289 leftover n=4 remaining K_020=4 drifted")
        ...
        self.assertTrue(prior_287.claim_holds)
        self.assertTrue(CYCLE287_CLAIM)
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-313 leftover n=4 remaining remaining-after-600 forward-020 lock."""
        lock = self.survey[
            "i_leftover_n4_remaining_090_076_remaining_after_600_fwd020"
        ]
        self.assertEqual(lock["cycle"], 313)
        ...
        self.assertEqual(tuple(lock["forward_3gram"]), ("090", "076", "020"))
        ...
        self.assertEqual(tuple(lock["locked_previous_stems_after_600"]), ("021", "600"))
        self.assertEqual(lock["N_I"], STANDING_N_I_LOCK)
        ...
        self.assertEqual(
            tuple(lock["remaining_after_600_next_stems"]),
        ...
        self.assertEqual(lock["line_final_sites"], [])
        ...
        self.assertEqual(lock["K_020"], STANDING_K_020_AFTER_600)
        self.assertEqual(lock["K_020"], 4)
        self.assertEqual(lock["N_without"], STANDING_N_WITHOUT)
        self.assertEqual(lock["N_without"], 2)
        self.assertEqual(
            lock["N_remaining_after_peeling_020"],
            STANDING_N_REMAINING_AFTER_PEELING_020,
        )
        self.assertEqual(lock["N_remaining_after_peeling_020"], 2)
        self.assertTrue(lock["g_uniquely_most_frequent"])
        self.assertTrue(lock["unique_max_still_020"])
        self.assertEqual(
            tuple(
                tuple(row)
                for row in lock["matching_leftover_n4_remaining_remaining_after_600_sites"]
            ),
            STANDING_MATCHING_SITES,
        )
        self.assertEqual(
        ...
        self.assertTrue(lock["matching_equals_cycle312_g_sites"])
        self.assertEqual(
            lock["matching_equals_cycle312_g_sites"],
            STANDING_MATCHING_EQUALS_CYCLE312_G_SITES,
        )
        self.assertTrue(lock["matching_equals_cycle289_next_020"])
        self.assertEqual(
            lock["matching_equals_cycle289_next_020"],
            STANDING_MATCHING_EQUALS_CYCLE289_NEXT_020,
        )
        self.assertTrue(lock["all_matching_4grams_are_090_076_020_010"])
        self.assertEqual(
            [list(gram) for gram in STANDING_MATCHING_NEXT_4GRAMS],
            lock["matching_next_4grams"],
        )
        self.assertEqual(
            lock["matching_leftover_n4_remaining_remaining_after_600_local_4grams"],
            matching_leftover_n4_remaining_remaining_after_600_local_4gram_rows(),
        )
        self.assertEqual(
            tuple(tuple(row) for row in lock["remaining_after_peeling_020_sites"]),
            STANDING_REMAINING_AFTER_PEELING_020_SITES,
        )
        self.assertEqual(
            [list(gram) for gram in STANDING_REMAINING_AFTER_PEELING_020_NEXT_4GRAMS],
            lock["remaining_after_peeling_020_next_4grams"],
        )
        self.assertEqual(
            tuple(tuple(row) for row in lock["cycle312_G_sites"]),
            CYCLE312_MATCHING_SITES,
        )
        self.assertEqual(
            tuple(tuple(row) for row in lock["cycle289_next_020_sites"]),
            CYCLE289_MATCHING_SITES,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            [list(site) for site in STANDING_OVERLAP_CYCLE289_NEXT_020],
            lock["overlap_cycle289_next_020_sites"],
        )
        self.assertEqual(lock["overlap_g_cycle258_extra_i_sites"], [])
        self.assertEqual(lock["overlap_g_cycle259_extra_i_sites"], [])
        self.assertEqual(lock["overlap_g_cycle295_next_057_sites"], [])
        self.assertEqual(lock["overlap_cycle285_extra_i_090_start_sites"], [])
        self.assertEqual(
            [list(site) for site in STANDING_OVERLAP_G_CYCLE287_EXTRA_I_090_START],
            lock["overlap_g_cycle287_extra_i_090_start_sites"],
        )
        self.assertTrue(lock["overlap_does_not_lose"])
        self.assertEqual(
            list(STANDING_NESTED_LEFTOVER_N4_REMAINING_LOCK),
            lock["nested_leftover_n4_remaining"],
        )
        self.assertEqual(lock["nested_cycle312_G"], "020")
        self.assertEqual(lock["nested_cycle312_K"], 4)
        self.assertEqual(lock["nested_cycle312_N_remaining_after_600"], 6)
        self.assertEqual(lock["nested_cycle312_N_distinct"], 2)
        self.assertTrue(lock["nested_cycle312_unique_next_stem"])
        self.assertEqual(lock["nested_cycle311_N_i_only"], 2)
        self.assertEqual(lock["nested_cycle311_N_hapax_i_only"], 2)
        self.assertTrue(lock["nested_cycle311_extra_i_prev4_all_i_only"])
        self.assertEqual(lock["nested_cycle310_N_i_only"], 4)
        self.assertEqual(lock["nested_cycle310_N_leak_off_i"], 2)
        self.assertEqual(lock["nested_cycle310_N_extra_total"], 21)
        ...
        self.assertEqual(lock["nested_cycle297_K"], 2)
        ...
        self.assertTrue(lock["nested_cycle289_exactly_4_share_forward_020"])
        ...
        self.assertTrue(
            lock["i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020"]
        )
        self.assertEqual(
            lock["i_leftover_n4_remaining_090_076_remaining_after_600_exactly_4_share_forward_020"],
            STANDING_I_LEFTOVER_N4_REMAINING_090_076_REMAINING_AFTER_600_EXACTLY_4_SHARE_FORWARD_020,
        ...
        self.assertFalse(lock["same_as_cycle312"])
        self.assertTrue(lock["same_claim_shape_as_cycle289"])
        self.assertTrue(lock["same_claim_shape_as_cycle293"])
        self.assertTrue(lock["same_claim_shape_as_cycle297"])
        self.assertTrue(lock["same_claim_shape_as_cycle307"])
        self.assertTrue(lock["off_i_t_sites_are_not_this_cycle"])
        self.assertTrue(lock["do_not_relock_cycle289_exactly_4_share_next_020"])
        self.assertTrue(lock["do_not_relock_cycle295_remaining_after_087_next_057"])
        self.assertTrue(lock["do_not_lock_remaining_after_600_remaining_after_020_unique_next"])
        self.assertTrue(lock["do_not_relock_cycle312_unique_next"])
        self.assertTrue(lock["076_071_does_not_count"])
        self.assertTrue(lock["076_070_does_not_count"])
        self.assertTrue(lock["leftover_extra_does_not_count"])
        self.assertTrue(lock["leftover_n4_remaining_remaining_after_087_is_not_this_cycle"])
        self.assertTrue(lock["leftover_extra_remaining_after_009_extra_i_is_not_this_cycle"])
        self.assertTrue(lock["leftover_extra_remaining_after_000_extra_i_is_not_this_cycle"])
        self.assertTrue(lock["leftover_n4_set_not_retuned"])
        self.assertTrue(lock["leftover_extra_peels_not_retuned"])
        self.assertTrue(lock["raw_stems_999_kept"])
        self.assertTrue(
            lock["standing_i_leftover_n4_remaining_090_076_remaining_after_600_next_stem_unchanged"]
        )
        self.assertTrue(
            lock["standing_i_leftover_n4_remaining_090_076_remaining_after_600_extra_i_prev4_i_only_unchanged"]
        )
        self.assertTrue(
            lock["standing_i_leftover_n4_remaining_090_076_remaining_after_600_3grams_i_only_unchanged"]
        )
        self.assertTrue(
        ...
        self.assertTrue(
            lock["standing_i_leftover_n4_remaining_090_076_remaining_after_021_previous_600_unchanged"]
        )
        self.assertTrue(
        ...
        self.assertEqual(
            self.survey["i_leftover_n4_remaining_090_076_remaining_after_600_next_stem"][
                "cycle"
            ],
            312,
        )
        self.assertTrue(
            self.survey["i_leftover_n4_remaining_090_076_remaining_after_600_next_stem"][
                "i_leftover_n4_remaining_090_076_remaining_after_600_unique_next_stem"
            ]
        )
...
class TestMamariILeftoverN4Remaining090076RemainingAfter600Fwd020ImageSnapshot(
    unittest.TestCase
):
    """Cycle 313 does not touch clustering. 83/62 / Hamming 6 stays."""
