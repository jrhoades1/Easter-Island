"""I's leftover n=4 remaining remaining-after-090-076 remaining-after-430-076 remaining-after-076-020 remaining-after-076-010 leftover 4-gram previous-stem lock.

Cycle 345 text-search lock. Uses already-vendored A–V and the
...
pile at K=1 (760 / 720 / 460 / 295 / 177 / 076 / 071 / 048 /
022 / 002 / 000). G=760 largest-id labeling only. Nested
leftover 4-gram I-only stays nested. Cycle 344 HOLD: leftover
remaining-after-076-010 forward 5-grams (leftover 4-gram plus
next stem) are all I-only hapax 1/0 extra I=0 (N_i_only=11
N_leak=0). Nested leftover 4-gram I-only extra I=0 stays
nested. Forward 5-gram peel of remaining-after-076-010 leftover
4-grams is closed (next-stem hapax + all-I-only extra I=0).
Nested cycle 343 unique_max false stays nested. This cycle's
population is leftover matching sites of the five leftover
4-grams (11 sites). Previous stem = the token immediately
before each leftover 4-gram. Nested leftover 4-gram I-only
stays nested. Do not re-lock leftover 4-gram I-only, leftover
3-gram I-only, extra-I 4-gram I-only, unique next stem,
forward 5-grams I-only, or unique most frequent 2-gram inside
leftover 4-grams.

Already locked (record overlap only, do not re-lock): nested
cycle 344 leftover 4-gram forward 5-grams I-only HOLD hapax
11/0 extra I=0 stays nested. Cycle 343 unique next stem
unique_max false hapax pile stays nested. Cycle 342 extra-I
...
4-gram I-only HOLD extra I=0 stays nested. Cycle 339, 338,
337, 336, 335, 334, 333, 332, 331, 330, 329, 328, 222,
leftover n=4 remaining I 090 076 peels (288–327), leftover
extra 090 076 peels, cycles 220–221, cycle 223.

Same claim-shape as cycle 302 leftover n=4 remaining I
090 076 unique previous stem HOLD (G=021 K=5). Also analog
cycle 308 leftover n=4 remaining remaining-after-600 unique
previous stem LOSE (6 hapax G=999 K=1). Also analog cycle
319 leftover n=4 remaining 021 090 076 4-gram
999 021 090 076 unique previous stem LOSE (2-way hapax
720/076). Do not claim leftover previous 5-grams I-only or
exactly-K-share this cycle. Do not peel labeled G with
exactly-1-share (tautology of a hapax).

HOLD iff unique_max true: one previous stem G is strictly
more frequent than any other among leftover matching sites
that have a previous token. LOSE if unique_max false (tie or
hapax pile). G is largest-id labeling only on a tie; do not
treat labeled G as unique-max. Empty remainder would not lose
HOLD.
...
and one previous stem strictly outcounts every other among
sites that have a previous token, or N_with_prev==0. This can
lose the same way cycle 308 lost (hapax pile G=999 K=1) and
cycle 319 lost (2-way hapax 720/076), or hold the same way
cycle 302 held (G=021 K=5). Measured: N=11, N_with_prev=11,
N_no_prev=0, N_distinct=11, hapax pile 11-way tie at K=1,
G=700 by largest-id labeling only, unique-max false. Matching
site of labeled G: Ia1[63] (700 then 071 999 604 076).
N_without_G=10. Nested cycle 344 forward 5-grams I-only hapax
11/0 extra I=0, cycle 343 unique_max false 11-way hapax pile
G=760 K=1, cycle 342 extra-I 4-grams I-only hapax 10/0, cycle
341 leftover 3-grams I-only extra I=5, cycle 340 leftover
4-grams I-only extra I=0 leftover matching sites 11, and
cycle 339 unique_max false hapax pile stay nested. The claim
...
from tests.test_mamari_i_leftover_n4_remaining_021_090_076_999_021_090_076_prev_stem_scoreboard import (
    ...
    STANDING_N_HAPAX as CYCLE319_N_HAPAX,
    STANDING_N_LINE_INITIAL as CYCLE319_N_LINE_INITIAL,
    STANDING_N_WITH_PREVIOUS as CYCLE319_N_WITH_PREVIOUS,
    STANDING_TIED_STEMS as CYCLE319_TIED,
...
from tests.test_mamari_i_leftover_n4_remaining_090_076_previous_stem_scoreboard import (
    ...
    STANDING_N_WITH_PREVIOUS as CYCLE302_N_WITH_PREVIOUS,
...
from tests.test_mamari_i_leftover_n4_remaining_090_076_remaining_after_600_previous_stem_scoreboard import (
    ...
    STANDING_N_HAPAX as CYCLE308_N_HAPAX,
...
STANDING_LINE_INITIAL_SITES = STANDING_NO_PREV_SITES
...
STANDING_G_IS_LABELING_ONLY = True
STANDING_MATCHING_SITES = ((SIDE_IA, "Ia1", 63),)
STANDING_MATCHING_4GRAM = GRAM4_071
STANDING_MATCHING_PREVIOUS_5GRAMS = (("700", "071", "999", "604", "076"),)
...
STANDING_FREQUENCY = (
    ("700", 1, ((SIDE_IA, "Ia1", 63),), (("700", "071", "999", "604", "076"),)),
    ("600", 1, ((SIDE_IA, "Ia9", 32),), (("600", "700", "076", "076", "053"),)),
    ("430", 1, ((SIDE_IA, "Ia1", 136),), (("430", "028", "076", "011", "076"),)),
    ("202", 1, ((SIDE_IA, "Ia4", 125),), (("202", "028", "076", "011", "076"),)),
    ("150", 1, ((SIDE_IA, "Ia12", 119),), (("150", "202", "076", "006", "055"),)),
    ("087", 1, ((SIDE_IA, "Ia8", 167),), (("087", "700", "076", "076", "053"),)),
    ("076", 1, ((SIDE_IA, "Ia6", 48),), (("076", "202", "076", "006", "055"),)),
    ("070", 1, ((SIDE_IA, "Ia8", 30),), (("070", "076", "999", "029", "076"),)),
    ("065", 1, ((SIDE_IA, "Ia9", 3),), (("065", "071", "999", "604", "076"),)),
    ("027", 1, ((SIDE_IA, "Ia14", 78),), (("027", "028", "076", "011", "076"),)),
    ("000", 1, ((SIDE_IA, "Ia10", 144),), (("000", "076", "999", "029", "076"),)),
)
...
STANDING_I_LEFTOVER_N4_REMAINING_AFTER_090_076_REMAINING_AFTER_430_076_REMAINING_AFTER_076_020_REMAINING_AFTER_076_010_UNIQUE_PREVIOUS_STEM = (
    False
)
STANDING_RESULT = (
...
STANDING_SAME_AS_CYCLE319 = False
...
STANDING_SAME_CLAIM_SHAPE_AS_CYCLE319 = True
...
def site_previous_stem_before_4gram(
    stems: list[str],
    index: int,
    gram4: tuple[str, ...],
) -> str | None:
    """Previous stem before leftover 4-gram; None at line-initial or mismatch."""
...
def site_previous_5gram_before_4gram(
    ...
    """Previous stem plus leftover 4-gram; None at line-initial or mismatch."""
...
def leftover_4gram_previous_stems(
    ...
    """Per-site previous stem before each leftover matching 4-gram."""
    return tuple(
        site_previous_stem_before_4gram(line_stems_for_site(i_sides, site), site[2], gram)
        for site, gram in zip(sites, grams, strict=True)
    )


def leftover_4gram_previous_5grams(
    i_sides: dict[str, list[list[str]]],
    sites: tuple[tuple[str, str, int], ...] = STANDING_LEFTOVER_MATCHING_SITES,
    grams: tuple[tuple[str, ...], ...] = STANDING_LEFTOVER_MATCHING_4GRAMS,
) -> tuple[tuple[str, ...] | None, ...]:
    """Per-site previous stem plus leftover 4-gram."""
    return tuple(
...
def site_previous_3gram_before_4gram(
    stems: list[str],
    index: int,
    gram4: tuple[str, ...],
) -> tuple[str, ...] | None:
    """Previous stem plus first two leftover tokens; None at line-initial or mismatch."""
    prev = site_previous_stem_before_4gram(stems, index, gram4)
    if prev is None:
        return None
    return (prev,) + gram4[:2]
...
def leftover_4gram_previous_3grams(
    i_sides: dict[str, list[list[str]]],
    sites: tuple[tuple[str, str, int], ...] = STANDING_LEFTOVER_MATCHING_SITES,
    grams: tuple[tuple[str, ...], ...] = STANDING_LEFTOVER_MATCHING_4GRAMS,
) -> tuple[tuple[str, ...] | None, ...]:
    """Per-site previous stem plus first two leftover tokens."""
    return tuple(
        site_previous_3gram_before_4gram(line_stems_for_site(i_sides, site), site[2], gram)
        for site, gram in zip(sites, grams, strict=True)
    )
...
def leftover_4gram_sites_with_prev(
    ...
    """Leftover matching 4-gram sites that have a previous token."""
    return leftover_sites_with_previous(sites, previous_stems)


def leftover_4gram_sites_without_prev(
    sites: tuple[tuple[str, str, int], ...],
    previous_stems: tuple[str | None, ...],
) -> tuple[tuple[str, str, int], ...]:
    """Leftover matching 4-gram sites that are line-initial (no previous token)."""
...
def leftover_4gram_with_g(
    ...
    """Leftover matching 4-gram sites whose previous token is G."""
    return tuple(
        site
...
def leftover_4gram_without_g(
    ...
    """Leftover matching 4-gram sites whose previous token is not G."""
    return tuple(
        site
        for site, prev in zip(sites, previous_stems, strict=True)
...
def leftover_4gram_previous_stem_counts(previous_stems: tuple[str, ...]) -> Counter:
    """Counts of previous stems among leftover matching 4-gram sites with a previous token."""
    return Counter(previous_stems)


def rank_leftover_4gram_previous_stems(
    counts: Counter,
) -> tuple[tuple[str, int], ...]:
...
def select_leftover_4gram_previous_g(
    remaining_stems: tuple[str, ...],
) -> tuple[str | None, int, bool]:
    """Return (G, K, uniquely_most_frequent). Empty remainder has no G."""
    ranked = rank_leftover_4gram_previous_stems(
        leftover_4gram_previous_stem_counts(remaining_stems)
    )
    if not ranked:
        return (None, 0, False)
    gram, count = ranked[0]
...
def leftover_4gram_previous_stem_frequency_table(
    sites: tuple[tuple[str, str, int], ...],
    previous_stems: tuple[str | None, ...],
    ...
    """Previous-stem frequency: highest count first, then larger id."""
    with_prev = leftover_4gram_sites_with_prev(sites, previous_stems)
    with_prev_stems = tuple(prev for prev in previous_stems if prev is not None)
    with_prev_5 = tuple(gram for gram in previous_5grams if gram is not None)
    ranked = rank_leftover_4gram_previous_stems(
        leftover_4gram_previous_stem_counts(with_prev_stems)
    )
    rows = []
    for stem, count in ranked:
        stem_sites = tuple(
            site
            for site, prev in zip(with_prev, with_prev_stems, strict=True)
            if prev == stem
        )
        stem_grams = tuple(
            gram
            for prev, gram in zip(with_prev_stems, with_prev_5, strict=True)
            if prev == stem
        )
...
def leftover_4gram_previous_stem_frequency_rows(
    frequency: tuple[
        tuple[str, int, tuple[tuple[str, str, int], ...], tuple[tuple[str, ...], ...]],
        ...,
    ] = STANDING_FREQUENCY,
) -> list[dict]:
    """Survey-shaped previous-stem frequency rows."""
    return [
        {
            "previous_stem": stem,
            "count": count,
...
def leftover_4gram_previous_stem_nested_counts_hold(
    n_sites: int,
    n_with_prev: int,
    n_no_prev: int,
    expected_n: int = STANDING_N,
    expected_with_prev: int = STANDING_N_WITH_PREV,
    expected_no_prev: int = STANDING_N_NO_PREV,
) -> bool:
    """Nested leftover matching sites 11/11/0."""
    return (
        n_sites == expected_n
        and n_with_prev == expected_with_prev
        and n_no_prev == expected_no_prev
        and n_with_prev + n_no_prev == n_sites
    )


def i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_unique_previous_stem(
    sites: tuple[tuple[str, str, int], ...],
    previous_stems: tuple[str | None, ...],
    expected_n: int = STANDING_N,
) -> bool:
    """True iff leftover matching 4-grams have a unique most frequent previous stem.

    Empty remainder (no previous tokens) does not lose HOLD. A tie at max K,
    including a hapax pile, loses. Labeled G is not unique-max.
    """
    if len(sites) != expected_n or len(previous_stems) != expected_n:
        return False
    with_prev = tuple(prev for prev in previous_stems if prev is not None)
    if not with_prev:
        return True
    _gram, _count, unique = select_leftover_4gram_previous_g(with_prev)
    return bool(unique)


class TestILeftoverN4RemainingAfter090076RemainingAfter430076RemainingAfter076020RemainingAfter076010PrevStemHelpers(
    unittest.TestCase
):
    """Helpers on leftover remaining-after-076-010 4-gram previous stems. No CV, no LLM."""

    def test_previous_stem_is_token_immediately_before_leftover_4gram(self):
        """Previous stem is index-1; mismatch or line-initial is None."""
        provider = MockProvider()
        planted = ["700", "071", "999", "604", "076", "460"]
        self.assertEqual(
            site_previous_stem_before_4gram(planted, 1, GRAM4_071),
            "700",
        )
        self.assertEqual(
            site_previous_5gram_before_4gram(planted, 1, GRAM4_071),
            ("700", "071", "999", "604", "076"),
        )
        self.assertIsNone(
            site_previous_stem_before_4gram(["071", "999", "604", "076"], 0, GRAM4_071)
        )
        self.assertIsNone(
            site_previous_5gram_before_4gram(["071", "999", "604", "076"], 0, GRAM4_071)
        )
        mismatch = ["700", "090", "076", "604", "076"]
        self.assertIsNone(site_previous_stem_before_4gram(mismatch, 1, GRAM4_071))
        self.assertNotEqual(NEAR_MISS_090_076, GRAM4_071[:2])
        self.assertFalse(
            any(
        ...
        self.assertTrue(STANDING_UNIQUE_NEXT_STEM_IS_NOT_THIS_CYCLE)
        self.assertTrue(STANDING_FWD5_I_ONLY_IS_NOT_THIS_CYCLE)
    ...
    def test_unique_max_can_fail_and_empty_remainder_holds(self):
        ...
        self.assertEqual(select_leftover_4gram_previous_g(()), (None, 0, False))
        self.assertTrue(STANDING_EMPTY_REMAINDER_DOES_NOT_LOSE)
        all_one = ("700",) * STANDING_N
        self.assertTrue(
            i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_unique_previous_stem(
                sites,
                all_one,
        ...
        hold_g, hold_k, hold_unique = select_leftover_4gram_previous_g(all_one)
        self.assertEqual(hold_g, "700")
        self.assertEqual(hold_k, 11)
        self.assertTrue(hold_unique)
        two_way = ("700",) * 5 + ("600",) * 5 + ("000",)
        self.assertFalse(
            i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_unique_previous_stem(
                sites,
                two_way,
        ...
        tie_g, tie_k, tie_unique = select_leftover_4gram_previous_g(("700", "600", "700", "600"))
        self.assertEqual(tie_g, "700")
    ...
    def test_tie_break_picks_larger_barthel_id(self):
        """Equal leftover-4-gram previous counts pick the larger Barthel id."""
        provider = MockProvider()
        counts = Counter({"700": 1, "600": 1, "000": 1})
        ranked = rank_leftover_4gram_previous_stems(counts)
        self.assertEqual(ranked[0], ("700", 1))
        self.assertEqual(ranked[1], ("600", 1))
        self.assertEqual(ranked[-1], ("000", 1))
        self.assertEqual(select_leftover_4gram_previous_g(("600", "700"))[0], "700")
        self.assertFalse(select_leftover_4gram_previous_g(("600", "700"))[2])
        self.assertEqual(select_leftover_4gram_previous_g(("700", "700", "600"))[0], "700")
        self.assertTrue(select_leftover_4gram_previous_g(("700", "700", "600"))[2])
        self.assertTrue(STANDING_SAME_CLAIM_SHAPE_AS_CYCLE302)
        self.assertTrue(STANDING_SAME_CLAIM_SHAPE_AS_CYCLE308)
        self.assertTrue(STANDING_SAME_CLAIM_SHAPE_AS_CYCLE319)
        self.assertFalse(STANDING_SAME_AS_CYCLE302)
        self.assertFalse(STANDING_SAME_AS_CYCLE308)
        self.assertFalse(STANDING_SAME_AS_CYCLE319)
        ...
        self.assertFalse(CYCLE319_UNIQUE)
        self.assertFalse(CYCLE319_CLAIM)
        self.assertEqual(provider.get_call_history(), [])


class TestMamariILeftoverN4RemainingAfter090076RemainingAfter430076RemainingAfter076020RemainingAfter076010PrevStemScoreboard(
    unittest.TestCase
):
    """Cited-fixture remaining-after-076-010 leftover 4-gram previous-stem lock. Mock only."""
    ...
    def setUp(self):
        ...
        self.with_prev = leftover_4gram_sites_with_prev(self.sites, self.previous_stems)
        self.no_prev = leftover_4gram_sites_without_prev(self.sites, self.previous_stems)
        self.matching = leftover_4gram_with_g(self.sites, self.previous_stems)
        self.without = leftover_4gram_without_g(self.sites, self.previous_stems)
        self.frequency = leftover_4gram_previous_stem_frequency_table(
            self.sites,
            self.previous_stems,
            self.previous_5grams,
        )
        self.n_sites = len(self.sites)
        self.n_with_prev = len(self.with_prev)
        self.n_no_prev = len(self.no_prev)
        self.n_distinct = len(self.frequency)
        self.g, self.k, self.unique = select_leftover_4gram_previous_g(
            tuple(prev for prev in self.previous_stems if prev is not None)
        )
        self.n_without = len(self.without)
        self.claim_holds = i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_unique_previous_stem(
            self.sites,
            self.previous_stems,
        )
    ...
    def test_counts_11_sites_hapax_pile_g_700_k_1_and_hypothesis_loses(self):
        """N=11, N_with_prev=11, N_distinct=11, G=700 K=1 unique-max false. Claim loses."""
        self.assertEqual(self.n_sites, STANDING_N)
        self.assertEqual(STANDING_N, 11)
        self.assertEqual(self.previous_stems, STANDING_PREVIOUS_STEMS)
        self.assertTrue(
            leftover_4gram_previous_stem_nested_counts_hold(
                self.n_sites,
                self.n_with_prev,
                self.n_no_prev,
            )
        ...
        self.assertEqual(STANDING_NO_PREV_SITES, ())
        self.assertEqual(self.n_with_prev + self.n_no_prev, self.n_sites)
        self.assertEqual(11 + 0, 11)
        self.assertEqual(self.with_prev, self.sites)
        ...
        self.assertEqual(CYCLE302_N_WITH_PREVIOUS, 13)
        ...
        self.assertEqual(CYCLE308_N_HAPAX, 6)
        self.assertFalse(CYCLE308_UNIQUE)
        self.assertFalse(CYCLE308_CLAIM)
        self.assertEqual(CYCLE319_G, "720")
        self.assertEqual(CYCLE319_K, 1)
        self.assertEqual(CYCLE319_N, 2)
        self.assertEqual(CYCLE319_N_DISTINCT, 2)
        self.assertEqual(CYCLE319_N_HAPAX, 2)
        self.assertEqual(CYCLE319_N_WITH_PREVIOUS, 2)
        self.assertEqual(CYCLE319_N_LINE_INITIAL, 0)
        self.assertEqual(CYCLE319_TIED, ("720", "076"))
        self.assertFalse(CYCLE319_UNIQUE)
        self.assertFalse(CYCLE319_CLAIM)
        self.assertEqual(CYCLE171_GRAM2, ("076", "071"))
        self.assertEqual(self.provider.get_call_history(), [])

    def test_matching_labeled_g_is_ia1_700_labeling_only(self):
        """Labeled G=700 is Ia1[63] before 071 999 604 076. Labeling only."""
        self.assertEqual(self.matching, STANDING_MATCHING_SITES)
        self.assertEqual(STANDING_MATCHING_SITES, ((SIDE_IA, "Ia1", 63),))
        self.assertEqual(STANDING_MATCHING_4GRAM, GRAM4_071)
        matching_5 = leftover_4gram_previous_5grams(
            self.i_sides,
            self.matching,
            (STANDING_MATCHING_4GRAM,),
        )
        self.assertEqual(matching_5, STANDING_MATCHING_PREVIOUS_5GRAMS)
        self.assertEqual(STANDING_MATCHING_PREVIOUS_5GRAMS, (("700", "071", "999", "604", "076"),))
        site = self.matching[0]
        stems = line_stems_for_site(self.i_sides, site)
        index = site[2]
        self.assertEqual(tuple(stems[index : index + STANDING_N4]), GRAM4_071)
        self.assertEqual(site_previous_stem_before_4gram(stems, index, GRAM4_071), "700")
        self.assertEqual(
            site_previous_5gram_before_4gram(stems, index, GRAM4_071),
            ("700", "071", "999", "604", "076"),
        )
        self.assertEqual(stems[index - 1], "700")
        for site in self.without:
            stems = line_stems_for_site(self.i_sides, site)
            gram = STANDING_LEFTOVER_MATCHING_4GRAMS[self.sites.index(site)]
            prev = site_previous_stem_before_4gram(stems, site[2], gram)
            self.assertIsNotNone(prev)
            self.assertNotEqual(prev, "700")
    ...
    def test_nested_cycle344_343_342_341_340_339_still_hold_and_are_not_relocked(self):
        """Forward 5-grams / unique next / extra-I 4-grams / leftover 3-grams / leftover 4-grams / unique-max 2-gram stay."""
        self.assertTrue(CYCLE344_CLAIM)
        self.assertEqual(CYCLE344_N, 11)
        ...
        self.assertEqual(len(CYCLE344_SEQUENCES), 11)
        ...
        self.assertEqual(CYCLE343_N, 11)
        self.assertEqual(CYCLE343_N_WITH_NEXT, 11)
        self.assertEqual(CYCLE343_N_NO_NEXT, 0)
        self.assertEqual(CYCLE343_N_DISTINCT, 11)
        self.assertEqual(CYCLE343_N_HAPAX, 11)
        self.assertEqual(CYCLE343_N_WITHOUT_G, 10)
        self.assertEqual(CYCLE343_NEXT_STEMS[6], "760")
        self.assertEqual(CYCLE343_TIED_STEMS[0], "760")
    ...
    def test_existing_344_343_342_341_340_339_337_319_308_302_223_and_222_scoreboards_still_compute(self):
        """Cycle 344 hapax 11/0, 343 unique-max false, 342 hapax 10/0, 302/308/319 previous-stem stay."""
        ...
        self.assertEqual(CYCLE343_G, "760")
        self.assertEqual(CYCLE343_K, 1)
        if prior_343.claim_holds or CYCLE343_UNIQUE:
            self.fail("nested cycle 343 leftover remaining-after-076-010 unique next stem hapax pile G=760 K=1 drifted")
        prior_342 = (
            TestMamariILeftoverN4RemainingAfter090076RemainingAfter430076RemainingAfter076020RemainingAfter076010ExtraI4gramsIOnlyScoreboard()
        )
        prior_342.setUp()
        ...
        self.assertEqual(CYCLE319_G, "720")
        self.assertEqual(CYCLE319_K, 1)
        if prior_319.claim_holds or CYCLE319_UNIQUE:
            self.fail("nested cycle 319 leftover n=4 remaining 999 021 090 076 unique previous stem hapax 720/076 drifted")
        ...
        self.assertEqual(CYCLE308_G, "999")
        self.assertEqual(CYCLE308_K, 1)
        if prior_308.claim_holds or CYCLE308_UNIQUE:
            self.fail("nested cycle 308 leftover n=4 remaining remaining-after-600 unique previous stem hapax pile G=999 K=1 drifted")
        ...
        self.assertEqual(CYCLE302_G, "021")
        self.assertEqual(CYCLE302_K, 5)
        if not prior_302.claim_holds or CYCLE302_G != "021" or CYCLE302_K != 5:
            self.fail("nested cycle 302 leftover n=4 remaining unique previous stem G=021 K=5 drifted")
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-345 leftover 4-gram previous-stem lose."""
        lock = self.survey[STANDING_RESULT]
        self.assertEqual(lock["cycle"], 345)
        ...
        self.assertTrue(lock["G_is_labeling_only"])
        ...
        self.assertEqual(
            ...
            leftover_4gram_previous_stem_frequency_rows(),
        )
        self.assertEqual(lock["nested_cycle344_forward_5grams_all_i_only"], True)
        ...
        self.assertEqual(lock["nested_cycle343_unique_max"], False)
        ...
        self.assertFalse(lock["same_as_cycle319"])
        ...
        self.assertTrue(lock["same_claim_shape_as_cycle319"])
        ...
        self.assertTrue(lock["standing_i_leftover_n4_remaining_021_090_076_999_021_090_076_prev_stem_unchanged"])
        self.assertTrue(lock["standing_i_leftover_n4_remaining_090_076_remaining_after_600_previous_stem_unchanged"])
        ...
        prior_319 = self.survey["i_leftover_n4_remaining_021_090_076_999_021_090_076_prev_stem"]
        self.assertEqual(prior_319["cycle"], 319)
        self.assertFalse(prior_319["i_leftover_n4_remaining_021_090_076_999_021_090_076_unique_previous_stem"])
        self.assertEqual(prior_319["G"], "720")
        self.assertEqual(prior_319["K"], 1)
        prior_308 = self.survey["i_leftover_n4_remaining_090_076_remaining_after_600_previous_stem"]
        self.assertEqual(prior_308["cycle"], 308)
        self.assertFalse(prior_308["i_leftover_n4_remaining_090_076_remaining_after_600_unique_previous_stem"])
...
class TestMamariILeftoverN4RemainingAfter090076RemainingAfter430076RemainingAfter076020RemainingAfter076010PrevStemImageSnapshot(
    unittest.TestCase
):
    """Cycle 345 does not touch clustering. 83/62 / Hamming 6 stays."""
