...
contiguous hit once on I. Empty H/P/Q side, zero A/B/C leak.
...
from tests.test_mamari_i_leftover_n6_next3_closed_tradition_hpq_abc_scoreboard import (
    STANDING_NEXT_CHEAP_LOCK as CYCLE836_NAMED_NEXT,
...
class TestMamariILeftoverN6Next4ClosedTraditionHpqAbcScoreboard(unittest.TestCase):
    ...
    def test_prior_locks_stay_locked(self):
        ...
        self.assertEqual(next3["N_hpq_ge1"], 0)
        self.assertEqual(next3["hits_I"], 21)
        self.assertEqual(next3["next_cheap_lock"], STANDING_NAMED_BY_CYCLE836)
        self.assertEqual(STANDING_NAMED_BY_CYCLE836, CYCLE836_NAMED_NEXT)
    ...
    def test_next_cheap_lock_is_the_locked_cycle_473_next5_list(self):
        ...
        self.assertNotIn("i_leftover_n6_next5_closed_tradition_hpq_abc", self.survey)
        self.assertEqual(
            STANDING_NEXT_CHEAP_LOCK,
            "cycle473_next5_reframed_closed_tradition_hpq_ge1_exact0_abc",
        )
