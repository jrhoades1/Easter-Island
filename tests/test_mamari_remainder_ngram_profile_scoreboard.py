...
(Aa / C-absent here). Cycle 40 locks a 600 inventory
on the existing fixtures (hits, flanks, motif
membership, calendar window-adjacency). Image snapshot
stays 83/62 / Hamming 6.
