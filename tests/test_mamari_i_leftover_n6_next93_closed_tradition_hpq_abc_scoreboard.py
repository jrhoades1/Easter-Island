"""Reframed closed-tradition hold-out of the locked leftover-6 next-93 grams.

Cycle 926 text-search lock. Uses already-vendored A–V and the
cycle-649 leftover n=6 remaining remaining-after-090-076
remaining-after-430-076 remaining-after-076-020 remaining-
after-076-010 next 93-grams (12 sequences; parent N=18; six
holes at Ia10[144], Ia10[143], Ia10[142], Ia8[167], Ia8[166],
and Ia8[165]). HEAD-check: that gram list exists and is not yet
locked under this reframed rule. Cycle 649 already locked the
I-only claim on these 93-grams as incomplete-set LOSE
(N_with_next93=12, N_no_next93=6, N_i_only=12, N_leak=0). Cycle
925 already locked the reframed claim on the cycle-647 next-92
grams as incomplete-set LOSE. This cycle does not re-lock either
claim, and does not re-lock Cycles 832–925.

Claim that can lose: each existing next-93 gram is an exact
...
Named claim: cycle649_next93_reframed_closed_tradition_hpq_ge1_exact0_abc.

Measured on the 12 with-next93 grams: N=12, N_hpq_ge1=0,
N_hpq_ge2=0, N_exact0_abc=12, N_i_ge1=12, N_exact0_i=0,
N_leak=0, N_hold=0, hits_I=12. Parent N=18, N_with_next93=12,
N_no_next93=6 (Ia10[144], Ia10[143], Ia10[142], Ia8[167],
Ia8[166], Ia8[165]). Every scored gram is exact-0 on H/P/Q and
on A/B/C and an exact contiguous hit once on I. The next-92 hapax
604 076 071 600 999 050 076 000 002 999 076 092 535 999 208 076 532 244 999 090 076 057 600 700 076 076 053 177 700 076 057 741 430 076 532 200 059 076 074 379 002 076 244 280 001 076 532 071 065 071 999 700 076 480 600 005 076 420 519 999 006 076 073 430 076 006 006 040 999 002 076 240 382 999 076 053 472 021 386 076 001 037 150 076 001 526 383 076 280 472 790 076 at Ia9[9] extends
to 604 076 071 600 999 050 076 000 002 999 076 092 535 999 208 076 532 244 999 090 076 057 600 700 076 076 053 177 700 076 057 741 430 076 532 200 059 076 074 379 002 076 244 280 001 076 532 071 065 071 999 700 076 480 600 005 076 420 519 999 006 076 073 430 076 006 006 040 999 002 076 240 382 999 076 053 472 021 386 076 001 037 150 076 001 526 383 076 280 472 790 076 445 at Ia9[9]
and hits I once. All twelve next-92 grams extend; no new hole.
...
next 93-grams as a peel, next 94-grams as a peel, prev-184, or
next-185. The cycle-651 next-94 I-only list stays the named
...
from tests.test_mamari_i_leftover_n6_next92_closed_tradition_hpq_abc_scoreboard import (
    ...
    STANDING_NO_NEXT92_SITES as CYCLE925_NO_NEXT92_SITES,
    STANDING_RESULT as CYCLE925_RESULT,
    STANDING_SEQUENCES as CYCLE925_SEQUENCES,
    STANDING_SITES as CYCLE925_SITES,
...
from tests.test_mamari_i_leftover_n6_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_next93_i_only_scoreboard import (
    HYPOTHESIS_ALL_I_ONLY as CYCLE649_HYPOTHESIS_ALL_I_ONLY,
    STANDING_I_LEFTOVER_N6_REMAINING_AFTER_090_076_REMAINING_AFTER_430_076_REMAINING_AFTER_076_020_REMAINING_AFTER_076_010_NEXT93_I_ONLY as CYCLE649_ALL_I_ONLY_CLAIM,
    STANDING_LEFTOVER_MATCHING_NEXT93_SITES as CYCLE649_SITES,
    STANDING_N as CYCLE649_N,
    STANDING_N_I_EACH as CYCLE649_N_I_EACH,
    STANDING_N_I_ONLY as CYCLE649_N_I_ONLY,
    STANDING_N_LEAK as CYCLE649_N_LEAK,
    STANDING_N_NO_NEXT93 as CYCLE649_N_NO_NEXT93,
    STANDING_N_SEQUENCES as CYCLE649_N_SEQUENCES,
    STANDING_N_WITH_NEXT93 as CYCLE649_N_WITH_NEXT93,
    STANDING_NO_NEXT93_SITES as CYCLE649_NO_NEXT93_SITES,
    STANDING_RESULT as CYCLE649_RESULT,
...
STANDING_NO_NEXT93_SITES = CYCLE649_NO_NEXT93_SITES
STANDING_PARENT_COMPLETE = False
STANDING_HITS_EACH = (0, 0, 0, 0, 0, 0, 1)
STANDING_HITS = (STANDING_HITS_EACH,) * STANDING_N
STANDING_SITES = CYCLE649_SITES
STANDING_SEQUENCES = CYCLE649_SEQUENCES
...
STANDING_NEXT92_HAPAX_STILL_HAPAX = (3,)
STANDING_NEXT92_ALL_EXTEND = True
STANDING_HITS_H = 0
STANDING_HITS_P = 0
STANDING_HITS_Q = 0
STANDING_HITS_A = 0
...
STANDING_CLAIM = "leftover6_next93_reframed_closed_tradition_hpq_ge1_and_exact0_abc"
STANDING_RESULT = "i_leftover_n6_next93_closed_tradition_hpq_abc"
STANDING_AXIS = "closed-tradition-reframed"
STANDING_FROM_CYCLE = 649
STANDING_I_ONLY_ALREADY_LOCKED = True
STANDING_I_ONLY_CYCLE = 649
...
class TestMamariILeftoverN6Next93ClosedTraditionHpqAbcScoreboard(unittest.TestCase):
    """Cycle 926 reframed closed-tradition lock on the cycle-649 next-93 population."""
    ...
    def test_population_is_the_locked_cycle_649_next93_grams(self):
        """Twelve next-93 sequences and sites come from cycle 649. None invented."""
        self.assertEqual(len(STANDING_SEQUENCES), STANDING_N)
        self.assertEqual(len(STANDING_SITES), STANDING_N)
        self.assertEqual(STANDING_SEQUENCES, CYCLE649_SEQUENCES)
        self.assertEqual(STANDING_SITES, CYCLE649_SITES)
        self.assertEqual(CYCLE649_N, STANDING_N_PARENT)
        self.assertEqual(CYCLE649_N, 18)
        self.assertEqual(CYCLE649_N_SEQUENCES, 12)
        self.assertEqual(STANDING_N_WITH_NEXT93, CYCLE649_N_WITH_NEXT93)
        self.assertEqual(STANDING_N_NO_NEXT93, CYCLE649_N_NO_NEXT93)
        self.assertEqual(
            STANDING_NO_NEXT93_SITES,
            (
                ("Ia", "Ia10", 144),
                ("Ia", "Ia10", 143),
                ("Ia", "Ia10", 142),
        ...
        self.assertEqual(STANDING_NO_NEXT93_SITES, CYCLE925_NO_NEXT92_SITES)
        self.assertFalse(STANDING_PARENT_COMPLETE)
        self.assertTrue(CYCLE649_HYPOTHESIS_ALL_I_ONLY)
        self.assertFalse(CYCLE649_ALL_I_ONLY_CLAIM)
        self.assertEqual(CYCLE649_N_I_ONLY, 12)
        self.assertEqual(CYCLE649_N_LEAK, 0)
        self.assertEqual(STANDING_FROM_CYCLE, 649)
        ...
        for row, tokens, site in zip(self.rows, STANDING_SEQUENCES, STANDING_SITES, strict=True):
            ...
            self.assertEqual(len(row.tokens), 93)
        prior = self.survey[CYCLE649_RESULT]
        all_i_only_key = (
            "i_leftover_n6_remaining_after_090_076_remaining_after_430_076_"
            "remaining_after_076_020_remaining_after_076_010_next_93grams_all_i_only"
        )
        self.assertEqual(CYCLE649_RESULT, (
            "i_leftover_n6_remaining_after_090_076_remaining_after_430_076_"
            "remaining_after_076_020_remaining_after_076_010_next93_i_only"
        ))
        self.assertEqual(prior["cycle"], 649)
        ...
        self.assertFalse(prior[CYCLE649_RESULT])
        self.assertEqual(prior["N_i_only"], 12)
        self.assertEqual(prior["N_leak"], 0)
        self.assertEqual(prior["N_no_next93"], 6)
        self.assertEqual(prior["N_with_next93"], 12)
        self.assertNotIn(STANDING_NAMED_BY_CYCLE925, self.survey)
        self.assertEqual(self.provider.get_call_history(), [])

    def test_prior_locks_stay_locked(self):
        """Do not re-lock cycle 649 I-only or the cycle 832–925 boards."""
        ...
        self.assertEqual(STANDING_I_ONLY_CYCLE, 649)
    ...
    def test_measured_table_is_incomplete_set_lose(self):
        ...
        self.assertEqual(tuple(row.hits[-1] for row in self.rows), CYCLE649_N_I_EACH)
        self.assertEqual(CYCLE649_N_I_EACH, (1,) * STANDING_N)
        ...
        self.assertTrue(STANDING_NEXT92_ALL_EXTEND)
        for n92, n93, site92, site93 in zip(
            CYCLE925_SEQUENCES, STANDING_SEQUENCES, CYCLE925_SITES, STANDING_SITES, strict=True
        ):
            self.assertEqual(n93[:92], n92)
            self.assertEqual(site93, site92)
        still = self.rows[STANDING_NEXT92_HAPAX_STILL_HAPAX[0]]
        self.assertEqual(
            still.tokens,
            (
        ...
        self.assertEqual(still.tokens[:92], CYCLE925_SEQUENCES[3])
        self.assertEqual(CYCLE925_SITES[3], ("Ia", "Ia9", 9))
        ...
        self.assertIn(("Ia", "Ia10", 144), STANDING_NO_NEXT93_SITES)
        self.assertIn(("Ia", "Ia10", 143), STANDING_NO_NEXT93_SITES)
        self.assertIn(("Ia", "Ia10", 142), STANDING_NO_NEXT93_SITES)
        self.assertIn(("Ia", "Ia8", 167), STANDING_NO_NEXT93_SITES)
        self.assertIn(("Ia", "Ia8", 166), STANDING_NO_NEXT93_SITES)
        self.assertIn(("Ia", "Ia8", 165), STANDING_NO_NEXT93_SITES)
    ...
    def test_next_cheap_lock_is_the_locked_cycle_651_next94_list(self):
        """Cycle 651 next-94 I-only list stays locked. The claim name is not a survey key."""
        self.assertEqual(CYCLE651_N, 18)
        self.assertEqual(CYCLE651_N_SEQUENCES, 12)
        self.assertEqual(len(CYCLE651_SEQUENCES), 12)
        self.assertTrue(all(len(tokens) == 94 for tokens in CYCLE651_SEQUENCES))
        ...
        self.assertNotIn("i_leftover_n6_next94_closed_tradition_hpq_abc", self.survey)
        self.assertEqual(
            STANDING_NEXT_CHEAP_LOCK,
            "cycle651_next94_reframed_closed_tradition_hpq_ge1_exact0_abc",
        )
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-926 incomplete-set LOSE table."""
        lock = self.survey[STANDING_RESULT]
        self.assertEqual(lock["cycle"], 926)
        ...
        self.assertEqual(
            tuple(tuple(site) for site in lock["no_next93_sites"]),
            STANDING_NO_NEXT93_SITES,
        )
        ...
        self.assertEqual(
            tuple(lock["next92_hapax_still_hapax"]),
            STANDING_NEXT92_HAPAX_STILL_HAPAX,
        )
        self.assertTrue(lock["next92_all_extend"])
        self.assertEqual(lock["next92_all_extend"], STANDING_NEXT92_ALL_EXTEND)
