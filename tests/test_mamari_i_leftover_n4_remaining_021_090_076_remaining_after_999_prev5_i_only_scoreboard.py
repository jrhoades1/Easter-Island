...
previous-5-grams I-only lock.

Cycle 322 text-search lock. Uses already-vendored A–V and the
cycle-321 leftover n=4 remaining 021 090 076 remaining-after-999
previous-stem LOSE population (the cycle-305 hapax trio at
Ia4[117], Ia5[28], Ia6[78]; 090 at the named index). Does not
retune leftover n=4 remaining remaining-after-999 unique
previous stem (cycle 321 lost: unique_max false, G=075 K=1,
N_distinct=3, 3-way hapax pile), leftover n=4 remaining
999 021 090 076 unique previous stem (cycle 319 lost), leftover
n=4 remaining 999 021 090 076 previous 5-grams I-only (cycle
320 holds: hapax 2/0 extra I=0), leftover n=4 remaining
...
exactly 5 share previous 021 (cycle 303), leftover n=4 remaining
unique previous stem (cycle 302 G=021 K=5), leftover n=4
remaining remaining-after-020 next 087 (cycle 293), leftover
extra extra I of 090 076 087 (cycle 245), leftover n=4 remaining
remaining-after-011 (cycles 298–301), leftover extra remaining-
after-000 extra I (cycles 258/259), leftover n=4 remaining
remaining-after-600 (cycles 308–318), or leftover n=4 remaining
remaining-after-021 unique previous G=600 K=2 (cycles 306–307;
a different population, not previous-021). Does not vendor a
...
n=4 remaining I 090 076 previous-021 sites (cycle 303):
Ia4[117], Ia5[28], Ia6[78], Ia8[106], Ia13[17]. 3-gram
021 090 076 I-only 5/0 extra I=0 (cycle 304). Previous 4-grams
all I-only (cycle 305): 600/007/150 hapax 1/0;
999 021 090 076 2/0 not hapax at Ia8[106]/Ia13[17]. Cycle 319
LOSE: unique previous stem of that not-hapax pair is a 2-way
hapax pile. Cycle 320 HOLD: those previous 5-grams all I-only
hapax 2/0 extra I=0. That 999-pair previous direction is
exhausted. Cycle 321 LOSE: leftover n=4 remaining 021 090 076
remaining-after-999 unique previous stem is a 3-way hapax pile.
N=3, N_with_previous=3, N_line_initial=0, unique_max false,
G=075 (largest-id), K=1, N_distinct=3, histogram 075×1 /
071×1 / 070×1, N_remaining after peeling G=2. This cycle's
N=3 population is those three remaining-after-999 previous
5-grams: Ia4[117] 070 600 021 090 076; Ia5[28]
071 007 021 090 076; Ia6[78] 075 150 021 090 076.

Already locked on these three sites (record overlap only, do
not re-lock): leftover n=4 remaining remaining-after-020 next
087 (cycle 293): Ia4[117]/Ia5[28]/Ia6[78]. Cycle 245 extra I
of leftover extra 090 076 087 equals those 3 sites. Remaining-
after-021 / remaining-after-600 (cycles 306–318) is a different
population (not previous-021). Cycle 305 already locked the
nested previous 4-grams 600/007/150 021 090 076 as I-only
hapax; do not re-lock them.

Same claim-shape as cycle 320 leftover n=4 remaining
021 090 076 4-gram 999 021 090 076 previous 5-grams all I-only
hapax 2/0 extra I=0 HOLD after cycle 319 unique previous stem
LOSE, and cycle 309 leftover n=4 remaining remaining-after-600
previous 4-grams all I-only hapax 6/0 after cycle 308 unique
previous stem LOSE. Cycle 321 leftover n=4 remaining
remaining-after-999 unique-max lost N=3 K=1 3-way tie G=075;
do not lock "exactly 1 share previous 075" (tautology on a
hapax pile). Nested-check cycle 321 unique-max false, N=3,
K=1, N_distinct=3, G=075, cycle 305 4-grams I-only N_i_only=4
N_hapax=3 N_not_hapax=1 N_leak=0 (do not retune
224/288/293/302/303/304/305/319/320/321). Nested leftover n=4
remaining 13 / 4 / 9 / 3 / 6 / 2 / 4 / 2 / 2 still computes.
If a site is line-initial after 600/007/150 (hapax 4-gram with
no 5th token X), lock that as no previous 5-gram rather than
inventing one; that site then does not count as a 5-gram
hapax and the I-only-5-gram claim loses because the 5-gram
set is incomplete relative to N=3. Measure; do not assume
all three have a 5th token. Cycle 321 N_line_initial=0 so all
three should have a previous token. Do not peel a specific
previous-of-hapax-4gram stem this cycle. Do not re-lock cycle
321 unique previous stem, cycles 319–320 (999-pair), cycle
305 previous-4-grams I-only, cycle 304 3-gram 021 090 076
I-only, cycles 302–303 previous-021, cycle 293 next-087,
cycle 245 leftover extra 090 076 087, cycles 298–301
remaining-after-011, or cycles 306–318 remaining-after-021 /
remaining-after-600. Off-I T sites are this cycle only as
off-I of a leftover n=4 remaining remaining-after-999 previous
5-gram if they match.

Locks exact consecutive hits of each leftover n=4 remaining
021 090 076 remaining-after-999 previous 5-gram on tablet I
and on every other vendored tablet A–H and J–V. The three
5-grams: 070 600 021 090 076 at Ia4[117], 071 007 021 090 076
at Ia5[28], 075 150 021 090 076 at Ia6[78]. Do not assume
hapax; count each from fixtures. Hypothesis: all previous
5-grams of the N=3 sites are I-only. Measured: each N_I=1 at
the previous-5 start three tokens before the leftover 090;
all N_off_I=0; extra I of each 5-gram (I occurrences outside
this leftover n=4 remaining previous-021 remaining-after-999
trio) is 0; no site is line-initial (all three have a 5th
token). Claim that can lose:
i_leftover_n4_remaining_021_090_076_remaining_after_999_previous_5grams_all_i_only.
True iff N==3, the three sites still compute as the cycle-305
hapax 600/007/150 trio, every site has a previous 5-gram, and
every such 5-gram has N_I ≥ 1 and N_off_I = 0 (hapax 1/0
expected given K=1). This can lose if any leaks off I (same
shape as cycle 219 090 076 070 000 1/1 on T), if N != 3, if a
site is line-initial so the 5-gram set is incomplete relative
to N=3, or if the three sites no longer compute as the hapax
trio. Extra I ≠ 0 does not make the claim lose (still I-only);
still lock extra I. Leftover-extra / next-087 overlap does
not fail the I-only claim. Nested cycle 321 unique_max false
and cycle 305 4-gram I-only stay nested, not re-locked. The
claim is true. Nested leftover n=4 remaining 13 / 4 / 9 / 3 /
6 / 2 / 4 / 2 / 2, cycle 321 unique-max false G=075 K=1
N_distinct=3, cycle 320 5-grams I-only hapax 2/0 extra I=0,
cycle 319 unique-max false G=720 K=1 N_distinct=2, cycle 305
4-grams I-only N_not_hapax=1, cycle 304 5/0 extra I=0, cycle
303 K_021=5, cycle 302 unique-max true G=021 K=5, cycle 309
remaining-after-600 prev4 I-only hapax 6/0, cycle 293 K_087=3,
cycle 245 leftover extra 090 076 087 extra I=3, cycle 308
unique-max previous false G=999 K=1, cycle 288 unique-max
G=020 K=4 share-one lost, cycle 224 13/56, and cycle 223 69/3
stay. Do not assume hapax; measure. Do not retune.
...
from tests.test_mamari_i_leftover_n4_remaining_021_090_076_remaining_after_999_prev_stem_scoreboard import (
    ...
    STANDING_N_LINE_INITIAL as CYCLE321_N_LINE_INITIAL,
    STANDING_N_WITH_PREVIOUS as CYCLE321_N_WITH_PREVIOUS,
    STANDING_OVERLAP_CYCLE245_EXTRA_I as CYCLE321_OVERLAP_245,
    STANDING_OVERLAP_CYCLE293_NEXT_087 as CYCLE321_OVERLAP_293,
    STANDING_PREVIOUS_5GRAMS as CYCLE321_PREVIOUS_5GRAMS,
    STANDING_PREVIOUS_STEMS as CYCLE321_PREVIOUS_STEMS,
    STANDING_SITES as CYCLE321_SITES,
    leftover_n4_remaining_remaining_after_999_nested_counts_hold,
    leftover_n4_remaining_remaining_after_999_previous_5grams,
    leftover_n4_remaining_remaining_after_999_previous_stems,
    leftover_n4_remaining_remaining_after_999_sites,
    leftover_n4_remaining_remaining_after_999_without_previous,
    leftover_n4_remaining_remaining_after_999_with_previous,
    site_previous_5gram,
    site_previous_of_hapax_4gram_stem,
...
NEAR_MISS_999_090_076 = ("999", "090", "076")
...
STANDING_N = 3
STANDING_N_WITH_PREVIOUS = 3
STANDING_N_LINE_INITIAL = 0
STANDING_N_NO_PREVIOUS = 0
STANDING_N_5GRAMS = 3
STANDING_N_CONTINUING = 3
STANDING_SITES = CYCLE321_SITES
STANDING_PREVIOUS_STEMS = CYCLE321_PREVIOUS_STEMS
STANDING_PREVIOUS_4GRAMS = LOCKED_HAPAX_PREVIOUS_4GRAMS
STANDING_SEQUENCES = CYCLE321_PREVIOUS_5GRAMS
STANDING_PER_SITE_PREVIOUS_5GRAMS = CYCLE321_PREVIOUS_5GRAMS
STANDING_LINE_INITIAL_SITES = ()
STANDING_NO_PREVIOUS_SITES = ()
STANDING_CONTINUING_SITES = STANDING_SITES
STANDING_N_I_EACH = (1, 1, 1)
STANDING_N_ON_I_EACH = STANDING_N_I_EACH
STANDING_N_OFF_I_EACH = (0, 0, 0)
STANDING_N_EXTRA_EACH = (0, 0, 0)
STANDING_HAPAX_EACH = (True, True, True)
STANDING_I_ONLY_EACH = (True, True, True)
STANDING_I_SITES = (
    ((SIDE_IA, "Ia4", 114),),
    ((SIDE_IA, "Ia5", 25),),
    ((SIDE_IA, "Ia6", 75),),
)
STANDING_CYCLE305_4GRAM_SITES = (
    ((SIDE_IA, "Ia4", 115),),
    ((SIDE_IA, "Ia5", 26),),
    ((SIDE_IA, "Ia6", 76),),
)
...
STANDING_ROLES = (
    "leftover_n4_remaining_021_090_076_remaining_after_999_previous_5gram",
) * STANDING_N
STANDING_CYCLE293_NEXT_4GRAMS = CYCLE293_NEXT_4GRAMS
STANDING_IB_HITS = 0
STANDING_IB_SITES = ()
...
STANDING_ALL_HAVE_PREVIOUS_TOKEN = True
STANDING_ALL_HAVE_FIFTH_TOKEN = True
STANDING_KNOWN_DISTINCT = True
STANDING_NOT_ASSUMED_HAPAX = True
STANDING_HAPAX_NOT_REQUIRED = True
STANDING_OVERLAP_CYCLE245_EXTRA_I = CYCLE321_OVERLAP_245
STANDING_OVERLAP_CYCLE293_NEXT_087 = CYCLE321_OVERLAP_293
...
STANDING_I_LEFTOVER_N4_REMAINING_021_090_076_REMAINING_AFTER_999_PREVIOUS_5GRAMS_ALL_I_ONLY = (
    True
)
STANDING_RESULT = "i_leftover_n4_remaining_021_090_076_remaining_after_999_prev5_i_only"
...
STANDING_SAME_AS_CYCLE320 = False
STANDING_SAME_AS_CYCLE321 = False
STANDING_SAME_CLAIM_SHAPE_AS_CYCLE309 = True
STANDING_SAME_CLAIM_SHAPE_AS_CYCLE320 = True
STANDING_DO_NOT_PEEL_A_SPECIFIC_REMAINING_STEM = True
STANDING_DO_NOT_LOCK_EXACTLY_1_SHARE_PREVIOUS_075 = True
STANDING_DO_NOT_RELOCK_CYCLE321 = True
...
STANDING_OFF_I_T_SITES_ARE_THIS_CYCLE_ONLY_IF_MATCHING_5GRAM = True
STANDING_NESTED_LEFTOVER_N4_REMAINING = (13, 4, 9, 3, 6, 2, 4, 2, 2)


def previous_5gram_start_site(
    leftover_site: tuple[str, str, int],
) -> tuple[str, str, int] | None:
    """Previous 5-gram starts three tokens before leftover 090 076."""
    side, line, index = leftover_site
    if index < 3:
        return None
    return (side, line, index - 3)


def leftover_n4_remaining_090_076_site_for_5gram(
    site: tuple[str, str, int],
) -> tuple[str, str, int]:
    """090 076 starts three tokens after the previous-5 start."""
...
def extra_i_sites_of_5gram(
    ...
    leftover_trio: tuple[tuple[str, str, int], ...] = STANDING_SITES,
) -> tuple[tuple[str, str, int], ...]:
    """I 5-gram starts whose leftover 090-start is outside the N=3 trio."""
    leftover_set = set(leftover_trio)
    return tuple(
        site
        for site in i_sites
        if leftover_n4_remaining_090_076_site_for_5gram(site) not in leftover_set
    )
...
def i_leftover_n4_remaining_021_090_076_remaining_after_999_previous_5grams_all_i_only(
    n_population: int,
    n_5grams: int,
    n_line_initial: int,
    n_i: tuple[int, ...],
    ...
    """True iff N=3, complete 5-grams, all I-only.

    Loses if any 5-gram appears off I, if N != 3, if a site is
    line-initial so the 5-gram set is incomplete relative to N=3,
    or if the three sites no longer compute as the cycle-305
    hapax 600/007/150 trio. Extra I is recorded, not a lose
    condition. Hapax is not assumed; N_I may be greater than 1.
    """
    if sites != expected_sites:
        return False
    if n_population != expected_n:
        return False
    if n_5grams != expected_n:
        return False
    if n_line_initial != 0:
        return False
    if any(gram is None for gram in per_site_previous):
        return False
    if len(per_site_previous) != expected_n:
        return False
...
def site_row_as_survey(row: dict) -> dict:
    ...
    return {
        ...
        "line": row["line"],
        "index": row["index"],
        "tokens5": list(row["tokens5"]),
        "cycle305_4gram_site": list(row["cycle305_4gram_site"]),
        "cycle304_site": list(row["cycle304_site"]),
        "leftover_n4_remaining_090_076_site": list(
            row["leftover_n4_remaining_090_076_site"]
        ),
        "previous_of_hapax_4gram": row["previous_of_hapax_4gram"],
        "role": row["role"],
        "in_cycle321_n3": row["in_cycle321_n3"],
...
STANDING_SITE_ROWS = tuple(
    {
        ...
        "index": site[2] - 3,
        "tokens5": gram,
        "cycle305_4gram_site": (site[0], site[1], site[2] - 2),
        "cycle304_site": (site[0], site[1], site[2] - 1),
        "leftover_n4_remaining_090_076_site": site,
        "previous_of_hapax_4gram": gram[0],
        "role": STANDING_ROLES[0],
        "in_cycle321_n3": True,
    ...
    for site, gram in zip(STANDING_SITES, STANDING_SEQUENCES, strict=True)
)


class TestILeftoverN4Remaining021090076RemainingAfter999Prev5IOnlyHelpers(
    unittest.TestCase
):
    """Helpers on leftover n=4 remaining remaining-after-999 previous 5-grams."""

    def test_counts_require_consecutive_tokens(self):
        """Adjacent 5-gram counts; a gap is not a hit. Cycle-305 4-grams are not."""
        provider = MockProvider()
        self.assertEqual(STANDING_SEQUENCES[0], ("070", "600", "021", "090", "076"))
        self.assertEqual(STANDING_SEQUENCES[1], ("071", "007", "021", "090", "076"))
        self.assertEqual(STANDING_SEQUENCES[2], GRAM5_PREV_G)
        self.assertEqual(STANDING_SEQUENCES[2], ("075", "150", "021", "090", "076"))
        self.assertEqual(len(STANDING_SEQUENCES), STANDING_N)
        self.assertEqual(len(set(STANDING_SEQUENCES)), STANDING_N)
        self.assertEqual(STANDING_SEQUENCES, CYCLE321_PREVIOUS_5GRAMS)
        for gram, prev4 in zip(STANDING_SEQUENCES, LOCKED_HAPAX_PREVIOUS_4GRAMS, strict=True):
            self.assertEqual(gram[1:], prev4)
            self.assertEqual(gram[2:], GRAM3)
            self.assertEqual(gram[3:], GRAM2)
        ...
        overlap = [["070", "600", "021", "090", "076", "070", "600", "021", "090", "076"]]
        ...
        self.assertEqual(
            ngram_hit_count([list(NEAR_MISS_999_090_076)], STANDING_SEQUENCES[0]),
            0,
        )
        self.assertEqual(
            ngram_hit_count([list(NEAR_MISS_999_021_090_076)], STANDING_SEQUENCES[0]),
            0,
        )
        self.assertEqual(
            ngram_hit_count([list(NEAR_MISS_I_5GRAM)], STANDING_SEQUENCES[0]),
            0,
        )
        self.assertEqual(
            ngram_hit_count([list(LOCKED_HAPAX_PREVIOUS_4GRAMS[0])], STANDING_SEQUENCES[0]),
            0,
        )
        has_070 = ["070", "600", "021", "090", "076"]
        self.assertEqual(site_previous_of_hapax_4gram_stem(has_070, 3), "070")
        self.assertEqual(site_previous_5gram(has_070, 3), STANDING_SEQUENCES[0])
        self.assertEqual(
            site_previous_4gram(has_070, 3, GRAM2), LOCKED_HAPAX_PREVIOUS_4GRAMS[0]
        )
        self.assertEqual(site_previous_stem(has_070, 3, GRAM2), "021")
        no_prev = ["600", "021", "090", "076"]
        self.assertEqual(
            site_previous_4gram(no_prev, 2, GRAM2), LOCKED_HAPAX_PREVIOUS_4GRAMS[0]
        )
        self.assertIsNone(site_previous_of_hapax_4gram_stem(no_prev, 2))
        ...
        self.assertTrue(STANDING_CYCLE321_UNIQUE_MAX_IS_NOT_THIS_CYCLE)
        self.assertEqual(provider.get_call_history(), [])

    def test_all_i_only_requires_zero_off_i_and_complete_n3(self):
        """Boolean is True only when N=3, complete 5-grams, all I-only."""
        provider = MockProvider()
        hold_ones = STANDING_N_I_EACH
        hold_zeros = STANDING_N_OFF_I_EACH
        hold_prev = STANDING_PER_SITE_PREVIOUS_5GRAMS
        self.assertTrue(
            i_leftover_n4_remaining_021_090_076_remaining_after_999_previous_5grams_all_i_only(
                3, 3, 0, hold_ones, hold_zeros, hold_prev
            )
        )
        self.assertTrue(STANDING_HAPAX_NOT_REQUIRED)
        self.assertTrue(STANDING_NOT_ASSUMED_HAPAX)
        self.assertEqual(STANDING_HAPAX_EACH, (True, True, True))
        leak_off = (0, 0, 1)
        self.assertFalse(
            i_leftover_n4_remaining_021_090_076_remaining_after_999_previous_5grams_all_i_only(
                3, 3, 0, hold_ones, leak_off, hold_prev
            )
        )
        self.assertFalse(
            i_leftover_n4_remaining_021_090_076_remaining_after_999_previous_5grams_all_i_only(
                2, 2, 0, hold_ones[:2], hold_zeros[:2], hold_prev[:2]
            )
        )
        self.assertFalse(
            i_leftover_n4_remaining_021_090_076_remaining_after_999_previous_5grams_all_i_only(
                3, 2, 1, hold_ones, hold_zeros, hold_prev[:-1] + (None,)
            )
        )
        shared_ok = (2, 1, 1)
        self.assertTrue(
            i_leftover_n4_remaining_021_090_076_remaining_after_999_previous_5grams_all_i_only(
                3, 3, 0, shared_ok, hold_zeros, hold_prev
            )
        )
        wrong_sites = ((SIDE_IA, "Ia8", 106), (SIDE_IA, "Ia13", 17), (SIDE_IA, "Ia4", 117))
        self.assertFalse(
            i_leftover_n4_remaining_021_090_076_remaining_after_999_previous_5grams_all_i_only(
                3, 3, 0, hold_ones, hold_zeros, hold_prev, sites=wrong_sites
            )
        )
        self.assertTrue(sequence_is_i_only(1, 0))
        self.assertTrue(sequence_is_hapax_i_only(1, 0))
        self.assertFalse(sequence_is_hapax_i_only(2, 0))
        self.assertFalse(sequence_is_i_only(1, 1))
        self.assertEqual(leaking_5grams(STANDING_SEQUENCES, hold_zeros), ())
        self.assertEqual(
            leaking_5grams(STANDING_SEQUENCES, leak_off),
            (STANDING_SEQUENCES[2],),
        )
    ...
    def test_5grams_are_cycle_321_population_not_retuned(self):
        """5-grams stay the cycle-321 leftover n=4 remaining remaining-after-999 trio."""
        provider = MockProvider()
        ...
        self.assertEqual(LOCKED_HAPAX_PREVIOUS_4GRAMS[1], ("007", "021", "090", "076"))
        self.assertEqual(LOCKED_HAPAX_PREVIOUS_4GRAMS[2], ("150", "021", "090", "076"))
        self.assertEqual(STANDING_SITES, CYCLE321_SITES)
        self.assertEqual(
            STANDING_SITES,
            ((SIDE_IA, "Ia4", 117), (SIDE_IA, "Ia5", 28), (SIDE_IA, "Ia6", 78)),
        )
        self.assertEqual(STANDING_SEQUENCES, CYCLE321_PREVIOUS_5GRAMS)
        self.assertEqual(STANDING_PREVIOUS_STEMS, CYCLE321_PREVIOUS_STEMS)
        self.assertEqual(CYCLE321_G, "075")
        self.assertEqual(CYCLE321_K, 1)
        self.assertFalse(CYCLE321_UNIQUE)
        self.assertFalse(CYCLE321_CLAIM)
        self.assertNotEqual(STANDING_SEQUENCES[0], GRAM5)
        self.assertEqual(GRAM5, ("999", "071", "076", "010", "079"))
        for site, gram, prev4 in zip(
            STANDING_SITES, STANDING_SEQUENCES, LOCKED_HAPAX_PREVIOUS_4GRAMS, strict=True
        ):
            start = previous_5gram_start_site(site)
            self.assertIsNotNone(start)
            self.assertEqual(start[2], site[2] - 3)
            self.assertEqual(leftover_n4_remaining_090_076_site_for_5gram(start), site)
            self.assertEqual(gram[1:], prev4)
            self.assertTrue(is_contiguous_substring(prev4, gram))
            self.assertTrue(is_contiguous_substring(GRAM3, gram))
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLE321)
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLES_319_320)
        ...
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLE293)
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLE245)
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLES_298_301)
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLES_306_318)
        self.assertTrue(STANDING_SAME_CLAIM_SHAPE_AS_CYCLE320)
        self.assertTrue(STANDING_SAME_CLAIM_SHAPE_AS_CYCLE309)
        self.assertFalse(STANDING_SAME_AS_CYCLE321)
        self.assertFalse(STANDING_SAME_AS_CYCLE320)
        self.assertFalse(STANDING_SAME_AS_CYCLE305)
        self.assertFalse(STANDING_SAME_AS_CYCLE309)
        self.assertFalse(STANDING_SAME_AS_I_5GRAM)
        self.assertEqual(len(STANDING_SEQUENCES[0]), STANDING_N5)
        self.assertLess(STANDING_N5, 8)
        self.assertEqual(provider.get_call_history(), [])


class TestMamariILeftoverN4Remaining021090076RemainingAfter999Prev5IOnlyScoreboard(
    unittest.TestCase
):
    """Cited-fixture leftover n=4 remaining remaining-after-999 previous-5 I-only lock."""
    ...
    def setUp(self):
        ...
        self.previous_stems = leftover_n4_remaining_remaining_after_999_previous_stems(
            self.i_sides,
            self.sites,
        )
        self.previous_5grams = leftover_n4_remaining_remaining_after_999_previous_5grams(
            self.i_sides,
            self.sites,
        )
        self.with_previous = leftover_n4_remaining_remaining_after_999_with_previous(
            self.sites,
            self.previous_stems,
        )
        self.line_initial = leftover_n4_remaining_remaining_after_999_without_previous(
            self.sites,
            self.previous_stems,
        )
        ...
        self.extra_each = tuple(
            extra_i_sites_of_5gram(sites, self.sites) for sites in self.i_sites
        )
        self.extra = tuple(
            site for extra in self.extra_each for site in extra
        )
        self.n_i_only = sum(
            1
        ...
        self.n_not_hapax = sum(
            1
            for on, off in zip(self.n_i, self.n_off_i, strict=True)
            if sequence_is_i_only(on, off) and not sequence_is_hapax_i_only(on, off)
        )
        self.n_leak_off_i = sum(1 for off in self.n_off_i if off)
        self.leaking = leaking_5grams(self.grams, self.n_off_i)
    ...
    def test_tokens_and_sites_are_cycle_321_population_not_retuned(self):
        """5-grams stay the cycle-321 N=3 trio; cycle 305/304 stay nested."""
        self.assertEqual(GRAM2, ("090", "076"))
        self.assertEqual(GRAM3, ("021", "090", "076"))
        self.assertEqual(LOCKED_HAPAX_PREVIOUS_4GRAMS[0], ("600", "021", "090", "076"))
        self.assertEqual(GRAM5, ("999", "071", "076", "010", "079"))
        ...
        self.assertEqual(self.previous_5grams, STANDING_PER_SITE_PREVIOUS_5GRAMS)
        self.assertEqual(self.previous_5grams, CYCLE321_PREVIOUS_5GRAMS)
        ...
        self.assertEqual(len(self.with_previous), STANDING_N_5GRAMS)
        self.assertEqual(STANDING_N_5GRAMS, 3)
        ...
        if self.sites != CYCLE321_SITES:
            self.fail("leftover n=4 remaining remaining-after-999 trio drifted")
        if any(gram is None for gram in self.previous_5grams):
            self.fail("a leftover remaining-after-999 site has no previous 5-gram")
        prior_321 = self.survey[
            "i_leftover_n4_remaining_021_090_076_remaining_after_999_prev_stem"
        ]
        self.assertEqual(prior_321["cycle"], 321)
        self.assertEqual(prior_321["N"], 3)
        self.assertEqual(prior_321["G"], "075")
        self.assertEqual(prior_321["K"], 1)
        self.assertFalse(prior_321["G_uniquely_most_frequent"])
        self.assertFalse(
            prior_321["i_leftover_n4_remaining_021_090_076_remaining_after_999_unique_previous_stem"]
        )
        self.assertEqual(
            [list(gram) for gram in STANDING_SEQUENCES],
            prior_321["previous_5grams"],
        )
        prior_320 = self.survey[
            "i_leftover_n4_remaining_021_090_076_999_021_090_076_prev5_i_only"
        ]
        self.assertEqual(prior_320["cycle"], 320)
        self.assertEqual(prior_320["N_i_only"], 2)
        self.assertEqual(prior_320["N_hapax_i_only"], 2)
        self.assertEqual(prior_320["N_leak_off_i"], 0)
        self.assertTrue(
            prior_320["i_leftover_n4_remaining_021_090_076_999_021_090_076_previous_5grams_all_i_only"]
        )
        ...
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLE321)
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLE305)
        self.assertTrue(STANDING_DO_NOT_LOCK_EXACTLY_1_SHARE_PREVIOUS_075)
        self.assertEqual(self.provider.get_call_history(), [])

    def test_all_5grams_are_i_only_hapax_and_claim_holds(self):
        """N_i_only=3 / N_hapax_i_only=3 / N_not_hapax=0 / N_leak_off_i=0. Claim holds."""
        ...
        self.assertEqual(self.extra_each, STANDING_EXTRA_I_SITES_EACH)
        self.assertEqual(STANDING_IB_HITS, 0)
        self.assertEqual(STANDING_OFF_I_TABLETS_WITH_HITS, ())
        for site, gram, prev, prev4 in zip(
            STANDING_SITES,
            STANDING_SEQUENCES,
            ...
            self.assertEqual(site_previous_5gram(stems, site[2]), gram)
            self.assertEqual(site_previous_of_hapax_4gram_stem(stems, site[2]), prev)
            self.assertEqual(site_previous_4gram(stems, site[2], GRAM2), prev4)
        ...
        self.assertEqual(self.forward_4grams, STANDING_CYCLE293_NEXT_4GRAMS)
        for (_site, prev4, nxt4), want_prev, want_fwd in zip(
            self.local_4grams,
            STANDING_PREVIOUS_4GRAMS,
            STANDING_CYCLE293_NEXT_4GRAMS,
            strict=True,
        ):
            self.assertEqual(prev4, want_prev)
            self.assertEqual(nxt4, want_fwd)
        self.assertTrue(STANDING_NOT_ASSUMED_HAPAX)
        self.assertTrue(STANDING_HAPAX_NOT_REQUIRED)
        ...
        for row in STANDING_SITE_ROWS:
            ...
            self.assertTrue(row["in_cycle321_n3"])
    ...
    def test_nested_overlap_recorded_does_not_lose(self):
        """Next-087 / leftover-extra overlap recorded; I-only does not fail."""
    ...
    def test_existing_321_320_305_304_309_293_245_308_224_223_still_compute(self):
        """Cycle 321 unique-max lose, 320 5-grams I-only, 305 4-grams, 304 5/0, analogs stay."""
        ...
        self.assertEqual(CYCLE321_N_LINE_INITIAL, 0)
        self.assertEqual(CYCLE321_N_WITH_PREVIOUS, 3)
        if (
            prior_321.n != 3
            or prior_321.k != 1
            or prior_321.g != "075"
            or prior_321.unique
            or prior_321.n_distinct != 3
        ):
            self.fail(
                "nested cycle 321 unique-max false N=3 K=1 G=075 N_distinct=3 drifted"
            )
        ...
        if prior_320.n_i_only != 2 or prior_320.n_leak_off_i != 0:
            self.fail("nested cycle 320 leftover n=4 remaining 999 prev5 I-only hapax 2/0 drifted")
        ...
        unused_304_extra = CYCLE304_N_EXTRA
        self.assertEqual(unused_304_extra, 0)
        unused_gram5 = GRAM5
        self.assertEqual(len(unused_gram5), 5)
        self.assertEqual(self.provider.get_call_history(), [])

    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-322 leftover n=4 remaining remaining-after-999 prev5 I-only lock."""
        lock = self.survey[
            "i_leftover_n4_remaining_021_090_076_remaining_after_999_prev5_i_only"
        ]
        self.assertEqual(lock["cycle"], 322)
        ...
        self.assertEqual(tuple(lock["backward_3gram"]), GRAM3)
        ...
        self.assertEqual(
            tuple(
                tuple(row)
                for row in lock["leftover_n4_remaining_021_090_076_remaining_after_999_sites"]
            ),
            STANDING_SITES,
        )
        self.assertEqual(
            tuple(lock["previous_of_hapax_4gram_stems"]),
            STANDING_PREVIOUS_STEMS,
        )
        self.assertEqual(
        ...
        self.assertEqual(lock["N_with_previous"], 3)
        ...
        self.assertEqual(lock["N_5grams"], 3)
        self.assertEqual(lock["N_continuing"], STANDING_N_CONTINUING)
        self.assertEqual(lock["N_distinct_5grams"], STANDING_N)
        self.assertTrue(lock["all_have_previous_token"])
        self.assertTrue(lock["all_have_fifth_token"])
        self.assertTrue(lock["not_assumed_hapax"])
        self.assertTrue(lock["hapax_not_required"])
        rows = lock["sequences"]
        self.assertEqual(len(rows), STANDING_N)
        for row, gram, site, prev, role, sites, cycle305, cycle304, leftover, n_on, n_off, hapax, extra, hits in zip(
            rows,
            STANDING_SEQUENCES,
            STANDING_SITES,
            STANDING_PREVIOUS_STEMS,
            ...
            self.assertEqual(tuple(row["cycle321_site"]), site)
            self.assertEqual(
                tuple(tuple(site_row) for site_row in row["cycle305_4gram_sites"]),
                cycle305,
            )
            self.assertEqual(
                tuple(tuple(site_row) for site_row in row["cycle304_sites"]),
                cycle304,
            )
            self.assertEqual(
            ...
            self.assertEqual(row["previous_of_hapax_4gram"], prev)
            ...
            self.assertEqual(row["N_off_I"], 0)
            self.assertEqual(row["N_extra"], extra)
            self.assertEqual(row["N_extra"], 0)
        ...
        self.assertEqual(
            [list(gram) for gram in STANDING_PER_SITE_PREVIOUS_5GRAMS],
            lock["per_site_previous_5grams"],
        )
        self.assertEqual(
            [list(gram) for gram in STANDING_CYCLE293_NEXT_4GRAMS],
            lock["remaining_after_020_next_087_forward_4grams"],
        )
        ...
        self.assertEqual(lock["nested_cycle321_N_line_initial"], 0)
        self.assertFalse(lock["nested_cycle321_G_uniquely_most_frequent"])
        self.assertFalse(lock["nested_cycle321_unique_previous_stem"])
        ...
        self.assertFalse(lock["same_as_cycle320"])
        self.assertFalse(lock["same_as_cycle321"])
        self.assertTrue(lock["same_claim_shape_as_cycle309"])
        self.assertTrue(lock["same_claim_shape_as_cycle320"])
        self.assertTrue(lock["do_not_peel_a_specific_remaining_stem"])
        self.assertTrue(lock["do_not_lock_exactly_1_share_previous_075"])
        self.assertTrue(lock["do_not_relock_cycle321"])
        ...
        self.assertTrue(lock["off_i_t_sites_are_this_cycle_only_if_matching_5gram"])
        ...
        self.assertEqual(
            self.survey["i_leftover_n4_remaining_021_090_076_remaining_after_999_prev_stem"]["cycle"],
            321,
        )
        self.assertFalse(
            self.survey["i_leftover_n4_remaining_021_090_076_remaining_after_999_prev_stem"][
                "i_leftover_n4_remaining_021_090_076_remaining_after_999_unique_previous_stem"
            ]
        )
        self.assertEqual(
            self.survey["i_leftover_n4_remaining_021_090_076_999_021_090_076_prev5_i_only"]["cycle"],
            320,
        )
        self.assertTrue(
            self.survey["i_leftover_n4_remaining_021_090_076_999_021_090_076_prev5_i_only"][
                "i_leftover_n4_remaining_021_090_076_999_021_090_076_previous_5grams_all_i_only"
            ]
        )
...
class TestMamariILeftoverN4Remaining021090076RemainingAfter999Prev5IOnlyImageSnapshot(
    unittest.TestCase
):
    """Cycle 322 does not touch clustering. 83/62 / Hamming 6 stays."""
