"""Reframed closed-tradition hold-out of the locked leftover-6 next-38 grams.

Cycle 871 text-search lock. Uses already-vendored A–V and the
cycle-539 leftover n=6 remaining remaining-after-090-076
remaining-after-430-076 remaining-after-076-020 remaining-
after-076-010 next 38-grams (15 sequences; parent N=18; three
line-final holes at Ia8[167], Ia8[166], and Ia8[165]).
HEAD-check: that gram list exists and is not yet locked under
this reframed rule. Cycle 539 already locked the I-only claim
on these 38-grams as incomplete-set LOSE (N_with_next38=15,
N_no_next38=3, N_i_only=15, N_leak=0). Cycle 870 already locked
the reframed claim on the cycle-537 next-37 grams as
incomplete-set LOSE. This cycle does not re-lock either claim,
and does not re-lock Cycles 832–870.

Claim that can lose: each existing next-38 gram is an exact
...
Named claim: cycle539_next38_reframed_closed_tradition_hpq_ge1_exact0_abc.

Measured on the 15 with-next38 grams: N=15, N_hpq_ge1=0,
N_hpq_ge2=0, N_exact0_abc=15, N_i_ge1=15, N_exact0_i=0,
N_leak=0, N_hold=0, hits_I=15. Parent N=18, N_with_next38=15,
N_no_next38=3 (Ia8[167], Ia8[166], Ia8[165]). Every scored gram
is exact-0 on H/P/Q and on A/B/C and an exact contiguous hit
once on I. The next-37 hapax 604 076 071 600 999 050 076 000
002 999 076 092 535 999 208 076 532 244 999 090 076 057 600 700
076 076 053 177 700 076 057 741 430 076 532 200 059 extends to
...
430 076 532 200 059 076 at Ia9[9] and hits I once. All fifteen
next-37 grams extend; no new hole. Verdict: incomplete-set LOSE.
...
next 38-grams as a peel, next 39-grams as a peel, prev-184, or
next-185. The cycle-541 next-39 I-only list stays the named
...
from tests.test_mamari_i_leftover_n6_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_next38_i_only_scoreboard import (
    HYPOTHESIS_ALL_I_ONLY as CYCLE539_HYPOTHESIS_ALL_I_ONLY,
    STANDING_I_LEFTOVER_N6_REMAINING_AFTER_090_076_REMAINING_AFTER_430_076_REMAINING_AFTER_076_020_REMAINING_AFTER_076_010_NEXT38_I_ONLY as CYCLE539_ALL_I_ONLY_CLAIM,
    STANDING_LEFTOVER_MATCHING_NEXT38_SITES as CYCLE539_SITES,
    STANDING_N as CYCLE539_N,
    STANDING_N_I_EACH as CYCLE539_N_I_EACH,
    STANDING_N_I_ONLY as CYCLE539_N_I_ONLY,
    STANDING_N_LEAK as CYCLE539_N_LEAK,
    STANDING_N_NO_NEXT38 as CYCLE539_N_NO_NEXT38,
    STANDING_N_SEQUENCES as CYCLE539_N_SEQUENCES,
    STANDING_N_WITH_NEXT38 as CYCLE539_N_WITH_NEXT38,
    STANDING_NO_NEXT38_SITES as CYCLE539_NO_NEXT38_SITES,
    STANDING_RESULT as CYCLE539_RESULT,
...
from tests.test_mamari_i_leftover_n6_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_next39_i_only_scoreboard import (
    HYPOTHESIS_ALL_I_ONLY as CYCLE541_HYPOTHESIS_ALL_I_ONLY,
    STANDING_I_LEFTOVER_N6_REMAINING_AFTER_090_076_REMAINING_AFTER_430_076_REMAINING_AFTER_076_020_REMAINING_AFTER_076_010_NEXT39_I_ONLY as CYCLE541_ALL_I_ONLY_CLAIM,
    ...
    STANDING_N_SEQUENCES as CYCLE541_N_SEQUENCES,
    STANDING_N_WITH_NEXT39 as CYCLE541_N_WITH_NEXT39,
    STANDING_NO_NEXT39_SITES as CYCLE541_NO_NEXT39_SITES,
    STANDING_RESULT as CYCLE541_RESULT,
...
STANDING_NO_NEXT38_SITES = CYCLE539_NO_NEXT38_SITES
STANDING_PARENT_COMPLETE = False
STANDING_HITS_EACH = (0, 0, 0, 0, 0, 0, 1)
STANDING_HITS = (STANDING_HITS_EACH,) * STANDING_N
STANDING_SITES = CYCLE539_SITES
STANDING_SEQUENCES = CYCLE539_SEQUENCES
...
STANDING_NEXT37_HAPAX_STILL_HAPAX = (3,)
STANDING_NEXT37_ALL_EXTEND = True
STANDING_HITS_H = 0
STANDING_HITS_P = 0
STANDING_HITS_Q = 0
STANDING_HITS_A = 0
...
STANDING_CLAIM = "leftover6_next38_reframed_closed_tradition_hpq_ge1_and_exact0_abc"
STANDING_RESULT = "i_leftover_n6_next38_closed_tradition_hpq_abc"
STANDING_AXIS = "closed-tradition-reframed"
STANDING_FROM_CYCLE = 539
STANDING_I_ONLY_ALREADY_LOCKED = True
STANDING_I_ONLY_CYCLE = 539
...
STANDING_DO_NOT_RELOCK_CYCLES_832_870 = True
...
class TestMamariILeftoverN6Next38ClosedTraditionHpqAbcScoreboard(unittest.TestCase):
    """Cycle 871 reframed closed-tradition lock on the cycle-539 next-38 population."""
    ...
    def test_population_is_the_locked_cycle_539_next38_grams(self):
        """Fifteen next-38 sequences and sites come from cycle 539. None invented."""
        self.assertEqual(len(STANDING_SEQUENCES), STANDING_N)
        self.assertEqual(len(STANDING_SITES), STANDING_N)
        self.assertEqual(STANDING_SEQUENCES, CYCLE539_SEQUENCES)
        self.assertEqual(STANDING_SITES, CYCLE539_SITES)
        self.assertEqual(CYCLE539_N, STANDING_N_PARENT)
        self.assertEqual(CYCLE539_N, 18)
        self.assertEqual(CYCLE539_N_SEQUENCES, 15)
        self.assertEqual(STANDING_N_WITH_NEXT38, CYCLE539_N_WITH_NEXT38)
        self.assertEqual(STANDING_N_NO_NEXT38, CYCLE539_N_NO_NEXT38)
        self.assertEqual(
            STANDING_NO_NEXT38_SITES,
            (("Ia", "Ia8", 167), ("Ia", "Ia8", 166), ("Ia", "Ia8", 165)),
        )
        self.assertEqual(STANDING_NO_NEXT38_SITES, CYCLE870_NO_NEXT37_SITES)
        self.assertFalse(STANDING_PARENT_COMPLETE)
        self.assertTrue(CYCLE539_HYPOTHESIS_ALL_I_ONLY)
        self.assertFalse(CYCLE539_ALL_I_ONLY_CLAIM)
        self.assertEqual(CYCLE539_N_I_ONLY, 15)
        self.assertEqual(CYCLE539_N_LEAK, 0)
        self.assertEqual(STANDING_FROM_CYCLE, 539)
        ...
        for row, tokens, site in zip(self.rows, STANDING_SEQUENCES, STANDING_SITES, strict=True):
            ...
            self.assertEqual(len(row.tokens), 38)
        prior = self.survey[CYCLE539_RESULT]
        all_i_only_key = (
            "i_leftover_n6_remaining_after_090_076_remaining_after_430_076_"
            "remaining_after_076_020_remaining_after_076_010_next_38grams_all_i_only"
        )
        self.assertEqual(CYCLE539_RESULT, (
            "i_leftover_n6_remaining_after_090_076_remaining_after_430_076_"
            "remaining_after_076_020_remaining_after_076_010_next38_i_only"
        ))
        self.assertEqual(prior["cycle"], 539)
        ...
        self.assertFalse(prior[CYCLE539_RESULT])
        self.assertEqual(prior["N_i_only"], 15)
        self.assertEqual(prior["N_leak"], 0)
        self.assertEqual(prior["N_no_next38"], 3)
        self.assertEqual(prior["N_with_next38"], 15)
        self.assertNotIn(STANDING_NAMED_BY_CYCLE870, self.survey)
        self.assertEqual(self.provider.get_call_history(), [])

    def test_prior_locks_stay_locked(self):
        """Do not re-lock cycle 539 I-only or the cycle 832–870 boards."""
        ...
        self.assertEqual(STANDING_I_ONLY_CYCLE, 539)
        ...
        self.assertTrue(STANDING_DO_NOT_RELOCK_CYCLES_832_870)
        self.assertEqual(self.provider.get_call_history(), [])
    ...
    def test_measured_table_is_incomplete_set_lose(self):
        ...
        self.assertEqual(tuple(row.hits[-1] for row in self.rows), CYCLE539_N_I_EACH)
        self.assertEqual(CYCLE539_N_I_EACH, (1,) * STANDING_N)
        ...
        self.assertTrue(STANDING_NEXT37_ALL_EXTEND)
        for n37, n38, site37, site38 in zip(
            CYCLE870_SEQUENCES, STANDING_SEQUENCES, CYCLE870_SITES, STANDING_SITES, strict=True
        ):
            self.assertEqual(n38[:37], n37)
            self.assertEqual(site38, site37)
        still = self.rows[STANDING_NEXT37_HAPAX_STILL_HAPAX[0]]
        self.assertEqual(
            still.tokens,
            (
                ...
                "430", "076", "532", "200", "059", "076",
            ),
        )
        self.assertEqual(still.site, ("Ia", "Ia9", 9))
        self.assertEqual(still.as_map()["I"], 1)
        self.assertEqual(still.tokens[:37], CYCLE870_SEQUENCES[3])
        self.assertEqual(CYCLE870_SITES[3], ("Ia", "Ia9", 9))
        ...
        self.assertIn(("Ia", "Ia8", 165), STANDING_NO_NEXT38_SITES)
    ...
    def test_next_cheap_lock_is_the_locked_cycle_541_next39_list(self):
        """Cycle 541 next-39 grams are already locked and not yet reframed."""
        self.assertEqual(CYCLE541_N, 18)
        self.assertEqual(CYCLE541_N_SEQUENCES, 15)
        self.assertEqual(len(CYCLE541_SEQUENCES), 15)
        self.assertTrue(all(len(tokens) == 39 for tokens in CYCLE541_SEQUENCES))
        self.assertTrue(CYCLE541_HYPOTHESIS_ALL_I_ONLY)
        self.assertFalse(CYCLE541_ALL_I_ONLY_CLAIM)
        ...
        self.assertEqual(
            CYCLE541_NO_NEXT39_SITES,
            (("Ia", "Ia8", 167), ("Ia", "Ia8", 166), ("Ia", "Ia8", 165)),
        )
        prior = self.survey[CYCLE541_RESULT]
        all_i_only_key = (
            "i_leftover_n6_remaining_after_090_076_remaining_after_430_076_"
            "remaining_after_076_020_remaining_after_076_010_next_39grams_all_i_only"
        )
        self.assertEqual(prior["cycle"], 541)
        self.assertEqual(prior["N"], 18)
        self.assertEqual(prior["N_sequences"], 15)
        self.assertEqual(prior["N_6grams"], 18)
        self.assertTrue(prior["hypothesis_all_i_only"])
        self.assertFalse(prior[all_i_only_key])
        self.assertFalse(prior[CYCLE541_RESULT])
        self.assertEqual(prior["N_i_only"], 15)
        self.assertEqual(prior["N_leak"], 0)
        self.assertEqual(prior["N_no_next39"], 3)
        self.assertEqual(prior["N_with_next39"], 15)
        self.assertNotIn(STANDING_NEXT_CHEAP_LOCK, self.survey)
        self.assertNotIn("i_leftover_n6_next39_closed_tradition_hpq_abc", self.survey)
        self.assertEqual(
            STANDING_NEXT_CHEAP_LOCK,
            "cycle541_next39_reframed_closed_tradition_hpq_ge1_exact0_abc",
        )
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-871 incomplete-set LOSE table."""
        lock = self.survey[STANDING_RESULT]
        self.assertEqual(lock["cycle"], 871)
        ...
        self.assertEqual(
            tuple(tuple(site) for site in lock["no_next38_sites"]),
            STANDING_NO_NEXT38_SITES,
        )
        ...
        self.assertTrue(lock["do_not_relock_cycles_832_870"])
        ...
        self.assertEqual(lock["named_by_cycle867"], STANDING_NAMED_BY_CYCLE867)
        self.assertEqual(lock["named_by_cycle868"], STANDING_NAMED_BY_CYCLE868)
        self.assertEqual(lock["named_by_cycle869"], STANDING_NAMED_BY_CYCLE869)
        self.assertEqual(lock["named_by_cycle870"], STANDING_NAMED_BY_CYCLE870)
        ...
        self.assertEqual(
            tuple(lock["next37_hapax_still_hapax"]),
            STANDING_NEXT37_HAPAX_STILL_HAPAX,
        )
        self.assertTrue(lock["next37_all_extend"])
        self.assertEqual(lock["next37_all_extend"], STANDING_NEXT37_ALL_EXTEND)
