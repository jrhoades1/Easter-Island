"""I's leftover n=4 remaining remaining-after-090-076 remaining-after-430-076 remaining-after-076-020 remaining-after-076-010 leftover 4-gram previous-5-grams I-only lock.

Cycle 346 text-search lock. Uses already-vendored A–V and the
...
4-grams (N=11). Previous stem = the token immediately before
each leftover 4-gram. Previous 5-gram = previous stem plus
that leftover 4-gram. Does not retune leftover 4-gram I-only
(cycle 340 extra I=0), leftover 3-gram I-only (cycle 341
extra I=5), extra-I 4-gram I-only (cycle 342 hapax 10/0),
cycle 343 unique next stem, cycle 344 forward 5-grams I-only,
cycle 345 unique previous stem, cycle 339 unique-max 2-gram,
...
341 HOLD: contiguous 3-grams of those five leftover 4-grams
are all I-only (N_i_only=10 extra I=5). Cycle 342 HOLD:
extra-I 4-grams of leftover 3-grams with extra I are all
I-only (10 hapax 1/0). Extra-I peel of leftover 3-grams is
closed. Cycle 343 LOSE unique next stem among leftover
matching sites of the five leftover 4-grams (11 sites,
N_with_next=11, N_no_next=0). unique_max false, 11-way hapax
pile at K=1. G=760 labeling only. Nested leftover 4-gram
I-only stays nested. Cycle 344 HOLD: leftover remaining-
after-076-010 forward 5-grams (leftover 4-gram plus next stem)
are all I-only hapax 1/0 extra I=0 (N_i_only=11 N_leak=0).
Nested leftover 4-gram I-only extra I=0 stays nested. Forward
5-gram peel of remaining-after-076-010 leftover 4-grams is
closed. Cycle 345 LOSE unique previous stem among leftover
matching sites of the five leftover 4-grams (11 sites,
N_with_prev=11, N_no_prev=0). unique_max false, 11-way hapax
pile at K=1 (700 / 600 / 430 / 202 / 150 / 087 / 076 / 070 /
065 / 027 / 000). G=700 largest-id labeling only (Ia1[63]:
700 then 071 999 604 076). N_without_G=10. Nested leftover
4-gram I-only extra I=0 stays nested. Nested cycle 344 fwd5
I-only hapax 11/0 extra I=0 stays nested. Nested cycle 345
unique_max false stays nested. Do not peel labeled G with
exactly-1-share (tautology of a hapax). This cycle's
population is the 11 previous 5-grams: the token immediately
before the leftover 4-gram, plus the leftover 4-gram, at
leftover matching sites. Nested leftover 4-gram I-only stays
nested (5-grams can leak while leftover 4-grams do not).
...
stem unique_max false hapax pile stays nested. Cycle 342
extra-I 4-gram I-only HOLD hapax 10/0 stays nested. Cycle 341
...
Same claim-shape as cycle 309 leftover n=4 remaining remaining-
after-600 previous 4-grams all I-only hapax 6/0 HOLD after
cycle 308 unique previous stem hapax pile. Also analog cycle
320 leftover n=4 remaining 021 090 076 4-gram 999 021 090 076
previous 5-grams all I-only hapax 2/0 extra I=0 HOLD after
cycle 319 unique previous stem hapax pile. Also analog cycle
344 leftover remaining-after-076-010 forward 5-grams all
I-only hapax 11/0 extra I=0 HOLD after cycle 343 unique next
stem hapax pile. Cycle 219 I 090 076 070 forward 4-grams lost
7/8; 090 076 070 000 leaks 1/1 on T — the lose-path analog.
Do not lock leftover 5-grams I-only as a re-lock of leftover
4-gram I-only. Do not peel labeled G. Do not retune leftover
n=4, leftover extra peels, 076-cells, or any detector. Do not
assume the I-only result. Extra I ≠ 0 is recorded, not this
cycle's claim; do not re-lock leftover 4-gram I-only or
all-I-inside-family.

Locks exact consecutive hits of each leftover remaining-
after-076-010 previous 5-gram on tablet I and on every other
...
5-gram set is complete relative to N=11, and every such
5-gram has N_I ≥ 1 and N_off_I = 0 (N_leak=0 per 5-gram).
This can lose if any leaks onto T (or any off-I tablet), if
N != 11, if a site is line-initial so the 5-gram set is
incomplete, or if the 11 sites no longer compute as leftover
matching sites. Hapax 1/0 is expected given cycle 345 K=1 but
is not assumed. Extra I ≠ 0 does not make the claim lose
(still I-only); still lock extra I. Nested leftover 4-gram
I-only stays nested, not re-locked. Nested cycle 345
unique_max false stays nested, not re-locked. Nested cycle
344 fwd5 I-only hapax 11/0 extra I=0 stays nested, not
re-locked. Measured: each of the 11 previous 5-grams is
N_I=1 at its previous-5 start one token before the leftover
4-gram, N_off_I=0, hapax; leftover matching sites remain 11;
extra I of the 5-grams is 0. N_i_only=11, N_leak=0,
N_hapax=11, N_not_hapax=0, Ib unpublished 0. The claim is
true. Do not retune.
...
from tests.test_mamari_i_leftover_n4_remaining_021_090_076_999_021_090_076_prev5_i_only_scoreboard import (
    ...
    STANDING_N_NOT_I_ONLY as CYCLE320_N_NOT_I_ONLY,
    STANDING_SEQUENCES as CYCLE320_SEQUENCES,
...
from tests.test_mamari_i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_next_stem_scoreboard import (
    ...
    STANDING_N_DISTINCT as CYCLE343_N_DISTINCT,
    STANDING_N_HAPAX as CYCLE343_N_HAPAX,
    STANDING_N_NO_NEXT as CYCLE343_N_NO_NEXT,
    STANDING_N_WITH_NEXT as CYCLE343_N_WITH_NEXT,
    STANDING_N_WITHOUT_G as CYCLE343_N_WITHOUT_G,
    STANDING_NEXT_STEMS as CYCLE343_NEXT_STEMS,
    STANDING_TIED_STEMS as CYCLE343_TIED_STEMS,
...
from tests.test_mamari_i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_prev_stem_scoreboard import (
    ...
    STANDING_LEFTOVER_MATCHING_4GRAMS as CYCLE345_MATCHING_4GRAMS,
    STANDING_LEFTOVER_MATCHING_SITES as CYCLE345_LEFTOVER_MATCHING,
    STANDING_N as CYCLE345_N,
    STANDING_N_DISTINCT as CYCLE345_N_DISTINCT,
    STANDING_N_HAPAX as CYCLE345_N_HAPAX,
    ...
    STANDING_NO_PREV_SITES as CYCLE345_NO_PREV,
    STANDING_PREVIOUS_STEMS as CYCLE345_PREVIOUS_STEMS,
    STANDING_TIED_STEMS as CYCLE345_TIED_STEMS,
...
STANDING_N_4GRAMS = 5
STANDING_N = 11
GRAM5_430_028 = ("430", "028", "076", "011", "076")
GRAM5_202_028 = ("202", "028", "076", "011", "076")
GRAM5_027_028 = ("027", "028", "076", "011", "076")
GRAM5_700_071 = ("700", "071", "999", "604", "076")
GRAM5_065_071 = ("065", "071", "999", "604", "076")
GRAM5_076_202 = ("076", "202", "076", "006", "055")
GRAM5_150_202 = ("150", "202", "076", "006", "055")
GRAM5_070_076 = ("070", "076", "999", "029", "076")
GRAM5_000_076 = ("000", "076", "999", "029", "076")
GRAM5_087_700 = ("087", "700", "076", "076", "053")
GRAM5_600_700 = ("600", "700", "076", "076", "053")
STANDING_SEQUENCES = (
    GRAM5_430_028,
    GRAM5_202_028,
    GRAM5_027_028,
...
STANDING_LEFTOVER_4GRAMS = CYCLE340_SEQUENCES
...
STANDING_NO_PREVIOUS_SITES = STANDING_NO_PREV_SITES
...
STANDING_I_LEFTOVER_N4_REMAINING_AFTER_090_076_REMAINING_AFTER_430_076_REMAINING_AFTER_076_020_REMAINING_AFTER_076_010_PREVIOUS_5GRAMS_ALL_I_ONLY = (
    True
)
STANDING_I_LEFTOVER_N4_REMAINING_AFTER_090_076_REMAINING_AFTER_430_076_REMAINING_AFTER_076_020_REMAINING_AFTER_076_010_PREV5_I_ONLY = (
    True
)
STANDING_RESULT = (
...
STANDING_FWD5_I_ONLY_IS_NOT_THIS_CYCLE = True
...
def previous_5gram_start_site(
    ...
    """Previous 5-gram starts one token before leftover 4-gram."""
...
def leftover_4gram_site_for_prev5(
    ...
    """Leftover 4-gram starts one token after the previous-5 start."""
...
def extra_i_sites_of_5gram(
    ...
    """I 5-gram starts whose leftover 4-gram start is outside leftover matching sites."""
    leftover_set = set(leftover_matching)
    return tuple(
        site
        for site in i_sites
        if leftover_4gram_site_for_prev5(site) not in leftover_set
    )


def leftover_matching_equals_prev5_plus_one(
    ...
    """True iff leftover matching 4-gram sites equal previous-5 I sites plus one."""
    measured = set(
        leftover_4gram_site_for_prev5(site) for sites in i_sites for site in sites
    )
...
def leaking_5grams(
    ...
    """Distinct leftover previous 5-grams with N_off_I>0."""
    return tuple(
        gram
...
def i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_previous_5grams_all_i_only(
    n_i: tuple[int, ...],
    n_off_i: tuple[int, ...],
    ...
    """True iff all 11 leftover remaining-after-076-010 previous 5-grams are I-only.
    ...
    the 5-gram set is complete relative to N=11, the five leftover
    4-grams still compute, and every previous 5-gram has N_I>=1
    and N_off_I=0. Hapax is not assumed. Nested cycle 345 unique-
    max lose, cycle 344 fwd5 I-only, and leftover 4-gram I-only
    do not make this claim lose. Peeling labeled G is not this
    claim. Extra I is recorded, not a lose condition.
    """
    ...
    if previous_5grams is None:
        previous_5grams = leftover_4gram_previous_5grams(load_i_sides())
    return (
        remaining_grams == STANDING_LEFTOVER_4GRAMS
        and leftover_sites == STANDING_LEFTOVER_MATCHING_SITES
        and len(leftover_sites) == expected_n
        and len(previous_5grams) == expected_n
        and None not in previous_5grams
        and tuple(previous_5grams) == sequences
...
def leftover_previous_5gram_survey_rows(
    sequences: tuple[tuple[str, ...], ...] = STANDING_SEQUENCES,
    i_sites: tuple[tuple[tuple[str, str, int], ...], ...] = STANDING_I_SITES,
    leftover_matching: tuple[tuple[str, str, int], ...] = STANDING_LEFTOVER_MATCHING_SITES,
    n_i: tuple[int, ...] = STANDING_N_I_EACH,
    n_off_i: tuple[int, ...] = STANDING_N_OFF_I_EACH,
    extra: tuple[tuple[tuple[str, str, int], ...], ...] = STANDING_EXTRA_I_SITES,
    hapax: tuple[bool, ...] = STANDING_HAPAX_EACH,
    hits: tuple[tuple[int, ...], ...] = STANDING_HITS_BY_TABLET,
) -> list[dict]:
    """Survey-shaped per-5-gram rows."""
    rows = []
    for gram, sites, leftover_site, on, off, extra_sites, is_hapax, tablet_hits in zip(
        sequences,
        i_sites,
        leftover_matching,
        n_i,
        ...
        rows.append(
            {
                ...
                "leftover_matching_sites": [list(leftover_site)],
                "N_I": on,
                "N_on_I": on,
                "ia_hits": on,
                ...
                "N_leak": off,
                "off_i_sites": [],
                "extra_i_sites": [list(site) for site in extra_sites],
                "N_extra": len(extra_sites),
...
class TestILeftoverN4RemainingAfter090076RemainingAfter430076RemainingAfter076020RemainingAfter076010Prev5IOnlyHelpers(
    unittest.TestCase
):
    """Helpers on leftover remaining-after-076-010 previous 5-grams. No CV, no LLM."""

    def test_counts_require_consecutive_tokens(self):
        """Adjacent 5-gram counts; a gap is not a hit. Labeled G / peels are not."""
        ...
        for gram, leftover4, prev in zip(
            STANDING_SEQUENCES,
            ...
            self.assertEqual(gram[1:], leftover4)
            self.assertEqual(gram[0], prev)
            self.assertFalse(is_contiguous_substring(NEAR_MISS_090_076, leftover4))
            self.assertFalse(is_contiguous_substring(NEAR_MISS_430_076, leftover4))
            self.assertFalse(is_contiguous_substring(NEAR_MISS_076_020, leftover4))
            self.assertFalse(is_contiguous_substring(NEAR_MISS_076_010, leftover4))
        adjacent = [list(gram) for gram in STANDING_SEQUENCES]
        self.assertEqual(ngram_hit_count(adjacent, GRAM5_430_028), 1)
        self.assertEqual(ngram_hit_count(adjacent, GRAM5_700_071), 1)
        self.assertEqual(ngram_hit_count(adjacent, GRAM5_600_700), 1)
        overlap = [list(GRAM5_430_028) + list(GRAM5_430_028)]
        self.assertEqual(ngram_hit_count(overlap, GRAM5_430_028), 2)
        gapped = [list(GRAM5_430_028[:3]) + ["000"] + list(GRAM5_430_028[3:])]
        self.assertEqual(ngram_hit_count(gapped, GRAM5_430_028), 0)
        self.assertEqual(ngram_hit_count([[]], GRAM5_430_028), 0)
        self.assertEqual(ngram_hit_count([list(GRAM4_028)], GRAM5_430_028), 0)
        self.assertEqual(ngram_hit_count([list(NEAR_MISS_090_076_070_000)], GRAM5_430_028), 0)
    ...
    def test_all_i_only_requires_on_i_and_zero_off_i_for_each_5gram(self):
        """Boolean is True only when all eleven leftover previous 5-grams are I-only."""
        provider = MockProvider()
        ...
        self.assertTrue(
            i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_previous_5grams_all_i_only(
                ones, zeros, leftovers=leftover, previous_5grams=STANDING_SEQUENCES
            )
        )
        twos = (2,) * STANDING_N
        self.assertTrue(
            i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_previous_5grams_all_i_only(
                twos, zeros, leftovers=leftover, previous_5grams=STANDING_SEQUENCES
            )
        )
        leak_first = (1,) + (0,) * (STANDING_N - 1)
        self.assertFalse(
            i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_previous_5grams_all_i_only(
                ones, leak_first, leftovers=leftover, previous_5grams=STANDING_SEQUENCES
            )
        )
        leak_last = (0,) * (STANDING_N - 1) + (1,)
        self.assertFalse(
            i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_previous_5grams_all_i_only(
                ones, leak_last, leftovers=leftover, previous_5grams=STANDING_SEQUENCES
            )
        )
        missing_first = (0,) + (1,) * (STANDING_N - 1)
        self.assertFalse(
            i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_previous_5grams_all_i_only(
                missing_first, zeros, leftovers=leftover, previous_5grams=STANDING_SEQUENCES
            )
        )
        self.assertFalse(
            i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_previous_5grams_all_i_only(
                ones[:-1], zeros[:-1], leftovers=leftover, previous_5grams=STANDING_SEQUENCES
            )
        )
        incomplete = STANDING_SEQUENCES[:-1] + (None,)
        self.assertFalse(
            i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_previous_5grams_all_i_only(
                ones, zeros, leftovers=leftover, previous_5grams=incomplete
            )
        )
        dropped = tuple(row for row in leftover if row[0] != GRAM4_028)
        self.assertFalse(
            i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_previous_5grams_all_i_only(
                ones, zeros, leftovers=dropped, previous_5grams=STANDING_SEQUENCES
            )
        )
        ...
        self.assertEqual(leaking_5grams(STANDING_SEQUENCES, zeros), ())
        self.assertEqual(
            leaking_5grams(STANDING_SEQUENCES, leak_first),
            (GRAM5_430_028,),
        )
        self.assertEqual(
            leaking_5grams(STANDING_SEQUENCES, leak_last),
            (GRAM5_600_700,),
        )
    ...
    def test_leftover_matching_equals_prev5_plus_one_and_extra_is_empty(self):
        """Leftover matching 4-gram sites equal previous-5 I sites plus one; extra I of 5-grams is 0."""
        provider = MockProvider()
        self.assertTrue(
            leftover_matching_equals_prev5_plus_one(
                STANDING_LEFTOVER_MATCHING_SITES,
                STANDING_I_SITES,
            )
        )
        self.assertEqual(STANDING_LEFTOVER_MATCHING_COUNT, 11)
        for sites, leftover_site in zip(
            STANDING_I_SITES, STANDING_LEFTOVER_MATCHING_SITES, strict=True
        ):
            self.assertEqual(leftover_4gram_site_for_prev5(sites[0]), leftover_site)
            self.assertEqual(previous_5gram_start_site(leftover_site), sites[0])
            self.assertEqual(
                extra_i_sites_of_5gram(sites, STANDING_LEFTOVER_MATCHING_SITES),
                (),
            )
        self.assertEqual(STANDING_N_EXTRA, 0)
        self.assertEqual(STANDING_N_EXTRA_EACH, (0,) * STANDING_N)
    ...
    def test_5grams_are_previous_stem_plus_leftover_4gram_not_labeled_g_or_peeled(self):
        """5-grams are previous stem plus leftover 4-gram, not labeled G and not peels."""
        provider = MockProvider()
        ...
        self.assertEqual(STANDING_SEQUENCES[3], GRAM5_700_071)
        self.assertEqual(STANDING_SEQUENCES[3][0], CYCLE345_G)
        ...
        for gram in STANDING_SEQUENCES:
            ...
            self.assertNotEqual(gram[1:3], NEAR_MISS_090_076)
            self.assertEqual(len(gram), STANDING_N5)
            self.assertLess(len(gram), 8)
        self.assertEqual(GRAM5, ("999", "071", "076", "010", "079"))
        self.assertFalse(STANDING_SAME_AS_I_5GRAM)
        self.assertFalse(STANDING_SAME_AS_CYCLE345)
        self.assertFalse(STANDING_SAME_AS_CYCLE344)
        self.assertFalse(STANDING_SAME_AS_CYCLE340)
        self.assertFalse(STANDING_SAME_AS_CYCLE320)
        self.assertFalse(STANDING_SAME_AS_CYCLE309)
        self.assertTrue(STANDING_SAME_CLAIM_SHAPE_AS_CYCLE344)
...
class TestMamariILeftoverN4RemainingAfter090076RemainingAfter430076RemainingAfter076020RemainingAfter076010Prev5IOnlyScoreboard(
    unittest.TestCase
):
    """Cited-fixture remaining-after-076-010 leftover 4-gram previous 5-grams I-only. Mock only."""
    ...
    def setUp(self):
        ...
        self.previous_stems = leftover_4gram_previous_stems(
            self.i_sides,
            self.leftover_matching,
            STANDING_LEFTOVER_MATCHING_4GRAMS,
        )
        self.previous_5grams = leftover_4gram_previous_5grams(
            self.i_sides,
            self.leftover_matching,
            STANDING_LEFTOVER_MATCHING_4GRAMS,
        )
        self.with_prev = leftover_4gram_sites_with_prev(
            self.leftover_matching, self.previous_stems
        )
        self.no_prev = leftover_4gram_sites_without_prev(
            self.leftover_matching, self.previous_stems
        )
        ...
        self.claim_holds = i_leftover_n4_remaining_after_090_076_remaining_after_430_076_remaining_after_076_020_remaining_after_076_010_previous_5grams_all_i_only(
            self.i_hits,
            self.off_i_hits,
            leftovers=self.leftover,
            leftover_sites=self.leftover_matching,
            previous_5grams=self.previous_5grams,
        )

    def test_tokens_are_cycle_345_leftover_matching_previous_5grams_not_retuned(self):
        """5-grams are previous stem plus leftover 4-gram at the 11 sites."""
        self.assertEqual(self.remaining_4grams, STANDING_LEFTOVER_4GRAMS)
        self.assertEqual(self.remaining_4grams, CYCLE340_SEQUENCES)
        self.assertEqual(len(self.remaining_after), STANDING_N_4GRAMS)
        ...
        self.assertEqual(self.leftover_matching, CYCLE345_LEFTOVER_MATCHING)
        self.assertEqual(len(self.leftover_matching), STANDING_N)
        self.assertEqual(STANDING_N, 11)
        self.assertEqual(self.previous_stems, STANDING_PREVIOUS_STEMS)
        self.assertEqual(self.previous_stems, CYCLE345_PREVIOUS_STEMS)
        self.assertEqual(self.previous_5grams, STANDING_SEQUENCES)
        self.assertEqual(len(self.with_prev), STANDING_N_WITH_PREV)
        self.assertEqual(STANDING_N_WITH_PREV, 11)
        self.assertEqual(self.no_prev, STANDING_NO_PREV_SITES)
        self.assertEqual(STANDING_N_NO_PREV, 0)
        self.assertEqual(self.no_prev, CYCLE345_NO_PREV)
        ...
        self.assertEqual(prior_345["N"], 11)
        self.assertEqual(prior_345["N_with_prev"], 11)
        self.assertEqual(prior_345["N_no_prev"], 0)
        self.assertEqual(prior_345["G"], "700")
        self.assertEqual(prior_345["K"], 1)
        self.assertFalse(prior_345["unique_max"])
        self.assertFalse(
            prior_345[
        ...
        self.assertTrue(prior_345["do_not_claim_5grams_i_only"])
        self.assertTrue(STANDING_CYCLE345_DOES_NOT_COUNT)
        self.assertTrue(STANDING_UNIQUE_PREVIOUS_STEM_IS_NOT_THIS_CYCLE)
        self.assertTrue(STANDING_PEEL_LABELED_G_IS_TAUTOLOGY)
    ...
    def test_each_5gram_is_i_only_hapax_extra_zero_and_claim_holds(self):
        """Each leftover previous 5-gram is I-only hapax 1/0. Extra I of 5-grams is 0. HOLD."""
        ...
        self.assertTrue(
            leftover_matching_equals_prev5_plus_one(self.leftover_matching, self.i_sites)
        )
        ...
        for gram, sites, n_on, n_off, extra, hapax, hits, leftover4, prev, leftover_site in zip(
            STANDING_SEQUENCES,
            STANDING_I_SITES,
            STANDING_N_I_EACH,
            ...
            self.assertEqual(sites, (previous_5gram_start_site(leftover_site),))
            self.assertEqual(gram[1:], leftover4)
            self.assertEqual(gram[0], prev)
            ...
            start = previous_5gram_start_site(leftover_site)
            side, line, index = start
            ...
            leftover_stems = line_stems_for_site(self.i_sides, leftover_site)
            self.assertEqual(
                leftover_stems[leftover_site[2] : leftover_site[2] + STANDING_N4],
                list(leftover4),
            )
            self.assertEqual(leftover_stems[leftover_site[2] - 1], prev)
        for gram in STANDING_SEQUENCES:
            self.assertEqual(named_off_i_sites(gram), ())
        self.assertEqual(leaking_5grams(STANDING_SEQUENCES, self.off_i_hits), ())
        self.assertEqual(STANDING_N_I_ONLY, 11)
    ...
    def test_nested_cycle345_unique_max_still_loses_and_is_not_peeled(self):
        """Hapax-pile unique previous stem stays false; labeled G is not peeled."""
        self.assertFalse(CYCLE345_UNIQUE)
        self.assertFalse(CYCLE345_CLAIM)
        self.assertEqual(CYCLE345_G, "700")
        self.assertEqual(CYCLE345_K, 1)
        self.assertEqual(CYCLE345_N, 11)
        self.assertEqual(CYCLE345_N_WITH_PREV, 11)
        self.assertEqual(CYCLE345_N_NO_PREV, 0)
        self.assertEqual(CYCLE345_N_DISTINCT, 11)
        self.assertEqual(CYCLE345_N_HAPAX, 11)
        self.assertEqual(CYCLE345_N_WITHOUT_G, 10)
        self.assertEqual(CYCLE345_TIED_STEMS, (
            "700", "600", "430", "202", "150", "087", "076", "070", "065", "027", "000",
        ))
        self.assertEqual(len(STANDING_SEQUENCES), CYCLE345_N)
        self.assertEqual(STANDING_SEQUENCES[3][0], CYCLE345_G)
        self.assertTrue(STANDING_PEEL_LABELED_G_IS_TAUTOLOGY)
        self.assertTrue(STANDING_CYCLE345_DOES_NOT_COUNT)
        self.assertTrue(STANDING_UNIQUE_PREVIOUS_STEM_IS_NOT_THIS_CYCLE)
    ...
    def test_existing_345_344_343_342_341_340_339_338_337_334_330_320_309_and_220_scoreboards_still_compute(self):
        """Cycle 345 unique-max lose, 344/342/341/340 HOLD, analog 320/309 hapax stay."""
        leftover = leftover_n4_rows()
        ...
        self.assertEqual(len(CYCLE320_SEQUENCES), 2)
        self.assertEqual(CYCLE320_N_I_ONLY, 2)
        self.assertEqual(CYCLE320_N_HAPAX, 2)
        self.assertEqual(CYCLE320_N_NOT_I_ONLY, 0)
        self.assertEqual(CYCLE320_N_LEAK, 0)
        self.assertTrue(CYCLE320_CLAIM)
        if not prior_320.claim_holds:
            self.fail("nested cycle 320 leftover n=4 remaining 999 021 090 076 prev5 hapax 2/0 drifted")
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-346 leftover previous 5-gram I-only hold."""
        lock = self.survey[STANDING_RESULT]
        self.assertEqual(lock["cycle"], 346)
        ...
        self.assertEqual(
            [list(gram) for gram in STANDING_LEFTOVER_4GRAMS],
        ...
        self.assertTrue(lock["leftover_matching_equals_prev5_plus_one"])
        ...
        self.assertEqual(
            tuple(tuple(row) for row in lock["no_prev_sites"]),
            STANDING_NO_PREV_SITES,
        )
        ...
        expected_rows = leftover_previous_5gram_survey_rows()
        self.assertEqual(rows, expected_rows)
        for row, gram, sites, leftover_site, n_on, n_off, extra, hapax, hits in zip(
            rows,
            STANDING_SEQUENCES,
            STANDING_I_SITES,
            STANDING_LEFTOVER_MATCHING_SITES,
        ...
        self.assertEqual(lock["nested_cycle345_K"], 1)
        self.assertEqual(lock["nested_cycle345_N"], 11)
        self.assertEqual(lock["nested_cycle345_N_with_prev"], 11)
        self.assertEqual(lock["nested_cycle345_N_no_prev"], 0)
        self.assertEqual(lock["nested_cycle345_N_distinct"], 11)
        self.assertEqual(lock["nested_cycle345_N_without_G"], 10)
        self.assertTrue(lock["nested_cycle344_forward_5grams_all_i_only"])
        self.assertEqual(lock["nested_cycle344_N_i_only"], 11)
        self.assertEqual(lock["nested_cycle344_N_hapax_i_only"], 11)
        self.assertEqual(lock["nested_cycle344_N_leak"], 0)
        self.assertEqual(lock["nested_cycle344_N_extra"], 0)
        self.assertFalse(lock["nested_cycle343_unique_max"])
        self.assertEqual(lock["nested_cycle343_G"], "760")
        self.assertEqual(lock["nested_cycle343_K"], 1)
        self.assertEqual(lock["nested_cycle343_N"], 11)
        self.assertEqual(lock["nested_cycle343_N_with_next"], 11)
        self.assertEqual(lock["nested_cycle343_N_no_next"], 0)
        self.assertEqual(lock["nested_cycle343_N_distinct"], 11)
        self.assertEqual(lock["nested_cycle343_N_without_G"], 10)
        ...
        self.assertFalse(lock["same_as_cycle343"])
        ...
        self.assertTrue(lock["fwd5_i_only_is_not_this_cycle"])
        ...
        self.assertTrue(
            lock[
                "standing_i_leftover_n4_remaining_021_090_076_999_021_090_076_prev5_i_only_unchanged"
            ]
        )
        self.assertTrue(
            lock[
        ...
        self.assertFalse(prior_343["unique_max"])
        self.assertEqual(prior_343["G"], "760")
        self.assertEqual(prior_343["K"], 1)
        self.assertEqual(prior_343["N"], 11)
        ...
        prior_320 = self.survey["i_leftover_n4_remaining_021_090_076_999_021_090_076_prev5_i_only"]
        ...
        prior_309 = self.survey["i_leftover_n4_remaining_090_076_remaining_after_600_prev4_i_only"]
...
class TestMamariILeftoverN4RemainingAfter090076RemainingAfter430076RemainingAfter076020RemainingAfter076010Prev5IOnlyImageSnapshot(
    unittest.TestCase
):
    """Cycle 346 does not touch clustering. 83/62 / Hamming 6 stays."""
