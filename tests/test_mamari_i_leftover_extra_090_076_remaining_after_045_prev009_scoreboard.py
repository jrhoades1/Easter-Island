"""I's cycle-281 leftover extra remaining-after-045 previous-009 lock.

Cycle 281 text-search lock. Uses already-vendored A–V and the
...
lock. Does not overwrite cycle 275's leftover extra
remaining-after-600 remaining-after-090 remaining-after-076
previous-071 lock. Does not overwrite cycle 276's 3-gram
071 090 076 I-only 2/0 lock. Does not overwrite cycle 277's
previous-4 I-only hapax 2/0 lock. Does not overwrite cycle
278's leftover extra remaining-after-045 previous-009 lock.
Does not overwrite cycle 279's 3-gram 045 090 076 I-only 2/0
lock. Does not overwrite cycle 280's previous-4 I-only hapax
2/0 lock. Does not retune cycle 272's 3-gram 090 090 076
I-only lose 3/1 on T extra I=1. Does not retune cycle 274's
3-gram 076 090 076 I-only lose 3/1 on T extra I=1. Does not
peel T / extra-I of 090 090 076 or of 076 090 076. Does not
...
do not peel its T / extra-I this cycle. Cycle 275 peeled 071
as exact-K: leftover extra remaining-after-600 remaining-
after-090 remaining-after-076 exactly 2 share previous 071
HOLDS at Ia3[87]/Ia7[88]; N_remaining_after_090_and_076_and_071=31.
Cycle 276 locked 3-gram 071 090 076 I-only and HOLDS 2/0
extra I=0; do not retune 276. Cycle 277 locked I 071 090 076
previous 4-grams all I-only hapax HOLDS 2/0; do not retune
277. Cycle 281 peeled 045 as exact-K: leftover extra
remaining-after-600 remaining-after-090 remaining-after-076
remaining-after-045 exactly 2 share previous 009 HOLDS at
Ia1[15]/Ia2[37]; N_remaining_after_090_and_076_and_071_and_045=29.
Cycle 279 locked 3-gram 045 090 076 I-only and HOLDS 2/0
extra I=0; do not retune 279. Cycle 280 locked I 045 090 076
previous 4-grams all I-only hapax HOLDS 2/0; do not retune
280. Last tied stem by the same largest-id order is 009. Do
not lock 3-gram 009 090 076 I-only this cycle. Do not retune
leftover n=4. Do not retune the forward peel. Do not retune
previous-999 / previous-600 / previous-090 / previous-076 /
previous-071 / previous-009 clusters. Off-I T sites are not
this cycle.

Hypothesis K=2: leftover extra remaining-after-600
remaining-after-090 remaining-after-076 remaining-after-045
remaining-after-045 I 090 076 sites include exactly 2 that
share previous stem 009 (backward 3-gram 009 090 076).
Nested-check leftover extra remaining-after-045 exactly 2
share previous 009, K_045==2,
N_remaining_after_090_and_076_and_071_and_045==29,
leftover extra==56, N_I==69 (do not retune
223/224/270/271/272/273/274/275/276/277/278/279/280). On
the remaining-after-045 population (leftover extra I 090 076
whose previous token is none of 600/090/076/071/045; N=29;
also not 999 because remaining-after-600 already peeled 999),
count previous-token frequencies. Lock K_009, the sites, and
N_remaining_after_090_and_076_and_071_and_045_and_009 =
29 − K_009. Nested-check cycle 270's 5-way still includes
009 at K=2 on remaining-after-600 (before subtracting
090/076/071/045), so after peeling 090, 076, 071, and 045
the remaining-after-045 K_009 is expected 2 unless those two
009 sites were the 090/076/071/045 sites (they should not
be: previous 009 vs previous 090/076/071/045). Measured:
K_009=2 at Ia2[174], Ia5[164]; those matching remaining-
after-045 sites equal the cycle-270 remaining-after-600
previous-009 pair. Previous 4-grams 009 009 090 076 /
071 009 090 076.
N_remaining_after_090_and_076_and_071_and_045_and_009=27
(29−2). Claim that can lose:
...
True only if K_009==2 among leftover extra remaining-after-045
I 090 076. The claim is true. This can lose if nested-check K
differs from 2. Nested cycle 280 prev4 hapax 2/0, cycle 279
2/0 extra I=0, cycle 281 K_045=2 N=29 previous 4-grams
093 045 090 076 / 061 045 090 076, cycle 277 prev4 hapax
2/0, cycle 276 2/0 extra I=0, cycle 275 K_071=2 N=31,
cycle 274 3/1 extra I=1, cycle 273 K_076=2 N=33, cycle 272
3/1 extra I=1, cycle 271 K_090=2 N=35, cycle 270 unique-max
false 5-way K=2 G=090, cycle 269 6/0 N_not_hapax=0, and
cycle 268 6/0 extra I=2 stay. Do not assume the result;
...
from tests.test_mamari_i_071_090_076_previous_4grams_i_only_scoreboard import (
    STANDING_I_071_090_076_PREVIOUS_4GRAMS_ALL_I_ONLY_HAPAX as CYCLE277_ALL_HAPAX,
...
from tests.test_mamari_i_045_090_076_previous_4grams_i_only_scoreboard import (
    STANDING_I_045_090_076_PREVIOUS_4GRAMS_ALL_I_ONLY_HAPAX as CYCLE280_ALL_HAPAX,
    STANDING_N_I_ONLY as CYCLE280_N_I_ONLY,
    STANDING_N_NOT_HAPAX as CYCLE280_N_NOT_HAPAX,
    STANDING_N_NOT_I_ONLY as CYCLE280_N_NOT_I_ONLY,
    TestMamariI045090076Previous4gramsIOnlyScoreboard,
)
...
from tests.test_mamari_i_leftover_extra_090_076_remaining_after_071_prev045_scoreboard import (
    LOCKED_PREVIOUS_STEMS_AFTER_071,
    ...
    STANDING_REMAINING_AFTER_090_AND_076_AND_071_AND_045_SITES as CYCLE278_REMAINING_AFTER_090_AND_076_AND_071_AND_045_SITES,
    leftover_extra_remaining_after_090_and_076_and_071,
    leftover_extra_remaining_after_090_and_076_and_071_nested_counts_hold,
    leftover_extra_remaining_after_090_and_076_and_071_previous_stems,
    leftover_extra_remaining_after_090_and_076_and_071_with_previous_045,
    leftover_extra_remaining_after_090_and_076_and_071_without_previous_045,
    leftover_extra_remaining_after_600_with_previous_045,
...
from tests.test_mamari_i_leftover_extra_090_076_remaining_after_600_prev071_scoreboard import (
    ...
    STANDING_N_REMAINING_AFTER_090_AND_076 as CYCLE275_N_REMAINING_AFTER_090_AND_076,
    STANDING_N_REMAINING_AFTER_090_AND_076_AND_071 as CYCLE275_N_REMAINING_AFTER_090_AND_076_AND_071,
    STANDING_REMAINING_AFTER_090_AND_076_AND_071_SITES as CYCLE275_REMAINING_AFTER_090_AND_076_AND_071_SITES,
    leftover_extra_remaining_after_090_and_076,
    leftover_extra_remaining_after_090_and_076_nested_counts_hold,
    leftover_extra_remaining_after_090_and_076_previous_stems,
    ...
    leftover_extra_remaining_after_600_with_previous_071,
...
LOCKED_PREVIOUS_STEMS_AFTER_045 = (
...
STANDING_N_WITH_PREVIOUS = 29
STANDING_N_NO_PREVIOUS = 0
STANDING_NO_PREVIOUS_SITES = ()
STANDING_N_DISTINCT_REMAINING_AFTER_090_AND_076_AND_071_AND_045 = 28
STANDING_K = 2
STANDING_K_009 = 2
STANDING_G = "009"
STANDING_N_WITHOUT = 27
STANDING_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045_AND_009 = 27
STANDING_N_TIED_AT_K_AFTER_600 = 5
STANDING_TIED_STEMS_AFTER_600 = ("090", "076", "071", "045", "009")
STANDING_OTHER_TIED_STEMS = ()
STANDING_CYCLE270_K_009 = 2
STANDING_CYCLE270_K_045 = 2
STANDING_009_STILL_MAX_K_AFTER_600 = True
STANDING_REMAINING_AFTER_090_AND_076_AND_071_AND_045_SITES = (
    (SIDE_IA, "Ia1", 27),
    (SIDE_IA, "Ia1", 59),
    (SIDE_IA, "Ia1", 96),
    (SIDE_IA, "Ia2", 14),
...
STANDING_REMAINING_AFTER_090_AND_076_AND_071_AND_045_PREVIOUS_STEMS = (
    "048",
    "380",
    "011",
    "499",
...
STANDING_CYCLE270_009_SITES = (
    (SIDE_IA, "Ia2", 174),
    (SIDE_IA, "Ia5", 164),
)
STANDING_MATCHING_EQUALS_CYCLE270_009_SITES = True
STANDING_REMAINING_AFTER_090_AND_076_AND_071_AND_045_AND_009_SITES = (
    (SIDE_IA, "Ia1", 27),
    (SIDE_IA, "Ia1", 59),
    (SIDE_IA, "Ia1", 96),
    (SIDE_IA, "Ia2", 14),
...
STANDING_I_LEFTOVER_EXTRA_090_076_REMAINING_AFTER_600_REMAINING_AFTER_090_REMAINING_AFTER_076_REMAINING_AFTER_071_REMAINING_AFTER_045_EXACTLY_2_SHARE_PREVIOUS_009 = True
STANDING_RESULT = (
...
STANDING_SAME_AS_CYCLE275 = False
STANDING_SAME_AS_CYCLE276 = False
STANDING_SAME_AS_CYCLE277 = False
STANDING_SAME_AS_CYCLE278 = False
STANDING_SAME_AS_CYCLE279 = False
STANDING_SAME_AS_CYCLE280 = False
...
STANDING_SAME_CLAIM_SHAPE_AS_CYCLE275 = True
STANDING_SAME_CLAIM_SHAPE_AS_CYCLE278 = True
STANDING_OFF_I_T_SITES_ARE_NOT_THIS_CYCLE = True
STANDING_LEFTOVER_EXTRA_4GRAM_I_ONLY_IS_NOT_THIS_CYCLE = True
STANDING_I_ONLY_OF_009_090_076_IS_NOT_THIS_CYCLE = True
STANDING_DO_NOT_RETUNE_272 = True
STANDING_DO_NOT_RETUNE_274 = True
STANDING_DO_NOT_RETUNE_275 = True
STANDING_DO_NOT_RETUNE_276 = True
STANDING_DO_NOT_RETUNE_277 = True
STANDING_DO_NOT_RETUNE_278 = True
STANDING_DO_NOT_RETUNE_279 = True
STANDING_DO_NOT_RETUNE_280 = True
...
STANDING_PREVIOUS_999_600_090_076_071_045_NOT_RETUNED = True
...
STANDING_CYCLE275_NOT_OVERWRITTEN = True
STANDING_CYCLE276_NOT_RETUNED = True
STANDING_CYCLE277_NOT_RETUNED = True
STANDING_CYCLE278_NOT_OVERWRITTEN = True
STANDING_CYCLE279_NOT_RETUNED = True
STANDING_CYCLE280_NOT_RETUNED = True
...
def leftover_extra_remaining_after_090_and_076_and_071_and_045(
    sites: tuple[tuple[str, str, int], ...],
    previous_stems: tuple[str | None, ...],
    locked: tuple[str, ...] = LOCKED_PREVIOUS_STEMS_AFTER_045,
) -> tuple[tuple[str, str, int], ...]:
    """Leftover extra sites whose previous token is not 999, 600, 090, 076, 071, or 045."""
...
def leftover_extra_remaining_after_090_and_076_and_071_and_045_previous_stems(
    sites: tuple[tuple[str, str, int], ...],
    previous_stems: tuple[str | None, ...],
    locked: tuple[str, ...] = LOCKED_PREVIOUS_STEMS_AFTER_045,
) -> tuple[str, ...]:
    """Previous stems of remaining-after-045 sites that have a previous token."""
    locked_set = set(locked)
    return tuple(
        prev
...
def leftover_extra_remaining_after_090_and_076_and_071_and_045_with_previous_009(
    sites: tuple[tuple[str, str, int], ...],
    previous_stems: tuple[str | None, ...],
    stem: str = STANDING_G,
    locked: tuple[str, ...] = LOCKED_PREVIOUS_STEMS_AFTER_045,
) -> tuple[tuple[str, str, int], ...]:
    """Leftover extra remaining-after-045 sites whose previous token is 009."""
    remaining = set(
        leftover_extra_remaining_after_090_and_076_and_071_and_045(sites, previous_stems, locked)
    )
    return tuple(
        site
        for site, prev in zip(sites, previous_stems, strict=True)
...
def leftover_extra_remaining_after_090_and_076_and_071_and_045_without_previous_009(
    sites: tuple[tuple[str, str, int], ...],
    previous_stems: tuple[str | None, ...],
    stem: str = STANDING_G,
    locked: tuple[str, ...] = LOCKED_PREVIOUS_STEMS_AFTER_045,
) -> tuple[tuple[str, str, int], ...]:
    """Leftover extra remaining-after-045 sites whose previous token is not 009."""
    locked_set = set(locked)
    return tuple(
        site
        for site, prev in zip(sites, previous_stems, strict=True)
...
def leftover_extra_remaining_after_600_with_previous_009(
    sites: tuple[tuple[str, str, int], ...],
    previous_stems: tuple[str | None, ...],
    stem: str = STANDING_G,
    locked: tuple[str, ...] = LOCKED_PREVIOUS_STEMS_AFTER_600,
) -> tuple[tuple[str, str, int], ...]:
    """Leftover extra remaining-after-600 sites whose previous token is 009."""
...
def matching_equals_cycle270_009_set(
    matching_sites: tuple[tuple[str, str, int], ...],
    cycle270_045_sites: tuple[tuple[str, str, int], ...] = STANDING_CYCLE270_009_SITES,
) -> bool:
    """True iff remaining-after-045 previous-009 sites equal the cycle-270 045 pair."""
    return matching_sites == cycle270_045_sites


def matching_leftover_extra_remaining_after_090_and_076_and_071_and_045_previous_009_local_4gram_rows(
    ...
    """Survey-shaped matching leftover extra remaining-after-045 previous-009 rows."""
    rows = []
...
def leftover_extra_remaining_after_090_and_076_and_071_and_045_nested_counts_hold(
    n_i: int,
    n_leftover: int,
    k_999: int,
    ...
    k_071: int,
    n_remaining_after_090_and_076_and_071: int,
    k_045: int,
    n_remaining_after_090_and_076_and_071_and_045: int,
    ...
    expected_k_071: int = STANDING_K_071,
    expected_remaining_071: int = STANDING_N_REMAINING_AFTER_090_AND_076_AND_071,
    expected_k_045: int = STANDING_K_045,
    expected_remaining_045: int = STANDING_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045,
) -> bool:
    """Nested leftover extra 69/56, K_999=15, K_600=4, K_090=2, K_076=2, K_071=2, K_045=2, remaining-after-045=29."""
    return (
        n_i == expected_i
        ...
        and k_071 == expected_k_071
        and n_remaining_after_090_and_076_and_071 == expected_remaining_071
        and k_045 == expected_k_045
        and n_remaining_after_090_and_076_and_071_and_045 == expected_remaining_045
        ...
        and n_remaining_after_090_and_076_and_071 == n_remaining_after_090_and_076 - k_071
        and n_remaining_after_090_and_076_and_071_and_045
        == n_remaining_after_090_and_076_and_071 - k_045
    )


def i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_remaining_after_045_exactly_2_share_previous_009(
    k: int,
    expected: int = HYPOTHESIS_K,
) -> bool:
    """True iff K_009 equals the hypothesized 2."""
    return k == expected


class TestILeftoverExtra090076RemainingAfter045Previous009Helpers(unittest.TestCase):
    """Helpers on leftover extra remaining-after-045 previous 009. No CV, no LLM."""

    def test_previous_045_requires_remaining_after_071_previous_stem(self):
        """Previous stem 045 is remaining-after-045; locked 999/600/090/076/071 are not."""
        provider = MockProvider()
        self.assertEqual(GRAM2, ("090", "076"))
        self.assertEqual(GRAM3_BACKWARD, ("009", "090", "076"))
        self.assertEqual(GRAM3_NESTED_071, ("071", "090", "076"))
        ...
        self.assertEqual(LOCKED_PREVIOUS_STEMS_AFTER_045, ("999", "600", "090", "076", "071", "045"))
        ...
        has_009 = ["009", "009", "090", "076"]
        self.assertEqual(site_previous_stem(has_009, 2, GRAM2), "009")
        self.assertEqual(site_backward_3gram(has_009, 2, GRAM2), GRAM3_BACKWARD)
        self.assertEqual(
            site_previous_4gram(has_009, 2, GRAM2),
            ("009", "009", "090", "076"),
        )
        has_071_009 = ["071", "009", "090", "076"]
        self.assertEqual(site_previous_stem(has_071_009, 2, GRAM2), "009")
        self.assertEqual(
            site_previous_4gram(has_071_009, 2, GRAM2),
            ("071", "009", "090", "076"),
        )
        has_071 = ["076", "071", "090", "076"]
        self.assertEqual(site_previous_stem(has_071, 2, GRAM2), "071")
        self.assertNotEqual(site_previous_stem(has_071, 2, GRAM2), "009")
        has_076 = ["071", "076", "090", "076"]
        self.assertEqual(site_previous_stem(has_076, 2, GRAM2), "076")
        self.assertNotEqual(site_previous_stem(has_076, 2, GRAM2), "009")
        has_090 = ["011", "090", "090", "076"]
        self.assertEqual(site_previous_stem(has_090, 2, GRAM2), "090")
        self.assertNotEqual(site_previous_stem(has_090, 2, GRAM2), "009")
        has_600 = ["076", "600", "090", "076"]
        self.assertEqual(site_previous_stem(has_600, 2, GRAM2), "600")
        self.assertNotEqual(site_previous_stem(has_600, 2, GRAM2), "009")
        has_999 = ["000", "999", "090", "076"]
        self.assertEqual(site_previous_stem(has_999, 2, GRAM2), "999")
        self.assertNotEqual(site_previous_stem(has_999, 2, GRAM2), "009")
        ...
        one_token_before = ["009", "090", "076"]
        self.assertEqual(site_previous_stem(one_token_before, 1, GRAM2), "009")
        ...
        planted_stems = ("009", "045", "071", "076", "090", "999", "600", "048")
        rem = leftover_extra_remaining_after_090_and_076_and_071_and_045(planted_sites, planted_stems)
        self.assertEqual(rem, (planted_sites[0], planted_sites[7]))
        self.assertEqual(
    ...
    def test_exactly_2_can_fail(self):
        ...
        provider = MockProvider()
        self.assertTrue(
            i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_remaining_after_045_exactly_2_share_previous_009(2)
        )
        self.assertFalse(
            i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_remaining_after_045_exactly_2_share_previous_009(0)
        )
        self.assertFalse(
            i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_remaining_after_045_exactly_2_share_previous_009(1)
        )
        self.assertFalse(
            i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_remaining_after_045_exactly_2_share_previous_009(3)
        )
        self.assertFalse(
            i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_remaining_after_045_exactly_2_share_previous_009(27)
        )
        self.assertFalse(
            i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_remaining_after_045_exactly_2_share_previous_009(29)
        )
        planted = STANDING_MATCHING_SITES + ((SIDE_IA, "Ia1", 27),)
        planted_stems = ("009",) * 3
        self.assertEqual(
            leftover_extra_remaining_after_090_and_076_and_071_and_045_with_previous_009(
                planted,
        ...
        self.assertTrue(
            STANDING_I_LEFTOVER_EXTRA_090_076_REMAINING_AFTER_600_REMAINING_AFTER_090_REMAINING_AFTER_076_REMAINING_AFTER_071_REMAINING_AFTER_045_EXACTLY_2_SHARE_PREVIOUS_009
        )
        self.assertEqual(
            STANDING_I_LEFTOVER_EXTRA_090_076_REMAINING_AFTER_600_REMAINING_AFTER_090_REMAINING_AFTER_076_REMAINING_AFTER_071_REMAINING_AFTER_045_EXACTLY_2_SHARE_PREVIOUS_009,
            HYPOTHESIS_K == STANDING_K_009,
        )
        self.assertEqual(
            STANDING_K_009 + STANDING_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045_AND_009,
            STANDING_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045,
        )
        self.assertEqual(2 + 27, 29)
        self.assertEqual(
            STANDING_K_045 + STANDING_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045,
            STANDING_N_REMAINING_AFTER_090_AND_076_AND_071,
        )
        self.assertEqual(2 + 29, 31)
        self.assertEqual(
    ...
    def test_cycle270_045_sites_survive_peeling_090_076_071_and_are_not_those_sites(self):
        """Cycle-270 previous-009 pair is disjoint from previous-090/076/071; peeling them keeps K_045=2."""
        provider = MockProvider()
        self.assertTrue(matching_equals_cycle270_009_set(STANDING_MATCHING_SITES))
        self.assertTrue(STANDING_MATCHING_EQUALS_CYCLE270_009_SITES)
        self.assertEqual(STANDING_MATCHING_SITES, STANDING_CYCLE270_009_SITES)
        self.assertNotEqual(STANDING_MATCHING_SITES, CYCLE278_MATCHING_SITES)
        self.assertNotEqual(STANDING_MATCHING_SITES, CYCLE275_MATCHING_SITES)
        ...
        for site in STANDING_MATCHING_SITES:
            self.assertNotIn(site, CYCLE278_MATCHING_SITES)
            self.assertNotIn(site, CYCLE275_MATCHING_SITES)
            ...
            self.assertIn(site, CYCLE278_REMAINING_AFTER_090_AND_076_AND_071_AND_045_SITES)
        for site in CYCLE278_MATCHING_SITES:
            self.assertNotIn(site, STANDING_MATCHING_SITES)
            self.assertNotIn(site, STANDING_REMAINING_AFTER_090_AND_076_AND_071_AND_045_SITES)
        for site in CYCLE275_MATCHING_SITES:
            self.assertNotIn(site, STANDING_MATCHING_SITES)
            self.assertNotIn(site, STANDING_REMAINING_AFTER_090_AND_076_AND_071_AND_045_SITES)
        ...
        self.assertFalse(matching_equals_cycle270_009_set(planted))
        self.assertFalse(
            i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_remaining_after_045_exactly_2_share_previous_009(
                len(planted)
            )
        )
        swapped = CYCLE275_MATCHING_SITES
        self.assertFalse(matching_equals_cycle270_009_set(swapped))
        self.assertTrue(
            i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_remaining_after_045_exactly_2_share_previous_009(
                len(swapped)
            )
        ...
        self.assertIn("009", CYCLE270_TIED_STEMS)
        self.assertIn("045", CYCLE270_TIED_STEMS)
        self.assertEqual(CYCLE270_N_TIED_AT_K, 5)
        self.assertEqual(STANDING_CYCLE270_K_009, 2)
        for stem, count, sites, _grams in CYCLE270_FREQUENCY:
            if stem == "009":
                self.assertEqual(count, 2)
                self.assertEqual(sites, STANDING_CYCLE270_009_SITES)
        self.assertTrue(STANDING_I_ONLY_OF_009_090_076_IS_NOT_THIS_CYCLE)
        self.assertTrue(STANDING_I_ONLY_OF_009_090_076_IS_NOT_THIS_CYCLE)
        self.assertTrue(STANDING_DO_NOT_RETUNE_272)
        self.assertTrue(STANDING_DO_NOT_RETUNE_274)
        self.assertTrue(STANDING_DO_NOT_RETUNE_275)
        self.assertTrue(STANDING_DO_NOT_RETUNE_276)
        self.assertTrue(STANDING_DO_NOT_RETUNE_277)
        ...
        self.assertTrue(STANDING_SAME_CLAIM_SHAPE_AS_CYCLE275)
        self.assertFalse(STANDING_SAME_AS_CYCLE275)
        self.assertFalse(STANDING_SAME_AS_CYCLE276)
        self.assertFalse(STANDING_SAME_AS_CYCLE277)
        self.assertFalse(STANDING_SAME_AS_CYCLE278)
        self.assertFalse(STANDING_SAME_AS_CYCLE279)
        self.assertFalse(STANDING_SAME_AS_CYCLE280)
        ...
        self.assertTrue(CYCLE277_ALL_HAPAX)
        self.assertTrue(CYCLE278_CLAIM)
        self.assertTrue(CYCLE279_CLAIM)
        self.assertTrue(CYCLE280_ALL_HAPAX)
        self.assertEqual(provider.get_call_history(), [])


class TestMamariILeftoverExtra090076RemainingAfter045Prev009Scoreboard(
    unittest.TestCase
):
    """Cited-fixture leftover extra remaining-after-045 previous-009 lock. Mock only."""
    ...
    def setUp(self):
        ...
        self.remaining_after_090_and_076 = leftover_extra_remaining_after_090_and_076(
            self.leftover_sites,
            self.previous_stems,
        )
        self.share_071 = leftover_extra_remaining_after_090_and_076_with_previous_071(
            self.leftover_sites,
            self.previous_stems,
        )
        self.remaining_after_071 = leftover_extra_remaining_after_090_and_076_and_071(
            self.leftover_sites,
            self.previous_stems,
        )
        self.share_045 = leftover_extra_remaining_after_090_and_076_and_071_with_previous_045(
            self.leftover_sites,
            self.previous_stems,
        )
        self.remaining = leftover_extra_remaining_after_090_and_076_and_071_and_045(
            self.leftover_sites,
            self.previous_stems,
        )
        self.remaining_stems = leftover_extra_remaining_after_090_and_076_and_071_and_045_previous_stems(
            self.leftover_sites,
            self.previous_stems,
        )
        ...
        self.matching = leftover_extra_remaining_after_090_and_076_and_071_and_045_with_previous_009(
            self.leftover_sites,
            self.previous_stems,
        )
        self.without = leftover_extra_remaining_after_090_and_076_and_071_and_045_without_previous_009(
            self.leftover_sites,
            self.previous_stems,
        )
        self.share_009_after_600 = leftover_extra_remaining_after_600_with_previous_009(
            self.leftover_sites,
            self.previous_stems,
        )
        ...
        self.n_remaining_after_090_and_076 = len(self.remaining_after_090_and_076)
        self.k_071 = len(self.share_071)
        self.n_remaining_after_090_and_076_and_071 = len(self.remaining_after_071)
        self.k_045 = len(self.share_045)
        self.n_remaining_after_090_and_076_and_071_and_045 = len(self.remaining)
        self.n_with_previous = len(self.remaining_stems)
        self.n_no_previous = (
            self.n_remaining_after_090_and_076_and_071_and_045 - self.n_with_previous
        )
        self.k = len(self.matching)
        self.k_009 = self.k
        self.n_without = len(self.without)
        self.n_remaining_after_090_and_076_and_071_and_045_and_009 = (
            self.n_remaining_after_090_and_076_and_071_and_045 - self.k_009
        )
        self.k_009_after_600 = len(self.share_009_after_600)
        self.tied_after_600 = tuple(
            stem for stem, count, _sites, _grams in self.frequency_600 if count == 2
        )
        self.equals_cycle270_009 = matching_equals_cycle270_009_set(self.matching)
        self.claim_holds = i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_remaining_after_045_exactly_2_share_previous_009(
            self.k_009,
        )

    def test_tokens_and_nested_leftover_extra_56_69_k071_2_n31_not_retuned(self):
        """2-gram and leftover extra 56 / N_I=69 / K_071=2 / N_remaining_after_071=31 stay."""
        self.assertEqual(GRAM2, ("090", "076"))
        self.assertEqual(GRAM3_BACKWARD, ("009", "090", "076"))
        self.assertEqual(GRAM3_NESTED_071, ("071", "090", "076"))
        self.assertEqual(GRAM3_NESTED_076, ("076", "090", "076"))
        ...
        self.assertEqual(prior_275["N_remaining_after_090_and_076"], 33)
        self.assertEqual(prior_275["N_remaining_after_090_and_076_and_071"], 31)
        self.assertEqual(prior_275["N_leftover_extra"], 56)
        self.assertEqual(prior_275["N_I"], 69)
        self.assertTrue(
            prior_275[
        ...
        self.assertTrue(CYCLE275_CLAIM)
        self.assertEqual(CYCLE275_K_071, 2)
        self.assertEqual(CYCLE275_N_REMAINING_AFTER_090_AND_076_AND_071, 31)
        if (
            prior_275["K_071"] != 2
            or prior_275["N_remaining_after_090_and_076_and_071"] != 31
            or prior_275["N_leftover_extra"] != 56
            or prior_275["N_I"] != 69
        ):
            self.fail(
                "nested cycle 275 K_071=2 N_remaining_after_090_and_076_and_071=31 leftover extra=56 N_I=69 drifted"
            )
        ...
        self.assertEqual(prior_278["N_remaining_after_090_and_076_and_071"], 31)
        self.assertEqual(prior_278["N_remaining_after_090_and_076_and_071_and_045"], 29)
        self.assertEqual(prior_278["N_leftover_extra"], 56)
        self.assertEqual(prior_278["N_I"], 69)
        self.assertTrue(
            prior_278[
        ...
        if (
            ...
            or prior_278["N_leftover_extra"] != 56
            or prior_278["N_I"] != 69
        ):
            self.fail(
                "nested cycle 278 K_045=2 N_remaining_after_090_and_076_and_071_and_045=29 leftover extra=56 N_I=69 drifted"
            )
        prior_280 = self.survey["i_045_090_076_previous_4grams_i_only"]
        self.assertEqual(prior_280["cycle"], 280)
        self.assertEqual(prior_280["N_i_only"], 2)
        self.assertEqual(prior_280["N_not_i_only"], 0)
        self.assertEqual(prior_280["N_not_hapax"], 0)
        self.assertTrue(prior_280["i_045_090_076_previous_4grams_all_i_only_hapax"])
        self.assertTrue(CYCLE280_ALL_HAPAX)
        self.assertEqual(CYCLE280_N_I_ONLY, 2)
        self.assertEqual(CYCLE280_N_NOT_I_ONLY, 0)
        self.assertEqual(CYCLE280_N_NOT_HAPAX, 0)
        ...
        self.assertIn("045", prior_270["tied_stems_at_K"])
        ...
        self.assertTrue(STANDING_PREVIOUS_999_600_090_076_071_045_NOT_RETUNED)
        ...
        self.assertTrue(STANDING_CYCLE275_NOT_OVERWRITTEN)
        self.assertTrue(STANDING_CYCLE276_NOT_RETUNED)
        self.assertTrue(STANDING_CYCLE277_NOT_RETUNED)
        self.assertEqual(self.provider.get_call_history(), [])

    def test_counts_2_of_31_and_hypothesis_k_2_holds(self):
        """N_remaining_after_071=31, cycle-270 045 still K=2, K_045=2. Claim holds."""
        ...
        self.assertEqual(self.share_071, CYCLE275_MATCHING_SITES)
        if self.k_071 != 2:
        ...
        self.assertEqual(
            self.n_remaining_after_090_and_076_and_071,
            CYCLE275_N_REMAINING_AFTER_090_AND_076_AND_071,
        )
        self.assertEqual(
            self.n_remaining_after_090_and_076_and_071,
        ...
        if self.n_remaining_after_090_and_076_and_071 != 31:
            self.fail("measured N_remaining_after_090_and_076_and_071 drifted from 31")
        self.assertEqual(self.k_045, STANDING_K_045)
        self.assertEqual(STANDING_K_045, 2)
        self.assertEqual(self.share_045, CYCLE278_MATCHING_SITES)
        if self.k_045 != 2:
            self.fail("nested-check K_045 drifted from 2")
        self.assertEqual(
            self.n_remaining_after_090_and_076_and_071_and_045,
            STANDING_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045,
        )
        self.assertEqual(STANDING_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045, 29)
        self.assertEqual(
            self.n_remaining_after_090_and_076_and_071_and_045,
            CYCLE278_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045,
        )
        self.assertEqual(
            self.n_remaining_after_090_and_076_and_071_and_045,
            self.n_remaining_after_090_and_076_and_071 - self.k_045,
        )
        self.assertEqual(31 - 2, 29)
        if self.n_remaining_after_090_and_076_and_071_and_045 != 29:
            self.fail("measured N_remaining_after_090_and_076_and_071_and_045 drifted from 29")
        self.assertTrue(
            leftover_extra_remaining_after_090_and_076_and_071_and_045_nested_counts_hold(
                self.n_i,
                self.n_leftover,
                self.k_999,
        ...
        self.assertEqual(self.remaining, STANDING_REMAINING_AFTER_090_AND_076_AND_071_AND_045_SITES)
        self.assertEqual(self.remaining, CYCLE278_REMAINING_AFTER_090_AND_076_AND_071_AND_045_SITES)
        self.assertEqual(
        ...
        self.assertEqual(STANDING_N_WITH_PREVIOUS, 29)
        ...
        self.assertIn("009", self.tied_after_600)
        self.assertIn("045", self.tied_after_600)
        self.assertEqual(len(self.tied_after_600), STANDING_N_TIED_AT_K_AFTER_600)
        self.assertEqual(STANDING_N_TIED_AT_K_AFTER_600, 5)
        if "009" not in self.tied_after_600 or self.k_009_after_600 != 2:
            self.fail("nested cycle 270 5-way no longer includes 009 at K=2")
        self.assertEqual(self.k_009_after_600, STANDING_CYCLE270_K_009)
        self.assertEqual(STANDING_CYCLE270_K_009, 2)
        self.assertEqual(self.share_009_after_600, STANDING_CYCLE270_009_SITES)
        self.assertEqual(self.share_009_after_600, self.matching)
        self.assertTrue(STANDING_009_STILL_MAX_K_AFTER_600)
        self.assertEqual(self.k, STANDING_K)
        self.assertEqual(self.k_009, STANDING_K_009)
        self.assertEqual(STANDING_K_009, HYPOTHESIS_K)
        self.assertEqual(STANDING_K_009, 2)
        self.assertEqual(self.n_without, STANDING_N_WITHOUT)
        self.assertEqual(STANDING_N_WITHOUT, 27)
        self.assertEqual(
            self.n_remaining_after_090_and_076_and_071_and_045_and_009,
            STANDING_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045_AND_009,
        )
        self.assertEqual(STANDING_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045_AND_009, 27)
        self.assertEqual(
            self.k_009 + self.n_remaining_after_090_and_076_and_071_and_045_and_009,
            self.n_remaining_after_090_and_076_and_071_and_045,
        )
        self.assertEqual(2 + 27, 29)
        if self.k_009 != 2:
            self.fail("nested-check K_009 drifted from 2")
        ...
        self.assertEqual(self.without, STANDING_REMAINING_AFTER_090_AND_076_AND_071_AND_045_AND_009_SITES)
        self.assertTrue(self.equals_cycle270_009)
        self.assertTrue(STANDING_MATCHING_EQUALS_CYCLE270_009_SITES)
        self.assertTrue(matching_equals_cycle270_009_set(self.matching))
        if len(self.matching) != 2 or not self.equals_cycle270_009:
            self.fail(
                "leftover extra remaining-after-045 previous-009 set drifted from cycle-270 045 pair"
            )
    ...
    def test_matching_remaining_after_045_sites_have_previous_009(self):
        """Two remaining-after-045 leftover extra sites are 009 090 076."""
        self.assertEqual(self.matching, STANDING_MATCHING_SITES)
        self.assertEqual(self.matching_previous_4grams, STANDING_MATCHING_PREVIOUS_4GRAMS)
        expected = (
            ((SIDE_IA, "Ia2", 174), ("009", "009", "090", "076")),
            ((SIDE_IA, "Ia5", 164), ("071", "009", "090", "076")),
        )
        for (site, prev4), (want_site, want_prev) in zip(
            ...
            self.assertEqual(stems[index - 1], "009")
            self.assertEqual(site_previous_stem(stems, index, GRAM2), "009")
            ...
            self.assertIn(site, STANDING_CYCLE270_009_SITES)
        self.assertEqual(self.matching, STANDING_CYCLE270_009_SITES)
        self.assertTrue(matching_equals_cycle270_009_set(self.matching))
        for site in self.without:
            ...
            self.assertNotEqual(prev, "009")
            self.assertNotEqual(prev, "045")
            ...
            self.assertIn(site, self.remaining)
            self.assertIn(site, STANDING_LEFTOVER_SITES)
            self.assertNotIn(site, STANDING_CYCLE270_009_SITES)
        for site in self.share_999:
            self.assertNotIn(site, self.remaining)
            self.assertNotIn(site, self.matching)
        ...
        for site in self.share_071:
            self.assertNotIn(site, self.remaining)
            self.assertNotIn(site, self.matching)
            self.assertIn(site, CYCLE275_MATCHING_SITES)
        for site in self.share_045:
            self.assertNotIn(site, self.remaining)
            self.assertNotIn(site, self.matching)
            self.assertIn(site, CYCLE278_MATCHING_SITES)
        ...
        for site in CYCLE274_I_SITES:
            self.assertNotIn(site, self.matching)
        for site in CYCLE276_I_SITES:
            self.assertNotIn(site, self.matching)
        for stem in STANDING_OTHER_TIED_STEMS:
            other = leftover_extra_remaining_after_090_and_076_and_071_and_045_with_previous_009(
                self.leftover_sites,
                self.previous_stems,
                stem,
            )
            ...
            for site in other:
                self.assertNotIn(site, self.matching)
                self.assertIn(site, self.remaining)
        self.assertEqual(len(self.without), STANDING_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045_AND_009)
        ...
        self.assertEqual(
            matching_leftover_extra_remaining_after_090_and_076_and_071_and_045_previous_009_local_4gram_rows(),
            [
                {
                    "tablet": "I",
                    "side": SIDE_IA,
                    "line": "Ia2",
                    "index": 174,
                    "previous_4gram": ["009", "009", "090", "076"],
                    "backward_3gram": ["009", "090", "076"],
                },
                {
                    "tablet": "I",
                    "side": SIDE_IA,
                    "line": "Ia5",
                    "index": 164,
                    "previous_4gram": ["071", "009", "090", "076"],
                    "backward_3gram": ["009", "090", "076"],
                },
            ],
        )
    ...
    def test_existing_280_279_278_277_276_275_274_273_272_271_270_269_268_and_223_still_compute(self):
        """Cycle 280 2/0, 279 2/0 extra I=0, 278 K_045=2/29, 277 2/0 stay."""
        prior_280 = TestMamariI045090076Previous4gramsIOnlyScoreboard()
        prior_280.setUp()
        prior_280.test_survey_matches_computed_lock()
        self.assertTrue(CYCLE280_ALL_HAPAX)
        self.assertEqual(CYCLE280_N_I_ONLY, 2)
        self.assertEqual(CYCLE280_N_NOT_I_ONLY, 0)
        self.assertEqual(CYCLE280_N_NOT_HAPAX, 0)
        if (
            CYCLE280_N_I_ONLY != 2
            or CYCLE280_N_NOT_I_ONLY != 0
            or CYCLE280_N_NOT_HAPAX != 0
            or not CYCLE280_ALL_HAPAX
        ):
            self.fail("nested cycle 280 prev4 hapax 2/0 N_not_hapax=0 drifted")
        ...
        self.assertEqual(prior_279.i_hits, CYCLE279_N_I)
        self.assertEqual(prior_279.i_hits, 2)
        self.assertEqual(prior_279.off_i_hits, CYCLE279_N_OFF_I)
        ...
        self.assertTrue(prior_279.claim_holds)
        self.assertTrue(CYCLE279_CLAIM)
        self.assertEqual(CYCLE279_N_I, 2)
        self.assertEqual(CYCLE279_N_OFF_I, 0)
        self.assertEqual(CYCLE279_N_EXTRA, 0)
        ...
        self.assertEqual(prior_278.k_045, 2)
        self.assertEqual(prior_278.n_remaining_after_090_and_076_and_071_and_045, 29)
        self.assertEqual(prior_278.matching, CYCLE278_MATCHING_SITES)
        self.assertEqual(prior_278.matching_previous_4grams, CYCLE278_MATCHING_PREVIOUS_4GRAMS)
        self.assertTrue(prior_278.claim_holds)
        self.assertTrue(CYCLE278_CLAIM)
        self.assertEqual(CYCLE278_K_045, 2)
        self.assertEqual(CYCLE278_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045, 29)
        self.assertEqual(
            CYCLE278_MATCHING_PREVIOUS_4GRAMS,
            (("093", "045", "090", "076"), ("061", "045", "090", "076")),
        )
        if (
            prior_278.k_045 != 2
            or prior_278.n_remaining_after_090_and_076_and_071_and_045 != 29
            or prior_278.matching_previous_4grams != CYCLE278_MATCHING_PREVIOUS_4GRAMS
        ):
            self.fail(
        ...
        if (
            CYCLE277_N_I_ONLY != 2
            or CYCLE277_N_NOT_I_ONLY != 0
            or CYCLE277_N_NOT_HAPAX != 0
            or not CYCLE277_ALL_HAPAX
        ):
        ...
        self.assertEqual(prior_276.i_hits, CYCLE276_N_I)
        self.assertEqual(prior_276.i_hits, 2)
        self.assertEqual(prior_276.off_i_hits, CYCLE276_N_OFF_I)
        ...
        self.assertTrue(prior_276.claim_holds)
        self.assertTrue(CYCLE276_CLAIM)
        self.assertEqual(CYCLE276_N_I, 2)
        self.assertEqual(CYCLE276_N_OFF_I, 0)
        self.assertEqual(CYCLE276_N_EXTRA, 0)
        ...
        self.assertEqual(prior_275.k_071, 2)
        self.assertEqual(prior_275.n_remaining_after_090_and_076_and_071, 31)
        self.assertEqual(prior_275.matching, CYCLE275_MATCHING_SITES)
        self.assertEqual(prior_275.matching_previous_4grams, CYCLE275_MATCHING_PREVIOUS_4GRAMS)
        self.assertTrue(prior_275.claim_holds)
        self.assertTrue(CYCLE275_CLAIM)
        self.assertEqual(CYCLE275_K_071, 2)
        self.assertEqual(CYCLE275_N_REMAINING_AFTER_090_AND_076_AND_071, 31)
        self.assertEqual(
            CYCLE275_MATCHING_PREVIOUS_4GRAMS,
            (("076", "071", "090", "076"), ("092", "071", "090", "076")),
        )
        if (
            prior_275.k_071 != 2
            or prior_275.n_remaining_after_090_and_076_and_071 != 31
            or prior_275.matching_previous_4grams != CYCLE275_MATCHING_PREVIOUS_4GRAMS
        ):
            self.fail(
        ...
        if prior_273.k_076 != 2 or prior_273.n_remaining_after_090_and_076 != 33:
            self.fail("nested cycle 273 K_076=2 N_remaining_after_090_and_076=33 drifted")
        ...
        self.assertTrue(CYCLE271_CLAIM)
        if prior_271.k_090 != 2 or prior_271.n_remaining_after_090 != 35:
            self.fail("nested cycle 271 K_090=2 N_remaining_after_090=35 drifted")
        ...
        self.assertIn("009", tied)
        self.assertIn("045", tied)
        ...
        if (
            ...
            self.fail(
                ...
                "5-way tie G=090 K=2 including 009 drifted"
            )
        ...
        self.assertEqual(CYCLE269_N_I_ONLY, 6)
        self.assertEqual(CYCLE269_N_NOT_HAPAX, 0)
        if CYCLE269_N_I_ONLY != 6 or CYCLE269_N_NOT_HAPAX != 0:
            self.fail("nested cycle 269 6/0 N_not_hapax=0 drifted")
        ...
        unused_275 = CYCLE275_N_REMAINING_AFTER_090_AND_076_AND_071
        self.assertEqual(unused_275, 31)
        ...
        unused_276 = CYCLE276_N_EXTRA
        self.assertEqual(unused_276, 0)
        unused_277 = CYCLE277_N_NOT_HAPAX
        self.assertEqual(unused_277, 0)
        unused_268 = CYCLE268_N_EXTRA
        self.assertEqual(unused_268, 2)
        unused_269 = CYCLE269_N_NOT_HAPAX
        self.assertEqual(unused_269, 0)
        ...
        unused_after_076_stems = leftover_extra_remaining_after_090_and_076_previous_stems
        self.assertTrue(callable(unused_after_076_stems))
        unused_after_071 = leftover_extra_remaining_after_090_and_076_and_071
        self.assertTrue(callable(unused_after_071))
        unused_after_045 = leftover_extra_remaining_after_090_and_076_and_071_and_045
        self.assertTrue(callable(unused_after_045))
        unused_278_n = CYCLE278_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045
        self.assertEqual(unused_278_n, 29)
        unused_280 = CYCLE280_N_NOT_HAPAX
        self.assertEqual(unused_280, 0)
        unused_279 = CYCLE279_N_EXTRA
        self.assertEqual(unused_279, 0)
        ...
        unused_275_n076 = CYCLE275_N_REMAINING_AFTER_090_AND_076
        self.assertEqual(unused_275_n076, 33)
        unused_273_n090 = CYCLE273_N_REMAINING_AFTER_090
        self.assertEqual(unused_273_n090, 35)
        unused_272_n_i = CYCLE272_N_I
        self.assertEqual(unused_272_n_i, 3)
        unused_272_sites = CYCLE272_I_SITES
        self.assertEqual(len(unused_272_sites), 3)
        unused_272_off = CYCLE272_OFF_I_SITES
        self.assertEqual(len(unused_272_off), 1)
        unused_274_off = CYCLE274_OFF_I_SITES
        self.assertEqual(len(unused_274_off), 1)
        unused_273_sites = CYCLE273_REMAINING_AFTER_090_AND_076_SITES
        self.assertEqual(len(unused_273_sites), 33)
        unused_without_076 = leftover_extra_remaining_after_090_without_previous_076
        self.assertTrue(callable(unused_without_076))
        unused_after_090 = leftover_extra_remaining_after_090
        self.assertTrue(callable(unused_after_090))
        unused_071_after_600 = leftover_extra_remaining_after_600_with_previous_071
        self.assertTrue(callable(unused_071_after_600))
        self.assertTrue(STANDING_FORWARD_PEEL_NOT_RETUNED)
        self.assertTrue(STANDING_I_ONLY_OF_009_090_076_IS_NOT_THIS_CYCLE)
        self.assertTrue(STANDING_DO_NOT_RETUNE_272)
        self.assertTrue(STANDING_DO_NOT_RETUNE_274)
    ...
    def test_survey_matches_computed_lock(self):
        """CORPUS_SURVEY.json records the cycle-281 leftover extra remaining-after-045 previous-009 lock."""
        lock = self.survey[
            "i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_remaining_after_045_previous_009"
        ]
        self.assertEqual(lock["cycle"], 281)
        ...
        self.assertEqual(tuple(lock["backward_3gram"]), ("009", "090", "076"))
        self.assertEqual(lock["n3"], STANDING_N3)
        self.assertEqual(lock["n4"], STANDING_N4)
        self.assertEqual(
            tuple(lock["locked_previous_stems_after_045"]),
            LOCKED_PREVIOUS_STEMS_AFTER_045,
        )
        self.assertEqual(
            tuple(lock["locked_previous_stems_after_045"]),
            ("999", "600", "090", "076", "071", "045"),
        )
        ...
        self.assertEqual(lock["K_045"], STANDING_K_045)
        self.assertEqual(lock["K_045"], 2)
        self.assertEqual(
            tuple(tuple(row) for row in lock["share_045_sites"]),
            CYCLE278_MATCHING_SITES,
        )
        self.assertEqual(
            lock["N_remaining_after_090_and_076_and_071_and_045"],
            STANDING_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045,
        )
        self.assertEqual(lock["N_remaining_after_090_and_076_and_071_and_045"], 29)
        self.assertEqual(
            tuple(tuple(row) for row in lock["remaining_after_090_and_076_and_071_and_045_sites"]),
            STANDING_REMAINING_AFTER_090_AND_076_AND_071_AND_045_SITES,
        )
        self.assertEqual(
            tuple(lock["remaining_after_090_and_076_and_071_and_045_previous_stems"]),
            STANDING_REMAINING_AFTER_090_AND_076_AND_071_AND_045_PREVIOUS_STEMS,
        )
        self.assertEqual(lock["N_with_previous"], STANDING_N_WITH_PREVIOUS)
        self.assertEqual(lock["N_with_previous"], 29)
        ...
        self.assertEqual(
            lock["N_distinct_remaining_after_090_and_076_and_071_and_045"],
            STANDING_N_DISTINCT_REMAINING_AFTER_090_AND_076_AND_071_AND_045,
        )
        self.assertEqual(lock["N_distinct_remaining_after_090_and_076_and_071_and_045"], 28)
        self.assertEqual(lock["G"], STANDING_G)
        self.assertEqual(lock["G"], "009")
        ...
        self.assertEqual(lock["cycle270_K_009"], STANDING_CYCLE270_K_009)
        self.assertEqual(lock["cycle270_K_009"], 2)
        self.assertTrue(lock["009_still_max_K_after_600"])
        ...
        self.assertEqual(lock["N_without"], 27)
        self.assertEqual(
            lock["N_remaining_after_090_and_076_and_071_and_045_and_009"],
            STANDING_N_REMAINING_AFTER_090_AND_076_AND_071_AND_045_AND_009,
        )
        self.assertEqual(lock["N_remaining_after_090_and_076_and_071_and_045_and_009"], 27)
        self.assertEqual(
            tuple(tuple(row) for row in lock["matching_leftover_extra_remaining_after_045_sites"]),
            STANDING_MATCHING_SITES,
        )
        self.assertEqual(
            tuple(tuple(row) for row in lock["matching_leftover_extra_remaining_after_045_sites"]),
        ...
        self.assertTrue(lock["matching_equals_cycle270_009_sites"])
        self.assertEqual(
            lock["matching_equals_cycle270_009_sites"],
            STANDING_MATCHING_EQUALS_CYCLE270_009_SITES,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            lock["matching_leftover_extra_remaining_after_045_local_4grams"],
            matching_leftover_extra_remaining_after_090_and_076_and_071_and_045_previous_009_local_4gram_rows(),
        )
        self.assertEqual(
            tuple(tuple(row) for row in lock["remaining_after_090_and_076_and_071_and_045_and_009_sites"]),
            STANDING_REMAINING_AFTER_090_AND_076_AND_071_AND_045_AND_009_SITES,
        )
        self.assertEqual(
            tuple(tuple(row) for row in lock["cycle270_009_sites"]),
            STANDING_CYCLE270_009_SITES,
        )
        ...
        self.assertIn("009", lock["cycle270_tied_stems_at_K"])
        self.assertIn("045", lock["cycle270_tied_stems_at_K"])
        ...
        self.assertEqual(lock["nested_cycle280_N_i_only"], 2)
        self.assertEqual(lock["nested_cycle280_N_not_i_only"], 0)
        self.assertEqual(lock["nested_cycle280_N_not_hapax"], 0)
        self.assertTrue(lock["nested_cycle280_all_i_only_hapax"])
        ...
        self.assertTrue(lock["nested_cycle279_i_only"])
        ...
        self.assertTrue(lock["nested_cycle278_exactly_2_share_previous_045"])
        ...
        self.assertEqual(lock["nested_cycle275_N_remaining_after_090_and_076"], 33)
        ...
        self.assertTrue(lock["nested_cycle275_exactly_2_share_previous_071"])
        ...
        self.assertIn("009", lock["nested_cycle270_tied_stems_at_K"])
        self.assertIn("045", lock["nested_cycle270_tied_stems_at_K"])
        ...
        self.assertFalse(lock["same_as_cycle275"])
        self.assertFalse(lock["same_as_cycle276"])
        self.assertFalse(lock["same_as_cycle277"])
        self.assertFalse(lock["same_as_cycle278"])
        self.assertFalse(lock["same_as_cycle279"])
        self.assertFalse(lock["same_as_cycle280"])
        ...
        self.assertTrue(lock["same_claim_shape_as_cycle275"])
        self.assertTrue(lock["same_claim_shape_as_cycle278"])
        self.assertTrue(lock["off_i_t_sites_are_not_this_cycle"])
        self.assertTrue(lock["leftover_extra_4gram_i_only_is_not_this_cycle"])
        self.assertTrue(lock["i_only_of_009_090_076_is_not_this_cycle"])
        self.assertTrue(lock["do_not_retune_272"])
        self.assertTrue(lock["do_not_retune_274"])
        self.assertTrue(lock["do_not_retune_275"])
        self.assertTrue(lock["do_not_retune_276"])
        self.assertTrue(lock["do_not_retune_277"])
        self.assertTrue(lock["do_not_retune_278"])
        self.assertTrue(lock["do_not_retune_279"])
        self.assertTrue(lock["do_not_retune_280"])
        ...
        self.assertTrue(lock["previous_999_600_090_076_071_045_not_retuned"])
        ...
        self.assertTrue(lock["cycle275_not_overwritten"])
        self.assertTrue(lock["cycle276_not_retuned"])
        self.assertTrue(lock["cycle277_not_retuned"])
        self.assertTrue(lock["cycle278_not_overwritten"])
        self.assertTrue(lock["cycle279_not_retuned"])
        self.assertTrue(lock["cycle280_not_retuned"])
        ...
        self.assertTrue(lock["standing_i_045_090_076_previous_4grams_i_only_unchanged"])
        self.assertTrue(lock["standing_i_3gram_045_090_076_i_only_unchanged"])
        self.assertTrue(
            lock["standing_i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_previous_045_unchanged"]
        )
        ...
        self.assertTrue(
            lock["standing_i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_previous_071_unchanged"]
        )
        ...
        self.assertEqual(
            self.survey["i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_previous_045"]["cycle"],
            278,
        )
        self.assertEqual(
            self.survey["i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_previous_045"]["K_045"],
            2,
        )
        self.assertEqual(
            self.survey["i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_remaining_after_071_previous_045"][
        ...
        self.assertEqual(self.survey["i_045_090_076_previous_4grams_i_only"]["cycle"], 280)
        self.assertEqual(self.survey["i_045_090_076_previous_4grams_i_only"]["N_i_only"], 2)
        self.assertEqual(self.survey["i_045_090_076_previous_4grams_i_only"]["N_not_i_only"], 0)
        self.assertEqual(self.survey["i_045_090_076_previous_4grams_i_only"]["N_not_hapax"], 0)
        self.assertTrue(
            self.survey["i_045_090_076_previous_4grams_i_only"][
                "i_045_090_076_previous_4grams_all_i_only_hapax"
            ]
        )
        self.assertEqual(
            self.survey["i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_previous_071"]["cycle"],
            275,
        )
        self.assertTrue(
            self.survey["i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_previous_071"][
                "i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_exactly_2_share_previous_071"
            ]
        )
        self.assertEqual(
            self.survey["i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_previous_071"]["K_071"],
            2,
        )
        self.assertEqual(
            self.survey["i_leftover_extra_090_076_remaining_after_600_remaining_after_090_remaining_after_076_previous_071"][
        ...
        self.assertEqual(self.survey["i_071_090_076_previous_4grams_i_only"]["N_not_i_only"], 0)
...
class TestMamariILeftoverExtra090076RemainingAfter045Prev009ImageSnapshot(
    unittest.TestCase
):
    """Cycle 281 does not touch clustering. 83/62 / Hamming 6 stays."""
